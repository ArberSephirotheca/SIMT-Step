module {
  func.func @main(%arg0: i32) attributes {simt.num_threads = array<i64: 1, 1, 1>} {
    ...
    %1:4 = "simt_step.switch"(%0, %c10_i32, %false, %false, %false) ({
    ^bb0(%arg1: i32, %arg2: i1, %arg3: i1, %arg4: i1):
      ...
      %9:4 = "simt_step.if"(%8) ({
        ...
        %44 = arith.addi %arg1, %c1_i32_10 : i32
        %45 = arith.ori %arg2, %6 : i1
        "simt_step.yield"(%44, %45, %true, %arg4) : (i32, i1, i1, i1) -> ()
      }, {
    ...
    ^bb1(%10: i32, %11: i1, %12: i1, %13: i1):  // no predecessors
      ...
      %14 = arith.cmpi eq, %13, %false_1 : i1
      %15 = arith.cmpi eq, %11, %false_1 : i1
      ...
      %21:4 = "simt_step.if"(%20) ({
        ...
        %44 = arith.addi %10, %c2_i32_10 : i32
        "simt_step.yield"(%44, %true_7, %false_8, %true_9) : (i32, i1, i1, i1) -> ()
      }, {
    ...
    ^bb2(%22: i32, %23: i1, %24: i1, %25: i1):  // no predecessors
      ...
      %26 = arith.cmpi eq, %25, %false_3 : i1
      %27 = arith.cmpi eq, %23, %false_3 : i1
      ...
      %33:4 = "simt_step.if"(%32) ({
        ...
        %44 = arith.addi %22, %c4_i32 : i32
        %45 = arith.ori %23, %30 : i1
        "simt_step.yield"(%44, %45, %true_4, %25) : (i32, i1, i1, i1) -> ()
      }, {
    ...
    ^bb3(%34: i32, %35: i1, %36: i1, %37: i1):  // no predecessors
      ...
      %38 = arith.cmpi eq, %37, %false_5 : i1
      %39 = arith.cmpi eq, %35, %false_5 : i1
