module {
  func.func @main(%arg0: i32) attributes {simt.num_threads = array<i64: 1, 1, 1>} {
    ...
    simt_step.fence {scope = #simt_step.scope<Workgroup>, memsem = #simt_step.memsem<AcqRel>, memspace = #simt_step.memspace<Global>}
    simt_step.fence {scope = #simt_step.scope<Workgroup>, memsem = #simt_step.memsem<AcqRel>, memspace = #simt_step.memspace<Global>}
    simt_step.barrier {scope = #simt_step.scope<Workgroup>, memsem = #simt_step.memsem<AcqRel>}
    simt_step.fence {scope = #simt_step.scope<Workgroup>, memsem = #simt_step.memsem<AcqRel>, memspace = #simt_step.memspace<Generic>}
    simt_step.fence {scope = #simt_step.scope<Workgroup>, memsem = #simt_step.memsem<AcqRel>, memspace = #simt_step.memspace<Generic>}
    simt_step.barrier {scope = #simt_step.scope<Workgroup>, memsem = #simt_step.memsem<AcqRel>}
    return
  }
