module {
  func.func @main(
      %arg0: !simt_step.resource<Shared, f16>,
      %arg1: !simt_step.resource<Global, f32>)
    ...
    %a = "simt_step.wmma_load_matrix"(%arg0, %base, %stride)
        : (!simt_step.resource<Shared, f16>, i32, i32)
        -> !simt_step.wmma_fragment<MatrixA, 16 x 16 x 16, f16, ColMajor>
    %b = "simt_step.wmma_load_matrix"(%arg0, %base, %stride)
        : (!simt_step.resource<Shared, f16>, i32, i32)
    ...
    %res = "simt_step.wmma_mma"(%a, %b, %acc)
        ...
        -> !simt_step.wmma_fragment<Accumulator, 16 x 16 x 16, f32, None>
    "simt_step.wmma_store_matrix"(%arg1, %base, %stride, %res)
        {layout = 1 : i32}
