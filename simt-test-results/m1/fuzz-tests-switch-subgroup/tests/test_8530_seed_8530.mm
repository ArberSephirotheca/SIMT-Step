...
inline void helper0(int v0, device int* v1, int v2, int v3, int __simt_tid){
  ...
  int v151 = 0;
  bool v152 = v2 != v151;
  int v153 = v152 ? v5 : v12;
  return;
}

kernel void kernel_main(device int* v154 [[buffer(0)]], device int* v155 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v156 = static_cast<int>(__simt_tid3.x);
  int v157 = 0;
  int v158 = v157 + v156;
  int v159 = v155[v158];
  int v160 = 4;
  int v161 = v160 + v156;
  int v162 = v155[v161];
  helper0(v156, v154, v159, v162, static_cast<int>(__simt_tid3.x));
  int v163 = 8;
  int v164 = v163 + v156;
  int v165 = v155[v164];
  int v166;
