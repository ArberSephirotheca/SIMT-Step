...
kernel void kernel_main(device int* v148 [[buffer(0)]], device int* v149 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  ...
  int v278 = v277 + v150;
  int v279 = v149[v278];
  uint v280 = simt_lane_id(static_cast<int>(__simt_tid3.x));
  int v281 = (int)(v280);
  int v282;
  v282 = v281;
  switch (v279) {
    ...
    case 1:
      ...
      int v389 = v388 + v150;
      int v390 = v149[v389];
      uint v391 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
      int v392 = (int)(v391);
      int v393;
      v393 = v392;
      switch (v390) {
        case 0:
          ...
          switch (v396) {
            ...
            default:
              ...
              int v406 = v405 + v150;
              bool v407 = true;
              int v408 = simt_wave_count_bits(v407);
              v148[v406] = v408;
              v399 = v403;
              break;
            }
        ...
        case 1:
          ...
          int v415 = v414 + v150;
          int v416 = v149[v415];
          uint v417 = simt_lane_id(static_cast<int>(__simt_tid3.x));
          int v418 = (int)(v417);
          int v419;
          v419 = v418;
          switch (v416) {
        ...
        default:
          ...
          switch (v427) {
            ...
            case 0:
              {
              uint v433 = simt_lane_id(static_cast<int>(__simt_tid3.x));
              int v434 = (int)(v433);
              bool v435 = true;
              int v436 = 672;
              int v437 = v436 + v150;
            ...
            case 1:
              {
              uint v440 = simt_lane_id(static_cast<int>(__simt_tid3.x));
              int v441 = (int)(v440);
              bool v442 = true;
              int v443 = 688;
              int v444 = v443 + v150;
