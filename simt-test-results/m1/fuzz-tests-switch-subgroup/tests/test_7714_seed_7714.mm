  ...
  switch (v5) {
    ...
    case 2:
      ...
      switch (v102) {
        ...
        case 1:
          {
          uint v142 = simt_lane_id(__simt_tid);
          int v143 = (int)(v142);
          int v144;
          v144 = v143;
          switch (v3) {
...
kernel void kernel_main(device int* v168 [[buffer(0)]], device int* v169 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v170 = static_cast<int>(__simt_tid3.x);
  int v171 = 0;
  int v172 = v171 + v170;
  int v173 = v169[v172];
  int v174 = 4;
  int v175 = v174 + v170;
  int v176 = v169[v175];
  helper0(v170, v168, v173, v176, static_cast<int>(__simt_tid3.x));
  int v177 = 0;
  int v178 = 0;
  int v179;
  int v180;
  ...
  if (v416) {
    ...
    if (v422) {
      ...
      int v433 = v432 + v170;
      bool v434 = true;
      int v435 = simt_wave_count_bits(v434);
      v168[v433] = v435;
      v423 = v429;
    } else {
      int v436 = 0;
      ...
      while (true) {
        ...
        int v456 = v455 + v170;
        bool v457 = true;
        int v458 = simt_wave_count_bits(v457);
        v168[v456] = v458;
        v438 = v448;
        v439 = v450;
      }
