...
kernel void kernel_main(device int* v133 [[buffer(0)]], device int* v134 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  ...
  if (v146) {
    ...
    if (v229) {
      ...
      if (v235) {
        ...
        uint v239 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
        int v240 = (int)(v239);
        v236 = v240;
      }
      int v241 = 400;
  ...
  int v323 = v322 + v135;
  int v324 = v134[v323];
  uint v325 = simt_lane_id(static_cast<int>(__simt_tid3.x));
  int v326 = (int)(v325);
  int v327;
  v327 = v326;
  switch (v324) {
      ...
      switch (v378) {
        ...
        case 1:
          ...
          switch (v391) {
            case 0:
              {
              uint v395 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
              int v396 = (int)(v395);
              bool v397 = true;
              int v398 = 560;
              int v399 = v398 + v135;
    ...
    default:
      ...
      switch (v439) {
        ...
        default:
          ...
          int v470;
          if (v469) {
            uint v471 = simt_lane_id(static_cast<int>(__simt_tid3.x));
            int v472 = (int)(v471);
            v470 = v472;
          } else {
            uint v473 = simt_lane_id(static_cast<int>(__simt_tid3.x));
            int v474 = (int)(v473);
            v470 = v474;
          }
          int v475 = 640;
