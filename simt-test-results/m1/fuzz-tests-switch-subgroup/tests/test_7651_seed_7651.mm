...
kernel void kernel_main(device int* v68 [[buffer(0)]], device int* v69 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  ...
  if (v409) {
    ...
    if (v461) {
      ...
      int v468;
      if (v467) {
        uint v469 = simt_lane_id(static_cast<int>(__simt_tid3.x));
        int v470 = (int)(v469);
        v468 = v470;
      } else {
        v468 = v70;
      ...
      switch (v477) {
        case 0:
          {
          uint v480 = simt_lane_id(static_cast<int>(__simt_tid3.x));
          int v481 = (int)(v480);
          bool v482 = true;
          int v483 = 560;
          int v484 = v483 + v70;
        ...
        case 1:
          {
          uint v487 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
          int v488 = (int)(v487);
          v479 = v488;
          break;
        }
        default:
          {
          uint v489 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
          int v490 = (int)(v489);
          v479 = v490;
          break;
        }
