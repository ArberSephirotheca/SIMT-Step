...
kernel void kernel_main(device int* v129 [[buffer(0)]], device int* v130 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  ...
  switch (v140) {
    ...
    default:
      ...
      if (v303) {
        ...
        int v306 = v305 + v131;
        int v307 = v130[v306];
        uint v308 = simt_lane_id(static_cast<int>(__simt_tid3.x));
        int v309 = (int)(v308);
        int v310;
        v310 = v309;
        switch (v307) {
          case 0:
            {
            uint v311 = simt_lane_id(static_cast<int>(__simt_tid3.x));
            int v312 = (int)(v311);
            bool v313 = true;
            int v314 = 480;
            int v315 = v314 + v131;
          ...
          case 1:
            {
            uint v323 = simt_lane_id(static_cast<int>(__simt_tid3.x));
            int v324 = (int)(v323);
            bool v325 = true;
            int v326 = 512;
            int v327 = v326 + v131;
  ...
  int v399 = v398 + v131;
  int v400 = v130[v399];
  uint v401 = simt_lane_id(static_cast<int>(__simt_tid3.x));
  int v402 = (int)(v401);
  int v403;
  v403 = v402;
  switch (v400) {
