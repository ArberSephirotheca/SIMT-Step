...
kernel void kernel_main(device int* v62 [[buffer(0)]], device int* v63 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  ...
  if (v244) {
    ...
    if (v330) {
      ...
      int v333 = v332 + v64;
      int v334 = v63[v333];
      uint v335 = simt_lane_id(static_cast<int>(__simt_tid3.x));
      int v336 = (int)(v335);
      int v337;
      v337 = v336;
      switch (v334) {
        ...
        case 2:
          {
          uint v344 = simt_lane_id(static_cast<int>(__simt_tid3.x));
          int v345 = (int)(v344);
          v337 = v345;
        }
        default:
  ...
  int v381 = v380 + v64;
  int v382 = v63[v381];
  uint v383 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
  int v384 = (int)(v383);
  int v385;
  v385 = v384;
  switch (v382) {
      ...
      switch (v416) {
        ...
        case 0:
          ...
          switch (v449) {
            case 0:
              {
              uint v453 = simt_lane_id(static_cast<int>(__simt_tid3.x));
              int v454 = (int)(v453);
              v452 = v454;
              break;
            }
        ...
        case 1:
          ...
          switch (v463) {
            case 0:
              {
              uint v467 = simt_lane_id(static_cast<int>(__simt_tid3.x));
              int v468 = (int)(v467);
              bool v469 = true;
              int v470 = 512;
              int v471 = v470 + v64;
    ...
    case 1:
      ...
      int v505 = v504 + v64;
      bool v506 = true;
      int v507 = simt_wave_count_bits(v506);
      v62[v505] = v507;
      v385 = v499;
      break;
    }
