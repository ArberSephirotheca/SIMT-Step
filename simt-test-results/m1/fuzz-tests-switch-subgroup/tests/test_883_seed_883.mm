...
inline void helper0(int v0, device int* v1, int v2, int v3, int __simt_tid){
  ...
  int v179 = 0;
  bool v180 = v2 != v179;
  int v181 = v180 ? v6 : v25;
  return;
}

kernel void kernel_main(device int* v182 [[buffer(0)]], device int* v183 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v184 = static_cast<int>(__simt_tid3.x);
  int v185 = 0;
  int v186 = v185 + v184;
  int v187 = v183[v186];
  int v188 = 4;
  ...
  if (v192) {
    ...
    while (true) {
      ...
      v196 = v196;
      if (!v198) break;
      helper0(v184, v182, v187, v190, static_cast<int>(__simt_tid3.x));
      int v199 = 1;
      int v200 = v196 + v199;
      v195 = v195;
      v196 = v200;
