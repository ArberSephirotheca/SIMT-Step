    ...
    case 1:
      ...
      switch (v94) {
        ...
        case 1:
          ...
          int v124 = 3;
          int v125 = v3 % v124;
          uint v126 = simt_subgroup_id(__simt_tid);
          int v127 = (int)(v126);
          int v128;
          v128 = v127;
          switch (v125) {
...
kernel void kernel_main(device int* v169 [[buffer(0)]], device int* v170 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v171 = static_cast<int>(__simt_tid3.x);
  int v172 = 0;
  int v173 = v172 + v171;
  int v174 = v170[v173];
  int v175 = 4;
  int v176 = v175 + v171;
  int v177 = v170[v176];
  helper0(v171, v169, v174, v177, static_cast<int>(__simt_tid3.x));
  int v178 = 0;
  int v179 = 0;
  int v180;
  int v181;
    ...
    case 0:
      ...
      switch (v282) {
        ...
        case 1:
          ...
          int v332;
          if (v331) {
            uint v333 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
            int v334 = (int)(v333);
            v332 = v334;
          } else {
            int v335 = 1;
