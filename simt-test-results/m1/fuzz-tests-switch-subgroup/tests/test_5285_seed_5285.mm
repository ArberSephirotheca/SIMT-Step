...
kernel void kernel_main(device int* v116 [[buffer(0)]], device int* v117 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  ...
  int v356 = v355 + v118;
  int v357 = v117[v356];
  uint v358 = simt_lane_id(static_cast<int>(__simt_tid3.x));
  int v359 = (int)(v358);
  int v360;
  v360 = v359;
  switch (v357) {
    ...
    default:
      ...
      switch (v376) {
        ...
        default:
          ...
          int v434 = v433 + v118;
          int v435 = v117[v434];
          uint v436 = simt_lane_id(static_cast<int>(__simt_tid3.x));
          int v437 = (int)(v436);
          int v438;
          v438 = v437;
          switch (v435) {
    ...
    case 1:
      ...
      if (v455) {
        ...
        switch (v470) {
          ...
          case 1:
            {
            uint v473 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
            int v474 = (int)(v473);
            bool v475 = true;
            int v476 = 736;
            int v477 = v476 + v118;
