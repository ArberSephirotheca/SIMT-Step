...
inline void helper0(int v0, device int* v1, int v2, int v3, int __simt_tid){
  ...
  int v156 = 0;
  bool v157 = v2 != v156;
  int v158 = v157 ? v6 : v26;
  return;
}

kernel void kernel_main(device int* v159 [[buffer(0)]], device int* v160 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v161 = static_cast<int>(__simt_tid3.x);
  int v162 = 0;
  int v163 = v162 + v161;
  int v164 = v160[v163];
  int v165 = 4;
  int v166 = v165 + v161;
  int v167 = v160[v166];
  helper0(v161, v159, v164, v167, static_cast<int>(__simt_tid3.x));
  int v168 = 8;
  int v169 = v168 + v161;
  int v170 = v160[v169];
  int v171 = 0;
