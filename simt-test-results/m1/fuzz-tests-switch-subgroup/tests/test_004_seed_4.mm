...
inline void helper0(int v0, device int* v1, int v2, int v3, int __simt_tid){
  ...
  switch (v14) {
    ...
    case 1:
      ...
      int v98 = 2;
      int v99 = v3 % v98;
      uint v100 = simt_lane_id(__simt_tid);
      int v101 = (int)(v100);
      int v102;
      v102 = v101;
      switch (v99) {
...
kernel void kernel_main(device int* v194 [[buffer(0)]], device int* v195 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  ...
  if (v256) {
    ...
    switch (v262) {
      ...
      case 1:
        ...
        int v298 = v297 + v196;
        int v299 = v195[v298];
        uint v300 = simt_lane_id(static_cast<int>(__simt_tid3.x));
        int v301 = (int)(v300);
        int v302;
        v302 = v301;
        switch (v299) {
          case 0:
            {
            uint v303 = simt_lane_id(static_cast<int>(__simt_tid3.x));
            int v304 = (int)(v303);
            v302 = v304;
            break;
          }
  ...
  v194[v334] = v336;
  uint v337 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
  int v338 = (int)(v337);
  return;
}
