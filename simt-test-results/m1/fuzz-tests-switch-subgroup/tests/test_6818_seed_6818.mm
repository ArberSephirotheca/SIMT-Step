...
kernel void kernel_main(device int* v170 [[buffer(0)]], device int* v171 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v172 = static_cast<int>(__simt_tid3.x);
  int v173 = 0;
  int v174 = v173 + v172;
  int v175 = v171[v174];
  int v176 = 4;
  int v177 = v176 + v172;
  int v178 = v171[v177];
  helper0(v172, v170, v175, v178, static_cast<int>(__simt_tid3.x));
  int v179 = 8;
  int v180 = v179 + v172;
  int v181 = v171[v180];
  int v182 = 3;
  ...
  if (v296) {
    ...
    uint v323 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
    int v324 = (int)(v323);
    v297 = v324;
  }
  int v325 = 512;
