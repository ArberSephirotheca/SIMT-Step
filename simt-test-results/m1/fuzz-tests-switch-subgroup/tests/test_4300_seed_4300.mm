...
kernel void kernel_main(device int* v29 [[buffer(0)]], device int* v30 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
    ...
    case 1:
      ...
      if (v325) {
        ...
        switch (v343) {
          ...
          case 1:
            {
            uint v354 = simt_lane_id(static_cast<int>(__simt_tid3.x));
            int v355 = (int)(v354);
            bool v356 = true;
            int v357 = 400;
            int v358 = v357 + v31;
  ...
  switch (v372) {
    ...
    case 1:
      ...
      int v407 = v406 + v31;
      int v408 = v30[v407];
      uint v409 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
      int v410 = (int)(v409);
      int v411;
      v411 = v410;
      switch (v408) {
    ...
    case 2:
      {
      uint v482 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
      int v483 = (int)(v482);
      v375 = v483;
      break;
    }
