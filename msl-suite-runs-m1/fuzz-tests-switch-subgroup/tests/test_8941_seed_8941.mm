    ...
    case 1:
      ...
      switch (v54) {
        ...
        default:
          ...
          int v105 = 3;
          int v106 = v3 % v105;
          uint v107 = simt_lane_id(__simt_tid);
          int v108 = (int)(v107);
          int v109;
          v109 = v108;
          switch (v106) {
...
kernel void kernel_main(device int* v220 [[buffer(0)]], device int* v221 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v222 = static_cast<int>(__simt_tid3.x);
  int v223 = 0;
  int v224 = v223 + v222;
  int v225 = v221[v224];
  int v226 = 4;
  ...
  if (v230) {
    ...
    if (v235) {
      ...
      helper0(v222, v220, v225, v228, static_cast<int>(__simt_tid3.x));
    }
  }
  int v236 = 12;
  int v237 = v236 + v222;
  ...
  if (v240) {
    ...
    switch (v279) {
      case 0:
        ...
        int v284 = v283 + v222;
        int v285 = v221[v284];
        uint v286 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
        int v287 = (int)(v286);
        int v288;
        v288 = v287;
        switch (v285) {
