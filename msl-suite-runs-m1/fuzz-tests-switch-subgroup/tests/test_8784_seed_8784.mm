    ...
    case 2:
      ...
      switch (v122) {
        ...
        case 1:
          ...
          int v142 = 4;
          int v143 = v3 % v142;
          uint v144 = simt_subgroup_id(__simt_tid);
          int v145 = (int)(v144);
          int v146;
          v146 = v145;
          switch (v143) {
...
kernel void kernel_main(device int* v185 [[buffer(0)]], device int* v186 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v187 = static_cast<int>(__simt_tid3.x);
  int v188 = 0;
  int v189 = v188 + v187;
  int v190 = v186[v189];
  int v191 = 4;
  int v192 = v191 + v187;
  int v193 = v186[v192];
  helper0(v187, v185, v190, v193, static_cast<int>(__simt_tid3.x));
