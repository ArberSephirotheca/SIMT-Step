    ...
    case 1:
      ...
      switch (v106) {
        case 0:
          ...
          int v108 = 3;
          int v109 = v3 % v108;
          uint v110 = simt_subgroup_id(__simt_tid);
          int v111 = (int)(v110);
          int v112;
          v112 = v111;
          switch (v109) {
...
kernel void kernel_main(device int* v173 [[buffer(0)]], device int* v174 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v175 = static_cast<int>(__simt_tid3.x);
  int v176 = 0;
  int v177 = v176 + v175;
  int v178 = v174[v177];
  int v179 = 4;
  ...
  if (v183) {
    ...
    if (v188) {
      ...
      helper0(v175, v173, v178, v181, static_cast<int>(__simt_tid3.x));
    }
  }
  int v189 = 12;
  int v190 = v189 + v175;
  ...
  switch (v266) {
    ...
    case 1:
      ...
      if (v315) {
        ...
        uint v340 = simt_lane_id(static_cast<int>(__simt_tid3.x));
        int v341 = (int)(v340);
        v316 = v341;
      }
      int v342 = 528;
      ...
      switch (v353) {
        default:
          ...
          switch (v359) {
            ...
            default:
              {
              uint v365 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
              int v366 = (int)(v365);
              v362 = v366;
              break;
            }
            case 1:
              {
              uint v367 = simt_lane_id(static_cast<int>(__simt_tid3.x));
              int v368 = (int)(v367);
              bool v369 = true;
              int v370 = 560;
              int v371 = v370 + v175;
