...
kernel void kernel_main(device int* v71 [[buffer(0)]], device int* v72 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
    ...
    case 1:
      ...
      switch (v209) {
        ...
        case 2:
          ...
          int v272 = v271 + v73;
          int v273 = v72[v272];
          uint v274 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
          int v275 = (int)(v274);
          int v276;
          v276 = v275;
          switch (v273) {
  ...
  if (v352) {
    ...
    int v355 = v354 + v73;
    int v356 = v72[v355];
    uint v357 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
    int v358 = (int)(v357);
    int v359;
    v359 = v358;
    switch (v356) {
      default:
        ...
        int v361 = v360 + v73;
        int v362 = v72[v361];
        uint v363 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
        int v364 = (int)(v363);
        int v365;
        v365 = v364;
        switch (v362) {
  ...
  if (v416) {
    ...
    int v494 = v493 + v73;
    bool v495 = true;
    int v496 = simt_wave_count_bits(v495);
    v71[v494] = v496;
    v417 = v446;
  }
  int v497 = 656;
