...
kernel void kernel_main(device int* v51 [[buffer(0)]], device int* v52 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  ...
  switch (v268) {
    default:
      ...
      if (v276) {
        ...
        switch (v303) {
          case 0:
            {
            uint v306 = simt_lane_id(static_cast<int>(__simt_tid3.x));
            int v307 = (int)(v306);
            bool v308 = true;
            int v309 = 336;
            int v310 = v309 + v53;
    ...
    case 0:
      {
      uint v321 = simt_lane_id(static_cast<int>(__simt_tid3.x));
      int v322 = (int)(v321);
      bool v323 = true;
      int v324 = 368;
      int v325 = v324 + v53;
      bool v326 = true;
      int v327 = simt_wave_count_bits(v326);
      v51[v325] = v327;
      v271 = v322;
      break;
    }
