    ...
    case 2:
      ...
      switch (v109) {
        ...
        case 1:
          ...
          int v157 = 2;
          int v158 = v3 % v157;
          uint v159 = simt_subgroup_id(__simt_tid);
          int v160 = (int)(v159);
          int v161;
          v161 = v160;
          switch (v158) {
...
kernel void kernel_main(device int* v192 [[buffer(0)]], device int* v193 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v194 = static_cast<int>(__simt_tid3.x);
  int v195 = 0;
  int v196 = v195 + v194;
  int v197 = v193[v196];
  int v198 = 4;
  int v199 = v198 + v194;
  int v200 = v193[v199];
  helper0(v194, v192, v197, v200, static_cast<int>(__simt_tid3.x));
  int v201 = 8;
  int v202 = v201 + v194;
  int v203 = v193[v202];
  int v204 = 0;
  ...
  if (v205) {
    ...
    uint v272 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
    int v273 = (int)(v272);
    v206 = v273;
  }
  int v274 = 432;
