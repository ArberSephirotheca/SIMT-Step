    ...
    default:
      ...
      switch (v122) {
        ...
        default:
          ...
          int v148 = 2;
          int v149 = v3 % v148;
          uint v150 = simt_lane_id(__simt_tid);
          int v151 = (int)(v150);
          int v152;
          v152 = v151;
          switch (v149) {
...
kernel void kernel_main(device int* v161 [[buffer(0)]], device int* v162 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v163 = static_cast<int>(__simt_tid3.x);
  int v164 = 0;
  int v165 = v164 + v163;
  int v166 = v162[v165];
  int v167 = 4;
  ...
  if (v171) {
    ...
    bool v176 = v174 != v175;
    if (v176) {
      helper0(v163, v161, v166, v169, static_cast<int>(__simt_tid3.x));
    } else {
    }
  }
  int v177 = 0;
    ...
    switch (v305) {
      ...
      case 1:
        ...
        if (v353) {
          ...
          uint v357 = simt_lane_id(static_cast<int>(__simt_tid3.x));
          int v358 = (int)(v357);
          v354 = v358;
        }
        int v359 = 496;
