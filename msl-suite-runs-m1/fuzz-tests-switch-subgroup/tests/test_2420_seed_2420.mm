...
kernel void kernel_main(device int* v118 [[buffer(0)]], device int* v119 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  ...
  switch (v313) {
    case 0:
      ...
      int v318 = v317 + v120;
      int v319 = v119[v318];
      uint v320 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
      int v321 = (int)(v320);
      int v322;
      v322 = v321;
      switch (v319) {
      ...
      switch (v359) {
        ...
        case 1:
          ...
          switch (v413) {
            ...
            case 1:
              {
              uint v416 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
              int v417 = (int)(v416);
              v415 = v417;
              break;
            }
