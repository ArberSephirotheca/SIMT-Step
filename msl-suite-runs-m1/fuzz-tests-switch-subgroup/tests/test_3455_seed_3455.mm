...
inline void helper0(int v0, device int* v1, int v2, int v3, int __simt_tid){
  ...
  int v171 = 0;
  bool v172 = v2 != v171;
  int v173 = v172 ? v5 : v12;
  return;
}

kernel void kernel_main(device int* v174 [[buffer(0)]], device int* v175 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v176 = static_cast<int>(__simt_tid3.x);
  int v177 = 0;
  int v178 = v177 + v176;
  int v179 = v175[v178];
  int v180 = 4;
  int v181 = v180 + v176;
  int v182 = v175[v181];
  helper0(v176, v174, v179, v182, static_cast<int>(__simt_tid3.x));
  int v183 = 8;
  int v184 = v183 + v176;
  int v185 = v175[v184];
  int v186 = 0;
