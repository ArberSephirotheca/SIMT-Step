  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%22: i32):  // no predecessors
      ...
      %26 = "simt_step.if"(%25) ({
        ...
        %39 = "simt_step.buffer.load"(%arg1, %38) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_9 = arith.constant 0 : i32
        %40 = "simt_step.switch"(%39, %c0_i32_9) ({
        ^bb0(%arg3: i32):
          %c1_i32 = arith.constant 1 : i32
    ...
    ^bb1(%27: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32):
          ...
          %true_12 = arith.constant true
          %57 = "simt_step.wave_count_bits"(%true_12) : (i1) -> i32
          "simt_step.buffer.store"(%arg0, %56, %57) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%55) {fallthrough = false} : (i32) -> ()
        ^bb1(%58: i32):  // no predecessors
          %c0_i32_13 = arith.constant 0 : i32
          %59 = arith.addi %0, %c0_i32_13 : i32
          %true_14 = arith.constant true
          %c448_i32 = arith.constant 448 : i32
          %60 = arith.addi %c448_i32, %0 : i32
          %true_15 = arith.constant true
    ...
    %18 = "simt_step.if"(%17) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %c4_i32_4 = arith.constant 4 : i32
        %29 = arith.muli %arg3, %c4_i32_4 : i32
        %30 = arith.addi %c608_i32, %29 : i32
