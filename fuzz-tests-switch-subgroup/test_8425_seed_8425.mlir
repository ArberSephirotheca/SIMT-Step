module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32):
          ...
          %38 = arith.addi %c0_i32_9, %arg0 : i32
        ...
        ^bb1(%39: i32):  // no predecessors
          ...
          %41 = arith.addi %c16_i32, %arg0 : i32
        ...
        ^bb3(%45: i32):  // no predecessors
          ...
          %47 = arith.addi %c48_i32, %arg0 : i32
      ...
      ^bb2(%30: i32):  // no predecessors
        ...
        %31 = arith.remsi %arg3, %c3_i32_6 : i32
    ...
    %5 = arith.addi %c368_i32, %arg0 : i32
