module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%4: i32):  // no predecessors
      ...
      %5 = "simt_step.switch"(%arg3, %c0_i32_0) ({
      ^bb0(%arg5: i32):
        %c0_i32_3 = arith.constant 0 : i32
      ...
      ^bb1(%16: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c4_i32_7 = arith.constant 4 : i32
          %19 = arith.muli %arg7, %c4_i32_7 : i32
    ...
    ^bb1(%15: i32):  // no predecessors
      ...
      ^bb1(%28: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %c4_i32_21 = arith.constant 4 : i32
          %40 = arith.muli %arg5, %c4_i32_21 : i32
      ...
      ^bb2(%32: i32):  // no predecessors
        ...
        %35 = "simt_step.switch"(%34, %c3_i32_16) ({
        ^bb0(%arg4: i32):
        ...
        ^bb3(%46: i32):  // no predecessors
          ...
          %47 = arith.addi %0, %c0_i32_23 : i32
          %true_24 = arith.constant true
          %c384_i32 = arith.constant 384 : i32
          %48 = arith.addi %c384_i32, %0 : i32
          %true_25 = arith.constant true
          %49 = "simt_step.wave_count_bits"(%true_25) : (i1) -> i32
