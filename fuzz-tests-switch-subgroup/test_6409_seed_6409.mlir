  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        %20 = "simt_step.switch"(%arg3, %c4_i32_4) ({
        ^bb0(%arg6: i32):
      ...
      ^bb1(%23: i32):  // no predecessors
        ...
        %24 = arith.remsi %arg3, %c4_i32_6 : i32
    ...
    ^bb2(%17: i32):  // no predecessors
      ...
      %19 = "simt_step.if"(%18) ({
        ...
        ^bb1(%25: i32):  // no predecessors
          ...
          %27 = arith.addi %c288_i32, %arg0 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb3(%49: i32):  // no predecessors
        ...
        %50:2 = "simt_step.loop"(%c0_i32_19, %c0_i32_20) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_23 = arith.constant 4 : i32
          %53 = arith.muli %arg5, %c4_i32_23 : i32
          %54 = arith.addi %53, %0 : i32
          %c80_i32 = arith.constant 80 : i32
          %55 = arith.addi %c80_i32, %54 : i32
