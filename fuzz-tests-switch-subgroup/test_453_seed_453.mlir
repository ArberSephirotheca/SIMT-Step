  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%23: i32):  // no predecessors
      ...
      %27 = "simt_step.if"(%26) ({
        %c0_i32_8 = arith.constant 0 : i32
        %c0_i32_9 = arith.constant 0 : i32
        %44:2 = "simt_step.loop"(%c0_i32_8, %c0_i32_9) ({
        ^bb0(%arg3: i32, %arg4: i32):
          %c4_i32_10 = arith.constant 4 : i32
          %45 = arith.muli %arg4, %c4_i32_10 : i32
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %47 = arith.muli %arg4, %c4_i32_11 : i32
        ...
        %46 = "simt_step.switch"(%45, %c3_i32_8) ({
        ^bb0(%arg3: i32):
          "simt_step.yield"(%0) {fallthrough = true} : (i32) -> ()
    ...
    ^bb2(%30: i32):  // no predecessors
      ...
      ^bb1(%52: i32):  // no predecessors
        ...
        ^bb1(%58: i32):  // no predecessors
          ...
          %true_13 = arith.constant true
          %62 = "simt_step.wave_count_bits"(%true_13) : (i1) -> i32
