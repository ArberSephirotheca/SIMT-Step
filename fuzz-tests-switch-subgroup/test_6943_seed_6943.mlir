    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %31 = arith.addi %c0_i32_11, %30 : i32
      ...
      ^bb3(%25: i32):  // no predecessors
        ...
        %27 = arith.addi %arg0, %c3_i32_9 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb3(%28: i32):  // no predecessors
      ...
      ^bb3(%54: i32):  // no predecessors
        ...
        %55:2 = "simt_step.loop"(%c0_i32_22, %c0_i32_23) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_26 = arith.constant 4 : i32
          %58 = arith.muli %arg5, %c4_i32_26 : i32
          %59 = arith.addi %58, %0 : i32
          %c112_i32 = arith.constant 112 : i32
          %60 = arith.addi %c112_i32, %59 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %c1_i32_26 = arith.constant 1 : i32
          %59 = arith.addi %arg5, %c1_i32_26 : i32
          %true_27 = arith.constant true
          %c480_i32 = arith.constant 480 : i32
          %c4_i32_28 = arith.constant 4 : i32
          %60 = arith.muli %arg5, %c4_i32_28 : i32
          %61 = arith.addi %c480_i32, %60 : i32
