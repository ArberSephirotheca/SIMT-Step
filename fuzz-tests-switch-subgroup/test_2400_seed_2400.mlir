  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb2(%10: i32):  // no predecessors
      ...
      ^bb2(%27: i32):  // no predecessors
        ...
        %28 = arith.remsi %arg3, %c3_i32_6 : i32
    ...
    ^bb3(%15: i32):  // no predecessors
      ...
      ^bb1(%20: i32):  // no predecessors
        ...
        ^bb1(%33: i32):  // no predecessors
          ...
          %35 = arith.addi %c400_i32, %arg0 : i32
        ...
        ^bb2(%36: i32):  // no predecessors
          ...
          %38 = arith.addi %c416_i32, %arg0 : i32
        ...
        ^bb3(%39: i32):  // no predecessors
          ...
          %41 = arith.addi %c432_i32, %arg0 : i32
      ...
      ^bb2(%25: i32):  // no predecessors
        ...
        %27 = arith.addi %c448_i32, %arg0 : i32
      ...
      ^bb3(%28: i32):  // no predecessors
        ...
        %30 = arith.addi %c464_i32, %arg0 : i32
        "simt_step.buffer.store"(%arg1, %30, %29) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        "simt_step.yield"(%29) {fallthrough = false} : (i32) -> ()
      }) {case_values = array<i64: 0, 1, 2>, default_index = 3 : i64} : (i32, i32) -> i32
    ...
    %3 = arith.addi %c480_i32, %arg0 : i32
