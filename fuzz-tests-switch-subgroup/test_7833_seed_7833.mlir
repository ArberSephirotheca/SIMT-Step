module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb2(%10: i32):  // no predecessors
      ...
      %11 = arith.remsi %arg3, %c2_i32_0 : i32
    ...
    ^bb3(%15: i32):  // no predecessors
      ...
      ^bb1(%24: i32):  // no predecessors
        ...
        %25 = arith.remsi %arg3, %c3_i32_4 : i32
      ...
      ^bb2(%29: i32):  // no predecessors
        ...
        %31 = arith.addi %c352_i32, %arg0 : i32
        "simt_step.buffer.store"(%arg1, %31, %30) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        "simt_step.yield"(%30) {fallthrough = true} : (i32) -> ()
      ^bb3(%32: i32):  // no predecessors
        %c0_i32 = arith.constant 0 : i32
        %33 = arith.cmpi ne, %arg2, %c0_i32 : i32
        %34 = "simt_step.if"(%33) ({
          %true_6 = arith.constant true
          %35 = "simt_step.wave_count_bits"(%true_6) : (i1) -> i32
      ...
      %19 = arith.addi %c400_i32, %arg0 : i32
