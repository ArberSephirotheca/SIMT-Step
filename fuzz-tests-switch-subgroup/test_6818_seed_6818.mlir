module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32):
          ...
          %39 = arith.addi %c0_i32_12, %arg0 : i32
        ...
        ^bb1(%40: i32):  // no predecessors
          ...
          %42 = arith.addi %c16_i32, %arg0 : i32
      ...
      ^bb1(%28: i32):  // no predecessors
        ...
        %29 = arith.remsi %arg3, %c3_i32_5 : i32
      ...
      ^bb2(%33: i32):  // no predecessors
        ...
        %34 = arith.remsi %arg3, %c2_i32_8 : i32
        ...
        ^bb2(%43: i32):  // no predecessors
          ...
          %45 = arith.addi %c144_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %45, %44) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%44) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1>, default_index = 1 : i64} : (i32, i32) -> i32
      ...
      ^bb3(%36: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %38 = arith.remsi %arg3, %c4_i32_11 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %39 = arith.muli %arg7, %c4_i32_12 : i32
      ...
      %9 = arith.addi %c176_i32, %arg0 : i32
    ...
    ^bb2(%13: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        %23 = arith.addi %c208_i32, %arg0 : i32
    ...
    ^bb3(%19: i32):  // no predecessors
      ...
      %20 = arith.cmpi ne, %arg2, %c0_i32 : i32
      %21 = "simt_step.if"(%20) ({
        ...
        %23 = "simt_step.if"(%22) ({
          ...
          %25 = arith.addi %c304_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %25, %24) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%24) : (i32) -> ()
        }) : (i1) -> i32
        ...
        %23 = "simt_step.if"(%22) ({
          ...
          %25 = arith.addi %c336_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %25, %24) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%24) : (i32) -> ()
        }) : (i1) -> i32
        "simt_step.yield"(%23) : (i32) -> ()
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%27: i32):  // no predecessors
      ...
      ^bb1(%49: i32):  // no predecessors
        ...
        %53 = "simt_step.if"(%52) ({
          ...
          %59 = arith.addi %0, %c1_i32_16 : i32
          "simt_step.yield"(%59) : (i32) -> ()
        }, {
          "simt_step.yield"(%0) : (i32) -> ()
        }) : (i1) -> i32
        %c608_i32 = arith.constant 608 : i32
        %54 = arith.addi %c608_i32, %0 : i32
        %true_13 = arith.constant true
    ...
    ^bb2(%37: i32):  // no predecessors
      ...
      %c0_i32_7 = arith.constant 0 : i32
      %40 = "simt_step.switch"(%39, %c0_i32_7) ({
      ^bb0(%arg3: i32):
        %true_10 = arith.constant true
        %c672_i32 = arith.constant 672 : i32
        %43 = arith.addi %c672_i32, %0 : i32
        %true_11 = arith.constant true
        %44 = "simt_step.wave_count_bits"(%true_11) : (i1) -> i32
        "simt_step.buffer.store"(%arg0, %43, %44) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
