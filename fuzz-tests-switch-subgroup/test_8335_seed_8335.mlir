  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      ^bb0(%arg6: i32, %arg7: i32):
        ...
        %10 = "simt_step.wave_count_bits"(%true_8) : (i1) -> i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32):
        ...
        %48 = arith.addi %c48_i32_11, %0 : i32
      ...
      ^bb2(%56: i32):  // no predecessors
        ...
        ^bb3(%77: i32):  // no predecessors
          ...
          %80 = arith.addi %c128_i32, %0 : i32
          %true_27 = arith.constant true
          %81 = "simt_step.wave_count_bits"(%true_27) : (i1) -> i32
    ...
    ^bb1(%26: i32):  // no predecessors
      ...
      %30 = "simt_step.if"(%29) ({
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %46 = arith.addi %arg4, %c1_i32_12 : i32
          %true_13 = arith.constant true
    ...
    ^bb3(%37: i32):  // no predecessors
      ...
      ^bb1(%48: i32):  // no predecessors
        ...
        %51 = "simt_step.switch"(%50, %c2_i32_12) ({
        ^bb0(%arg4: i32):
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %c1_i32_15 = arith.constant 1 : i32
          %34 = arith.addi %arg6, %c1_i32_15 : i32
          %true_16 = arith.constant true
    ...
    ^bb2(%27: i32):  // no predecessors
      ...
      ^bb3(%52: i32):  // no predecessors
        ...
        %56 = "simt_step.if"(%55) ({
          ...
          %59 = arith.addi %0, %c1_i32_22 : i32
          "simt_step.yield"(%59) : (i32) -> ()
        }) : (i1) -> i32
        %c544_i32 = arith.constant 544 : i32
        %57 = arith.addi %c544_i32, %0 : i32
