  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %41 = arith.addi %arg6, %c1_i32_16 : i32
        ...
        %35 = arith.addi %arg4, %c1_i32_12 : i32
    ...
    ^bb1(%16: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %37 = arith.addi %c144_i32_14, %36 : i32
        %38 = arith.addi %37, %0 : i32
    ...
    ^bb2(%20: i32):  // no predecessors
      ...
      ^bb1(%35: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %53 = arith.addi %arg5, %c1_i32_21 : i32
          %true_22 = arith.constant true
          %c176_i32 = arith.constant 176 : i32
          %c4_i32_23 = arith.constant 4 : i32
          %54 = arith.muli %arg5, %c4_i32_23 : i32
          %55 = arith.addi %c176_i32, %54 : i32
    ...
    ^bb3(%26: i32):  // no predecessors
      ...
      ^bb1(%35: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %c1_i32_14 = arith.constant 1 : i32
          %40 = arith.addi %arg5, %c1_i32_14 : i32
          %true_15 = arith.constant true
    ...
    ^bb2(%23: i32):  // no predecessors
      ...
      ^bb1(%35: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %c1_i32_16 = arith.constant 1 : i32
          %44 = arith.addi %arg5, %c1_i32_16 : i32
          %true_17 = arith.constant true
