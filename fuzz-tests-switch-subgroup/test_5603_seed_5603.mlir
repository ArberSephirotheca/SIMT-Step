  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    %1 = "simt_step.if"(%0) ({
      ...
      ^bb1(%12: i32):  // no predecessors
        ...
        %13 = "simt_step.switch"(%arg3, %c2_i32) ({
        ^bb0(%arg5: i32):
          %true_3 = arith.constant true
          %22 = "simt_step.wave_count_bits"(%true_3) : (i1) -> i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        ^bb0(%arg4: i32):
          ...
          %17 = arith.addi %arg4, %c1_i32_10 : i32
          "simt_step.yield"(%17) {fallthrough = false} : (i32) -> ()
        ^bb1(%18: i32):  // no predecessors
          %c2_i32_11 = arith.constant 2 : i32
          %19 = arith.addi %18, %c2_i32_11 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %27 = arith.muli %arg4, %c4_i32_17 : i32
    ...
    ^bb2(%18: i32):  // no predecessors
      ...
      %19:2 = "simt_step.loop"(%c0_i32_13, %c0_i32_14) ({
      ^bb0(%arg3: i32, %arg4: i32):
        %c4_i32_15 = arith.constant 4 : i32
        %25 = arith.muli %arg4, %c4_i32_15 : i32
        %26 = arith.addi %25, %0 : i32
    ...
    ^bb3(%20: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %34 = arith.muli %arg5, %c4_i32_25 : i32
          %35 = arith.addi %c272_i32, %34 : i32
          %36 = arith.addi %35, %0 : i32
          %true_26 = arith.constant true
          %37 = "simt_step.wave_count_bits"(%true_26) : (i1) -> i32
      ...
      ^bb2(%28: i32):  // no predecessors
        ...
        %31 = "simt_step.wave_count_bits"(%true_22) : (i1) -> i32
