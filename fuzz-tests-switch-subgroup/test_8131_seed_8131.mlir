  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb2(%15: i32):  // no predecessors
      ...
      ^bb1(%27: i32):  // no predecessors
        ...
        %28 = arith.remsi %arg3, %c4_i32_6 : i32
        %c0_i32_7 = arith.constant 0 : i32
        %29 = arith.addi %arg0, %c0_i32_7 : i32
        ...
        ^bb3(%47: i32):  // no predecessors
          ...
          %49 = arith.addi %c192_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %49, %48) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%48) {fallthrough = false} : (i32) -> ()
      ...
      ^bb3(%36: i32):  // no predecessors
        ...
        ^bb3(%47: i32):  // no predecessors
          ...
          %49 = arith.addi %c288_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %49, %48) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%48) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1, 2>, default_index = 2 : i64} : (i32, i32) -> i32
    ...
    ^bb3(%20: i32):  // no predecessors
      ...
      %22 = arith.addi %c304_i32, %arg0 : i32
