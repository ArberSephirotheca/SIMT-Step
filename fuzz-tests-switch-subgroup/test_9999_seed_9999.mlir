module {
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %10 = arith.addi %arg3, %c1_i32_8 : i32
      %true = arith.constant true
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb0(%arg4: i32):
        ...
        ^bb2(%34: i32):  // no predecessors
          ...
          %36 = "simt_step.wave_count_bits"(%true_22) : (i1) -> i32
      ...
      ^bb2(%24: i32):  // no predecessors
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %34 = arith.muli %arg6, %c4_i32_22 : i32
      ...
      ^bb3(%28: i32):  // no predecessors
        ...
        %31 = "simt_step.wave_count_bits"(%true_19) : (i1) -> i32
        "simt_step.buffer.store"(%arg0, %30, %31) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        "simt_step.yield"(%29#0) {fallthrough = false} : (i32) -> ()
      }) {case_values = array<i64: 0, 1, 2>, default_index = 3 : i64} : (i32, i32) -> i32
      %14 = arith.addi %arg2, %13 : i32
      %c1_i32_8 = arith.constant 1 : i32
      %15 = arith.addi %arg3, %c1_i32_8 : i32
      %true = arith.constant true
