  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %33 = arith.muli %arg6, %c4_i32_21 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %35 = arith.muli %arg6, %c4_i32_23 : i32
          %36 = arith.addi %c96_i32, %35 : i32
          %37 = arith.addi %36, %0 : i32
          %true_24 = arith.constant true
          %38 = "simt_step.wave_count_bits"(%true_24) : (i1) -> i32
          "simt_step.buffer.store"(%arg0, %37, %38) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%33, %34) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %27 = arith.addi %arg3, %26#0 : i32
        %c1_i32_17 = arith.constant 1 : i32
        %28 = arith.addi %arg4, %c1_i32_17 : i32
        ...
        %32 = "simt_step.wave_count_bits"(%true_20) : (i1) -> i32
    ...
    ^bb1(%13: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %27 = arith.addi %arg4, %c1_i32_15 : i32
        ...
        %true_18 = arith.constant true
        %31 = "simt_step.wave_count_bits"(%true_18) : (i1) -> i32
    ...
    ^bb2(%17: i32):  // no predecessors
      ...
      %21 = "simt_step.if"(%20) ({
        ...
        ^bb3(%37: i32):  // no predecessors
          %c1_i32_21 = arith.constant 1 : i32
          %38 = arith.addi %0, %c1_i32_21 : i32
          %true_22 = arith.constant true
          %c208_i32 = arith.constant 208 : i32
          %39 = arith.addi %c208_i32, %0 : i32
          %true_23 = arith.constant true
          %40 = "simt_step.wave_count_bits"(%true_23) : (i1) -> i32
