    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      ^bb2(%13: i32):  // no predecessors
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %c4_i32_5 = arith.constant 4 : i32
          %16 = arith.muli %arg8, %c4_i32_5 : i32
          %17 = arith.addi %c48_i32, %16 : i32
          %18 = arith.addi %17, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %18, %15) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          %c1_i32_6 = arith.constant 1 : i32
          %19 = arith.addi %arg8, %c1_i32_6 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %33 = "simt_step.switch"(%32, %c0_i32_14) ({
        ^bb0(%arg5: i32):
        ...
        %37 = arith.addi %c112_i32_17, %36 : i32
    ...
    ^bb1(%12: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb3(%57: i32):  // no predecessors
          ...
          %59 = "simt_step.wave_count_bits"(%true_29) : (i1) -> i32
      ...
      ^bb1(%36: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %47 = arith.addi %arg5, %c1_i32_23 : i32
          %true_24 = arith.constant true
          ...
          %true_26 = arith.constant true
          %51 = "simt_step.wave_count_bits"(%true_26) : (i1) -> i32
          "simt_step.buffer.store"(%arg0, %50, %51) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
      ...
      ^bb2(%40: i32):  // no predecessors
        ...
        %43 = "simt_step.switch"(%42, %c2_i32_20) ({
        ^bb0(%arg4: i32):
          %46 = simt_step.lane_id
          %47 = arith.index_cast %46 : index to i32
