module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      %7 = arith.addi %arg5, %c1_i32_1 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb2(%27: i32):  // no predecessors
      ...
      ^bb1(%49: i32):  // no predecessors
        ...
        %52 = "simt_step.switch"(%51, %c0_i32_20) ({
        ^bb0(%arg4: i32):
          %true_27 = arith.constant true
          %c288_i32 = arith.constant 288 : i32
          %68 = arith.addi %c288_i32, %0 : i32
          %true_28 = arith.constant true
          %69 = "simt_step.wave_count_bits"(%true_28) : (i1) -> i32
      ...
      ^bb3(%62: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32):
          ...
          %true_28 = arith.constant true
          %71 = "simt_step.wave_count_bits"(%true_28) : (i1) -> i32
    ...
    ^bb3(%36: i32):  // no predecessors
      ...
      %40 = "simt_step.if"(%39) ({
        ...
        %44 = "simt_step.buffer.load"(%arg1, %43) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_18 = arith.constant 0 : i32
        %45 = "simt_step.switch"(%44, %c0_i32_18) ({
        ^bb0(%arg3: i32):
