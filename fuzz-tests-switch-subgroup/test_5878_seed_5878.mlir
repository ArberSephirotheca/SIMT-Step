module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      ^bb0(%arg6: i32, %arg7: i32):
        %c1_i32_3 = arith.constant 1 : i32
        %3 = "simt_step.switch"(%arg3, %c1_i32_3) ({
        ^bb0(%arg8: i32):
          %true_5 = arith.constant true
          %9 = "simt_step.wave_count_bits"(%true_5) : (i1) -> i32
          %c0_i32_6 = arith.constant 0 : i32
          %c4_i32_7 = arith.constant 4 : i32
          %10 = arith.muli %arg7, %c4_i32_7 : i32
        ...
        ^bb1(%13: i32):  // no predecessors
          ...
          %15 = arith.muli %arg7, %c4_i32_9 : i32
        ...
        %8 = arith.addi %arg7, %c1_i32_4 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      "simt_step.if"(%12) ({
        ...
        %13 = arith.remsi %0, %c3_i32_2 : i32
        %c2_i32 = arith.constant 2 : i32
        %14 = arith.addi %0, %c2_i32 : i32
        %15 = "simt_step.switch"(%13, %14) ({
        ^bb0(%arg2: i32):
          %c0_i32_3 = arith.constant 0 : i32
          %16 = arith.addi %arg2, %c0_i32_3 : i32
          "simt_step.yield"(%16) {fallthrough = false} : (i32) -> ()
        ^bb1(%17: i32):  // no predecessors
          %c2_i32_4 = arith.constant 2 : i32
          %18 = arith.addi %17, %c2_i32_4 : i32
    ...
    ^bb1(%12: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb1(%38: i32):  // no predecessors
          ...
          %41 = arith.addi %c64_i32_17, %0 : i32
