    ...
    ^bb1(%21: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb2(%70: i32):  // no predecessors
          ...
          "simt_step.yield"(%c0_i32_28) {fallthrough = false} : (i32) -> ()
      ...
      ^bb2(%55: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %64 = arith.addi %arg5, %c1_i32_26 : i32
          %true_27 = arith.constant true
      ...
      ^bb3(%59: i32):  // no predecessors
        ...
        %60:2 = "simt_step.loop"(%c0_i32_22, %c0_i32_23) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_26 = arith.constant 4 : i32
          %63 = arith.muli %arg5, %c4_i32_26 : i32
          %64 = arith.addi %63, %0 : i32
          %c96_i32 = arith.constant 96 : i32
          %65 = arith.addi %c96_i32, %64 : i32
          %66 = "simt_step.buffer.load"(%arg1, %65) : (!simt_step.resource<Global, i32>, i32) -> i32
          %c0_i32_27 = arith.constant 0 : i32
          %67 = arith.cmpi ne, %66, %c0_i32_27 : i32
          "simt_step.condition"(%67, %arg4, %arg5) : (i1, i32, i32) -> ()
