module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb1(%29: i32):  // no predecessors
        ...
        %31 = "simt_step.if"(%30) ({
          ...
          %44 = arith.addi %c32_i32, %arg0 : i32
      ...
      ^bb2(%32: i32):  // no predecessors
        ...
        %33 = arith.remsi %arg3, %c3_i32_6 : i32
        %c3_i32_7 = arith.constant 3 : i32
        %34 = arith.addi %arg0, %c3_i32_7 : i32
        ...
        ^bb1(%45: i32):  // no predecessors
          ...
          %47 = arith.addi %c80_i32, %arg0 : i32
        ...
        ^bb2(%48: i32):  // no predecessors
          ...
          %50 = arith.addi %c96_i32, %arg0 : i32
        ...
        ^bb3(%51: i32):  // no predecessors
          ...
          %53 = arith.addi %c112_i32, %arg0 : i32
      ...
      ^bb3(%36: i32):  // no predecessors
        ...
        %37 = arith.remsi %arg3, %c2_i32_8 : i32
        ...
        ^bb1(%45: i32):  // no predecessors
          ...
          %47 = arith.addi %c144_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %47, %46) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%46) {fallthrough = false} : (i32) -> ()
        ...
        %42 = arith.addi %c160_i32, %arg0 : i32
    ...
    ^bb1(%14: i32):  // no predecessors
      ...
      ^bb1(%29: i32):  // no predecessors
        ...
        %31 = "simt_step.if"(%30) ({
          ...
          %40 = arith.addi %c208_i32, %arg0 : i32
          ...
          %40 = arith.addi %c224_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %40, %39) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%39) : (i32) -> ()
        }) : (i1) -> i32
        "simt_step.yield"(%31) {fallthrough = false} : (i32) -> ()
      ^bb2(%32: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32):
          ...
          %40 = arith.addi %c240_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %40, %39) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        ...
        ^bb1(%41: i32):  // no predecessors
          ...
          %43 = arith.addi %c256_i32, %arg0 : i32
        ...
        ^bb2(%44: i32):  // no predecessors
          ...
          %46 = arith.addi %c272_i32, %arg0 : i32
    ...
    ^bb2(%19: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %35 = arith.muli %arg7, %c4_i32_9 : i32
      ...
      ^bb1(%28: i32):  // no predecessors
        ...
        %30 = "simt_step.if"(%29) ({
          ...
          %35 = arith.addi %c336_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %35, %34) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%34) : (i32) -> ()
        }) : (i1) -> i32
    ...
    ^bb3(%24: i32):  // no predecessors
      ...
      %26 = "simt_step.if"(%25) ({
        %27 = "simt_step.switch"(%arg3, %arg0) ({
        ^bb0(%arg5: i32):
          %true_4 = arith.constant true
          %28 = "simt_step.wave_count_bits"(%true_4) : (i1) -> i32
          %c368_i32 = arith.constant 368 : i32
          %29 = arith.addi %c368_i32, %arg0 : i32
        ...
        %27 = arith.remsi %arg3, %c4_i32_4 : i32
        ...
        ^bb3(%41: i32):  // no predecessors
          ...
          %43 = arith.addi %c448_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %43, %42) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%42) {fallthrough = false} : (i32) -> ()
        ...
        %32 = arith.addi %c464_i32, %arg0 : i32
        "simt_step.buffer.store"(%arg1, %32, %31) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
    ...
    ^bb3(%29: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb2(%54: i32):  // no predecessors
          %c4_i32_18 = arith.constant 4 : i32
          %55 = arith.addi %0, %c4_i32_18 : i32
          "simt_step.yield"(%55) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1>, default_index = 0 : i64} : (i32, i32) -> i32
        %true_13 = arith.constant true
        %c624_i32 = arith.constant 624 : i32
        %42 = arith.addi %c624_i32, %0 : i32
        %true_14 = arith.constant true
