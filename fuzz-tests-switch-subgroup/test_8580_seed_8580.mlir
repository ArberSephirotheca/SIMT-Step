  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb3(%30: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %35 = "simt_step.buffer.load"(%arg1, %34) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c4_i32_15 = arith.constant 4 : i32
        %36 = "simt_step.switch"(%35, %c4_i32_15) ({
        ^bb0(%arg5: i32):
    ...
    ^bb1(%30: i32):  // no predecessors
      ...
      ^bb1(%57: i32):  // no predecessors
        ...
        %58:2 = "simt_step.loop"(%c0_i32_17, %c0_i32_18) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_21 = arith.constant 4 : i32
          %67 = arith.muli %arg5, %c4_i32_21 : i32
          %68 = arith.addi %67, %0 : i32
          %c172_i32 = arith.constant 172 : i32
          %69 = arith.addi %c172_i32, %68 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %69 = arith.muli %arg5, %c4_i32_22 : i32
          %70 = arith.addi %c496_i32, %69 : i32
          %71 = arith.addi %70, %0 : i32
          %true_23 = arith.constant true
          %72 = "simt_step.wave_count_bits"(%true_23) : (i1) -> i32
    ...
    ^bb3(%39: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        %49 = arith.addi %c200_i32, %0 : i32
        %50 = "simt_step.buffer.load"(%arg1, %49) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c3_i32_13 = arith.constant 3 : i32
        %51 = arith.addi %0, %c3_i32_13 : i32
