module {
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb2(%19: i32):  // no predecessors
      ...
      %22 = "simt_step.switch"(%21, %c0_i32_5) ({
      ^bb0(%arg3: i32):
    ...
    ^bb3(%25: i32):  // no predecessors
      ...
      ^bb1(%40: i32):  // no predecessors
        ...
        ^bb3(%68: i32):  // no predecessors
          ...
          %69 = arith.addi %c320_i32, %0 : i32
          %true_30 = arith.constant true
          %70 = "simt_step.wave_count_bits"(%true_30) : (i1) -> i32
          "simt_step.buffer.store"(%arg0, %69, %70) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%0) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1, 2>, default_index = 2 : i64} : (i32, i32) -> i32
        %true_14 = arith.constant true
      ...
      ^bb2(%50: i32):  // no predecessors
        ...
        %c0_i32_18 = arith.constant 0 : i32
        %53 = "simt_step.switch"(%52, %c0_i32_18) ({
        ^bb0(%arg4: i32):
          ...
          "simt_step.buffer.store"(%arg0, %60, %61) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%c0_i32_25) {fallthrough = true} : (i32) -> ()
        ^bb1(%62: i32):  // no predecessors
          %63 = simt_step.lane_id
          %64 = arith.index_cast %63 : index to i32
          "simt_step.yield"(%64) {fallthrough = false} : (i32) -> ()
      ...
      ^bb3(%56: i32):  // no predecessors
        ...
        %57:2 = "simt_step.loop"(%c0_i32_21, %c0_i32_22) ({
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %64 = arith.cmpi ne, %63, %c0_i32_26 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %62 = arith.muli %arg5, %c4_i32_26 : i32
          %63 = arith.addi %c400_i32, %62 : i32
