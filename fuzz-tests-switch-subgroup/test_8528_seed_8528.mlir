    ...
    ^bb1(%21: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32):
          ...
          "simt_step.yield"(%c0_i32_23) {fallthrough = true} : (i32) -> ()
        ...
        ^bb2(%67: i32):  // no predecessors
          ...
          %68 = arith.addi %c144_i32, %0 : i32
          %true_27 = arith.constant true
          %69 = "simt_step.wave_count_bits"(%true_27) : (i1) -> i32
        ...
        ^bb3(%70: i32):  // no predecessors
          ...
          %72 = "simt_step.wave_count_bits"(%true_30) : (i1) -> i32
          "simt_step.buffer.store"(%arg0, %71, %72) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%c4_i32_28) {fallthrough = false} : (i32) -> ()
    ...
    ^bb2(%31: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %63 = arith.muli %arg5, %c4_i32_29 : i32
          ...
          %67 = arith.cmpi ne, %66, %c0_i32_30 : i32
