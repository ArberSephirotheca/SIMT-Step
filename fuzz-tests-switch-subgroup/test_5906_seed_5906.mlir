  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %35 = arith.remsi %arg3, %c4_i32_12 : i32
          %c1_i32 = arith.constant 1 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %36 = arith.muli %arg7, %c4_i32_13 : i32
      ...
      ^bb2(%28: i32):  // no predecessors
        ...
        %29 = arith.remsi %arg3, %c3_i32_8 : i32
        ...
        ^bb2(%40: i32):  // no predecessors
          ...
          %42 = arith.addi %c80_i32, %arg0 : i32
        ...
        ^bb3(%43: i32):  // no predecessors
          ...
          %45 = arith.addi %c96_i32, %arg0 : i32
    ...
    ^bb1(%13: i32):  // no predecessors
      ...
      ^bb1(%26: i32):  // no predecessors
        ...
        ^bb2(%40: i32):  // no predecessors
          ...
          %42 = arith.addi %c208_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %42, %41) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%41) {fallthrough = false} : (i32) -> ()
      ...
      ^bb2(%31: i32):  // no predecessors
        ...
        %32 = arith.remsi %arg3, %c3_i32_6 : i32
        %c3_i32_7 = arith.constant 3 : i32
        %33 = arith.addi %arg0, %c3_i32_7 : i32
        ...
        ^bb2(%40: i32):  // no predecessors
          ...
          %42 = arith.addi %c256_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %42, %41) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%41) {fallthrough = false} : (i32) -> ()
        ^bb3(%43: i32):  // no predecessors
          ...
          %45 = arith.addi %c272_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %45, %44) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%44) {fallthrough = false} : (i32) -> ()
    ...
    ^bb2(%18: i32):  // no predecessors
      ...
      ^bb1(%25: i32):  // no predecessors
        ...
        %27 = arith.addi %c304_i32, %arg0 : i32
        "simt_step.buffer.store"(%arg1, %27, %26) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        "simt_step.yield"(%26) {fallthrough = false} : (i32) -> ()
    ...
    %6 = arith.addi %c352_i32, %arg0 : i32
