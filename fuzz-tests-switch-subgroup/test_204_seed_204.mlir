    ...
    ^bb0(%arg4: i32):
      ...
      %3 = "simt_step.if"(%2) ({
        ...
        ^bb0(%arg5: i32):
          ...
          %19 = arith.addi %c0_i32_7, %arg0 : i32
    ...
    ^bb2(%10: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb3(%31: i32):  // no predecessors
          ...
          %33 = arith.muli %arg6, %c4_i32_11 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%17: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        %c0_i32_1 = arith.constant 0 : i32
        %c0_i32_2 = arith.constant 0 : i32
        %29:2 = "simt_step.loop"(%c0_i32_1, %c0_i32_2) ({
    ...
    ^bb2(%23: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        %c0_i32_1 = arith.constant 0 : i32
        %31 = arith.cmpi ne, %30, %c0_i32_1 : i32
        %32 = "simt_step.if"(%31) ({
        ...
        %34 = "simt_step.wave_count_bits"(%true_2) : (i1) -> i32
      ...
      ^bb1(%35: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32):
          ...
          %true_6 = arith.constant true
          %44 = "simt_step.wave_count_bits"(%true_6) : (i1) -> i32
        ...
        %true_4 = arith.constant true
        %42 = "simt_step.wave_count_bits"(%true_4) : (i1) -> i32
