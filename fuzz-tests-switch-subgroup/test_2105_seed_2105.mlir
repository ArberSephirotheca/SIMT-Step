    ...
    "simt_step.if"(%5) ({
      ...
      "simt_step.if"(%15) ({
        ...
        ^bb0(%arg2: i32):
          ...
          %19 = arith.addi %arg2, %c3_i32_5 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %54 = arith.addi %arg5, %c1_i32_20 : i32
    ...
    ^bb1(%17: i32):  // no predecessors
      ...
      ^bb1(%47: i32):  // no predecessors
        ...
        ^bb2(%70: i32):  // no predecessors
          ...
          %71 = arith.addi %0, %c3_i32_24 : i32
          %true_25 = arith.constant true
          %c224_i32 = arith.constant 224 : i32
          %72 = arith.addi %c224_i32, %0 : i32
          %true_26 = arith.constant true
        ...
        ^bb3(%74: i32):  // no predecessors
          ...
          %77 = arith.addi %c240_i32, %0 : i32
          %true_28 = arith.constant true
          %78 = "simt_step.wave_count_bits"(%true_28) : (i1) -> i32
