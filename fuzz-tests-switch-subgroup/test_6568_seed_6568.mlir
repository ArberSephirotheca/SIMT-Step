module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %10 = arith.addi %c0_i32_1, %arg0 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      "simt_step.if"(%12) ({
        ...
        %13 = "simt_step.switch"(%0, %c2_i32_4) ({
        ^bb0(%arg2: i32):
          %c3_i32 = arith.constant 3 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32):
        ...
        %27 = "simt_step.switch"(%26, %c2_i32_10) ({
        ^bb0(%arg4: i32):
        ...
        ^bb2(%59: i32):  // no predecessors
          ...
          "simt_step.yield"(%c3_i32_27) {fallthrough = true} : (i32) -> ()
        ^bb3(%60: i32):  // no predecessors
          %c2_i32_28 = arith.constant 2 : i32
          %61 = arith.addi %0, %c2_i32_28 : i32
      ...
      ^bb3(%46: i32):  // no predecessors
        ...
        %49 = "simt_step.switch"(%48, %c1_i32_19) ({
        ^bb0(%arg4: i32):
