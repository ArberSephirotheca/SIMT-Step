  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%4: i32):  // no predecessors
      ...
      ^bb2(%22: i32):  // no predecessors
        ...
        %24 = "simt_step.switch"(%23, %c1_i32_8) ({
        ^bb0(%arg6: i32):
          %true_10 = arith.constant true
          %28 = "simt_step.wave_count_bits"(%true_10) : (i1) -> i32
    ...
    ^bb2(%8: i32):  // no predecessors
      ...
      ^bb1(%18: i32):  // no predecessors
        ...
        %20 = arith.addi %arg0, %c2_i32_6 : i32
      ...
      ^bb2(%22: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %28 = arith.addi %27, %c1_i32_12 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %28 = arith.muli %arg7, %c4_i32_12 : i32
      ...
      ^bb3(%24: i32):  // no predecessors
        ...
        %26 = "simt_step.switch"(%25, %c3_i32_10) ({
        ^bb0(%arg6: i32):
          %true_11 = arith.constant true
          %27 = "simt_step.wave_count_bits"(%true_11) : (i1) -> i32
    ...
    ^bb3(%12: i32):  // no predecessors
      ...
      ^bb1(%18: i32):  // no predecessors
        ...
        %19 = arith.remsi %arg3, %c3_i32_5 : i32
        ...
        ^bb1(%31: i32):  // no predecessors
          ...
          %33 = arith.addi %c368_i32, %arg0 : i32
        ...
        ^bb2(%34: i32):  // no predecessors
          ...
          %36 = arith.addi %c384_i32, %arg0 : i32
        ...
        ^bb3(%37: i32):  // no predecessors
          ...
          %39 = arith.addi %c400_i32, %arg0 : i32
        ...
        %24 = arith.addi %c416_i32, %arg0 : i32
      ...
      ^bb2(%25: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32):
          ...
          %30 = arith.addi %c432_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %30, %29) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        ...
        ^bb1(%31: i32):  // no predecessors
          ...
          %33 = arith.addi %c448_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %33, %32) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
