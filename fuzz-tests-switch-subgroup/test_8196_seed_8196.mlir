  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb1(%41: i32):  // no predecessors
          ...
          %43 = arith.addi %c64_i32, %arg0 : i32
    ...
    ^bb3(%23: i32):  // no predecessors
      ...
      ^bb1(%34: i32):  // no predecessors
        ...
        %35 = arith.cmpi ne, %arg2, %c0_i32_10 : i32
        %36 = "simt_step.if"(%35) ({
          %true_11 = arith.constant true
          %39 = "simt_step.wave_count_bits"(%true_11) : (i1) -> i32
          ...
          %40 = arith.addi %c304_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %40, %39) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%39) : (i32) -> ()
        }) : (i1) -> i32
        "simt_step.yield"(%36) {fallthrough = false} : (i32) -> ()
      ^bb2(%37: i32):  // no predecessors
        %38 = "simt_step.switch"(%arg3, %arg0) ({
        ^bb0(%arg6: i32):
          %true_11 = arith.constant true
          %39 = "simt_step.wave_count_bits"(%true_11) : (i1) -> i32
    ...
    %10 = arith.addi %c368_i32, %arg0 : i32
