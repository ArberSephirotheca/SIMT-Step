module {
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    %12 = "simt_step.switch"(%11, %c4_i32_2) ({
    ^bb0(%arg2: i32):
      %c0_i32_5 = arith.constant 0 : i32
      %c0_i32_6 = arith.constant 0 : i32
      %19:2 = "simt_step.loop"(%c0_i32_5, %c0_i32_6) ({
    ...
    %16 = "simt_step.if"(%15) ({
      ...
      ^bb1(%29: i32):  // no predecessors
        %c192_i32_11 = arith.constant 192 : i32
        %30 = arith.addi %c192_i32_11, %0 : i32
      ...
      ^bb2(%40: i32):  // no predecessors
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          "simt_step.condition"(%55, %arg3, %arg4) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg3: i32, %arg4: i32):
          %51 = arith.addi %arg3, %arg4 : i32
          %c1_i32_19 = arith.constant 1 : i32
          %52 = arith.addi %arg4, %c1_i32_19 : i32
          %true_20 = arith.constant true
          %c512_i32 = arith.constant 512 : i32
          %c4_i32_21 = arith.constant 4 : i32
          %53 = arith.muli %arg4, %c4_i32_21 : i32
          %54 = arith.addi %c512_i32, %53 : i32
