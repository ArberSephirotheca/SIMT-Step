module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%3: i32):  // no predecessors
      ...
      %4 = arith.remsi %arg3, %c3_i32_1 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %47 = arith.muli %arg5, %c4_i32_26 : i32
          %48 = arith.addi %c240_i32, %47 : i32
          %49 = arith.addi %48, %0 : i32
          %true_27 = arith.constant true
          %50 = "simt_step.wave_count_bits"(%true_27) : (i1) -> i32
      ...
      ^bb3(%40: i32):  // no predecessors
        ...
        %43 = arith.addi %0, %c0_i32_24 : i32
        %44 = "simt_step.switch"(%42, %43) ({
        ^bb0(%arg4: i32):
          %c4_i32_25 = arith.constant 4 : i32
          %45 = arith.addi %0, %c4_i32_25 : i32
        ...
        ^bb1(%46: i32):  // no predecessors
          ...
          %48 = "simt_step.wave_count_bits"(%true_28) : (i1) -> i32
