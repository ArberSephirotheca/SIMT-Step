  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    %9 = "simt_step.if"(%8) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %26 = arith.addi %arg3, %c1_i32_8 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %49 = arith.addi %arg4, %c1_i32_21 : i32
        %true_22 = arith.constant true
        %c64_i32 = arith.constant 64 : i32
        %c4_i32_23 = arith.constant 4 : i32
        %50 = arith.muli %arg4, %c4_i32_23 : i32
    ...
    ^bb1(%27: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %49 = arith.addi %c80_i32_21, %48 : i32
        %50 = "simt_step.buffer.load"(%arg1, %49) : (!simt_step.resource<Global, i32>, i32) -> i32
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %53 = arith.addi %arg3, %50 : i32
        %c1_i32_22 = arith.constant 1 : i32
        %54 = arith.addi %arg4, %c1_i32_22 : i32
    ...
    ^bb2(%29: i32):  // no predecessors
      ...
      %33 = "simt_step.if"(%32) ({
        ...
        ^bb0(%arg3: i32):
          ...
          %54 = arith.addi %c128_i32_24, %0 : i32
          %true_25 = arith.constant true
    ...
    %21 = "simt_step.if"(%20) ({
      ...
      %27 = "simt_step.if"(%26) ({
        ...
        ^bb0(%arg2: i32, %arg3: i32):
          ...
          %32 = arith.addi %arg3, %c1_i32_10 : i32
          %true_11 = arith.constant true
