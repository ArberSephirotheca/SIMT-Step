module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %2 = arith.remsi %arg3, %c3_i32_1 : i32
      %c3_i32_2 = arith.constant 3 : i32
      %3 = "simt_step.switch"(%2, %c3_i32_2) ({
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32):
          ...
          %31 = arith.addi %c0_i32_12, %arg0 : i32
    ...
    ^bb1(%4: i32):  // no predecessors
      ...
      %5:2 = "simt_step.loop"(%c0_i32, %c0_i32_3) ({
    ...
    ^bb3(%9: i32):  // no predecessors
      ...
      %11 = arith.addi %c256_i32, %arg0 : i32
