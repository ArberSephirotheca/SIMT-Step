  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%20: i32):  // no predecessors
      ...
      ^bb1(%44: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32):
          ...
          %53 = arith.addi %0, %c2_i32_13 : i32
          %true_14 = arith.constant true
          %c80_i32_15 = arith.constant 80 : i32
          %54 = arith.addi %c80_i32_15, %0 : i32
    ...
    ^bb3(%32: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        %40 = "simt_step.switch"(%39, %c2_i32_7) ({
        ^bb0(%arg4: i32):
          %c1_i32 = arith.constant 1 : i32
      ...
      ^bb1(%43: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %52 = arith.muli %arg5, %c4_i32_14 : i32
          %53 = arith.addi %52, %0 : i32
          %c56_i32 = arith.constant 56 : i32
          %54 = arith.addi %c56_i32, %53 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %54 = arith.muli %arg5, %c4_i32_15 : i32
