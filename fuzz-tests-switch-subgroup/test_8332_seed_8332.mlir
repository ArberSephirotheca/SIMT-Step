    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %56 = arith.addi %arg5, %c1_i32_21 : i32
    ...
    ^bb2(%38: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %50 = arith.muli %arg6, %c4_i32_19 : i32
          ...
          "simt_step.condition"(%54, %arg5, %arg6) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg5: i32, %arg6: i32):
          %50 = arith.addi %arg5, %arg6 : i32
          %c1_i32_19 = arith.constant 1 : i32
          %51 = arith.addi %arg6, %c1_i32_19 : i32
          %true_20 = arith.constant true
        ...
        %44 = arith.addi %arg3, %43#0 : i32
        %c1_i32_15 = arith.constant 1 : i32
        %45 = arith.addi %arg4, %c1_i32_15 : i32
        %true_16 = arith.constant true
