  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb2(%28: i32):  // no predecessors
        ...
        %29 = arith.remsi %arg3, %c2_i32_6 : i32
    ...
    ^bb1(%11: i32):  // no predecessors
      ...
      ^bb3(%31: i32):  // no predecessors
        ...
        %32 = arith.cmpi ne, %arg2, %c0_i32_7 : i32
        %33 = "simt_step.if"(%32) ({
          %true_8 = arith.constant true
          %34 = "simt_step.wave_count_bits"(%true_8) : (i1) -> i32
    ...
    ^bb3(%17: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        %24 = "simt_step.switch"(%23, %c4_i32_4) ({
        ^bb0(%arg6: i32):
          %true_7 = arith.constant true
        ...
        %26 = arith.addi %c320_i32, %arg0 : i32
      ...
      ^bb1(%27: i32):  // no predecessors
        ...
        %29 = "simt_step.if"(%28) ({
          ...
          %31 = arith.addi %c336_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %31, %30) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
      ...
      %22 = arith.addi %c368_i32, %arg0 : i32
