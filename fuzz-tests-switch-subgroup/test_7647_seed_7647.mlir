module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        %21 = "simt_step.if"(%20) ({
          ...
          %37 = arith.addi %c0_i32_10, %arg0 : i32
          ...
          %37 = arith.addi %c16_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %37, %36) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%36) : (i32) -> ()
        }) : (i1) -> i32
      ...
      ^bb2(%25: i32):  // no predecessors
        ...
        %27 = arith.addi %arg0, %c3_i32_6 : i32
      ...
      ^bb3(%31: i32):  // no predecessors
        ...
        %32 = arith.remsi %arg3, %c2_i32_8 : i32
    ...
    ^bb1(%8: i32):  // no predecessors
      ...
      %10 = arith.addi %c192_i32, %arg0 : i32
    ...
    ^bb3(%14: i32):  // no predecessors
      ...
      ^bb2(%24: i32):  // no predecessors
        ...
        %25 = arith.remsi %arg3, %c3_i32_7 : i32
        %c4_i32_8 = arith.constant 4 : i32
        %26 = arith.addi %arg0, %c4_i32_8 : i32
        %27 = "simt_step.switch"(%25, %26) ({
        ^bb0(%arg6: i32):
          %true_9 = arith.constant true
          %28 = "simt_step.wave_count_bits"(%true_9) : (i1) -> i32
          %c320_i32 = arith.constant 320 : i32
          %29 = arith.addi %c320_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %29, %28) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%28) {fallthrough = false} : (i32) -> ()
        ^bb1(%30: i32):  // no predecessors
          %true_10 = arith.constant true
        ...
        ^bb2(%33: i32):  // no predecessors
          ...
          %35 = arith.addi %c352_i32, %arg0 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      %14 = "simt_step.if"(%13) ({
        ...
        %27 = "simt_step.switch"(%26, %c0_i32_13) ({
        ^bb0(%arg3: i32):
