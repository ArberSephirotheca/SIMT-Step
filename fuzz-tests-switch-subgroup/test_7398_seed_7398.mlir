module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %37 = arith.remsi %arg3, %c4_i32_9 : i32
          %c1_i32_10 = arith.constant 1 : i32
          %38 = arith.addi %37, %c1_i32_10 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %38 = arith.muli %arg7, %c4_i32_10 : i32
          ...
          %41 = arith.addi %arg7, %c1_i32_11 : i32
          "simt_step.yield"(%37, %41) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        "simt_step.yield"(%26#0) {fallthrough = false} : (i32) -> ()
      ^bb1(%27: i32):  // no predecessors
        %c2_i32 = arith.constant 2 : i32
        %28 = arith.remsi %arg3, %c2_i32 : i32
    ...
    ^bb1(%12: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb1(%39: i32):  // no predecessors
          ...
          %41 = arith.addi %c128_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %41, %40) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%40) {fallthrough = false} : (i32) -> ()
        ^bb2(%42: i32):  // no predecessors
          ...
          %44 = arith.addi %c144_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %44, %43) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        ...
        ^bb3(%45: i32):  // no predecessors
          ...
          %47 = arith.addi %c160_i32, %arg0 : i32
      ...
      ^bb1(%30: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %37 = arith.remsi %arg3, %c4_i32_12 : i32
    ...
    ^bb2(%17: i32):  // no predecessors
      ...
      %19 = arith.addi %arg0, %c0_i32_3 : i32
      ...
      ^bb1(%28: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          %c4_i32_9 = arith.constant 4 : i32
          %33 = arith.remsi %arg3, %c4_i32_9 : i32
          %c1_i32 = arith.constant 1 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c4_i32_10 = arith.constant 4 : i32
          %34 = arith.muli %arg7, %c4_i32_10 : i32
      ...
      ^bb2(%30: i32):  // no predecessors
        %c0_i32_8 = arith.constant 0 : i32
        %31 = arith.cmpi ne, %arg2, %c0_i32_8 : i32
        %32 = "simt_step.if"(%31) ({
          %true_9 = arith.constant true
          %33 = "simt_step.wave_count_bits"(%true_9) : (i1) -> i32
          %c288_i32 = arith.constant 288 : i32
          %34 = arith.addi %c288_i32, %arg0 : i32
    ...
    ^bb3(%21: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32):
          ...
          %42 = arith.addi %c320_i32, %arg0 : i32
        ...
        ^bb1(%43: i32):  // no predecessors
          ...
          %45 = arith.addi %c336_i32, %arg0 : i32
      ...
      ^bb1(%29: i32):  // no predecessors
        ...
        %31 = "simt_step.if"(%30) ({
          ...
          %42 = arith.addi %c352_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %42, %41) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          ...
          %42 = arith.addi %c368_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %42, %41) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%41) : (i32) -> ()
        }) : (i1) -> i32
      ...
      ^bb3(%35: i32):  // no predecessors
        ...
        %36 = arith.remsi %arg3, %c3_i32_7 : i32
        %c1_i32_8 = arith.constant 1 : i32
        %37 = arith.addi %arg0, %c1_i32_8 : i32
        %38 = "simt_step.switch"(%36, %37) ({
        ^bb0(%arg6: i32):
          %true_10 = arith.constant true
          %41 = "simt_step.wave_count_bits"(%true_10) : (i1) -> i32
          %c400_i32 = arith.constant 400 : i32
          %42 = arith.addi %c400_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %42, %41) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%41) {fallthrough = false} : (i32) -> ()
        ^bb1(%43: i32):  // no predecessors
          %true_11 = arith.constant true
          ...
          %45 = arith.addi %c416_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %45, %44) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%44) {fallthrough = false} : (i32) -> ()
        ^bb2(%46: i32):  // no predecessors
          ...
          %48 = arith.addi %c432_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %48, %47) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%47) {fallthrough = false} : (i32) -> ()
        ^bb3(%49: i32):  // no predecessors
          %true_13 = arith.constant true
          %50 = "simt_step.wave_count_bits"(%true_13) : (i1) -> i32
          %c448_i32 = arith.constant 448 : i32
          %51 = arith.addi %c448_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %51, %50) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%50) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1, 2>, default_index = 2 : i64} : (i32, i32) -> i32
        %true_9 = arith.constant true
        %39 = "simt_step.wave_count_bits"(%true_9) : (i1) -> i32
        %c464_i32 = arith.constant 464 : i32
        %40 = arith.addi %c464_i32, %arg0 : i32
    ...
    ^bb1(%25: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %46 = "simt_step.if"(%45) ({
          ...
          %55 = arith.addi %0, %c0_i32_16 : i32
          "simt_step.yield"(%55) : (i32) -> ()
        }, {
          %c1_i32_16 = arith.constant 1 : i32
          %55 = arith.addi %0, %c1_i32_16 : i32
          "simt_step.yield"(%55) : (i32) -> ()
        }) : (i1) -> i32
