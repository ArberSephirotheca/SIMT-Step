  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        %19 = arith.addi %c0_i32_2, %arg0 : i32
      ...
      ^bb3(%26: i32):  // no predecessors
        ...
        %27 = arith.remsi %arg3, %c3_i32_5 : i32
        %c3_i32_6 = arith.constant 3 : i32
        %28 = arith.addi %arg0, %c3_i32_6 : i32
    ...
    ^bb2(%10: i32):  // no predecessors
      ...
      ^bb1(%20: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %26 = arith.addi %arg7, %c1_i32_6 : i32
    ...
    ^bb3(%14: i32):  // no predecessors
      ...
      %15 = arith.remsi %arg3, %c4_i32_0 : i32
      %c0_i32_1 = arith.constant 0 : i32
      %16 = arith.addi %arg0, %c0_i32_1 : i32
      %17 = "simt_step.switch"(%15, %16) ({
      ^bb0(%arg5: i32):
        %c3_i32_2 = arith.constant 3 : i32
        %18 = arith.remsi %arg3, %c3_i32_2 : i32
        %c1_i32_3 = arith.constant 1 : i32
        %19 = arith.addi %arg0, %c1_i32_3 : i32
      ...
      ^bb3(%26: i32):  // no predecessors
        ...
        ^bb1(%35: i32):  // no predecessors
          ...
          %37 = arith.addi %c304_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %37, %36) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%36) {fallthrough = false} : (i32) -> ()
        ^bb2(%38: i32):  // no predecessors
          %true_10 = arith.constant true
          ...
          %40 = arith.addi %c320_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %40, %39) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%39) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1>, default_index = 2 : i64} : (i32, i32) -> i32
        %true = arith.constant true
        %31 = "simt_step.wave_count_bits"(%true) : (i1) -> i32
