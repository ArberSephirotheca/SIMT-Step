module {
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%20: i32):  // no predecessors
      ...
      ^bb1(%34: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %52 = arith.muli %arg5, %c4_i32_24 : i32
      ...
      ^bb2(%38: i32):  // no predecessors
        ...
        ^bb3(%59: i32):  // no predecessors
          ...
          "simt_step.yield"(%c1_i32_27) {fallthrough = false} : (i32) -> ()
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        %c0_i32_10 = arith.constant 0 : i32
        %36 = arith.addi %arg3, %c0_i32_10 : i32
        %c1_i32_11 = arith.constant 1 : i32
        %37 = arith.addi %arg4, %c1_i32_11 : i32
        %true_12 = arith.constant true
    ...
    ^bb0(%arg2: i32):
      ...
      %21 = "simt_step.switch"(%20, %c1_i32_2) ({
      ^bb0(%arg3: i32):
