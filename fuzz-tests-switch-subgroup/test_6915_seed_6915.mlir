  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        %20 = arith.addi %c0_i32_6, %arg0 : i32
    ...
    ^bb1(%9: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb1(%37: i32):  // no predecessors
          ...
          %39 = arith.addi %c144_i32, %arg0 : i32
      ...
      ^bb1(%23: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %35 = arith.remsi %arg3, %c4_i32_10 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %36 = arith.muli %arg7, %c4_i32_11 : i32
          ...
          %39 = arith.addi %arg7, %c1_i32_12 : i32
          "simt_step.yield"(%35, %39) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        "simt_step.yield"(%24#0) {fallthrough = false} : (i32) -> ()
      ^bb2(%25: i32):  // no predecessors
        %c4_i32_7 = arith.constant 4 : i32
        %26 = arith.remsi %arg3, %c4_i32_7 : i32
        ...
        ^bb1(%37: i32):  // no predecessors
          ...
          %39 = arith.addi %c208_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %39, %38) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%38) {fallthrough = false} : (i32) -> ()
        ^bb2(%40: i32):  // no predecessors
          %true_12 = arith.constant true
          ...
          %42 = arith.addi %c224_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %42, %41) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%41) {fallthrough = false} : (i32) -> ()
        ^bb3(%43: i32):  // no predecessors
          ...
          %45 = arith.addi %c240_i32, %arg0 : i32
    ...
    ^bb2(%14: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %c1_i32_6 = arith.constant 1 : i32
        %21 = arith.addi %arg6, %c1_i32_6 : i32
    ...
    ^bb3(%16: i32):  // no predecessors
      ...
      %18 = "simt_step.if"(%17) ({
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %24 = arith.addi %arg6, %c1_i32_9 : i32
    ...
    %4 = arith.addi %c368_i32, %arg0 : i32
