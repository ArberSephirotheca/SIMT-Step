  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %10 = "simt_step.if"(%9) ({
        ...
        %18 = "simt_step.switch"(%17, %c1_i32_4) ({
        ^bb0(%arg5: i32):
          %true_5 = arith.constant true
    ...
    ^bb2(%14: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %34 = arith.remsi %arg3, %c4_i32_10 : i32
          %c1_i32_11 = arith.constant 1 : i32
          %35 = arith.addi %34, %c1_i32_11 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %35 = arith.muli %arg7, %c4_i32_11 : i32
          ...
          %38 = arith.addi %arg7, %c1_i32_12 : i32
      ...
      ^bb1(%18: i32):  // no predecessors
        ...
        ^bb2(%39: i32):  // no predecessors
          ...
          %41 = arith.addi %c240_i32, %arg0 : i32
        ...
        ^bb3(%42: i32):  // no predecessors
          ...
          %44 = arith.addi %c256_i32, %arg0 : i32
        ...
        %24 = arith.addi %c272_i32, %arg0 : i32
      ...
      ^bb2(%25: i32):  // no predecessors
        ...
        ^bb1(%36: i32):  // no predecessors
          ...
          %38 = arith.addi %c304_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %38, %37) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
      ...
      ^bb3(%30: i32):  // no predecessors
        ...
        %31 = arith.remsi %arg3, %c3_i32_8 : i32
        %c1_i32_9 = arith.constant 1 : i32
        %32 = arith.addi %arg0, %c1_i32_9 : i32
        ...
        ^bb2(%39: i32):  // no predecessors
          ...
          %41 = arith.addi %c352_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %41, %40) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
    ...
    %6 = arith.addi %c368_i32, %arg0 : i32
