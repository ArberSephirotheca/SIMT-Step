  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%22: i32):  // no predecessors
      ...
      ^bb1(%48: i32):  // no predecessors
        ...
        %51 = "simt_step.switch"(%50, %c4_i32_19) ({
        ^bb0(%arg4: i32):
        ...
        ^bb2(%69: i32):  // no predecessors
          ...
          %70 = arith.addi %0, %c4_i32_28 : i32
          %true_29 = arith.constant true
          %c176_i32 = arith.constant 176 : i32
          %71 = arith.addi %c176_i32, %0 : i32
      ...
      ^bb2(%54: i32):  // no predecessors
        ...
        ^bb3(%71: i32):  // no predecessors
          %c4_i32_28 = arith.constant 4 : i32
          %72 = arith.addi %0, %c4_i32_28 : i32
          %true_29 = arith.constant true
          %c224_i32 = arith.constant 224 : i32
          %73 = arith.addi %c224_i32, %0 : i32
          %true_30 = arith.constant true
          %74 = "simt_step.wave_count_bits"(%true_30) : (i1) -> i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      %c4_i32_5 = arith.constant 4 : i32
      %14 = arith.addi %arg2, %c4_i32_5 : i32
      %c1_i32 = arith.constant 1 : i32
