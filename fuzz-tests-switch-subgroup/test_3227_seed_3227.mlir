    ...
    ^bb2(%34: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %66 = arith.muli %arg5, %c4_i32_18 : i32
          %67 = arith.addi %66, %0 : i32
          %c108_i32 = arith.constant 108 : i32
          %68 = arith.addi %c108_i32, %67 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %68 = arith.muli %arg5, %c4_i32_19 : i32
          %69 = arith.addi %c336_i32, %68 : i32
      ...
      ^bb1(%50: i32):  // no predecessors
        ...
        %51 = arith.addi %c128_i32_13, %0 : i32
      ...
      ^bb2(%58: i32):  // no predecessors
        ...
        %65 = "simt_step.wave_count_bits"(%true_17) : (i1) -> i32
