    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      ^bb1(%18: i32):  // no predecessors
        ...
        ^bb0(%arg7: i32):
          ...
          %24 = arith.muli %arg5, %c4_i32_7 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %25 = arith.remsi %0, %c3_i32 : i32
        %26 = "simt_step.switch"(%25, %0) ({
        ^bb0(%arg4: i32):
          %c3_i32_6 = arith.constant 3 : i32
          %28 = arith.addi %arg4, %c3_i32_6 : i32
          "simt_step.yield"(%28) {fallthrough = false} : (i32) -> ()
        ^bb1(%29: i32):  // no predecessors
          %c3_i32_7 = arith.constant 3 : i32
          %30 = arith.addi %29, %c3_i32_7 : i32
    ...
    %9 = "simt_step.if"(%8) ({
      ...
      ^bb0(%arg2: i32):
        ...
        ^bb1(%51: i32):  // no predecessors
          ...
          %52 = arith.addi %c112_i32_17, %0 : i32
      ...
      ^bb2(%38: i32):  // no predecessors
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %51 = arith.muli %arg4, %c4_i32_16 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      %25 = "simt_step.buffer.load"(%arg1, %24) : (!simt_step.resource<Global, i32>, i32) -> i32
      %c4_i32_4 = arith.constant 4 : i32
      %26 = "simt_step.switch"(%25, %c4_i32_4) ({
      ^bb0(%arg3: i32):
