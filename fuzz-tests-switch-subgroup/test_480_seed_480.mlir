  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      "simt_step.if"(%19) ({
        ...
        ^bb1(%25: i32):  // no predecessors
          ...
          %26 = arith.addi %25, %c0_i32_3 : i32
          "simt_step.yield"(%26) {fallthrough = false} : (i32) -> ()
        ^bb2(%27: i32):  // no predecessors
          %c3_i32_4 = arith.constant 3 : i32
          %28 = arith.addi %27, %c3_i32_4 : i32
          "simt_step.yield"(%28) {fallthrough = false} : (i32) -> ()
        ^bb3(%29: i32):  // no predecessors
          %c0_i32_5 = arith.constant 0 : i32
          %30 = arith.addi %29, %c0_i32_5 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb3(%51: i32):  // no predecessors
        ...
        %52:2 = "simt_step.loop"(%c0_i32_14, %c0_i32_15) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_18 = arith.constant 4 : i32
          %55 = arith.muli %arg5, %c4_i32_18 : i32
          %56 = arith.addi %55, %0 : i32
          %c32_i32 = arith.constant 32 : i32
          %57 = arith.addi %c32_i32, %56 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %56 = arith.addi %arg5, %c1_i32_18 : i32
          %true_19 = arith.constant true
          %c272_i32 = arith.constant 272 : i32
          %c4_i32_20 = arith.constant 4 : i32
          %57 = arith.muli %arg5, %c4_i32_20 : i32
          %58 = arith.addi %c272_i32, %57 : i32
