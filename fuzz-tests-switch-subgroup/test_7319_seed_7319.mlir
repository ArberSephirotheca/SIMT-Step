    ...
    ^bb0(%arg4: i32):
      ...
      ^bb2(%26: i32):  // no predecessors
        ...
        ^bb1(%38: i32):  // no predecessors
          ...
          %40 = arith.addi %c128_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %40, %39) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%39) {fallthrough = false} : (i32) -> ()
      ...
      ^bb3(%31: i32):  // no predecessors
        ...
        %33 = "simt_step.switch"(%32, %c2_i32_10) ({
        ^bb0(%arg6: i32):
          %true_12 = arith.constant true
          %36 = "simt_step.wave_count_bits"(%true_12) : (i1) -> i32
    ...
    ^bb1(%15: i32):  // no predecessors
      ...
      %17 = "simt_step.if"(%16) ({
        ...
        %21 = "simt_step.if"(%20) ({
          ...
          %23 = arith.addi %c272_i32, %arg0 : i32
          ...
          %23 = arith.addi %c288_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %23, %22) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%22) : (i32) -> ()
        }) : (i1) -> i32
    ...
    %10 = "simt_step.if"(%9) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %21 = arith.muli %arg5, %c4_i32_13 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %26 = "simt_step.wave_count_bits"(%true_16) : (i1) -> i32
