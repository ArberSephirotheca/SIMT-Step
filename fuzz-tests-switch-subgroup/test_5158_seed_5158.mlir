  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      %9 = "simt_step.if"(%8) ({
        ...
        %11 = "simt_step.switch"(%arg3, %c3_i32) ({
        ^bb0(%arg6: i32):
          %true_7 = arith.constant true
        ...
        ^bb1(%16: i32):  // no predecessors
          ...
          %18 = arith.muli %arg5, %c4_i32_9 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb1(%46: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %66 = arith.addi %c256_i32, %65 : i32
          %67 = arith.addi %66, %0 : i32
          %true_24 = arith.constant true
          %68 = "simt_step.wave_count_bits"(%true_24) : (i1) -> i32
          "simt_step.buffer.store"(%arg0, %67, %68) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.continue"(%63, %64) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb1(%24: i32):  // no predecessors
      ...
      ^bb1(%47: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %54 = arith.muli %arg5, %c4_i32_21 : i32
          %55 = arith.addi %c352_i32, %54 : i32
    ...
    ^bb2(%30: i32):  // no predecessors
      ...
      ^bb2(%46: i32):  // no predecessors
        ...
        %47 = arith.addi %c156_i32, %0 : i32
        %48 = "simt_step.buffer.load"(%arg1, %47) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c4_i32_19 = arith.constant 4 : i32
        %49 = "simt_step.switch"(%48, %c4_i32_19) ({
        ^bb0(%arg4: i32):
          "simt_step.yield"(%0) {fallthrough = false} : (i32) -> ()
