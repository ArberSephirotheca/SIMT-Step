  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb2(%24: i32):  // no predecessors
        ...
        %26 = "simt_step.switch"(%25, %c3_i32_5) ({
        ^bb0(%arg6: i32):
          %true_7 = arith.constant true
          %30 = "simt_step.wave_count_bits"(%true_7) : (i1) -> i32
    ...
    ^bb2(%13: i32):  // no predecessors
      ...
      %15 = "simt_step.if"(%14) ({
        ...
        %20 = arith.addi %c256_i32, %arg0 : i32
        "simt_step.buffer.store"(%arg1, %20, %19) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        "simt_step.yield"(%19) : (i32) -> ()
      }, {
    ...
    ^bb3(%16: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        %19 = arith.remsi %arg3, %c3_i32_2 : i32
      ...
      ^bb1(%25: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %30 = arith.remsi %arg3, %c4_i32_7 : i32
          %c1_i32 = arith.constant 1 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %31 = arith.muli %arg7, %c4_i32_8 : i32
      ...
      ^bb2(%27: i32):  // no predecessors
        ...
        %29 = "simt_step.if"(%28) ({
          ...
          %31 = arith.addi %c368_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %31, %30) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%30) : (i32) -> ()
        }, {
          %true_7 = arith.constant true
          ...
          %31 = arith.addi %c384_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %31, %30) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%30) : (i32) -> ()
        }) : (i1) -> i32
        "simt_step.yield"(%29) {fallthrough = false} : (i32) -> ()
