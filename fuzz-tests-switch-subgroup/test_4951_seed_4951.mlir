  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %22 = arith.muli %arg7, %c4_i32_6 : i32
          %23 = arith.addi %c0_i32_5, %22 : i32
    ...
    ^bb3(%15: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %c4_i32_2 = arith.constant 4 : i32
        %18 = arith.muli %arg6, %c4_i32_2 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      "simt_step.if"(%22) ({
        ...
        %c4_i32_5 = arith.constant 4 : i32
        %23 = arith.remsi %0, %c4_i32_5 : i32
        %c0_i32_6 = arith.constant 0 : i32
        %24 = arith.addi %0, %c0_i32_6 : i32
        %25 = "simt_step.switch"(%23, %24) ({
        ^bb0(%arg2: i32):
          %c4_i32_7 = arith.constant 4 : i32
          %26 = arith.addi %arg2, %c4_i32_7 : i32
          "simt_step.yield"(%26) {fallthrough = false} : (i32) -> ()
        ^bb1(%27: i32):  // no predecessors
          %c0_i32_8 = arith.constant 0 : i32
          %28 = arith.addi %27, %c0_i32_8 : i32
          "simt_step.yield"(%28) {fallthrough = false} : (i32) -> ()
        ^bb2(%29: i32):  // no predecessors
          %c0_i32_9 = arith.constant 0 : i32
          %30 = arith.addi %29, %c0_i32_9 : i32
