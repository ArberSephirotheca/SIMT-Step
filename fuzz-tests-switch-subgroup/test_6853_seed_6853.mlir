module {
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      %18 = "simt_step.switch"(%17, %c1_i32_2) ({
      ^bb0(%arg3: i32):
        %c16_i32 = arith.constant 16 : i32
      ...
      ^bb2(%47: i32):  // no predecessors
        ...
        ^bb1(%55: i32):  // no predecessors
          ...
          %true_10 = arith.constant true
          %59 = "simt_step.wave_count_bits"(%true_10) : (i1) -> i32
        ...
        ^bb3(%63: i32):  // no predecessors
          ...
          %true_12 = arith.constant true
          %67 = "simt_step.wave_count_bits"(%true_12) : (i1) -> i32
    ...
    ^bb2(%25: i32):  // no predecessors
      ...
      ^bb2(%44: i32):  // no predecessors
        ...
        %47 = arith.cmpi ne, %46, %c0_i32_10 : i32
        %48 = "simt_step.if"(%47) ({
