  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    %1 = "simt_step.if"(%0) ({
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        %3 = "simt_step.switch"(%arg3, %c2_i32) ({
        ^bb0(%arg6: i32):
          %true = arith.constant true
          %5 = "simt_step.wave_count_bits"(%true) : (i1) -> i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%22: i32):  // no predecessors
      ...
      ^bb2(%56: i32):  // no predecessors
        ...
        %59 = "simt_step.switch"(%58, %c2_i32_15) ({
        ^bb0(%arg4: i32):
          %c2_i32_18 = arith.constant 2 : i32
          %65 = arith.addi %0, %c2_i32_18 : i32
          "simt_step.yield"(%65) {fallthrough = false} : (i32) -> ()
        ^bb1(%66: i32):  // no predecessors
        ...
        ^bb2(%67: i32):  // no predecessors
          ...
          %70 = arith.addi %c160_i32, %0 : i32
          %true_21 = arith.constant true
          %71 = "simt_step.wave_count_bits"(%true_21) : (i1) -> i32
    ...
    ^bb2(%32: i32):  // no predecessors
      ...
      %36 = "simt_step.if"(%35) ({
        ...
        %44 = arith.addi %c96_i32_13, %0 : i32
        %45 = "simt_step.buffer.load"(%arg1, %44) : (!simt_step.resource<Global, i32>, i32) -> i32
