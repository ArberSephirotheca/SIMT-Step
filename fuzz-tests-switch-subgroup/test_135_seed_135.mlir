  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %5 = "simt_step.if"(%4) ({
        ...
        %17 = arith.addi %c0_i32_2, %arg0 : i32
        "simt_step.buffer.store"(%arg1, %17, %16) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        "simt_step.yield"(%16) : (i32) -> ()
      }, {
        %c2_i32_1 = arith.constant 2 : i32
        %16 = arith.remsi %arg3, %c2_i32_1 : i32
        %c3_i32_2 = arith.constant 3 : i32
        %17 = arith.addi %arg0, %c3_i32_2 : i32
    ...
    ^bb1(%6: i32):  // no predecessors
      ...
      ^bb1(%20: i32):  // no predecessors
        ...
        %21 = arith.remsi %arg3, %c4_i32_2 : i32
      ...
      ^bb2(%25: i32):  // no predecessors
        ...
        %26 = arith.remsi %arg3, %c3_i32_3 : i32
      ...
      %12 = arith.addi %c240_i32, %arg0 : i32
      "simt_step.buffer.store"(%arg1, %12, %11) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
      "simt_step.yield"(%10) {fallthrough = true} : (i32) -> ()
    ^bb2(%13: i32):  // no predecessors
      %c0_i32_0 = arith.constant 0 : i32
      %14 = arith.cmpi ne, %arg2, %c0_i32_0 : i32
      %15 = "simt_step.if"(%14) ({
        %true_1 = arith.constant true
        %16 = "simt_step.wave_count_bits"(%true_1) : (i1) -> i32
        %c256_i32 = arith.constant 256 : i32
        %17 = arith.addi %c256_i32, %arg0 : i32
        "simt_step.buffer.store"(%arg1, %17, %16) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        "simt_step.yield"(%16) : (i32) -> ()
      }, {
        ...
        %17 = "simt_step.if"(%16) ({
          ...
          %19 = arith.addi %c272_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %19, %18) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%18) : (i32) -> ()
        }, {
          %true_2 = arith.constant true
