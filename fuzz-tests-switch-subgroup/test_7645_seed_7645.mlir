  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %39 = arith.muli %arg4, %c4_i32_20 : i32
        %40 = arith.addi %c464_i32, %39 : i32
    ...
    ^bb3(%35: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %37 = arith.addi %c164_i32, %0 : i32
        %38 = "simt_step.buffer.load"(%arg1, %37) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_19 = arith.constant 0 : i32
        %39 = arith.cmpi ne, %38, %c0_i32_19 : i32
        %40 = "simt_step.if"(%39) ({
          %c0_i32_24 = arith.constant 0 : i32
          %49 = arith.addi %0, %c0_i32_24 : i32
          "simt_step.yield"(%49) : (i32) -> ()
        }, {
          "simt_step.yield"(%0) : (i32) -> ()
        }) : (i1) -> i32
        %c592_i32 = arith.constant 592 : i32
        %41 = arith.addi %c592_i32, %0 : i32
        %true_20 = arith.constant true
        %42 = "simt_step.wave_count_bits"(%true_20) : (i1) -> i32
        "simt_step.buffer.store"(%arg0, %41, %42) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        ...
        %45 = arith.muli %arg4, %c4_i32_22 : i32
        %46 = arith.addi %c608_i32, %45 : i32
        %47 = arith.addi %46, %0 : i32
