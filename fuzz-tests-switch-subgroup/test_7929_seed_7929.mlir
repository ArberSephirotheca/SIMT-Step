module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %2 = arith.remsi %arg3, %c2_i32_1 : i32
      %c2_i32_2 = arith.constant 2 : i32
      %3 = "simt_step.switch"(%2, %c2_i32_2) ({
      ^bb0(%arg5: i32):
        %true_5 = arith.constant true
        %13 = "simt_step.wave_count_bits"(%true_5) : (i1) -> i32
        %c0_i32_6 = arith.constant 0 : i32
        %14 = arith.addi %c0_i32_6, %arg0 : i32
    ...
    ^bb2(%11: i32):  // no predecessors
      ...
      %12:2 = "simt_step.loop"(%c0_i32, %c0_i32_4) ({
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%20: i32):  // no predecessors
      ...
      ^bb2(%42: i32):  // no predecessors
        ...
        %45 = "simt_step.switch"(%44, %c3_i32_15) ({
        ^bb0(%arg4: i32):
