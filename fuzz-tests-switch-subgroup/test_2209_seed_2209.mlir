  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    %5 = "simt_step.if"(%4) ({
      ...
      %9 = "simt_step.if"(%8) ({
        ...
        %10:2 = "simt_step.loop"(%c0_i32_7, %c0_i32_8) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32 = arith.constant 4 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb0(%arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %37 = arith.muli %arg6, %c4_i32_21 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %38 = arith.addi %arg6, %c1_i32_21 : i32
          %true_22 = arith.constant true
          %c96_i32_23 = arith.constant 96 : i32
          %c4_i32_24 = arith.constant 4 : i32
          %39 = arith.muli %arg6, %c4_i32_24 : i32
          %40 = arith.addi %c96_i32_23, %39 : i32
          %41 = arith.addi %40, %0 : i32
          %true_25 = arith.constant true
          %42 = "simt_step.wave_count_bits"(%true_25) : (i1) -> i32
      ...
      ^bb1(%20: i32):  // no predecessors
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %39 = arith.muli %arg6, %c4_i32_23 : i32
          %40 = arith.addi %c128_i32, %39 : i32
          %41 = arith.addi %40, %0 : i32
          %true_24 = arith.constant true
          %42 = "simt_step.wave_count_bits"(%true_24) : (i1) -> i32
          "simt_step.buffer.store"(%arg0, %41, %42) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
      ...
      ^bb2(%24: i32):  // no predecessors
        ...
        %30 = "simt_step.wave_count_bits"(%true_17) : (i1) -> i32
      ...
      ^bb3(%31: i32):  // no predecessors
        ...
        %34 = "simt_step.switch"(%33, %c0_i32_18) ({
        ^bb0(%arg5: i32):
          %c1_i32_21 = arith.constant 1 : i32
          %37 = arith.addi %0, %c1_i32_21 : i32
          %true_22 = arith.constant true
          %c176_i32 = arith.constant 176 : i32
          %38 = arith.addi %c176_i32, %0 : i32
          %true_23 = arith.constant true
          %39 = "simt_step.wave_count_bits"(%true_23) : (i1) -> i32
          "simt_step.buffer.store"(%arg0, %38, %39) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%37) {fallthrough = false} : (i32) -> ()
        ^bb1(%40: i32):  // no predecessors
          %c4_i32_24 = arith.constant 4 : i32
          %41 = arith.addi %0, %c4_i32_24 : i32
        ...
        ^bb2(%42: i32):  // no predecessors
          ...
          %44 = "simt_step.wave_count_bits"(%true_26) : (i1) -> i32
        ...
        %36 = "simt_step.wave_count_bits"(%true_20) : (i1) -> i32
