  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    %3 = "simt_step.if"(%2) ({
      ...
      %7 = "simt_step.if"(%6) ({
        ...
        %9 = arith.addi %c160_i32, %arg0 : i32
    ...
    ^bb1(%14: i32):  // no predecessors
      ...
      ^bb1(%25: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %40 = arith.muli %arg5, %c4_i32_26 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %42 = arith.muli %arg5, %c4_i32_27 : i32
          %43 = arith.addi %c224_i32, %42 : i32
          %44 = arith.addi %43, %0 : i32
          %true_28 = arith.constant true
          %45 = "simt_step.wave_count_bits"(%true_28) : (i1) -> i32
      ...
      ^bb2(%27: i32):  // no predecessors
        ...
        %30 = "simt_step.wave_count_bits"(%true_20) : (i1) -> i32
        "simt_step.buffer.store"(%arg0, %29, %30) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
      ...
      ^bb3(%31: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32):
          ...
          %43 = "simt_step.wave_count_bits"(%true_27) : (i1) -> i32
