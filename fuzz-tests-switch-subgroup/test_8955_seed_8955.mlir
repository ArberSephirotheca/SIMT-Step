  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %3 = "simt_step.if"(%2) ({
        ...
        %12 = arith.remsi %arg3, %c4_i32_0 : i32
        ...
        %12 = arith.remsi %arg3, %c3_i32_0 : i32
        %13 = simt_step.lane_id
        %14 = arith.index_cast %13 : index to i32
        %15 = "simt_step.switch"(%12, %14) ({
        ^bb0(%arg5: i32):
    ...
    ^bb2(%7: i32):  // no predecessors
      ...
      ^bb1(%14: i32):  // no predecessors
        ...
        %16 = arith.addi %c320_i32, %arg0 : i32
        "simt_step.buffer.store"(%arg1, %16, %15) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        "simt_step.yield"(%15) {fallthrough = false} : (i32) -> ()
      ^bb2(%17: i32):  // no predecessors
        %c4_i32_1 = arith.constant 4 : i32
        %18 = arith.remsi %arg3, %c4_i32_1 : i32
      ...
      ^bb3(%22: i32):  // no predecessors
        %c0_i32_2 = arith.constant 0 : i32
        %23 = arith.cmpi ne, %arg2, %c0_i32_2 : i32
        %24 = "simt_step.if"(%23) ({
          %true_3 = arith.constant true
          %25 = "simt_step.wave_count_bits"(%true_3) : (i1) -> i32
          %c400_i32 = arith.constant 400 : i32
          %26 = arith.addi %c400_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %26, %25) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%25) : (i32) -> ()
        }, {
          %true_3 = arith.constant true
          ...
          %26 = arith.addi %c416_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %26, %25) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%25) : (i32) -> ()
        }) : (i1) -> i32
        "simt_step.yield"(%24) {fallthrough = false} : (i32) -> ()
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %21 = arith.muli %arg4, %c4_i32_10 : i32
