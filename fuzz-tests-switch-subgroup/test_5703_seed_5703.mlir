  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb3(%34: i32):  // no predecessors
      ...
      ^bb2(%56: i32):  // no predecessors
        ...
        %57:2 = "simt_step.loop"(%c0_i32_15, %c0_i32_16) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_21 = arith.constant 4 : i32
          %68 = arith.muli %arg5, %c4_i32_21 : i32
          %69 = arith.addi %68, %0 : i32
          %c88_i32 = arith.constant 88 : i32
          %70 = arith.addi %c88_i32, %69 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %70 = arith.muli %arg5, %c4_i32_22 : i32
          %71 = arith.addi %c384_i32, %70 : i32
