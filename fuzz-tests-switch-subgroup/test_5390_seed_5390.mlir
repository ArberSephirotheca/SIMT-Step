module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32):
          ...
          %27 = arith.addi %c0_i32_9, %arg0 : i32
    ...
    ^bb1(%8: i32):  // no predecessors
      ...
      %9:2 = "simt_step.loop"(%c0_i32, %c0_i32_1) ({
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %20 = arith.muli %arg6, %c4_i32_8 : i32
    ...
    ^bb3(%12: i32):  // no predecessors
      ...
      ^bb1(%17: i32):  // no predecessors
        ...
        %19 = arith.addi %c288_i32, %arg0 : i32
    ...
    %8 = "simt_step.if"(%7) ({
      ...
      ^bb0(%arg2: i32):
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %42 = arith.muli %arg4, %c4_i32_21 : i32
          %43 = arith.addi %42, %0 : i32
          %c24_i32 = arith.constant 24 : i32
          %44 = arith.addi %c24_i32, %43 : i32
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %44 = arith.muli %arg4, %c4_i32_22 : i32
