module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %c0_i32_2 = arith.constant 0 : i32
      %15 = arith.addi %arg0, %c0_i32_2 : i32
      %16 = "simt_step.switch"(%14, %15) ({
      ^bb0(%arg5: i32):
        %c3_i32_6 = arith.constant 3 : i32
        %30 = arith.remsi %arg3, %c3_i32_6 : i32
        %c3_i32_7 = arith.constant 3 : i32
        %31 = "simt_step.switch"(%30, %c3_i32_7) ({
        ^bb0(%arg6: i32):
        ...
        ^bb1(%41: i32):  // no predecessors
          ...
          %43 = arith.addi %c96_i32, %arg0 : i32
        ...
        ^bb2(%44: i32):  // no predecessors
          ...
          %46 = arith.addi %c112_i32, %arg0 : i32
        ...
        ^bb3(%47: i32):  // no predecessors
          ...
          %49 = arith.addi %c128_i32, %arg0 : i32
      ...
      ^bb2(%35: i32):  // no predecessors
        ...
        %36 = arith.remsi %arg3, %c4_i32_9 : i32
        %c0_i32_10 = arith.constant 0 : i32
        %37 = arith.addi %arg0, %c0_i32_10 : i32
        ...
        ^bb3(%47: i32):  // no predecessors
          ...
          %49 = arith.addi %c208_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %49, %48) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%48) {fallthrough = false} : (i32) -> ()
    ...
    ^bb1(%17: i32):  // no predecessors
      ...
      %19 = arith.addi %c224_i32, %arg0 : i32
    ...
    ^bb3(%23: i32):  // no predecessors
      ...
      %24 = arith.remsi %arg3, %c3_i32_4 : i32
      ...
      ^bb1(%32: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %40 = arith.remsi %arg3, %c4_i32_11 : i32
          %c1_i32 = arith.constant 1 : i32
          %41 = arith.addi %40, %c1_i32 : i32
          %42 = arith.cmpi slt, %arg7, %41 : i32
          "simt_step.condition"(%42, %arg6, %arg7) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg6: i32, %arg7: i32):
          %true_11 = arith.constant true
          ...
          %41 = arith.muli %arg7, %c4_i32_12 : i32
          ...
          "simt_step.break"(%40, %44) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        "simt_step.yield"(%33#0) {fallthrough = false} : (i32) -> ()
      ^bb2(%34: i32):  // no predecessors
        %c0_i32_9 = arith.constant 0 : i32
        %35 = arith.cmpi ne, %arg2, %c0_i32_9 : i32
        %36 = "simt_step.if"(%35) ({
          %true_11 = arith.constant true
          %40 = "simt_step.wave_count_bits"(%true_11) : (i1) -> i32
          %c288_i32 = arith.constant 288 : i32
          %41 = arith.addi %c288_i32, %arg0 : i32
