  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        %25 = "simt_step.switch"(%24, %c1_i32_5) ({
        ^bb0(%arg6: i32):
    ...
    ^bb1(%13: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          %c4_i32_9 = arith.constant 4 : i32
          %30 = arith.remsi %arg3, %c4_i32_9 : i32
          %c1_i32_10 = arith.constant 1 : i32
          %31 = arith.addi %30, %c1_i32_10 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %31 = arith.muli %arg7, %c4_i32_10 : i32
          ...
          %34 = arith.addi %arg7, %c1_i32_11 : i32
    ...
    ^bb2(%16: i32):  // no predecessors
      ...
      ^bb1(%26: i32):  // no predecessors
        ...
        %27 = arith.remsi %arg3, %c3_i32 : i32
        ...
        ^bb2(%41: i32):  // no predecessors
          ...
          %43 = arith.addi %c240_i32, %arg0 : i32
        ...
        ^bb3(%44: i32):  // no predecessors
          ...
          %46 = arith.addi %c256_i32, %arg0 : i32
      ...
      ^bb3(%33: i32):  // no predecessors
        ...
        %35 = arith.addi %c288_i32, %arg0 : i32
        "simt_step.buffer.store"(%arg1, %35, %34) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
    ...
    ^bb3(%21: i32):  // no predecessors
      ...
      %22 = arith.cmpi ne, %arg2, %c0_i32_3 : i32
      %23 = "simt_step.if"(%22) ({
        %c3_i32 = arith.constant 3 : i32
        %24 = "simt_step.switch"(%arg3, %c3_i32) ({
        ^bb0(%arg5: i32):
        ...
        ^bb1(%29: i32):  // no predecessors
          ...
          %31 = arith.addi %c320_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %31, %30) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%30) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0>, default_index = 0 : i64} : (i32, i32) -> i32
        ...
        %26 = arith.addi %c336_i32, %arg0 : i32
        ...
        %25 = "simt_step.switch"(%24, %c2_i32_4) ({
        ^bb0(%arg5: i32):
          %true_6 = arith.constant true
        ...
        ^bb2(%33: i32):  // no predecessors
          ...
          %35 = arith.addi %c384_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %35, %34) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%34) {fallthrough = false} : (i32) -> ()
        ^bb3(%36: i32):  // no predecessors
          %true_9 = arith.constant true
          ...
          %38 = arith.addi %c400_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %38, %37) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%37) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1, 2>, default_index = 0 : i64} : (i32, i32) -> i32
        %true_5 = arith.constant true
        ...
        %27 = arith.addi %c416_i32, %arg0 : i32
    ...
    %7 = arith.addi %c432_i32, %arg0 : i32
