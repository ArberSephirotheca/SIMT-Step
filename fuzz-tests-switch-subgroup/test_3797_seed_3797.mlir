  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %5 = "simt_step.if"(%4) ({
        ...
        %21 = arith.cmpi ne, %arg2, %c0_i32_2 : i32
        %22 = "simt_step.if"(%21) ({
          %true_3 = arith.constant true
          %23 = "simt_step.wave_count_bits"(%true_3) : (i1) -> i32
          %c0_i32_4 = arith.constant 0 : i32
          %24 = arith.addi %c0_i32_4, %arg0 : i32
    ...
    ^bb1(%6: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        %21 = arith.remsi %arg3, %c3_i32_2 : i32
        ...
        ^bb0(%arg6: i32):
          ...
          %44 = arith.addi %c48_i32, %arg0 : i32
        ...
        ^bb1(%45: i32):  // no predecessors
          ...
          %47 = arith.addi %c64_i32, %arg0 : i32
        ...
        ^bb2(%48: i32):  // no predecessors
          ...
          %50 = arith.addi %c80_i32, %arg0 : i32
        ...
        ^bb3(%51: i32):  // no predecessors
          ...
          %53 = arith.addi %c96_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %53, %52) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
      ...
      ^bb2(%30: i32):  // no predecessors
        ...
        %31 = arith.remsi %arg3, %c2_i32_5 : i32
        ...
        ^bb2(%48: i32):  // no predecessors
          ...
          %50 = arith.addi %c176_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %50, %49) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%49) {fallthrough = false} : (i32) -> ()
      ...
      ^bb3(%37: i32):  // no predecessors
        ...
        ^bb1(%45: i32):  // no predecessors
          ...
          %47 = arith.addi %c224_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %47, %46) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%46) {fallthrough = false} : (i32) -> ()
      ...
      %12 = arith.addi %c256_i32, %arg0 : i32
    ...
    ^bb2(%13: i32):  // no predecessors
      ...
      %15 = "simt_step.switch"(%14, %c0_i32_0) ({
      ^bb0(%arg5: i32):
        %c0_i32_2 = arith.constant 0 : i32
        %21 = arith.cmpi ne, %arg2, %c0_i32_2 : i32
        %22 = "simt_step.if"(%21) ({
          ...
          %32 = arith.addi %c288_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %32, %31) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%31) : (i32) -> ()
        }) : (i1) -> i32
      ...
      ^bb1(%23: i32):  // no predecessors
        ...
        %24 = arith.remsi %arg3, %c3_i32_3 : i32
        ...
        ^bb0(%arg6: i32):
          ...
          %32 = arith.addi %c304_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %32, %31) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        ...
        ^bb1(%33: i32):  // no predecessors
          ...
          %35 = arith.addi %c320_i32, %arg0 : i32
        ...
        ^bb2(%36: i32):  // no predecessors
          ...
          %38 = arith.addi %c336_i32, %arg0 : i32
    ...
    ^bb3(%16: i32):  // no predecessors
      ...
      ^bb1(%22: i32):  // no predecessors
        ...
        %23 = arith.remsi %arg3, %c4_i32_4 : i32
        %c3_i32_5 = arith.constant 3 : i32
        %24 = "simt_step.switch"(%23, %c3_i32_5) ({
        ^bb0(%arg6: i32):
          %true_9 = arith.constant true
          %29 = "simt_step.wave_count_bits"(%true_9) : (i1) -> i32
          %c416_i32 = arith.constant 416 : i32
          %30 = arith.addi %c416_i32, %arg0 : i32
        ...
        ^bb1(%31: i32):  // no predecessors
          ...
          %33 = arith.addi %c432_i32, %arg0 : i32
        ...
        ^bb2(%34: i32):  // no predecessors
          ...
          %36 = arith.addi %c448_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %36, %35) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        ...
        ^bb3(%37: i32):  // no predecessors
          ...
          %39 = arith.addi %c464_i32, %arg0 : i32
        ...
        %26 = arith.addi %c480_i32, %arg0 : i32
        "simt_step.buffer.store"(%arg1, %26, %25) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        "simt_step.yield"(%24) {fallthrough = false} : (i32) -> ()
