module {
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%25: i32):  // no predecessors
      ...
      %c0_i32_2 = arith.constant 0 : i32
      %28 = "simt_step.switch"(%27, %c0_i32_2) ({
      ^bb0(%arg3: i32):
        %c0_i32_5 = arith.constant 0 : i32
    ...
    ^bb3(%38: i32):  // no predecessors
      ...
      ^bb1(%55: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %71 = arith.muli %arg5, %c4_i32_28 : i32
          %72 = arith.addi %c384_i32, %71 : i32
          %73 = arith.addi %72, %0 : i32
          %true_29 = arith.constant true
          %74 = "simt_step.wave_count_bits"(%true_29) : (i1) -> i32
      ...
      ^bb2(%59: i32):  // no predecessors
        ...
        %60:2 = "simt_step.loop"(%c0_i32_23, %c0_i32_24) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_27 = arith.constant 4 : i32
          %69 = arith.muli %arg5, %c4_i32_27 : i32
          %70 = arith.addi %69, %0 : i32
          %c132_i32 = arith.constant 132 : i32
          %71 = arith.addi %c132_i32, %70 : i32
          %72 = "simt_step.buffer.load"(%arg1, %71) : (!simt_step.resource<Global, i32>, i32) -> i32
          %c0_i32_28 = arith.constant 0 : i32
          %73 = arith.cmpi ne, %72, %c0_i32_28 : i32
          "simt_step.condition"(%73, %arg4, %arg5) : (i1, i32, i32) -> ()
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %c4_i32_28 = arith.constant 4 : i32
          %71 = arith.muli %arg5, %c4_i32_28 : i32
          %72 = arith.addi %c416_i32, %71 : i32
          %73 = arith.addi %72, %0 : i32
          %true_29 = arith.constant true
          %74 = "simt_step.wave_count_bits"(%true_29) : (i1) -> i32
          "simt_step.buffer.store"(%arg0, %73, %74) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.continue"(%69, %70) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb3(%63: i32):  // no predecessors
        ...
        ^bb3(%77: i32):  // no predecessors
          ...
          %80 = arith.addi %c480_i32, %0 : i32
          %true_32 = arith.constant true
          %81 = "simt_step.wave_count_bits"(%true_32) : (i1) -> i32
