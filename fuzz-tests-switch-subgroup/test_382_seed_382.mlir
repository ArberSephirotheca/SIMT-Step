    ...
    ^bb1(%11: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %34 = arith.remsi %arg3, %c4_i32_13 : i32
          %c1_i32 = arith.constant 1 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %35 = arith.muli %arg7, %c4_i32_14 : i32
      ...
      ^bb1(%27: i32):  // no predecessors
        ...
        %29 = "simt_step.switch"(%28, %c2_i32_9) ({
        ^bb0(%arg6: i32):
          %true_13 = arith.constant true
          %34 = "simt_step.wave_count_bits"(%true_13) : (i1) -> i32
        ...
        ^bb2(%39: i32):  // no predecessors
          ...
          %41 = arith.addi %c80_i32, %arg0 : i32
    ...
    ^bb3(%23: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb1(%45: i32):  // no predecessors
          ...
          %47 = arith.addi %c208_i32, %arg0 : i32
        ...
        ^bb2(%48: i32):  // no predecessors
          ...
          %50 = arith.addi %c224_i32, %arg0 : i32
        ...
        ^bb3(%51: i32):  // no predecessors
          ...
          %53 = arith.addi %c240_i32, %arg0 : i32
      ...
      ^bb1(%31: i32):  // no predecessors
        %c2_i32_9 = arith.constant 2 : i32
        %32 = arith.remsi %arg3, %c2_i32_9 : i32
      ...
      ^bb2(%38: i32):  // no predecessors
        ...
        %39 = arith.remsi %arg3, %c2_i32_11 : i32
        ...
        ^bb1(%45: i32):  // no predecessors
          ...
          %47 = arith.addi %c336_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %47, %46) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%46) {fallthrough = false} : (i32) -> ()
        ^bb2(%48: i32):  // no predecessors
          %true_14 = arith.constant true
          ...
          %50 = arith.addi %c352_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %50, %49) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%49) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1>, default_index = 2 : i64} : (i32, i32) -> i32
