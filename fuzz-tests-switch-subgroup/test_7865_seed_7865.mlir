module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %6 = arith.remsi %arg3, %c4_i32_1 : i32
      %7 = simt_step.lane_id
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %37 = arith.remsi %arg3, %c4_i32_10 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %38 = arith.muli %arg7, %c4_i32_11 : i32
      ...
      ^bb2(%29: i32):  // no predecessors
        ...
        %30 = arith.remsi %arg3, %c3_i32 : i32
        ...
        ^bb2(%42: i32):  // no predecessors
          ...
          %44 = arith.addi %c96_i32, %arg0 : i32
    ...
    ^bb1(%10: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          %c4_i32_11 = arith.constant 4 : i32
          %34 = arith.remsi %arg3, %c4_i32_11 : i32
          %c1_i32 = arith.constant 1 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %35 = arith.muli %arg7, %c4_i32_12 : i32
    ...
    ^bb2(%15: i32):  // no predecessors
      ...
      %17 = arith.addi %c272_i32, %arg0 : i32
    ...
    ^bb3(%18: i32):  // no predecessors
      ...
      ^bb1(%27: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32):
          ...
          %31 = arith.addi %c304_i32, %arg0 : i32
      ...
      %24 = arith.addi %c336_i32, %arg0 : i32
