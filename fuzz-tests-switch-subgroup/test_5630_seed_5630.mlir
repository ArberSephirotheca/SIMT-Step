  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        %13 = "simt_step.if"(%12) ({
          ...
          %24 = arith.addi %c0_i32_6, %arg0 : i32
    ...
    ^bb1(%7: i32):  // no predecessors
      ...
      ^bb2(%20: i32):  // no predecessors
        ...
        %22 = arith.addi %arg0, %c1_i32_5 : i32
      ...
      ^bb3(%24: i32):  // no predecessors
        ...
        %25 = arith.remsi %arg3, %c3_i32_6 : i32
        ...
        ^bb3(%35: i32):  // no predecessors
          ...
          %37 = arith.addi %c336_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %37, %36) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%36) {fallthrough = false} : (i32) -> ()
    ...
    %3 = arith.addi %c352_i32, %arg0 : i32
