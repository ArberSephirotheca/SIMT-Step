module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb1(%26: i32):  // no predecessors
        ...
        %27 = arith.cmpi ne, %arg2, %c0_i32 : i32
        %28 = "simt_step.if"(%27) ({
          %true_6 = arith.constant true
          %32 = "simt_step.wave_count_bits"(%true_6) : (i1) -> i32
    ...
    ^bb2(%13: i32):  // no predecessors
      ...
      ^bb2(%26: i32):  // no predecessors
        ...
        %27 = arith.remsi %arg3, %c2_i32_4 : i32
        ...
        ^bb1(%36: i32):  // no predecessors
          ...
          %38 = arith.addi %c256_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %38, %37) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%37) {fallthrough = false} : (i32) -> ()
        ^bb2(%39: i32):  // no predecessors
          %true_8 = arith.constant true
          ...
          %41 = arith.addi %c272_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %41, %40) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%40) {fallthrough = false} : (i32) -> ()
    ...
    ^bb3(%16: i32):  // no predecessors
      ...
      %17 = arith.remsi %arg3, %c4_i32_2 : i32
      ...
      ^bb0(%arg5: i32):
        ...
        %21 = "simt_step.if"(%20) ({
          ...
          %30 = arith.addi %c304_i32, %arg0 : i32
      ...
      ^bb1(%22: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %29 = arith.remsi %arg3, %c4_i32_8 : i32
          %c1_i32_9 = arith.constant 1 : i32
          %30 = arith.addi %29, %c1_i32_9 : i32
      ...
      ^bb2(%24: i32):  // no predecessors
        ...
        %26 = "simt_step.if"(%25) ({
          ...
          %30 = arith.addi %c368_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %30, %29) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%29) : (i32) -> ()
        }) : (i1) -> i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %c4_i32_2 = arith.constant 4 : i32
      %16 = arith.muli %arg3, %c4_i32_2 : i32
      %17 = arith.addi %c400_i32, %16 : i32
    ...
    ^bb2(%24: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %44 = arith.muli %arg5, %c4_i32_20 : i32
