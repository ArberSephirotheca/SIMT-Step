  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      "simt_step.if"(%16) ({
        ...
        %17 = arith.remsi %0, %c4_i32_7 : i32
        %c4_i32_8 = arith.constant 4 : i32
        %18 = arith.addi %0, %c4_i32_8 : i32
        %19 = "simt_step.switch"(%17, %18) ({
        ^bb0(%arg2: i32):
          %c1_i32 = arith.constant 1 : i32
          %20 = arith.addi %arg2, %c1_i32 : i32
          "simt_step.yield"(%20) {fallthrough = false} : (i32) -> ()
        ^bb1(%21: i32):  // no predecessors
          %c0_i32_9 = arith.constant 0 : i32
          %22 = arith.addi %21, %c0_i32_9 : i32
        ...
        ^bb3(%25: i32):  // no predecessors
          ...
          %26 = arith.addi %25, %c0_i32_10 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %28 = arith.muli %arg7, %c4_i32_17 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          %28 = arith.addi %arg6, %arg7 : i32
          %c1_i32_17 = arith.constant 1 : i32
          %29 = arith.addi %arg7, %c1_i32_17 : i32
          %true_18 = arith.constant true
          %c96_i32 = arith.constant 96 : i32
          %c4_i32_19 = arith.constant 4 : i32
          %30 = arith.muli %arg7, %c4_i32_19 : i32
          %31 = arith.addi %c96_i32, %30 : i32
          %32 = arith.addi %31, %0 : i32
          %true_20 = arith.constant true
          %33 = "simt_step.wave_count_bits"(%true_20) : (i1) -> i32
          "simt_step.buffer.store"(%arg0, %32, %33) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%28, %29) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %22 = arith.addi %arg4, %21#0 : i32
