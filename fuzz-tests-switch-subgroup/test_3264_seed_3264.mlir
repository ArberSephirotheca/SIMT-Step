  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    %1 = "simt_step.if"(%0) ({
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        %6 = arith.addi %arg5, %c1_i32_2 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      %22 = "simt_step.if"(%21) ({
        ...
        %49 = arith.addi %c40_i32, %0 : i32
        %50 = "simt_step.buffer.load"(%arg1, %49) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_14 = arith.constant 0 : i32
        %51 = "simt_step.switch"(%50, %c0_i32_14) ({
        ^bb0(%arg3: i32):
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %50 = arith.muli %arg4, %c4_i32_16 : i32
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %c4_i32_17 = arith.constant 4 : i32
          %52 = arith.muli %arg4, %c4_i32_17 : i32
    ...
    ^bb1(%27: i32):  // no predecessors
      ...
      ^bb1(%56: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %66 = arith.muli %arg5, %c4_i32_29 : i32
          ...
          %70 = arith.cmpi ne, %69, %c0_i32_30 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %68 = arith.muli %arg5, %c4_i32_30 : i32
          %69 = arith.addi %c224_i32, %68 : i32
          ...
          "simt_step.break"(%66, %67) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        "simt_step.yield"(%57#0) {fallthrough = true} : (i32) -> ()
      ^bb2(%58: i32):  // no predecessors
        %c0_i32_21 = arith.constant 0 : i32
        %c0_i32_22 = arith.constant 0 : i32
        %59:2 = "simt_step.loop"(%c0_i32_21, %c0_i32_22) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_29 = arith.constant 4 : i32
          %66 = arith.muli %arg5, %c4_i32_29 : i32
          %67 = arith.addi %66, %0 : i32
          %c92_i32 = arith.constant 92 : i32
          %68 = arith.addi %c92_i32, %67 : i32
          %69 = "simt_step.buffer.load"(%arg1, %68) : (!simt_step.resource<Global, i32>, i32) -> i32
          %c0_i32_30 = arith.constant 0 : i32
          %70 = arith.cmpi ne, %69, %c0_i32_30 : i32
          "simt_step.condition"(%70, %arg4, %arg5) : (i1, i32, i32) -> ()
      ...
      ^bb3(%62: i32):  // no predecessors
        ...
        %63:2 = "simt_step.loop"(%c0_i32_25, %c0_i32_26) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_29 = arith.constant 4 : i32
          %66 = arith.muli %arg5, %c4_i32_29 : i32
          %67 = arith.addi %66, %0 : i32
          %c112_i32 = arith.constant 112 : i32
          %68 = arith.addi %c112_i32, %67 : i32
          %69 = "simt_step.buffer.load"(%arg1, %68) : (!simt_step.resource<Global, i32>, i32) -> i32
          %c0_i32_30 = arith.constant 0 : i32
          %70 = arith.cmpi ne, %69, %c0_i32_30 : i32
          "simt_step.condition"(%70, %arg4, %arg5) : (i1, i32, i32) -> ()
    ...
    ^bb3(%44: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        %49 = arith.addi %c144_i32_14, %0 : i32
        %50 = "simt_step.buffer.load"(%arg1, %49) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_15 = arith.constant 0 : i32
      ...
      ^bb2(%62: i32):  // no predecessors
        %c0_i32_19 = arith.constant 0 : i32
        %c0_i32_20 = arith.constant 0 : i32
        %63:2 = "simt_step.loop"(%c0_i32_19, %c0_i32_20) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_23 = arith.constant 4 : i32
          %66 = arith.muli %arg5, %c4_i32_23 : i32
          %67 = arith.addi %66, %0 : i32
          %c152_i32 = arith.constant 152 : i32
          %68 = arith.addi %c152_i32, %67 : i32
          %69 = "simt_step.buffer.load"(%arg1, %68) : (!simt_step.resource<Global, i32>, i32) -> i32
