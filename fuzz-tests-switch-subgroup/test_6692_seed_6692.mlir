  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        %c1_i32 = arith.constant 1 : i32
        %18 = arith.cmpi slt, %arg3, %c1_i32 : i32
        "simt_step.condition"(%18, %arg2, %arg3) : (i1, i32, i32) -> ()
      }, {
      ^bb0(%arg2: i32, %arg3: i32):
        %c4_i32_6 = arith.constant 4 : i32
        %18 = arith.remsi %0, %c4_i32_6 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32):
        ...
        %41 = arith.addi %c64_i32_16, %0 : i32
      ...
      ^bb1(%45: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %57 = arith.muli %arg5, %c4_i32_27 : i32
      ...
      ^bb3(%53: i32):  // no predecessors
        ...
        %54:2 = "simt_step.loop"(%c0_i32_24, %c0_i32_25) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_26 = arith.constant 4 : i32
          %55 = arith.muli %arg5, %c4_i32_26 : i32
          %56 = arith.addi %55, %0 : i32
