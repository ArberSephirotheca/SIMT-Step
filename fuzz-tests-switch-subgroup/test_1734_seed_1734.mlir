module {
    ...
    ^bb1(%19: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %36 = arith.remsi %arg3, %c4_i32_14 : i32
          %c1_i32 = arith.constant 1 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %37 = arith.muli %arg7, %c4_i32_15 : i32
    ...
    ^bb2(%22: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c4_i32_15 = arith.constant 4 : i32
          %32 = arith.muli %arg7, %c4_i32_15 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      "simt_step.if"(%11) ({
        ...
        ^bb0(%arg2: i32):
          ...
          %16 = arith.addi %arg2, %c4_i32_8 : i32
        ...
        ^bb3(%21: i32):  // no predecessors
          ...
          %22 = arith.addi %21, %c4_i32_10 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      %c0_i32_6 = arith.constant 0 : i32
      %9 = arith.addi %arg2, %c0_i32_6 : i32
      %c1_i32 = arith.constant 1 : i32
      %10 = arith.addi %arg3, %c1_i32 : i32
      %true = arith.constant true
