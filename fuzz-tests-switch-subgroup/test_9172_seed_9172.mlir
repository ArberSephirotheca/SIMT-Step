  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb1(%39: i32):  // no predecessors
        ...
        %42 = "simt_step.switch"(%41, %c4_i32_14) ({
        ^bb0(%arg4: i32):
          %c2_i32 = arith.constant 2 : i32
    ...
    ^bb2(%31: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %34 = arith.addi %arg4, %c1_i32_12 : i32
        %true_13 = arith.constant true
    ...
    ^bb1(%21: i32):  // no predecessors
      ...
      ^bb2(%47: i32):  // no predecessors
        ...
        ^bb2(%60: i32):  // no predecessors
          ...
          "simt_step.yield"(%c3_i32_27) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1>, default_index = 2 : i64} : (i32, i32) -> i32
        %true_18 = arith.constant true
      ...
      ^bb3(%55: i32):  // no predecessors
        ...
        %56:2 = "simt_step.loop"(%c0_i32_22, %c0_i32_23) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_24 = arith.constant 4 : i32
          %57 = arith.muli %arg5, %c4_i32_24 : i32
          %58 = arith.addi %57, %0 : i32
