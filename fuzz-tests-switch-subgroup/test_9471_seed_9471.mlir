  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%24: i32):  // no predecessors
      ...
      ^bb1(%34: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_11 = arith.constant 4 : i32
          %47 = arith.muli %arg5, %c4_i32_11 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %48 = arith.addi %arg5, %c1_i32_11 : i32
          %true_12 = arith.constant true
          %c208_i32 = arith.constant 208 : i32
          %c4_i32_13 = arith.constant 4 : i32
          %49 = arith.muli %arg5, %c4_i32_13 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      %21 = "simt_step.if"(%20) ({
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %47 = arith.muli %arg4, %c4_i32_19 : i32
          %48 = arith.addi %47, %0 : i32
          %c80_i32 = arith.constant 80 : i32
          %49 = arith.addi %c80_i32, %48 : i32
          %50 = "simt_step.buffer.load"(%arg1, %49) : (!simt_step.resource<Global, i32>, i32) -> i32
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %49 = arith.muli %arg4, %c4_i32_20 : i32
    ...
    ^bb1(%26: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        "simt_step.buffer.store"(%arg0, %50, %51) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        %52 = arith.addi %arg3, %49 : i32
        %c1_i32 = arith.constant 1 : i32
        %53 = arith.addi %arg4, %c1_i32 : i32
        %true_19 = arith.constant true
        %c336_i32 = arith.constant 336 : i32
        %c4_i32_20 = arith.constant 4 : i32
        %54 = arith.muli %arg4, %c4_i32_20 : i32
    ...
    ^bb2(%30: i32):  // no predecessors
      ...
      ^bb1(%54: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %67 = arith.muli %arg5, %c4_i32_27 : i32
          %68 = arith.addi %c448_i32, %67 : i32
      ...
      ^bb3(%61: i32):  // no predecessors
        ...
        %62 = arith.addi %c152_i32, %0 : i32
        %63 = "simt_step.buffer.load"(%arg1, %62) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_25 = arith.constant 0 : i32
        %64 = "simt_step.switch"(%63, %c0_i32_25) ({
        ^bb0(%arg4: i32):
          %c4_i32_26 = arith.constant 4 : i32
          %65 = arith.addi %0, %c4_i32_26 : i32
          %true_27 = arith.constant true
          %c480_i32 = arith.constant 480 : i32
          %66 = arith.addi %c480_i32, %0 : i32
          %true_28 = arith.constant true
          %67 = "simt_step.wave_count_bits"(%true_28) : (i1) -> i32
        ...
        ^bb1(%68: i32):  // no predecessors
          ...
          %69 = arith.addi %0, %c2_i32_29 : i32
          %true_30 = arith.constant true
          %c496_i32 = arith.constant 496 : i32
          %70 = arith.addi %c496_i32, %0 : i32
          %true_31 = arith.constant true
          %71 = "simt_step.wave_count_bits"(%true_31) : (i1) -> i32
        ...
        ^bb2(%72: i32):  // no predecessors
          ...
          %75 = arith.addi %c512_i32, %0 : i32
          %true_33 = arith.constant true
          %76 = "simt_step.wave_count_bits"(%true_33) : (i1) -> i32
          "simt_step.buffer.store"(%arg0, %75, %76) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%74) {fallthrough = true} : (i32) -> ()
        ^bb3(%77: i32):  // no predecessors
          %78 = simt_step.lane_id
