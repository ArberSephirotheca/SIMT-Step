module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %3 = arith.addi %arg0, %c3_i32_1 : i32
      ...
      ^bb0(%arg5: i32):
        ...
        %13 = "simt_step.if"(%12) ({
          ...
          %23 = arith.addi %c0_i32_12, %arg0 : i32
      ...
      ^bb2(%17: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c4_i32_12 = arith.constant 4 : i32
          %23 = arith.muli %arg7, %c4_i32_12 : i32
    ...
    ^bb1(%5: i32):  // no predecessors
      ...
      %6:2 = "simt_step.loop"(%c0_i32, %c0_i32_2) ({
    ...
    ^bb2(%7: i32):  // no predecessors
      ...
      ^bb2(%17: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %20 = arith.muli %arg7, %c4_i32_11 : i32
