module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    %2 = arith.addi %arg0, %c2_i32_1 : i32
    ...
    ^bb1(%7: i32):  // no predecessors
      ...
      %9 = "simt_step.if"(%8) ({
        ...
        %15 = arith.addi %arg0, %c2_i32_8 : i32
        %16 = "simt_step.switch"(%14, %15) ({
        ^bb0(%arg5: i32):
          %true = arith.constant true
    ...
    ^bb2(%10: i32):  // no predecessors
      ...
      %11 = arith.remsi %arg3, %c2_i32_6 : i32
      %c1_i32 = arith.constant 1 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      %14 = "simt_step.if"(%13) ({
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %42 = arith.addi %arg4, %c1_i32_10 : i32
          %true_11 = arith.constant true
    ...
    ^bb3(%32: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb2(%71: i32):  // no predecessors
          ...
          %75 = "simt_step.wave_count_bits"(%true_20) : (i1) -> i32
      ...
      ^bb1(%47: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32):
          ...
          %67 = arith.addi %c336_i32, %0 : i32
          %true_17 = arith.constant true
          %68 = "simt_step.wave_count_bits"(%true_17) : (i1) -> i32
        ...
        %true_11 = arith.constant true
        %54 = "simt_step.wave_count_bits"(%true_11) : (i1) -> i32
      ...
      ^bb3(%60: i32):  // no predecessors
        ...
        %65 = "simt_step.wave_count_bits"(%true_14) : (i1) -> i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %19 = arith.muli %arg4, %c4_i32_9 : i32
        %20 = arith.addi %19, %0 : i32
        %c92_i32 = arith.constant 92 : i32
        %21 = arith.addi %c92_i32, %20 : i32
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %c1_i32_9 = arith.constant 1 : i32
        %20 = arith.addi %arg4, %c1_i32_9 : i32
        %true_10 = arith.constant true
        %c432_i32 = arith.constant 432 : i32
        %c4_i32_11 = arith.constant 4 : i32
        %21 = arith.muli %arg4, %c4_i32_11 : i32
        %22 = arith.addi %c432_i32, %21 : i32
