  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      "simt_step.if"(%14) ({
        ...
        ^bb0(%arg2: i32):
          ...
          %19 = arith.addi %arg2, %c4_i32_3 : i32
    ...
    ^bb2(%25: i32):  // no predecessors
      ...
      ^bb1(%51: i32):  // no predecessors
        ...
        %c4_i32_15 = arith.constant 4 : i32
        %54 = "simt_step.switch"(%53, %c4_i32_15) ({
        ^bb0(%arg4: i32):
      ...
      ^bb2(%57: i32):  // no predecessors
        ...
        %58:2 = "simt_step.loop"(%c0_i32_18, %c0_i32_19) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_22 = arith.constant 4 : i32
          %64 = arith.muli %arg5, %c4_i32_22 : i32
          %65 = arith.addi %64, %0 : i32
          %c48_i32 = arith.constant 48 : i32
          %66 = arith.addi %c48_i32, %65 : i32
