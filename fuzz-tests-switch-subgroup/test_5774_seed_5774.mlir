module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %7 = "simt_step.if"(%6) ({
        ...
        %19 = "simt_step.if"(%18) ({
          ...
          %21 = arith.addi %c0_i32_7, %arg0 : i32
    ...
    ^bb1(%8: i32):  // no predecessors
      ...
      %9 = arith.remsi %arg3, %c4_i32_0 : i32
    ...
    ^bb2(%11: i32):  // no predecessors
      ...
      ^bb3(%28: i32):  // no predecessors
        ...
        %29 = arith.cmpi ne, %arg2, %c0_i32_10 : i32
        %30 = "simt_step.if"(%29) ({
          %true_11 = arith.constant true
          %31 = "simt_step.wave_count_bits"(%true_11) : (i1) -> i32
    ...
    ^bb3(%15: i32):  // no predecessors
      ...
      %17 = "simt_step.if"(%16) ({
        ...
        %19 = arith.addi %c304_i32, %arg0 : i32
        "simt_step.buffer.store"(%arg1, %19, %18) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        ...
        ^bb0(%arg5: i32):
          ...
          %23 = arith.addi %c320_i32, %arg0 : i32
        ...
        %21 = arith.addi %c384_i32, %arg0 : i32
        "simt_step.buffer.store"(%arg1, %21, %20) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        "simt_step.yield"(%19) : (i32) -> ()
      }) : (i1) -> i32
    ...
    %5 = arith.addi %c400_i32, %arg0 : i32
