module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    %2 = arith.addi %c192_i32, %arg0 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%29: i32):  // no predecessors
      ...
      %33 = "simt_step.if"(%32) ({
        ...
        ^bb3(%57: i32):  // no predecessors
          ...
          %true_11 = arith.constant true
          %61 = "simt_step.wave_count_bits"(%true_11) : (i1) -> i32
          "simt_step.buffer.store"(%arg0, %60, %61) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
    ...
    ^bb3(%39: i32):  // no predecessors
      ...
      %43 = "simt_step.if"(%42) ({
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          %c4_i32_12 = arith.constant 4 : i32
          %47 = arith.muli %arg4, %c4_i32_12 : i32
          %48 = arith.addi %47, %0 : i32
          %c120_i32 = arith.constant 120 : i32
          %49 = arith.addi %c120_i32, %48 : i32
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %48 = arith.addi %arg4, %c1_i32_12 : i32
          %true_13 = arith.constant true
          %c608_i32 = arith.constant 608 : i32
          %c4_i32_14 = arith.constant 4 : i32
          %49 = arith.muli %arg4, %c4_i32_14 : i32
