  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb1(%44: i32):  // no predecessors
        %c16_i32 = arith.constant 16 : i32
        %45 = arith.addi %c16_i32, %0 : i32
        %46 = "simt_step.buffer.load"(%arg1, %45) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c4_i32_15 = arith.constant 4 : i32
        %47 = "simt_step.switch"(%46, %c4_i32_15) ({
        ^bb0(%arg4: i32):
    ...
    ^bb1(%24: i32):  // no predecessors
      ...
      ^bb3(%58: i32):  // no predecessors
        ...
        %59:2 = "simt_step.loop"(%c0_i32_25, %c0_i32_26) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_29 = arith.constant 4 : i32
          %62 = arith.muli %arg5, %c4_i32_29 : i32
          %63 = arith.addi %62, %0 : i32
          %c72_i32 = arith.constant 72 : i32
          %64 = arith.addi %c72_i32, %63 : i32
          %65 = "simt_step.buffer.load"(%arg1, %64) : (!simt_step.resource<Global, i32>, i32) -> i32
          %c0_i32_30 = arith.constant 0 : i32
          %66 = arith.cmpi ne, %65, %c0_i32_30 : i32
          "simt_step.condition"(%66, %arg4, %arg5) : (i1, i32, i32) -> ()
