module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb2(%11: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        %c0_i32_5 = arith.constant 0 : i32
        %19 = "simt_step.switch"(%arg3, %c0_i32_5) ({
        ^bb0(%arg6: i32):
      ...
      ^bb1(%20: i32):  // no predecessors
        ...
        ^bb1(%39: i32):  // no predecessors
          ...
          %41 = arith.addi %c208_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %41, %40) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%40) {fallthrough = false} : (i32) -> ()
        ^bb2(%42: i32):  // no predecessors
          ...
          %44 = arith.addi %c224_i32, %arg0 : i32
        ...
        ^bb3(%45: i32):  // no predecessors
          ...
          %47 = arith.addi %c240_i32, %arg0 : i32
      ...
      ^bb2(%27: i32):  // no predecessors
        ...
        %28 = arith.cmpi ne, %arg2, %c0_i32_8 : i32
        %29 = "simt_step.if"(%28) ({
          %true_11 = arith.constant true
          %37 = "simt_step.wave_count_bits"(%true_11) : (i1) -> i32
      ...
      ^bb3(%30: i32):  // no predecessors
        ...
        ^bb2(%42: i32):  // no predecessors
          ...
          %44 = arith.addi %c336_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %44, %43) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        ...
        ^bb3(%45: i32):  // no predecessors
          ...
          %47 = arith.addi %c352_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %47, %46) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%46) {fallthrough = false} : (i32) -> ()
      ...
      %15 = arith.addi %c384_i32, %arg0 : i32
    ...
    ^bb2(%22: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %32 = arith.addi %arg6, %c1_i32_13 : i32
          %true_14 = arith.constant true
          %c496_i32 = arith.constant 496 : i32
          %c4_i32_15 = arith.constant 4 : i32
          %33 = arith.muli %arg6, %c4_i32_15 : i32
          %34 = arith.addi %c496_i32, %33 : i32
