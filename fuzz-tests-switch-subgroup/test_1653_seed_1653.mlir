  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    %8 = "simt_step.if"(%7) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %29 = arith.addi %arg3, %c1_i32_8 : i32
    ...
    ^bb2(%39: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %48 = arith.muli %arg6, %c4_i32_19 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %49 = arith.addi %arg6, %c1_i32_19 : i32
          %true_20 = arith.constant true
          %c288_i32 = arith.constant 288 : i32
          %c4_i32_21 = arith.constant 4 : i32
          %50 = arith.muli %arg6, %c4_i32_21 : i32
    ...
    ^bb1(%31: i32):  // no predecessors
      ...
      %35 = "simt_step.if"(%34) ({
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %47 = arith.addi %arg4, %c1_i32_17 : i32
          %true_18 = arith.constant true
          %c432_i32 = arith.constant 432 : i32
          %c4_i32_19 = arith.constant 4 : i32
          %48 = arith.muli %arg4, %c4_i32_19 : i32
          %49 = arith.addi %c432_i32, %48 : i32
    ...
    ^bb2(%40: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %50 = arith.addi %arg4, %c1_i32_16 : i32
        %true_17 = arith.constant true
