  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        ^bb1(%28: i32):  // no predecessors
          ...
          %29 = arith.addi %28, %c0_i32_8 : i32
          "simt_step.yield"(%29) {fallthrough = false} : (i32) -> ()
        ^bb2(%30: i32):  // no predecessors
          %c2_i32_9 = arith.constant 2 : i32
          %31 = arith.addi %30, %c2_i32_9 : i32
    ...
    %9 = "simt_step.if"(%8) ({
      ...
      ^bb0(%arg2: i32):
        ...
        %28 = "simt_step.switch"(%27, %c4_i32_4) ({
        ^bb0(%arg3: i32):
      ...
      ^bb0(%arg2: i32):
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %32 = arith.addi %arg4, %c1_i32_12 : i32
    ...
    ^bb2(%38: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %c1_i32_19 = arith.constant 1 : i32
        %45 = arith.addi %arg4, %c1_i32_19 : i32
        %true_20 = arith.constant true
        %c576_i32 = arith.constant 576 : i32
        %c4_i32_21 = arith.constant 4 : i32
        %46 = arith.muli %arg4, %c4_i32_21 : i32
        %47 = arith.addi %c576_i32, %46 : i32
    ...
    ^bb3(%40: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %49 = "simt_step.wave_count_bits"(%true_20) : (i1) -> i32
        "simt_step.buffer.store"(%arg0, %48, %49) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        %50 = arith.addi %arg3, %47 : i32
        %c1_i32_21 = arith.constant 1 : i32
        %51 = arith.addi %arg4, %c1_i32_21 : i32
        %true_22 = arith.constant true
        %c608_i32 = arith.constant 608 : i32
        %c4_i32_23 = arith.constant 4 : i32
        %52 = arith.muli %arg4, %c4_i32_23 : i32
        %53 = arith.addi %c608_i32, %52 : i32
