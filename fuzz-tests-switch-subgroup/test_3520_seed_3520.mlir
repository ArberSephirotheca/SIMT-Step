module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      %9 = arith.muli %arg5, %c4_i32_6 : i32
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      %c4_i32_5 = arith.constant 4 : i32
      %9 = arith.muli %arg5, %c4_i32_5 : i32
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %24 = arith.muli %arg8, %c4_i32_14 : i32
    ...
    ^bb1(%9: i32):  // no predecessors
      ...
      %11 = "simt_step.switch"(%10, %c4_i32_7) ({
      ^bb0(%arg5: i32):
      ...
      ^bb1(%23: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %26 = arith.muli %arg7, %c4_i32_15 : i32
    ...
    ^bb3(%15: i32):  // no predecessors
      ...
      ^bb1(%23: i32):  // no predecessors
        ...
        %24 = "simt_step.switch"(%arg3, %c3_i32_12) ({
        ^bb0(%arg6: i32):
          %true_13 = arith.constant true
          %25 = "simt_step.wave_count_bits"(%true_13) : (i1) -> i32
