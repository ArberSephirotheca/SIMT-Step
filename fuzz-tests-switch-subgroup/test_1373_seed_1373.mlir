  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %10 = "simt_step.if"(%9) ({
        ...
        %22 = "simt_step.switch"(%arg3, %c2_i32_6) ({
        ^bb0(%arg5: i32):
    ...
    ^bb1(%11: i32):  // no predecessors
      ...
      ^bb3(%30: i32):  // no predecessors
        ...
        %31 = arith.cmpi ne, %arg2, %c0_i32_9 : i32
        %32 = "simt_step.if"(%31) ({
          %true_10 = arith.constant true
          %33 = "simt_step.wave_count_bits"(%true_10) : (i1) -> i32
    ...
    ^bb2(%16: i32):  // no predecessors
      ...
      ^bb1(%24: i32):  // no predecessors
        ...
        ^bb1(%38: i32):  // no predecessors
          ...
          %40 = arith.addi %c272_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %40, %39) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%39) {fallthrough = false} : (i32) -> ()
        ^bb2(%41: i32):  // no predecessors
          %true_12 = arith.constant true
          ...
          %43 = arith.addi %c288_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %43, %42) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%42) {fallthrough = false} : (i32) -> ()
      ...
      ^bb2(%29: i32):  // no predecessors
        ...
        ^bb2(%41: i32):  // no predecessors
          ...
          %43 = arith.addi %c336_i32, %arg0 : i32
          "simt_step.buffer.store"(%arg1, %43, %42) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%42) {fallthrough = false} : (i32) -> ()
        ^bb3(%44: i32):  // no predecessors
          ...
          %46 = arith.addi %c352_i32, %arg0 : i32
    ...
    ^bb3(%19: i32):  // no predecessors
      ...
      %21 = "simt_step.if"(%20) ({
        ...
        %23 = "simt_step.switch"(%22, %c4_i32_7) ({
        ^bb0(%arg5: i32):
          %true_8 = arith.constant true
          %24 = "simt_step.wave_count_bits"(%true_8) : (i1) -> i32
          %c384_i32 = arith.constant 384 : i32
          %25 = arith.addi %c384_i32, %arg0 : i32
        ...
        ^bb1(%26: i32):  // no predecessors
          ...
          %28 = arith.addi %c400_i32, %arg0 : i32
        ...
        ^bb2(%29: i32):  // no predecessors
          ...
          %31 = arith.addi %c416_i32, %arg0 : i32
    ...
    %6 = arith.addi %c448_i32, %arg0 : i32
    ...
    "simt_step.if"(%5) ({
      ...
      "simt_step.if"(%14) ({
        ...
        ^bb1(%18: i32):  // no predecessors
          ...
          %19 = arith.addi %18, %c4_i32_3 : i32
          "simt_step.yield"(%19) {fallthrough = false} : (i32) -> ()
        ^bb2(%20: i32):  // no predecessors
          %c3_i32_4 = arith.constant 3 : i32
          %21 = arith.addi %20, %c3_i32_4 : i32
          "simt_step.yield"(%21) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1>, default_index = 1 : i64} : (i32, i32) -> i32
