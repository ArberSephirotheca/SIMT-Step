module {
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [64, 1, 1], simt.subgroup_width = 32 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %9 = arith.muli %arg3, %c64_i32_4 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %18 = arith.muli %arg3, %c64_i32_6 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %9 = arith.addi %c896_i32, %0 : i32
      %10 = "simt_step.buffer.load"(%arg1, %9) : (!simt_step.resource<Global, i32>, i32) -> i32
      %c4_i32 = arith.constant 4 : i32
      %11 = arith.addi %0, %c4_i32 : i32
      %12 = "simt_step.switch"(%10, %11) ({
      ^bb0(%arg4: i32):
        %c960_i32 = arith.constant 960 : i32
        %21 = arith.addi %c960_i32, %0 : i32
      ...
      ^bb1(%25: i32):  // no predecessors
        ...
        %26 = arith.addi %c1024_i32_9, %0 : i32
      ...
      %c64_i32_6 = arith.constant 64 : i32
      %17 = arith.muli %arg3, %c64_i32_6 : i32
      %18 = arith.addi %c1024_i32, %17 : i32
