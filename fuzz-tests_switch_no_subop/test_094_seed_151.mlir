  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [64, 1, 1], simt.subgroup_width = 32 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb1(%24: i32):  // no predecessors
        ...
        %25 = arith.addi %c512_i32_10, %0 : i32
        %26 = "simt_step.buffer.load"(%arg1, %25) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c2_i32_11 = arith.constant 2 : i32
        %27 = "simt_step.switch"(%26, %c2_i32_11) ({
        ^bb0(%arg5: i32):
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb1(%24: i32):  // no predecessors
        ...
        %25 = arith.addi %c768_i32_11, %0 : i32
        %26 = "simt_step.buffer.load"(%arg1, %25) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_12 = arith.constant 0 : i32
        %27 = arith.cmpi ne, %26, %c0_i32_12 : i32
        %28 = "simt_step.if"(%27) ({
          %c0_i32_17 = arith.constant 0 : i32
          %33 = arith.addi %0, %c0_i32_17 : i32
          "simt_step.yield"(%33) : (i32) -> ()
        }, {
          "simt_step.yield"(%0) : (i32) -> ()
        }) : (i1) -> i32
      ...
      ^bb2(%29: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %33 = arith.muli %arg5, %c64_i32_17 : i32
          %34 = arith.addi %33, %0 : i32
          %c832_i32 = arith.constant 832 : i32
          %35 = arith.addi %c832_i32, %34 : i32
      ...
      ^bb3(%31: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %35 = arith.addi %c1152_i32, %34 : i32
          %36 = "simt_step.buffer.load"(%arg1, %35) : (!simt_step.resource<Global, i32>, i32) -> i32
          %c0_i32_18 = arith.constant 0 : i32
          %37 = arith.cmpi ne, %36, %c0_i32_18 : i32
          "simt_step.condition"(%37, %arg4, %arg5) : (i1, i32, i32) -> ()
    ...
    ^bb1(%16: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %20 = arith.muli %arg4, %c64_i32_10 : i32
    ...
    ^bb2(%18: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %22 = arith.addi %c1856_i32, %21 : i32
        %23 = "simt_step.buffer.load"(%arg1, %22) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_11 = arith.constant 0 : i32
        %24 = arith.cmpi ne, %23, %c0_i32_11 : i32
        "simt_step.condition"(%24, %arg3, %arg4) : (i1, i32, i32) -> ()
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %20 = arith.addi %c2176_i32, %0 : i32
        %21 = "simt_step.buffer.load"(%arg1, %20) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c2_i32_10 = arith.constant 2 : i32
        %22 = arith.addi %0, %c2_i32_10 : i32
        %23 = "simt_step.switch"(%21, %22) ({
        ^bb0(%arg5: i32):
          %c0_i32_13 = arith.constant 0 : i32
          %26 = arith.addi %0, %c0_i32_13 : i32
