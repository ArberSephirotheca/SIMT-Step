  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [64, 1, 1], simt.subgroup_width = 32 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      %21 = "simt_step.if"(%20) ({
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %33 = arith.muli %arg4, %c64_i32_13 : i32
    ...
    ^bb1(%22: i32):  // no predecessors
      ...
      ^bb1(%32: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %42 = arith.muli %arg5, %c64_i32_15 : i32
          %43 = arith.addi %42, %0 : i32
          %c704_i32 = arith.constant 704 : i32
          %44 = arith.addi %c704_i32, %43 : i32
    ...
    ^bb2(%26: i32):  // no predecessors
      ...
      ^bb1(%35: i32):  // no predecessors
        ...
        %36 = arith.addi %c1280_i32_13, %0 : i32
      ...
      ^bb2(%40: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %47 = arith.muli %arg5, %c64_i32_18 : i32
          %48 = arith.addi %47, %0 : i32
          %c1344_i32 = arith.constant 1344 : i32
          %49 = arith.addi %c1344_i32, %48 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %48 = arith.addi %arg5, %c1_i32_18 : i32
    ...
    ^bb3(%30: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %32 = arith.muli %arg4, %c64_i32_11 : i32
        %33 = arith.addi %32, %0 : i32
        %c1728_i32 = arith.constant 1728 : i32
        %34 = arith.addi %c1728_i32, %33 : i32
    ...
    %14 = "simt_step.if"(%13) ({
      ...
      ^bb1(%27: i32):  // no predecessors
        %c2432_i32 = arith.constant 2432 : i32
        %28 = arith.addi %c2432_i32, %0 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %c2496_i32 = arith.constant 2496 : i32
      %20 = arith.addi %c2496_i32, %19 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %18 = arith.addi %c2816_i32, %0 : i32
      %19 = "simt_step.buffer.load"(%arg1, %18) : (!simt_step.resource<Global, i32>, i32) -> i32
      %c0_i32_6 = arith.constant 0 : i32
      %20 = arith.cmpi ne, %19, %c0_i32_6 : i32
      %21 = "simt_step.if"(%20) ({
        %c2880_i32 = arith.constant 2880 : i32
        %30 = arith.addi %c2880_i32, %0 : i32
        ...
        %c2944_i32 = arith.constant 2944 : i32
        %30 = arith.addi %c2944_i32, %0 : i32
        %31 = "simt_step.buffer.load"(%arg1, %30) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_12 = arith.constant 0 : i32
        %32 = arith.cmpi ne, %31, %c0_i32_12 : i32
        %33 = "simt_step.if"(%32) ({
      ...
      %27 = arith.addi %c2304_i32, %26 : i32
