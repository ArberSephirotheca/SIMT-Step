  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32):
          ...
          %28 = arith.addi %arg0, %c0_i32_11 : i32
      ...
      ^bb3(%26: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %28 = arith.addi %arg7, %c1_i32_11 : i32
    ...
    ^bb2(%12: i32):  // no predecessors
      ...
      ^bb1(%20: i32):  // no predecessors
        ...
        ^bb2(%30: i32):  // no predecessors
          %c3_i32_11 = arith.constant 3 : i32
          %31 = arith.addi %arg0, %c3_i32_11 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          %c4_i32_9 = arith.constant 4 : i32
          %30 = arith.muli %arg6, %c4_i32_9 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %31 = arith.addi %arg6, %c1_i32_9 : i32
    ...
    ^bb2(%21: i32):  // no predecessors
      ...
      ^bb2(%30: i32):  // no predecessors
        ...
        %33 = "simt_step.switch"(%32, %c1_i32_10) ({
        ^bb0(%arg4: i32):
          %c4_i32_11 = arith.constant 4 : i32
    ...
    ^bb3(%25: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        %c2_i32 = arith.constant 2 : i32
        %27 = arith.addi %arg3, %c2_i32 : i32
        %c1_i32_6 = arith.constant 1 : i32
        %28 = arith.addi %arg4, %c1_i32_6 : i32
        %true = arith.constant true
