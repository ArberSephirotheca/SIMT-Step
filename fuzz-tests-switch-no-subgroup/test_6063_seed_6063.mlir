  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb1(%20: i32):  // no predecessors
        ...
        %21 = arith.remsi %arg3, %c2_i32_8 : i32
      ...
      ^bb2(%24: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.continue"(%arg0, %28) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb1(%12: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb3(%35: i32):  // no predecessors
          ...
          %36 = arith.addi %arg0, %c2_i32_17 : i32
      ...
      ^bb3(%28: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.continue"(%c0_i32_14, %30) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb3(%42: i32):  // no predecessors
        ...
        %45 = "simt_step.switch"(%44, %c4_i32_11) ({
        ^bb0(%arg4: i32):
          "simt_step.yield"(%0) {fallthrough = false} : (i32) -> ()
    ...
    ^bb3(%35: i32):  // no predecessors
      ...
      %39 = "simt_step.if"(%38) ({
        ...
        ^bb1(%44: i32):  // no predecessors
          %c0_i32_11 = arith.constant 0 : i32
          %45 = arith.addi %0, %c0_i32_11 : i32
          "simt_step.yield"(%45) {fallthrough = false} : (i32) -> ()
        ^bb2(%46: i32):  // no predecessors
          %c3_i32_12 = arith.constant 3 : i32
          %47 = arith.addi %0, %c3_i32_12 : i32
