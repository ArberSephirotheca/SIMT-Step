  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_12 = arith.constant 1 : i32
          %28 = arith.addi %arg7, %c1_i32_12 : i32
      ...
      ^bb2(%25: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          %c1_i32_11 = arith.constant 1 : i32
          %27 = arith.addi %arg7, %c1_i32_11 : i32
    ...
    ^bb1(%12: i32):  // no predecessors
      ...
      ^bb2(%27: i32):  // no predecessors
        ...
        %29 = "simt_step.switch"(%28, %c0_i32_12) ({
        ^bb0(%arg6: i32):
          "simt_step.yield"(%arg0) {fallthrough = false} : (i32) -> ()
        ^bb1(%32: i32):  // no predecessors
        ...
        ^bb2(%34: i32):  // no predecessors
          ...
          %35 = arith.addi %arg0, %c2_i32_16 : i32
          "simt_step.yield"(%35) {fallthrough = false} : (i32) -> ()
        ^bb3(%36: i32):  // no predecessors
          %c0_i32_17 = arith.constant 0 : i32
          %37 = arith.addi %arg0, %c0_i32_17 : i32
    ...
    ^bb2(%16: i32):  // no predecessors
      ...
      ^bb2(%26: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_14 = arith.constant 1 : i32
          %30 = arith.addi %arg7, %c1_i32_14 : i32
          "simt_step.yield"(%c3_i32, %30) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb3(%28: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c4_i32_14, %30) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
