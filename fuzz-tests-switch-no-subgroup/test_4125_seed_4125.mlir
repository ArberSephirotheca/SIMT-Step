    ...
    %1 = "simt_step.if"(%0) ({
      ...
      ^bb0(%arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          "simt_step.yield"(%c4_i32_4, %12) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      "simt_step.if"(%10) ({
        ...
        %11 = arith.remsi %0, %c4_i32_7 : i32
        %12 = "simt_step.switch"(%11, %0) ({
        ^bb0(%arg2: i32):
          %c4_i32_8 = arith.constant 4 : i32
          %13 = arith.addi %arg2, %c4_i32_8 : i32
        ...
        ^bb2(%16: i32):  // no predecessors
          ...
          %17 = arith.addi %16, %c4_i32_9 : i32
          "simt_step.yield"(%17) {fallthrough = false} : (i32) -> ()
        ^bb3(%18: i32):  // no predecessors
          %c0_i32_10 = arith.constant 0 : i32
          %19 = arith.addi %18, %c0_i32_10 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        %17 = arith.addi %c32_i32_11, %16 : i32
