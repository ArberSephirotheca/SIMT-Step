module {
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        %c3_i32 = arith.constant 3 : i32
        %10 = arith.remsi %0, %c3_i32 : i32
        %11 = "simt_step.switch"(%10, %0) ({
        ^bb0(%arg4: i32):
          %c1_i32_9 = arith.constant 1 : i32
          %13 = arith.addi %arg4, %c1_i32_9 : i32
          "simt_step.yield"(%13) {fallthrough = false} : (i32) -> ()
        ^bb1(%14: i32):  // no predecessors
          %c0_i32_10 = arith.constant 0 : i32
          %15 = arith.addi %14, %c0_i32_10 : i32
          "simt_step.yield"(%15) {fallthrough = false} : (i32) -> ()
        ^bb2(%16: i32):  // no predecessors
          %c0_i32_11 = arith.constant 0 : i32
          %17 = arith.addi %16, %c0_i32_11 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %13 = arith.addi %arg3, %c1_i32_7 : i32
      %true = arith.constant true
      %c80_i32 = arith.constant 80 : i32
      %c4_i32_8 = arith.constant 4 : i32
      %14 = arith.muli %arg3, %c4_i32_8 : i32
