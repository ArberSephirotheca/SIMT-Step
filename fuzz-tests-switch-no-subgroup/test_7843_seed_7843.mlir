    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          "simt_step.yield"(%c3_i32_7, %17) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32 = arith.constant 1 : i32
    ...
    ^bb1(%9: i32):  // no predecessors
      ...
      ^bb1(%16: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c3_i32_9, %18) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb2(%12: i32):  // no predecessors
      ...
      ^bb2(%19: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c4_i32_11, %23) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        ^bb0(%arg4: i32):
          %c0_i32_6 = arith.constant 0 : i32
          %15 = arith.addi %arg4, %c0_i32_6 : i32
    ...
    %7 = arith.addi %0, %c3_i32_1 : i32
    %c8_i32 = arith.constant 8 : i32
    %8 = arith.addi %c8_i32, %0 : i32
    %9 = "simt_step.buffer.load"(%arg1, %8) : (!simt_step.resource<Global, i32>, i32) -> i32
    %c4_i32_2 = arith.constant 4 : i32
    %10 = "simt_step.switch"(%9, %c4_i32_2) ({
    ^bb0(%arg2: i32):
      %c0_i32_3 = arith.constant 0 : i32
    ...
    ^bb3(%22: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        %c0_i32_8 = arith.constant 0 : i32
        %24 = arith.addi %arg3, %c0_i32_8 : i32
        %c1_i32 = arith.constant 1 : i32
