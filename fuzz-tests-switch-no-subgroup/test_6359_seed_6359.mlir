module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%9: i32):  // no predecessors
      ...
      %11 = "simt_step.if"(%10) ({
        %c3_i32 = arith.constant 3 : i32
        %12 = "simt_step.switch"(%arg3, %c3_i32) ({
        ^bb0(%arg5: i32):
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    %8 = "simt_step.if"(%7) ({
      ...
      ^bb0(%arg2: i32):
        ...
        %20 = arith.addi %c16_i32_1, %0 : i32
        %21 = "simt_step.buffer.load"(%arg1, %20) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c1_i32_2 = arith.constant 1 : i32
        %22 = arith.addi %0, %c1_i32_2 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb1(%28: i32):  // no predecessors
        ...
        ^bb1(%32: i32):  // no predecessors
          %c2_i32_3 = arith.constant 2 : i32
          %33 = arith.addi %0, %c2_i32_3 : i32
          "simt_step.yield"(%33) {fallthrough = true} : (i32) -> ()
        ^bb2(%34: i32):  // no predecessors
          %c0_i32_4 = arith.constant 0 : i32
          %35 = arith.addi %0, %c0_i32_4 : i32
    ...
    ^bb1(%19: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        %30 = "simt_step.switch"(%29, %c2_i32_1) ({
        ^bb0(%arg4: i32):
    ...
    ^bb2(%23: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        %c0_i32_2 = arith.constant 0 : i32
        %28:2 = "simt_step.loop"(%c0_i32_1, %c0_i32_2) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_3 = arith.constant 4 : i32
          %30 = arith.muli %arg5, %c4_i32_3 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %31 = arith.addi %arg5, %c1_i32_3 : i32
