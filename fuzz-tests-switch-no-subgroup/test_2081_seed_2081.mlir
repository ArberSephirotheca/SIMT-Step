    ...
    ^bb1(%8: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c4_i32_8, %23) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        %16 = arith.muli %arg5, %c4_i32_9 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %23 = arith.muli %arg7, %c4_i32_15 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %25 = arith.muli %arg7, %c4_i32_17 : i32
          %26 = arith.addi %c48_i32, %25 : i32
          %27 = arith.addi %26, %0 : i32
          %true_18 = arith.constant true
          %28 = "simt_step.wave_count_bits"(%true_18) : (i1) -> i32
        ...
        %19 = arith.muli %arg5, %c4_i32_13 : i32
        %20 = arith.addi %c64_i32, %19 : i32
        %21 = arith.addi %20, %0 : i32
        %true_14 = arith.constant true
        %22 = "simt_step.wave_count_bits"(%true_14) : (i1) -> i32
