module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%16: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %26 = "simt_step.if"(%25) ({
          ...
          %28 = arith.addi %arg0, %c1_i32_9 : i32
          "simt_step.yield"(%28) : (i32) -> ()
        }) : (i1) -> i32
        %c1_i32 = arith.constant 1 : i32
    ...
    ^bb2(%18: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          %c4_i32 = arith.constant 4 : i32
          %35 = arith.remsi %arg3, %c4_i32 : i32
          %c1_i32 = arith.constant 1 : i32
      ...
      ^bb1(%26: i32):  // no predecessors
        ...
        %28 = "simt_step.if"(%27) ({
          ...
          %35 = arith.addi %arg0, %c3_i32_13 : i32
          "simt_step.yield"(%35) : (i32) -> ()
        }) : (i1) -> i32
      ...
      ^bb2(%29: i32):  // no predecessors
        ...
        %31 = "simt_step.if"(%30) ({
          ...
          %35 = arith.addi %arg0, %c0_i32_13 : i32
          "simt_step.yield"(%35) : (i32) -> ()
        }) : (i1) -> i32
        "simt_step.yield"(%31) {fallthrough = false} : (i32) -> ()
      ^bb3(%32: i32):  // no predecessors
        %c0_i32_12 = arith.constant 0 : i32
        %33 = arith.cmpi ne, %arg2, %c0_i32_12 : i32
        %34 = "simt_step.if"(%33) ({
          %c4_i32 = arith.constant 4 : i32
          %35 = arith.addi %arg0, %c4_i32 : i32
          "simt_step.yield"(%35) : (i32) -> ()
        }, {
    ...
    %13 = arith.addi %c0_i32_1, %arg0 : i32
    ...
    "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        ^bb0(%arg4: i32):
          ...
          %18 = arith.addi %arg4, %c0_i32_6 : i32
          "simt_step.yield"(%18) {fallthrough = false} : (i32) -> ()
        ^bb1(%19: i32):  // no predecessors
          %c0_i32_7 = arith.constant 0 : i32
          %20 = arith.addi %19, %c0_i32_7 : i32
