  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb1(%27: i32):  // no predecessors
        ...
        %c0_i32_1 = arith.constant 0 : i32
        %30 = arith.cmpi ne, %29, %c0_i32_1 : i32
        %31 = "simt_step.if"(%30) ({
          %c3_i32_2 = arith.constant 3 : i32
          %32 = arith.addi %0, %c3_i32_2 : i32
          "simt_step.yield"(%32) : (i32) -> ()
        }, {
          %c1_i32_2 = arith.constant 1 : i32
          %32 = arith.addi %0, %c1_i32_2 : i32
          "simt_step.yield"(%32) : (i32) -> ()
        }) : (i1) -> i32
    ...
    ^bb1(%13: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        %c0_i32_1 = arith.constant 0 : i32
        %29 = "simt_step.switch"(%28, %c0_i32_1) ({
        ^bb0(%arg4: i32):
          "simt_step.yield"(%0) {fallthrough = false} : (i32) -> ()
      ...
      ^bb1(%30: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_5 = arith.constant 4 : i32
          %38 = arith.muli %arg5, %c4_i32_5 : i32
          %39 = arith.addi %38, %0 : i32
          %c28_i32 = arith.constant 28 : i32
          %40 = arith.addi %c28_i32, %39 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %39 = arith.addi %arg5, %c1_i32_5 : i32
    ...
    ^bb2(%17: i32):  // no predecessors
      ...
      %c0_i32_0 = arith.constant 0 : i32
      %20 = arith.cmpi ne, %19, %c0_i32_0 : i32
      %21 = "simt_step.if"(%20) ({
        %c3_i32_1 = arith.constant 3 : i32
        %27 = arith.addi %0, %c3_i32_1 : i32
        "simt_step.yield"(%27) : (i32) -> ()
      }, {
        %c1_i32_1 = arith.constant 1 : i32
        "simt_step.yield"(%c1_i32_1) : (i32) -> ()
      }) : (i1) -> i32
    ...
    ^bb3(%22: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        %c0_i32_1 = arith.constant 0 : i32
        %c0_i32_2 = arith.constant 0 : i32
        %27:2 = "simt_step.loop"(%c0_i32_1, %c0_i32_2) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_3 = arith.constant 4 : i32
          %32 = arith.muli %arg5, %c4_i32_3 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %c1_i32_3 = arith.constant 1 : i32
          %33 = arith.addi %arg5, %c1_i32_3 : i32
          %true = arith.constant true
