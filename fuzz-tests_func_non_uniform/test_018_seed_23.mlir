module {
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [64, 1, 1], simt.subgroup_width = 32 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %13 = arith.muli %arg3, %c64_i32_6 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %15 = arith.muli %arg3, %c64_i32_7 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %18 = arith.muli %arg4, %c64_i32_12 : i32
    ...
    ^bb1(%14: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %21 = arith.muli %arg6, %c64_i32_15 : i32
    ...
    ^bb2(%16: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %20 = arith.addi %c1536_i32, %19 : i32
        %21 = "simt_step.buffer.load"(%arg1, %20) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_13 = arith.constant 0 : i32
        %22 = arith.cmpi ne, %21, %c0_i32_13 : i32
        "simt_step.condition"(%22, %arg3, %arg4) : (i1, i32, i32) -> ()
