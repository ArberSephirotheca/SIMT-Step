module {
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [64, 1, 1], simt.subgroup_width = 32 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb2(%28: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %30 = arith.muli %arg5, %c64_i32_11 : i32
          %31 = arith.addi %30, %0 : i32
          %c704_i32 = arith.constant 704 : i32
          %32 = arith.addi %c704_i32, %31 : i32
    ...
    ^bb1(%15: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        %c4_i32 = arith.constant 4 : i32
        %20 = arith.addi %0, %c4_i32 : i32
        "simt_step.yield"(%20) {fallthrough = false} : (i32) -> ()
      ^bb1(%21: i32):  // no predecessors
        %c1088_i32 = arith.constant 1088 : i32
        %22 = arith.addi %c1088_i32, %0 : i32
      ...
      ^bb3(%30: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          %c64_i32_11 = arith.constant 64 : i32
          %32 = arith.muli %arg5, %c64_i32_11 : i32
          %33 = arith.addi %32, %0 : i32
          %c1216_i32 = arith.constant 1216 : i32
          %34 = arith.addi %c1216_i32, %33 : i32
