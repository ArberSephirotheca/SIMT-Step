  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %20:2 = "simt_step.loop"(%c0_i32_14, %c0_i32_15) ({
        ^bb0(%arg7: i32, %arg8: i32):
          %c4_i32_17 = arith.constant 4 : i32
          %22 = arith.remsi %arg3, %c4_i32_17 : i32
          %c1_i32_18 = arith.constant 1 : i32
          %23 = arith.addi %22, %c1_i32_18 : i32
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %22 = arith.addi %arg8, %c1_i32_17 : i32
          "simt_step.yield"(%c2_i32, %22) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32 = arith.constant 1 : i32
        %c1_i32_16 = arith.constant 1 : i32
        %21 = arith.addi %arg6, %c1_i32_16 : i32
        "simt_step.yield"(%20#0, %21) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
      %c3_i32_6 = arith.constant 3 : i32
      %11 = arith.addi %arg0, %c3_i32_6 : i32
    ...
    ^bb2(%14: i32):  // no predecessors
      ...
      %15 = arith.cmpi ne, %arg2, %c0_i32_10 : i32
      %16 = "simt_step.if"(%15) ({
        %c0_i32_14 = arith.constant 0 : i32
        %c0_i32_15 = arith.constant 0 : i32
        %20:2 = "simt_step.loop"(%c0_i32_14, %c0_i32_15) ({
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          "simt_step.yield"(%c2_i32_16, %22) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c2_i32 = arith.constant 2 : i32
        ...
        %21 = "simt_step.if"(%20) ({
          ...
          %23 = arith.addi %arg0, %c3_i32_16 : i32
    ...
    ^bb3(%17: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %c0_i32_15 = arith.constant 0 : i32
        %21 = arith.addi %arg0, %c0_i32_15 : i32
        ...
        ^bb2(%25: i32):  // no predecessors
          %c4_i32_17 = arith.constant 4 : i32
          %26 = arith.addi %arg0, %c4_i32_17 : i32
      ...
      %19 = arith.addi %arg0, %c0_i32_13 : i32
