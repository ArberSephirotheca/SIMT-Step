    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %c1_i32_13 = arith.constant 1 : i32
          %16 = arith.addi %arg8, %c1_i32_13 : i32
          "simt_step.yield"(%c2_i32_12, %16) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c4_i32 = arith.constant 4 : i32
        %14 = arith.addi %arg0, %c4_i32 : i32
        %c1_i32 = arith.constant 1 : i32
        %15 = arith.addi %arg6, %c1_i32 : i32
        "simt_step.continue"(%13#0, %15) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
      %c3_i32_3 = arith.constant 3 : i32
      "simt_step.yield"(%4#0) {fallthrough = false} : (i32) -> ()
    ^bb1(%5: i32):  // no predecessors
      %c0_i32_4 = arith.constant 0 : i32
      %6 = arith.cmpi ne, %arg2, %c0_i32_4 : i32
      %7 = "simt_step.if"(%6) ({
        %c2_i32_10 = arith.constant 2 : i32
        %13 = arith.remsi %arg3, %c2_i32_10 : i32
        %c4_i32 = arith.constant 4 : i32
        ...
        %13 = arith.remsi %arg3, %c3_i32_10 : i32
        %c4_i32 = arith.constant 4 : i32
        %14 = "simt_step.switch"(%13, %c4_i32) ({
        ^bb0(%arg5: i32):
          %c1_i32 = arith.constant 1 : i32
        ...
        ^bb1(%16: i32):  // no predecessors
          %c2_i32_12 = arith.constant 2 : i32
          %17 = arith.addi %arg0, %c2_i32_12 : i32
