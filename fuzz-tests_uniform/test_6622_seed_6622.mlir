    ...
    ^bb1(%5: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %9 = arith.addi %arg8, %c1_i32_7 : i32
          "simt_step.yield"(%c0_i32_6, %9) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %29 = arith.muli %arg5, %c4_i32_19 : i32
          %30 = arith.addi %29, %0 : i32
          %c16_i32_20 = arith.constant 16 : i32
          %31 = arith.addi %c16_i32_20, %30 : i32
