module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      %12 = "simt_step.switch"(%11, %c0_i32_4) ({
      ^bb0(%arg6: i32):
      ...
      "simt_step.continue"(%12, %15) : (i32, i32) -> ()
    }) : (i32, i32) -> (i32, i32)
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %26 = arith.addi %arg8, %c1_i32_15 : i32
    ...
    ^bb1(%12: i32):  // no predecessors
      ...
      %14 = "simt_step.if"(%13) ({
        ...
        %25 = "simt_step.switch"(%24, %c1_i32_12) ({
        ^bb0(%arg5: i32):
          "simt_step.yield"(%arg0) {fallthrough = false} : (i32) -> ()
        ...
        %26 = arith.addi %arg0, %c2_i32_13 : i32
    ...
    ^bb2(%15: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %35 = arith.remsi %arg3, %c4_i32_20 : i32
          %c1_i32_21 = arith.constant 1 : i32
          %36 = arith.addi %35, %c1_i32_21 : i32
          %37 = arith.cmpi slt, %arg7, %36 : i32
          "simt_step.condition"(%37, %arg6, %arg7) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg6: i32, %arg7: i32):
          %c4_i32_20 = arith.constant 4 : i32
          %35 = arith.addi %arg0, %c4_i32_20 : i32
          %c1_i32_21 = arith.constant 1 : i32
          %36 = arith.addi %arg7, %c1_i32_21 : i32
      ...
      ^bb1(%25: i32):  // no predecessors
        ...
        %26 = arith.cmpi ne, %arg2, %c0_i32_15 : i32
        %27 = "simt_step.if"(%26) ({
        ...
        %c1_i32_16 = arith.constant 1 : i32
        %28 = arith.addi %arg0, %c1_i32_16 : i32
        "simt_step.yield"(%27) {fallthrough = false} : (i32) -> ()
      ^bb2(%29: i32):  // no predecessors
        %c2_i32 = arith.constant 2 : i32
        %30 = arith.remsi %arg3, %c2_i32 : i32
        %31 = "simt_step.switch"(%30, %arg0) ({
        ^bb0(%arg6: i32):
          %c0_i32_20 = arith.constant 0 : i32
          "simt_step.yield"(%c0_i32_20) {fallthrough = true} : (i32) -> ()
        ^bb1(%35: i32):  // no predecessors
          %c4_i32_21 = arith.constant 4 : i32
          %36 = arith.addi %arg0, %c4_i32_21 : i32
      ...
      ^bb3(%32: i32):  // no predecessors
        ...
        %33:2 = "simt_step.loop"(%c0_i32_17, %c0_i32_18) ({
        ^bb0(%arg6: i32, %arg7: i32):
          %c4_i32_20 = arith.constant 4 : i32
          %35 = arith.remsi %arg3, %c4_i32_20 : i32
          %c1_i32_21 = arith.constant 1 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %35 = arith.addi %arg7, %c1_i32_20 : i32
    ...
    ^bb3(%19: i32):  // no predecessors
      ...
      ^bb1(%26: i32):  // no predecessors
        ...
        %28 = "simt_step.if"(%27) ({
          ...
          %c1_i32_17 = arith.constant 1 : i32
          %33 = arith.addi %arg0, %c1_i32_17 : i32
      ...
      ^bb2(%29: i32):  // no predecessors
        %c0_i32_15 = arith.constant 0 : i32
        %30 = arith.cmpi ne, %arg2, %c0_i32_15 : i32
        %31 = "simt_step.if"(%30) ({
          %c3_i32_17 = arith.constant 3 : i32
          %33 = arith.addi %arg0, %c3_i32_17 : i32
          "simt_step.yield"(%33) : (i32) -> ()
        }, {
          %c1_i32_17 = arith.constant 1 : i32
          "simt_step.yield"(%c1_i32_17) : (i32) -> ()
      ...
      %23 = arith.addi %arg0, %c1_i32_11 : i32
