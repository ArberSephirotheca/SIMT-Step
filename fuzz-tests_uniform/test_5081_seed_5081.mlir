    ...
    ^bb0(%arg4: i32):
      ...
      %5 = "simt_step.if"(%4) ({
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          "simt_step.yield"(%c1_i32_9, %18) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb1(%6: i32):  // no predecessors
      ...
      %8 = "simt_step.if"(%7) ({
        ...
        ^bb1(%19: i32):  // no predecessors
          %c1_i32_10 = arith.constant 1 : i32
          %20 = arith.addi %arg0, %c1_i32_10 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %31 = arith.muli %arg4, %c4_i32_20 : i32
    ...
    ^bb2(%21: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        %33 = "simt_step.switch"(%32, %c2_i32_20) ({
        ^bb0(%arg4: i32):
      ...
      ^bb2(%36: i32):  // no predecessors
        ...
        %37:2 = "simt_step.loop"(%c0_i32_25, %c0_i32_26) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_28 = arith.constant 4 : i32
          %38 = arith.muli %arg5, %c4_i32_28 : i32
          %39 = arith.addi %38, %0 : i32
