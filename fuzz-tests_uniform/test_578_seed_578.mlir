module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      "simt_step.yield"(%c3_i32_5, %10) : (i32, i32) -> ()
    }) : (i32, i32) -> (i32, i32)
    ...
    %4 = arith.addi %arg0, %c3_i32_2 : i32
    ...
    ^bb1(%12: i32):  // no predecessors
      ...
      ^bb2(%24: i32):  // no predecessors
        ...
        %25 = arith.remsi %arg3, %c3_i32_12 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%24: i32):  // no predecessors
      ...
      ^bb1(%39: i32):  // no predecessors
        ...
        %42 = "simt_step.switch"(%41, %c0_i32_16) ({
        ^bb0(%arg4: i32):
          %c1_i32 = arith.constant 1 : i32
    ...
    ^bb2(%29: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        %39 = "simt_step.buffer.load"(%arg1, %38) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c4_i32_13 = arith.constant 4 : i32
        %40 = "simt_step.switch"(%39, %c4_i32_13) ({
        ^bb0(%arg4: i32):
    ...
    ^bb3(%34: i32):  // no predecessors
      ...
      ^bb2(%46: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %51 = arith.addi %arg5, %c1_i32_22 : i32
      ...
      ^bb3(%48: i32):  // no predecessors
        ...
        %49:2 = "simt_step.loop"(%c0_i32_19, %c0_i32_20) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_22 = arith.constant 4 : i32
          %50 = arith.muli %arg5, %c4_i32_22 : i32
          %51 = arith.addi %50, %0 : i32
