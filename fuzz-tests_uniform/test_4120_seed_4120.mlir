module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%7: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %17 = arith.remsi %arg3, %c4_i32_13 : i32
          %c1_i32_14 = arith.constant 1 : i32
          %18 = arith.addi %17, %c1_i32_14 : i32
          %19 = arith.cmpi slt, %arg8, %18 : i32
          "simt_step.condition"(%19, %arg7, %arg8) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg7: i32, %arg8: i32):
          %c0_i32_13 = arith.constant 0 : i32
          %17 = arith.addi %arg0, %c0_i32_13 : i32
          %c1_i32_14 = arith.constant 1 : i32
          %18 = arith.addi %arg8, %c1_i32_14 : i32
    ...
    ^bb2(%10: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %16 = arith.addi %arg0, %c1_i32_11 : i32
        %c1_i32_12 = arith.constant 1 : i32
        %17 = arith.addi %arg6, %c1_i32_12 : i32
        "simt_step.yield"(%15#0, %17) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
    ...
    ^bb3(%12: i32):  // no predecessors
      ...
      %14 = "simt_step.switch"(%13, %c3_i32_8) ({
      ^bb0(%arg5: i32):
        %c4_i32_9 = arith.constant 4 : i32
      ...
      ^bb1(%15: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %23 = arith.remsi %arg3, %c4_i32_15 : i32
          %c1_i32_16 = arith.constant 1 : i32
          %24 = arith.addi %23, %c1_i32_16 : i32
          %25 = arith.cmpi slt, %arg7, %24 : i32
          "simt_step.condition"(%25, %arg6, %arg7) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg6: i32, %arg7: i32):
          %c2_i32_15 = arith.constant 2 : i32
          %23 = arith.addi %arg0, %c2_i32_15 : i32
          %c1_i32_16 = arith.constant 1 : i32
      ...
      ^bb2(%17: i32):  // no predecessors
        ...
        %18 = arith.cmpi ne, %arg2, %c0_i32_12 : i32
        %19 = "simt_step.if"(%18) ({
      ...
      ^bb3(%20: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          %c0_i32_15 = arith.constant 0 : i32
          %23 = arith.addi %arg0, %c0_i32_15 : i32
          %c1_i32_16 = arith.constant 1 : i32
          %24 = arith.addi %arg7, %c1_i32_16 : i32
          "simt_step.yield"(%23, %24) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      %17 = arith.addi %0, %c4_i32_5 : i32
      %18 = "simt_step.switch"(%16, %17) ({
      ^bb0(%arg3: i32):
        %c16_i32_13 = arith.constant 16 : i32
        %24 = arith.addi %c16_i32_13, %0 : i32
      ...
      ^bb1(%27: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %31 = arith.muli %arg5, %c4_i32_21 : i32
          %32 = arith.addi %31, %0 : i32
          %c20_i32 = arith.constant 20 : i32
          %33 = arith.addi %c20_i32, %32 : i32
          %34 = "simt_step.buffer.load"(%arg1, %33) : (!simt_step.resource<Global, i32>, i32) -> i32
          %c0_i32_22 = arith.constant 0 : i32
          %35 = arith.cmpi ne, %34, %c0_i32_22 : i32
