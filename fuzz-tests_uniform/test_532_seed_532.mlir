  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          "simt_step.continue"(%arg0, %21) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c2_i32_11 = arith.constant 2 : i32
        %c1_i32 = arith.constant 1 : i32
        %20 = arith.addi %arg6, %c1_i32 : i32
        "simt_step.continue"(%19#0, %20) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
    ...
    ^bb2(%11: i32):  // no predecessors
      ...
      ^bb1(%21: i32):  // no predecessors
        ...
        %22 = arith.remsi %arg3, %c3_i32_12 : i32
        %c2_i32_13 = arith.constant 2 : i32
        %23 = "simt_step.switch"(%22, %c2_i32_13) ({
        ^bb0(%arg6: i32):
        ...
        ^bb2(%29: i32):  // no predecessors
          ...
          %30 = arith.addi %arg0, %c0_i32_18 : i32
      ...
      ^bb2(%25: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.break"(%c4_i32_17, %27) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb3(%15: i32):  // no predecessors
      ...
      %17 = "simt_step.switch"(%16, %c3_i32_7) ({
      ^bb0(%arg5: i32):
        %c0_i32_9 = arith.constant 0 : i32
      ...
      ^bb2(%24: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.break"(%c0_i32_14, %26) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
