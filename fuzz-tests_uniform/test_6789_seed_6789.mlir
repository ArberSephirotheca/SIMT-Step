module {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      ^bb0(%arg6: i32, %arg7: i32):
        ...
        ^bb0(%arg8: i32, %arg9: i32):
          ...
          %23 = arith.cmpi slt, %arg9, %22 : i32
          "simt_step.condition"(%23, %arg8, %arg9) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg8: i32, %arg9: i32):
          %c1_i32_11 = arith.constant 1 : i32
          %21 = arith.addi %arg0, %c1_i32_11 : i32
          %c1_i32_12 = arith.constant 1 : i32
          %22 = arith.addi %arg9, %c1_i32_12 : i32
        ...
        "simt_step.yield"(%17#0, %20) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb2(%19: i32):  // no predecessors
      ...
      %20 = arith.addi %c32_i32_10, %0 : i32
      %21 = "simt_step.buffer.load"(%arg1, %20) : (!simt_step.resource<Global, i32>, i32) -> i32
      %c0_i32_11 = arith.constant 0 : i32
      %22 = "simt_step.switch"(%21, %c0_i32_11) ({
      ^bb0(%arg3: i32):
