    ...
    ^bb0(%arg4: i32):
      ...
      %9 = "simt_step.if"(%8) ({
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %c1_i32_8 = arith.constant 1 : i32
          %21 = arith.addi %arg6, %c1_i32_8 : i32
        ...
        ^bb1(%22: i32):  // no predecessors
          ...
          %23 = arith.addi %arg0, %c4_i32_6 : i32
    ...
    ^bb1(%11: i32):  // no predecessors
      ...
      ^bb1(%22: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c2_i32_8, %24) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb3(%15: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c0_i32_14, %30) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32_6 = arith.constant 1 : i32
        %20 = arith.addi %arg0, %c1_i32_6 : i32
      ...
      ^bb1(%21: i32):  // no predecessors
        ...
        %23 = "simt_step.if"(%22) ({
          ...
          %30 = arith.addi %arg0, %c2_i32_14 : i32
