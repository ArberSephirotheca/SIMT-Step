module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %12 = arith.remsi %arg3, %c3_i32_9 : i32
        %c3_i32_10 = arith.constant 3 : i32
        %13 = arith.addi %arg0, %c3_i32_10 : i32
    ...
    ^bb1(%5: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %14 = arith.remsi %arg3, %c4_i32_12 : i32
          %c1_i32_13 = arith.constant 1 : i32
          %15 = arith.addi %14, %c1_i32_13 : i32
    ...
    ^bb2(%7: i32):  // no predecessors
      ...
      %8 = arith.remsi %arg3, %c3_i32_5 : i32
      ...
      ^bb0(%arg5: i32):
        ...
        %13 = "simt_step.switch"(%12, %c2_i32_10) ({
        ^bb0(%arg6: i32):
    ...
    ^bb3(%10: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %14 = arith.addi %arg0, %c1_i32_11 : i32
          %c1_i32_12 = arith.constant 1 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    %10 = "simt_step.switch"(%9, %c4_i32_3) ({
    ^bb0(%arg2: i32):
