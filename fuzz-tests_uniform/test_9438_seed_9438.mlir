module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      "simt_step.yield"(%c2_i32_7, %20) : (i32, i32) -> ()
    }) : (i32, i32) -> (i32, i32)
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %27 = arith.addi %arg0, %c2_i32_15 : i32
          %c1_i32_16 = arith.constant 1 : i32
          %28 = arith.addi %arg8, %c1_i32_16 : i32
        ...
        "simt_step.yield"(%24#0, %26) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
    ...
    ^bb1(%21: i32):  // no predecessors
      ...
      ^bb1(%27: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %36 = arith.remsi %arg3, %c4_i32_21 : i32
          %c1_i32 = arith.constant 1 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.break"(%c1_i32, %36) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c4_i32_16 = arith.constant 4 : i32
        "simt_step.yield"(%28#0) {fallthrough = false} : (i32) -> ()
      ^bb2(%29: i32):  // no predecessors
        %c0_i32_17 = arith.constant 0 : i32
        %30 = arith.cmpi ne, %arg2, %c0_i32_17 : i32
        %31 = "simt_step.if"(%30) ({
          %c3_i32_21 = arith.constant 3 : i32
          %36 = arith.addi %arg0, %c3_i32_21 : i32
          "simt_step.yield"(%36) : (i32) -> ()
        }, {
          %c3_i32_21 = arith.constant 3 : i32
      ...
      ^bb3(%32: i32):  // no predecessors
        ...
        %33 = arith.remsi %arg3, %c2_i32_19 : i32
        ...
        ^bb1(%36: i32):  // no predecessors
          %c0_i32_21 = arith.constant 0 : i32
          %37 = arith.addi %arg0, %c0_i32_21 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %16 = arith.muli %arg3, %c4_i32_11 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %18 = arith.addi %c48_i32_12, %17 : i32
      %19 = "simt_step.buffer.load"(%arg1, %18) : (!simt_step.resource<Global, i32>, i32) -> i32
      %c0_i32_13 = arith.constant 0 : i32
      %20 = arith.cmpi ne, %19, %c0_i32_13 : i32
      "simt_step.condition"(%20, %arg2, %arg3) : (i1, i32, i32) -> ()
    }, {
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %19 = "simt_step.if"(%18) ({
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_15 = arith.constant 4 : i32
          %23 = arith.muli %arg5, %c4_i32_15 : i32
