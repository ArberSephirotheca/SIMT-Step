module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32):
          ...
          %21 = arith.addi %arg0, %c1_i32_6 : i32
      ...
      ^bb1(%17: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          %c1_i32_6 = arith.constant 1 : i32
          %21 = arith.addi %arg7, %c1_i32_6 : i32
      ...
      %8 = arith.addi %arg0, %c4_i32_0 : i32
    ...
    ^bb2(%10: i32):  // no predecessors
      ...
      %12 = arith.addi %arg0, %c0_i32_1 : i32
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c2_i32_9, %23) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb2(%20: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_10 = arith.constant 1 : i32
          %23 = arith.addi %arg7, %c1_i32_10 : i32
          "simt_step.break"(%c2_i32_9, %23) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb2(%17: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %24 = "simt_step.buffer.load"(%arg1, %23) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_12 = arith.constant 0 : i32
        %25 = "simt_step.switch"(%24, %c0_i32_12) ({
        ^bb0(%arg5: i32):
          %c2_i32_14 = arith.constant 2 : i32
          %28 = arith.addi %0, %c2_i32_14 : i32
          "simt_step.yield"(%28) {fallthrough = false} : (i32) -> ()
    ...
    ^bb3(%19: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %33 = arith.muli %arg5, %c4_i32_21 : i32
          %34 = arith.addi %33, %0 : i32
      ...
      ^bb3(%28: i32):  // no predecessors
        ...
        %31 = arith.addi %0, %c4_i32_19 : i32
        %32 = "simt_step.switch"(%30, %31) ({
        ^bb0(%arg4: i32):
          "simt_step.yield"(%0) {fallthrough = false} : (i32) -> ()
        ^bb1(%33: i32):  // no predecessors
          %c2_i32_21 = arith.constant 2 : i32
          %34 = arith.addi %0, %c2_i32_21 : i32
