    ...
    %1 = "simt_step.if"(%0) ({
      ...
      ^bb1(%8: i32):  // no predecessors
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          "simt_step.break"(%c2_i32, %18) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb2(%12: i32):  // no predecessors
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          "simt_step.yield"(%c3_i32_7, %14) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %19 = arith.muli %arg4, %c4_i32_12 : i32
    ...
    ^bb1(%15: i32):  // no predecessors
      ...
      %16 = arith.addi %c32_i32_10, %0 : i32
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %22 = arith.muli %arg5, %c4_i32_18 : i32
      ...
      ^bb1(%20: i32):  // no predecessors
        ...
        %21:2 = "simt_step.loop"(%c0_i32_15, %c0_i32_16) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_18 = arith.constant 4 : i32
          %22 = arith.muli %arg5, %c4_i32_18 : i32
          %23 = arith.addi %22, %0 : i32
