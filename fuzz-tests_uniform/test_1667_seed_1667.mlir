module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        "simt_step.yield"(%c3_i32_7, %15) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
    ...
    ^bb3(%13: i32):  // no predecessors
      ...
      %14 = "simt_step.switch"(%arg3, %c0_i32_6) ({
      ^bb0(%arg5: i32):
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %16 = arith.addi %arg3, %c1_i32_11 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        %18 = arith.muli %arg5, %c4_i32_15 : i32
        %19 = arith.addi %18, %0 : i32
        %c48_i32_16 = arith.constant 48 : i32
        %20 = arith.addi %c48_i32_16, %19 : i32
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        %19 = arith.addi %arg5, %c1_i32_15 : i32
        "simt_step.yield"(%18, %19) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
      %true_13 = arith.constant true
      %16 = arith.addi %arg2, %15#0 : i32
      %c1_i32_14 = arith.constant 1 : i32
      %17 = arith.addi %arg3, %c1_i32_14 : i32
