module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %4 = arith.addi %arg0, %c3_i32_1 : i32
    ...
    ^bb3(%10: i32):  // no predecessors
      ...
      ^bb3(%25: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c3_i32_15, %28) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      %13 = "simt_step.switch"(%12, %c3_i32_2) ({
      ^bb0(%arg3: i32):
        %c16_i32_7 = arith.constant 16 : i32
        %17 = arith.addi %c16_i32_7, %0 : i32
    ...
    ^bb1(%14: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %17 = arith.muli %arg4, %c4_i32_7 : i32
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %20 = arith.muli %arg6, %c4_i32_10 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          %20 = arith.addi %arg5, %arg6 : i32
          %c1_i32_10 = arith.constant 1 : i32
          %21 = arith.addi %arg6, %c1_i32_10 : i32
          "simt_step.yield"(%20, %21) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %true_9 = arith.constant true
        %18 = arith.addi %arg3, %17#0 : i32
        %c1_i32 = arith.constant 1 : i32
