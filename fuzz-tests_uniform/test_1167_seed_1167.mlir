module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%9: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        "simt_step.yield"(%17#0, %19) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
    ...
    ^bb2(%11: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %c1_i32_10 = arith.constant 1 : i32
          %19 = arith.addi %arg8, %c1_i32_10 : i32
          "simt_step.break"(%c2_i32_9, %19) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c2_i32 = arith.constant 2 : i32
        %c1_i32_8 = arith.constant 1 : i32
    ...
    ^bb3(%13: i32):  // no predecessors
      ...
      ^bb2(%22: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %29 = arith.addi %28, %c1_i32_15 : i32
          %30 = arith.cmpi slt, %arg7, %29 : i32
          "simt_step.condition"(%30, %arg6, %arg7) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg6: i32, %arg7: i32):
          %c4_i32_14 = arith.constant 4 : i32
          %28 = arith.addi %arg0, %c4_i32_14 : i32
          %c1_i32_15 = arith.constant 1 : i32
          %29 = arith.addi %arg7, %c1_i32_15 : i32
      ...
      ^bb3(%24: i32):  // no predecessors
        ...
        ^bb2(%29: i32):  // no predecessors
          ...
          %30 = arith.addi %arg0, %c0_i32_14 : i32
          "simt_step.yield"(%30) {fallthrough = false} : (i32) -> ()
        ^bb3(%31: i32):  // no predecessors
          %c1_i32_15 = arith.constant 1 : i32
          %32 = arith.addi %arg0, %c1_i32_15 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %c1_i32_10 = arith.constant 1 : i32
      %17 = arith.addi %arg3, %c1_i32_10 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        %c4_i32_14 = arith.constant 4 : i32
        %19 = arith.muli %arg5, %c4_i32_14 : i32
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        %20 = arith.addi %arg5, %c1_i32_14 : i32
        "simt_step.continue"(%19, %20) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
      %true_12 = arith.constant true
      %17 = arith.addi %arg2, %16#0 : i32
      %c1_i32_13 = arith.constant 1 : i32
      %18 = arith.addi %arg3, %c1_i32_13 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb2(%35: i32):  // no predecessors
          ...
          %36 = arith.addi %0, %c0_i32_21 : i32
          "simt_step.yield"(%36) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1>, default_index = 0 : i64} : (i32, i32) -> i32
        %true_19 = arith.constant true
        %32 = arith.addi %arg3, %31 : i32
        %c1_i32_20 = arith.constant 1 : i32
        %33 = arith.addi %arg4, %c1_i32_20 : i32
    ...
    ^bb1(%17: i32):  // no predecessors
      ...
      %c0_i32_14 = arith.constant 0 : i32
      %18:2 = "simt_step.loop"(%c0_i32_13, %c0_i32_14) ({
      ^bb0(%arg3: i32, %arg4: i32):
        %c4_i32_19 = arith.constant 4 : i32
        %29 = arith.muli %arg4, %c4_i32_19 : i32
        %30 = arith.addi %29, %0 : i32
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        %29 = arith.addi %arg3, %0 : i32
        %c1_i32_19 = arith.constant 1 : i32
        %30 = arith.addi %arg4, %c1_i32_19 : i32
    ...
    ^bb2(%19: i32):  // no predecessors
      ...
      %c0_i32_16 = arith.constant 0 : i32
      %22 = arith.cmpi ne, %21, %c0_i32_16 : i32
      %23 = "simt_step.if"(%22) ({
        %c120_i32 = arith.constant 120 : i32
        %29 = arith.addi %c120_i32, %0 : i32
        %30 = "simt_step.buffer.load"(%arg1, %29) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_19 = arith.constant 0 : i32
        %31 = arith.cmpi ne, %30, %c0_i32_19 : i32
        %32 = "simt_step.if"(%31) ({
