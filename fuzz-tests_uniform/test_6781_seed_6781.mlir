  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      ^bb2(%11: i32):  // no predecessors
        ...
        %12 = "simt_step.switch"(%arg3, %c4_i32_7) ({
        ^bb0(%arg7: i32):
          %c0_i32_9 = arith.constant 0 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %18 = arith.muli %arg4, %c4_i32_14 : i32
        %19 = arith.addi %18, %0 : i32
        %c32_i32_15 = arith.constant 32 : i32
        %20 = arith.addi %c32_i32_15, %19 : i32
    ...
    ^bb1(%14: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %19 = arith.addi %arg4, %c1_i32_14 : i32
    ...
    ^bb2(%16: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb1(%23: i32):  // no predecessors
          ...
          %24 = arith.addi %0, %c1_i32_16 : i32
          "simt_step.yield"(%24) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0>, default_index = 0 : i64} : (i32, i32) -> i32
        %true_14 = arith.constant true
        %21 = arith.addi %arg3, %20 : i32
        %c1_i32_15 = arith.constant 1 : i32
        %22 = arith.addi %arg4, %c1_i32_15 : i32
