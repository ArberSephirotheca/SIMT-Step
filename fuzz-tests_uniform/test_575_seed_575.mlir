    ...
    ^bb3(%10: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %c1_i32_15 = arith.constant 1 : i32
          %17 = arith.addi %arg8, %c1_i32_15 : i32
          "simt_step.continue"(%16, %17) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c2_i32_12 = arith.constant 2 : i32
        %14 = arith.addi %arg0, %c2_i32_12 : i32
        %c1_i32_13 = arith.constant 1 : i32
        %15 = arith.addi %arg6, %c1_i32_13 : i32
        "simt_step.yield"(%13#0, %15) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
      %c4_i32_9 = arith.constant 4 : i32
      %12 = arith.addi %arg0, %c4_i32_9 : i32
