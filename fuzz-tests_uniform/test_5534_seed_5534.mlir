module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %15 = arith.addi %arg6, %c1_i32_12 : i32
    ...
    ^bb2(%9: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %15 = arith.addi %arg0, %c3_i32_13 : i32
          %c1_i32_14 = arith.constant 1 : i32
          %16 = arith.addi %arg8, %c1_i32_14 : i32
          "simt_step.yield"(%15, %16) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32_12 = arith.constant 1 : i32
        %14 = arith.addi %arg6, %c1_i32_12 : i32
        "simt_step.continue"(%13#0, %14) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
      %c3_i32_8 = arith.constant 3 : i32
      %11 = arith.addi %arg0, %c3_i32_8 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %41 = arith.addi %c16_i32_17, %40 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %40 = arith.addi %arg5, %c1_i32_16 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        %c0_i32_9 = arith.constant 0 : i32
        %30 = arith.addi %arg3, %c0_i32_9 : i32
        %c1_i32 = arith.constant 1 : i32
