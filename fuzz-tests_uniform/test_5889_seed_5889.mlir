    ...
    ^bb3(%13: i32):  // no predecessors
      ...
      %15 = "simt_step.if"(%14) ({
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %c1_i32 = arith.constant 1 : i32
          %18 = arith.addi %arg6, %c1_i32 : i32
          "simt_step.yield"(%c4_i32_7, %18) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32):
        ...
        %32 = "simt_step.switch"(%31, %c4_i32_14) ({
        ^bb0(%arg4: i32):
          "simt_step.yield"(%0) {fallthrough = false} : (i32) -> ()
        ^bb1(%41: i32):  // no predecessors
          %c1_i32_21 = arith.constant 1 : i32
          %42 = arith.addi %0, %c1_i32_21 : i32
    ...
    ^bb3(%26: i32):  // no predecessors
      ...
      ^bb2(%33: i32):  // no predecessors
        ...
        %36 = arith.addi %0, %c4_i32_19 : i32
        %37 = "simt_step.switch"(%35, %36) ({
        ^bb0(%arg4: i32):
          "simt_step.yield"(%0) {fallthrough = false} : (i32) -> ()
        ^bb1(%38: i32):  // no predecessors
          %c4_i32_21 = arith.constant 4 : i32
          %39 = arith.addi %0, %c4_i32_21 : i32
