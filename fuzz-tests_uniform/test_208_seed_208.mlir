module {
    ...
    %1 = "simt_step.if"(%0) ({
      ...
      ^bb1(%11: i32):  // no predecessors
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          "simt_step.yield"(%c4_i32_3, %14) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c4_i32 = arith.constant 4 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      %18 = arith.addi %arg2, %0 : i32
      %c1_i32_9 = arith.constant 1 : i32
      %19 = arith.addi %arg3, %c1_i32_9 : i32
    ...
    ^bb1(%19: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %c0_i32_19 = arith.constant 0 : i32
        %25:2 = "simt_step.loop"(%c0_i32_18, %c0_i32_19) ({
        ^bb0(%arg5: i32, %arg6: i32):
          %c4_i32_22 = arith.constant 4 : i32
          %28 = arith.muli %arg6, %c4_i32_22 : i32
    ...
    ^bb3(%23: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb1(%30: i32):  // no predecessors
          ...
          %31 = arith.addi %0, %c4_i32_20 : i32
          "simt_step.yield"(%31) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0>, default_index = 1 : i64} : (i32, i32) -> i32
        %true_18 = arith.constant true
        %28 = arith.addi %arg3, %27 : i32
        %c1_i32_19 = arith.constant 1 : i32
        %29 = arith.addi %arg4, %c1_i32_19 : i32
        "simt_step.yield"(%28, %29) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
