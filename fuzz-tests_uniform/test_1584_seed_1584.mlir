  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          %c1_i32_14 = arith.constant 1 : i32
          %20 = arith.addi %arg0, %c1_i32_14 : i32
          %c1_i32_15 = arith.constant 1 : i32
          %21 = arith.addi %arg7, %c1_i32_15 : i32
      ...
      ^bb1(%13: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          %c1_i32_14 = arith.constant 1 : i32
          %20 = arith.addi %arg7, %c1_i32_14 : i32
      ...
      ^bb3(%17: i32):  // no predecessors
        ...
        %19 = "simt_step.if"(%18) ({
          ...
          %20 = arith.addi %arg0, %c2_i32_14 : i32
    ...
    ^bb1(%7: i32):  // no predecessors
      ...
      %8 = "simt_step.switch"(%arg3, %c1_i32) ({
      ^bb0(%arg5: i32):
        %c3_i32_7 = arith.constant 3 : i32
        %12 = arith.remsi %arg3, %c3_i32_7 : i32
    ...
    ^bb2(%10: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          %c3_i32_11 = arith.constant 3 : i32
          %c1_i32_12 = arith.constant 1 : i32
          %14 = arith.addi %arg8, %c1_i32_12 : i32
          "simt_step.yield"(%c3_i32_11, %14) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c3_i32_9 = arith.constant 3 : i32
        %c1_i32_10 = arith.constant 1 : i32
        %13 = arith.addi %arg6, %c1_i32_10 : i32
        "simt_step.break"(%12#0, %13) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      %15 = "simt_step.if"(%14) ({
        ...
        %22 = "simt_step.switch"(%21, %c1_i32_4) ({
        ^bb0(%arg3: i32):
          %c3_i32 = arith.constant 3 : i32
