module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      "simt_step.yield"(%10#0, %13) : (i32, i32) -> ()
    }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %19 = arith.addi %arg3, %c1_i32_7 : i32
    ...
    ^bb3(%21: i32):  // no predecessors
      ...
      ^bb3(%33: i32):  // no predecessors
        ...
        %34:2 = "simt_step.loop"(%c0_i32_18, %c0_i32_19) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_21 = arith.constant 4 : i32
          %35 = arith.muli %arg5, %c4_i32_21 : i32
          %36 = arith.addi %35, %0 : i32
          %c164_i32 = arith.constant 164 : i32
          %37 = arith.addi %c164_i32, %36 : i32
          %38 = "simt_step.buffer.load"(%arg1, %37) : (!simt_step.resource<Global, i32>, i32) -> i32
          %c0_i32_22 = arith.constant 0 : i32
          %39 = arith.cmpi ne, %38, %c0_i32_22 : i32
          "simt_step.condition"(%39, %arg4, %arg5) : (i1, i32, i32) -> ()
