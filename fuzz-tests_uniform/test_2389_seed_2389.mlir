module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    %4 = "simt_step.switch"(%3, %c3_i32_2) ({
    ^bb0(%arg4: i32):
      %c2_i32 = arith.constant 2 : i32
      %9 = arith.remsi %arg3, %c2_i32 : i32
      %c2_i32_5 = arith.constant 2 : i32
      %10 = "simt_step.switch"(%9, %c2_i32_5) ({
      ^bb0(%arg5: i32):
      ...
      ^bb1(%20: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c2_i32_14, %22) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32 = arith.constant 1 : i32
    ...
    ^bb1(%11: i32):  // no predecessors
      ...
      %13 = "simt_step.switch"(%12, %c2_i32_7) ({
      ^bb0(%arg5: i32):
        %c4_i32_11 = arith.constant 4 : i32
        ...
        ^bb3(%35: i32):  // no predecessors
          ...
          %36 = arith.addi %arg0, %c1_i32_21 : i32
      ...
      ^bb1(%24: i32):  // no predecessors
        ...
        %25 = arith.cmpi ne, %arg2, %c0_i32_14 : i32
        %26 = "simt_step.if"(%25) ({
          %c0_i32_19 = arith.constant 0 : i32
        ...
        %27 = arith.addi %arg0, %c4_i32_15 : i32
        "simt_step.yield"(%26) {fallthrough = false} : (i32) -> ()
      ^bb2(%28: i32):  // no predecessors
        %c3_i32_16 = arith.constant 3 : i32
        %29 = arith.remsi %arg3, %c3_i32_16 : i32
        %c2_i32_17 = arith.constant 2 : i32
        %30 = "simt_step.switch"(%29, %c2_i32_17) ({
        ^bb0(%arg6: i32):
          %c4_i32_19 = arith.constant 4 : i32
          %32 = arith.addi %arg0, %c4_i32_19 : i32
          "simt_step.yield"(%32) {fallthrough = true} : (i32) -> ()
        ^bb1(%33: i32):  // no predecessors
          %c0_i32_20 = arith.constant 0 : i32
          %34 = arith.addi %arg0, %c0_i32_20 : i32
          "simt_step.yield"(%34) {fallthrough = true} : (i32) -> ()
        ^bb2(%35: i32):  // no predecessors
          %c2_i32_21 = arith.constant 2 : i32
          %36 = arith.addi %arg0, %c2_i32_21 : i32
          "simt_step.yield"(%36) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1>, default_index = 2 : i64} : (i32, i32) -> i32
        %c4_i32_18 = arith.constant 4 : i32
        %31 = arith.addi %arg0, %c4_i32_18 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%18: i32):  // no predecessors
      ...
      %c0_i32_8 = arith.constant 0 : i32
      %21 = "simt_step.switch"(%20, %c0_i32_8) ({
      ^bb0(%arg3: i32):
      ...
      ^bb1(%26: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %37 = arith.addi %arg5, %c1_i32_17 : i32
      ...
      ^bb3(%32: i32):  // no predecessors
        ...
        %33 = arith.addi %c64_i32_15, %0 : i32
    ...
    ^bb1(%22: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %29 = arith.addi %arg4, %c1_i32_14 : i32
