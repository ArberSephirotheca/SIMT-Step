module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%7: i32):  // no predecessors
      ...
      %9 = arith.addi %arg0, %c3_i32_0 : i32
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          %c4_i32_12 = arith.constant 4 : i32
          %c1_i32_13 = arith.constant 1 : i32
          %18 = arith.addi %arg7, %c1_i32_13 : i32
          "simt_step.break"(%c4_i32_12, %18) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb1(%14: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_13 = arith.constant 1 : i32
          %18 = arith.addi %arg7, %c1_i32_13 : i32
          "simt_step.yield"(%c3_i32_12, %18) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c2_i32_10 = arith.constant 2 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %33 = arith.addi %arg4, %c1_i32_11 : i32
    ...
    ^bb2(%27: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %37 = arith.addi %c48_i32_15, %36 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %c1_i32_14 = arith.constant 1 : i32
          %36 = arith.addi %arg5, %c1_i32_14 : i32
