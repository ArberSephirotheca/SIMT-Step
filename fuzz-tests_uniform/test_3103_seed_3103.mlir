module {
    ...
    ^bb2(%7: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_11 = arith.constant 1 : i32
          %16 = arith.addi %arg7, %c1_i32_11 : i32
          "simt_step.break"(%c2_i32_10, %16) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb3(%10: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %16 = arith.addi %arg0, %c0_i32_10 : i32
          %c1_i32_11 = arith.constant 1 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %18 = arith.muli %arg3, %c4_i32_16 : i32
      %19 = arith.addi %18, %0 : i32
      %c8_i32 = arith.constant 8 : i32
      %20 = arith.addi %c8_i32, %19 : i32
      %21 = "simt_step.buffer.load"(%arg1, %20) : (!simt_step.resource<Global, i32>, i32) -> i32
      %c0_i32_17 = arith.constant 0 : i32
      %22 = arith.cmpi ne, %21, %c0_i32_17 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %20 = arith.addi %c48_i32_17, %19 : i32
      %21 = "simt_step.buffer.load"(%arg1, %20) : (!simt_step.resource<Global, i32>, i32) -> i32
      %c0_i32_18 = arith.constant 0 : i32
      %22 = arith.cmpi ne, %21, %c0_i32_18 : i32
      "simt_step.condition"(%22, %arg2, %arg3) : (i1, i32, i32) -> ()
    }, {
    ^bb0(%arg2: i32, %arg3: i32):
      %18 = arith.addi %arg2, %arg3 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %18 = arith.addi %arg2, %c3_i32_16 : i32
      %c1_i32 = arith.constant 1 : i32
      %19 = arith.addi %arg3, %c1_i32 : i32
      "simt_step.yield"(%18, %19) : (i32, i32) -> ()
    }) : (i32, i32) -> (i32, i32)
    ...
    %17 = "simt_step.wave_count_bits"(%true_15) : (i1) -> i32
