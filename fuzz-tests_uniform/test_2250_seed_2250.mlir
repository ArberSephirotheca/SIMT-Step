module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %4 = "simt_step.switch"(%arg3, %c1_i32) ({
      ^bb0(%arg5: i32):
      ...
      ^bb1(%16: i32):  // no predecessors
        ...
        %18 = "simt_step.if"(%17) ({
          ...
          %19 = arith.addi %arg0, %c1_i32_12 : i32
    ...
    ^bb1(%6: i32):  // no predecessors
      ...
      ^bb1(%15: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.break"(%c4_i32, %20) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32_12 = arith.constant 1 : i32
      ...
      ^bb3(%18: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %20 = arith.addi %arg7, %c1_i32_16 : i32
          "simt_step.continue"(%c3_i32_15, %20) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb2(%9: i32):  // no predecessors
      ...
      ^bb1(%15: i32):  // no predecessors
        ...
        %16 = arith.remsi %arg3, %c3_i32_9 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %22 = arith.muli %arg4, %c4_i32_14 : i32
