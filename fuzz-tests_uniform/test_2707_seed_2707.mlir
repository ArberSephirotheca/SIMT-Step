module {
    ...
    ^bb1(%5: i32):  // no predecessors
      ...
      ^bb2(%15: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c3_i32_11, %20) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c3_i32 = arith.constant 3 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %17 = arith.muli %arg3, %c4_i32_12 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        %20 = arith.muli %arg5, %c4_i32_15 : i32
        %21 = arith.addi %20, %0 : i32
        %c48_i32_16 = arith.constant 48 : i32
        %22 = arith.addi %c48_i32_16, %21 : i32
    ...
    %16 = "simt_step.wave_count_bits"(%true_11) : (i1) -> i32
