  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %23 = arith.addi %arg7, %c1_i32_19 : i32
          "simt_step.yield"(%c1_i32_18, %23) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb1(%17: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          %c4_i32 = arith.constant 4 : i32
          %c1_i32_18 = arith.constant 1 : i32
          %23 = arith.addi %arg7, %c1_i32_18 : i32
          "simt_step.yield"(%c4_i32, %23) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c0_i32_15 = arith.constant 0 : i32
        "simt_step.yield"(%18#0) {fallthrough = false} : (i32) -> ()
      ^bb2(%19: i32):  // no predecessors
        %c2_i32_16 = arith.constant 2 : i32
        %20 = arith.remsi %arg3, %c2_i32_16 : i32
        %21 = "simt_step.switch"(%20, %arg0) ({
        ^bb0(%arg6: i32):
          %c1_i32_18 = arith.constant 1 : i32
          %23 = arith.addi %arg0, %c1_i32_18 : i32
          "simt_step.yield"(%23) {fallthrough = false} : (i32) -> ()
        ^bb1(%24: i32):  // no predecessors
          %c0_i32_19 = arith.constant 0 : i32
          %25 = arith.addi %arg0, %c0_i32_19 : i32
          "simt_step.yield"(%25) {fallthrough = false} : (i32) -> ()
        ^bb2(%26: i32):  // no predecessors
          "simt_step.yield"(%arg0) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1>, default_index = 0 : i64} : (i32, i32) -> i32
        %c0_i32_17 = arith.constant 0 : i32
        %22 = arith.addi %arg0, %c0_i32_17 : i32
    ...
    ^bb1(%7: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %18 = arith.addi %arg8, %c1_i32_15 : i32
          "simt_step.break"(%c1_i32_14, %18) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c2_i32_12 = arith.constant 2 : i32
        %c1_i32_13 = arith.constant 1 : i32
        %17 = arith.addi %arg6, %c1_i32_13 : i32
        "simt_step.continue"(%16#0, %17) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
    ...
    ^bb2(%10: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          %c1_i32_13 = arith.constant 1 : i32
          %18 = arith.addi %arg8, %c1_i32_13 : i32
    ...
    ^bb3(%12: i32):  // no predecessors
      ...
      %14 = "simt_step.switch"(%13, %c1_i32_8) ({
      ^bb0(%arg5: i32):
        %c2_i32_10 = arith.constant 2 : i32
        %16 = arith.addi %arg0, %c2_i32_10 : i32
      ...
      ^bb2(%21: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %27 = arith.addi %arg0, %c2_i32_17 : i32
          %c1_i32_18 = arith.constant 1 : i32
          %28 = arith.addi %arg7, %c1_i32_18 : i32
          "simt_step.yield"(%27, %28) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        "simt_step.yield"(%22#0) {fallthrough = false} : (i32) -> ()
      ^bb3(%23: i32):  // no predecessors
        %c3_i32_15 = arith.constant 3 : i32
        %24 = arith.remsi %arg3, %c3_i32_15 : i32
        %c1_i32_16 = arith.constant 1 : i32
        %25 = arith.addi %arg0, %c1_i32_16 : i32
      ...
      %15 = arith.addi %arg0, %c1_i32_9 : i32
