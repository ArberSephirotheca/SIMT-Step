module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %9 = "simt_step.if"(%8) ({
        ...
        %18 = arith.remsi %arg3, %c2_i32_6 : i32
        %c0_i32_7 = arith.constant 0 : i32
        %19 = "simt_step.switch"(%18, %c0_i32_7) ({
        ^bb0(%arg5: i32):
        ...
        ^bb1(%22: i32):  // no predecessors
          ...
          %23 = arith.addi %arg0, %c1_i32_10 : i32
    ...
    ^bb3(%15: i32):  // no predecessors
      ...
      %17 = "simt_step.if"(%16) ({
        ...
        %18 = arith.remsi %arg3, %c2_i32_6 : i32
        %c2_i32_7 = arith.constant 2 : i32
        %19 = "simt_step.switch"(%18, %c2_i32_7) ({
        ^bb0(%arg5: i32):
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %24 = arith.addi %c32_i32_12, %23 : i32
      %25 = "simt_step.buffer.load"(%arg1, %24) : (!simt_step.resource<Global, i32>, i32) -> i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %33 = arith.muli %arg4, %c4_i32_17 : i32
    ...
    ^bb1(%23: i32):  // no predecessors
      ...
      ^bb2(%34: i32):  // no predecessors
        ...
        %36 = "simt_step.buffer.load"(%arg1, %35) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_18 = arith.constant 0 : i32
        %37 = "simt_step.switch"(%36, %c0_i32_18) ({
        ^bb0(%arg4: i32):
          "simt_step.yield"(%0) {fallthrough = false} : (i32) -> ()
