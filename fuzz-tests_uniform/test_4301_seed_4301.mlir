module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      "simt_step.continue"(%arg0, %9) : (i32, i32) -> ()
    }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      %c4_i32_11 = arith.constant 4 : i32
      %16 = arith.addi %arg2, %c4_i32_11 : i32
      %c1_i32 = arith.constant 1 : i32
      %17 = arith.addi %arg3, %c1_i32 : i32
    ...
    %13 = "simt_step.switch"(%12, %c4_i32_8) ({
    ^bb0(%arg2: i32):
    ...
    ^bb1(%20: i32):  // no predecessors
      ...
      %21 = arith.addi %c64_i32_12, %0 : i32
      ...
      %24 = "simt_step.if"(%23) ({
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %33 = arith.muli %arg4, %c4_i32_21 : i32
    ...
    ^bb2(%25: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %32 = arith.muli %arg4, %c4_i32_18 : i32
    ...
    ^bb3(%27: i32):  // no predecessors
      ...
      %31 = "simt_step.if"(%30) ({
        ...
        %33 = "simt_step.buffer.load"(%arg1, %32) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_18 = arith.constant 0 : i32
        %34 = arith.addi %0, %c0_i32_18 : i32
        %35 = "simt_step.switch"(%33, %34) ({
        ^bb0(%arg3: i32):
          %c0_i32_20 = arith.constant 0 : i32
          %36 = arith.addi %0, %c0_i32_20 : i32
