  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb0(%arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %35 = arith.addi %c32_i32_17, %34 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %26 = arith.muli %arg4, %c4_i32_19 : i32
    ...
    ^bb1(%18: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32):
          ...
          "simt_step.yield"(%c1_i32_26) {fallthrough = false} : (i32) -> ()
        ^bb1(%39: i32):  // no predecessors
          %c0_i32_27 = arith.constant 0 : i32
          %40 = arith.addi %0, %c0_i32_27 : i32
          "simt_step.yield"(%40) {fallthrough = false} : (i32) -> ()
        ^bb2(%41: i32):  // no predecessors
          %c1_i32_28 = arith.constant 1 : i32
          "simt_step.yield"(%c1_i32_28) {fallthrough = false} : (i32) -> ()
        ^bb3(%42: i32):  // no predecessors
          %c1_i32_29 = arith.constant 1 : i32
          %43 = arith.addi %0, %c1_i32_29 : i32
    ...
    ^bb2(%22: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %28 = arith.cmpi ne, %27, %c0_i32_19 : i32
        %29 = "simt_step.if"(%28) ({
          %c0_i32_20 = arith.constant 0 : i32
          %32 = arith.addi %0, %c0_i32_20 : i32
    ...
    ^bb3(%24: i32):  // no predecessors
      ...
      %25:2 = "simt_step.loop"(%c0_i32_16, %c0_i32_17) ({
      ^bb0(%arg3: i32, %arg4: i32):
        %c4_i32_19 = arith.constant 4 : i32
        %26 = arith.muli %arg4, %c4_i32_19 : i32
        %27 = arith.addi %26, %0 : i32
