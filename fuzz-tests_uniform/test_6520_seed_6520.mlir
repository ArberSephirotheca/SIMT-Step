module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32):
          ...
          %39 = arith.addi %arg0, %c3_i32_19 : i32
          "simt_step.yield"(%39) {fallthrough = false} : (i32) -> ()
        ^bb1(%40: i32):  // no predecessors
          %c1_i32_20 = arith.constant 1 : i32
          %41 = arith.addi %arg0, %c1_i32_20 : i32
      ...
      ^bb1(%28: i32):  // no predecessors
        ...
        %30 = arith.addi %arg0, %c4_i32_14 : i32
        %31 = "simt_step.switch"(%29, %30) ({
        ^bb0(%arg6: i32):
          "simt_step.yield"(%arg0) {fallthrough = false} : (i32) -> ()
        ^bb1(%39: i32):  // no predecessors
          %c1_i32_19 = arith.constant 1 : i32
          %40 = arith.addi %arg0, %c1_i32_19 : i32
          "simt_step.yield"(%40) {fallthrough = false} : (i32) -> ()
        ^bb2(%41: i32):  // no predecessors
          %c4_i32_20 = arith.constant 4 : i32
          %42 = arith.addi %arg0, %c4_i32_20 : i32
          "simt_step.yield"(%42) {fallthrough = false} : (i32) -> ()
        ^bb3(%43: i32):  // no predecessors
          %c0_i32_21 = arith.constant 0 : i32
          %44 = arith.addi %arg0, %c0_i32_21 : i32
          "simt_step.yield"(%44) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1, 2>, default_index = 2 : i64} : (i32, i32) -> i32
        "simt_step.yield"(%31) {fallthrough = false} : (i32) -> ()
      ^bb2(%32: i32):  // no predecessors
        %c0_i32_15 = arith.constant 0 : i32
        %33 = arith.cmpi ne, %arg2, %c0_i32_15 : i32
        %34 = "simt_step.if"(%33) ({
          "simt_step.yield"(%arg0) : (i32) -> ()
        }, {
          %c4_i32_19 = arith.constant 4 : i32
          %39 = arith.addi %arg0, %c4_i32_19 : i32
          "simt_step.yield"(%39) : (i32) -> ()
        }) : (i1) -> i32
        %c3_i32_16 = arith.constant 3 : i32
        %35 = arith.addi %arg0, %c3_i32_16 : i32
        "simt_step.yield"(%34) {fallthrough = false} : (i32) -> ()
      ^bb3(%36: i32):  // no predecessors
        %c0_i32_17 = arith.constant 0 : i32
        %37 = arith.cmpi ne, %arg2, %c0_i32_17 : i32
        %38 = "simt_step.if"(%37) ({
          "simt_step.yield"(%arg0) : (i32) -> ()
        }, {
          "simt_step.yield"(%arg0) : (i32) -> ()
    ...
    ^bb1(%15: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %30 = arith.cmpi slt, %arg8, %29 : i32
          "simt_step.condition"(%30, %arg7, %arg8) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg7: i32, %arg8: i32):
          %c4_i32_15 = arith.constant 4 : i32
          %28 = arith.addi %arg0, %c4_i32_15 : i32
          %c1_i32_16 = arith.constant 1 : i32
          %29 = arith.addi %arg8, %c1_i32_16 : i32
          "simt_step.yield"(%28, %29) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32_14 = arith.constant 1 : i32
        %27 = arith.addi %arg6, %c1_i32_14 : i32
        "simt_step.yield"(%26#0, %27) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
    ...
    ^bb2(%18: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %32 = arith.remsi %arg3, %c4_i32_16 : i32
          %c1_i32_17 = arith.constant 1 : i32
          %33 = arith.addi %32, %c1_i32_17 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c3_i32_16, %32) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      %22 = arith.addi %arg0, %c3_i32_9 : i32
    ...
    ^bb3(%23: i32):  // no predecessors
      ...
      %25 = "simt_step.if"(%24) ({
        ...
        %28 = arith.addi %arg0, %c2_i32_13 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %13 = arith.addi %c48_i32_8, %12 : i32
      %14 = "simt_step.buffer.load"(%arg1, %13) : (!simt_step.resource<Global, i32>, i32) -> i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %14 = "simt_step.if"(%13) ({
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_11 = arith.constant 4 : i32
          %18 = arith.muli %arg5, %c4_i32_11 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %19 = arith.addi %arg5, %c1_i32_11 : i32
