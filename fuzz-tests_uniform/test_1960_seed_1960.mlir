module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      %15 = arith.addi %arg5, %c1_i32_4 : i32
    ...
    ^bb0(%arg4: i32):
      ...
      %12 = "simt_step.switch"(%11, %c3_i32_5) ({
      ^bb0(%arg5: i32):
    ...
    ^bb1(%14: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          %c1_i32_13 = arith.constant 1 : i32
          %23 = arith.addi %arg0, %c1_i32_13 : i32
          %c1_i32_14 = arith.constant 1 : i32
          %24 = arith.addi %arg8, %c1_i32_14 : i32
    ...
    ^bb2(%17: i32):  // no predecessors
      ...
      %19 = "simt_step.if"(%18) ({
        ...
        %21 = arith.addi %arg0, %c2_i32_10 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %27 = arith.muli %arg5, %c4_i32_19 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %28 = arith.addi %arg5, %c1_i32_19 : i32
    ...
    ^bb1(%18: i32):  // no predecessors
      ...
      %21 = "simt_step.switch"(%20, %c1_i32_8) ({
      ^bb0(%arg3: i32):
