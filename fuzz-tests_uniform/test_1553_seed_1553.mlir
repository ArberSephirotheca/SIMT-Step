  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %15 = arith.cmpi ne, %arg2, %c0_i32_11 : i32
        %16 = "simt_step.if"(%15) ({
    ...
    ^bb1(%6: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %15:2 = "simt_step.loop"(%c0_i32_11, %c0_i32_12) ({
        ^bb0(%arg7: i32, %arg8: i32):
          %c4_i32_14 = arith.constant 4 : i32
          %17 = arith.remsi %arg3, %c4_i32_14 : i32
          %c1_i32_15 = arith.constant 1 : i32
          %18 = arith.addi %17, %c1_i32_15 : i32
          %19 = arith.cmpi slt, %arg8, %18 : i32
          "simt_step.condition"(%19, %arg7, %arg8) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg7: i32, %arg8: i32):
          %c2_i32_14 = arith.constant 2 : i32
          %17 = arith.addi %arg0, %c2_i32_14 : i32
          %c1_i32_15 = arith.constant 1 : i32
        ...
        %16 = arith.addi %arg6, %c1_i32_13 : i32
    ...
    ^bb2(%9: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %17 = arith.addi %arg0, %c3_i32_15 : i32
          %c1_i32_16 = arith.constant 1 : i32
          %18 = arith.addi %arg8, %c1_i32_16 : i32
          "simt_step.yield"(%17, %18) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c2_i32_13 = arith.constant 2 : i32
        %c1_i32_14 = arith.constant 1 : i32
        %16 = arith.addi %arg6, %c1_i32_14 : i32
        "simt_step.yield"(%15#0, %16) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
    ...
    ^bb3(%12: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %15 = arith.remsi %arg3, %c2_i32_11 : i32
        ...
        ^bb1(%19: i32):  // no predecessors
          ...
          %20 = arith.addi %arg0, %c2_i32_16 : i32
        ...
        %c1_i32_14 = arith.constant 1 : i32
        %18 = arith.addi %arg6, %c1_i32_14 : i32
        "simt_step.yield"(%17, %18) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
      %c0_i32_10 = arith.constant 0 : i32
      %14 = arith.addi %arg0, %c0_i32_10 : i32
