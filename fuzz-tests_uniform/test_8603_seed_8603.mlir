  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb2(%9: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c0_i32_17, %23) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb1(%16: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32 = arith.constant 1 : i32
          %23 = arith.addi %arg7, %c1_i32 : i32
          "simt_step.yield"(%c3_i32_17, %23) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c2_i32_13 = arith.constant 2 : i32
        "simt_step.yield"(%17#0) {fallthrough = false} : (i32) -> ()
      ^bb2(%18: i32):  // no predecessors
        %c4_i32_14 = arith.constant 4 : i32
        %19 = "simt_step.switch"(%arg3, %c4_i32_14) ({
        ^bb0(%arg6: i32):
          "simt_step.yield"(%arg0) {fallthrough = false} : (i32) -> ()
      ...
      ^bb3(%20: i32):  // no predecessors
        ...
        %21 = arith.cmpi ne, %arg2, %c0_i32_16 : i32
        %22 = "simt_step.if"(%21) ({
          %c4_i32_17 = arith.constant 4 : i32
    ...
    ^bb3(%12: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        "simt_step.continue"(%c4_i32_8, %15) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
