module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %6 = "simt_step.switch"(%arg3, %c0_i32_0) ({
      ^bb0(%arg5: i32):
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %47 = arith.addi %arg5, %c1_i32_20 : i32
      ...
      ^bb2(%37: i32):  // no predecessors
        ...
        %40 = "simt_step.switch"(%39, %c2_i32_17) ({
        ^bb0(%arg4: i32):
          %c3_i32 = arith.constant 3 : i32
