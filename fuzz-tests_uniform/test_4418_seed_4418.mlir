  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32):
        ...
        %25 = arith.cmpi ne, %24, %c0_i32_18 : i32
        %26 = "simt_step.if"(%25) ({
      ...
      ^bb1(%27: i32):  // no predecessors
        ...
        %30 = "simt_step.switch"(%29, %c3_i32_19) ({
        ^bb0(%arg4: i32):
    ...
    ^bb1(%19: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %23 = arith.muli %arg4, %c4_i32_18 : i32
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %23 = arith.addi %c64_i32_18, %0 : i32
        %24 = "simt_step.buffer.load"(%arg1, %23) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c2_i32 = arith.constant 2 : i32
        ...
        ^bb2(%30: i32):  // no predecessors
          %c0_i32_21 = arith.constant 0 : i32
          %31 = arith.addi %0, %c0_i32_21 : i32
          "simt_step.yield"(%31) {fallthrough = false} : (i32) -> ()
        ^bb3(%32: i32):  // no predecessors
          %c4_i32_22 = arith.constant 4 : i32
          %33 = arith.addi %0, %c4_i32_22 : i32
          "simt_step.yield"(%33) {fallthrough = false} : (i32) -> ()
    ...
    ^bb2(%21: i32):  // no predecessors
      ...
      %22:2 = "simt_step.loop"(%c0_i32_15, %c0_i32_16) ({
      ^bb0(%arg3: i32, %arg4: i32):
        %c4_i32_18 = arith.constant 4 : i32
        %23 = arith.muli %arg4, %c4_i32_18 : i32
        %24 = arith.addi %23, %0 : i32
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32):
          %c0_i32_19 = arith.constant 0 : i32
          %28 = arith.addi %0, %c0_i32_19 : i32
          "simt_step.yield"(%28) {fallthrough = false} : (i32) -> ()
        ^bb1(%29: i32):  // no predecessors
          %c1_i32_20 = arith.constant 1 : i32
          %30 = arith.addi %0, %c1_i32_20 : i32
          "simt_step.yield"(%30) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0>, default_index = 0 : i64} : (i32, i32) -> i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb1(%21: i32):  // no predecessors
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %23 = arith.muli %arg6, %c4_i32_13 : i32
          %24 = arith.addi %23, %0 : i32
