module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%8: i32):  // no predecessors
      ...
      %9 = "simt_step.switch"(%arg3, %c4_i32) ({
      ^bb0(%arg5: i32):
        %c0_i32_2 = arith.constant 0 : i32
        %10 = arith.cmpi ne, %arg2, %c0_i32_2 : i32
        %11 = "simt_step.if"(%10) ({
      ...
      ^bb1(%12: i32):  // no predecessors
        ...
        %14 = "simt_step.switch"(%13, %c2_i32_5) ({
        ^bb0(%arg6: i32):
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %20 = arith.muli %arg4, %c4_i32_13 : i32
    ...
    ^bb1(%14: i32):  // no predecessors
      ...
      ^bb1(%24: i32):  // no predecessors
        ...
        %27 = "simt_step.switch"(%26, %c1_i32_15) ({
        ^bb0(%arg4: i32):
          %c2_i32 = arith.constant 2 : i32
    ...
    ^bb2(%18: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %23 = arith.muli %arg6, %c4_i32_17 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %c1_i32_17 = arith.constant 1 : i32
          %24 = arith.addi %arg6, %c1_i32_17 : i32
          "simt_step.yield"(%23, %24) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %true_15 = arith.constant true
        %21 = arith.addi %arg3, %20#0 : i32
        %c1_i32_16 = arith.constant 1 : i32
        %22 = arith.addi %arg4, %c1_i32_16 : i32
