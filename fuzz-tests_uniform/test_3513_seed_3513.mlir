module {
    ...
    %1 = "simt_step.if"(%0) ({
      ...
      ^bb3(%15: i32):  // no predecessors
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          "simt_step.yield"(%c3_i32, %17) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb2(%11: i32):  // no predecessors
        ...
        %14 = arith.addi %arg0, %c2_i32_5 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %19 = arith.addi %arg3, %c1_i32_10 : i32
    ...
    ^bb1(%16: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %22 = arith.muli %arg4, %c4_i32_19 : i32
        %23 = arith.addi %22, %0 : i32
        %c52_i32 = arith.constant 52 : i32
        %24 = arith.addi %c52_i32, %23 : i32
        %25 = "simt_step.buffer.load"(%arg1, %24) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_20 = arith.constant 0 : i32
        %26 = arith.cmpi ne, %25, %c0_i32_20 : i32
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %27 = arith.addi %arg4, %c1_i32_20 : i32
    ...
    ^bb3(%20: i32):  // no predecessors
      ...
      %21:2 = "simt_step.loop"(%c0_i32_16, %c0_i32_17) ({
      ^bb0(%arg3: i32, %arg4: i32):
        %c4_i32_19 = arith.constant 4 : i32
        %22 = arith.muli %arg4, %c4_i32_19 : i32
        %23 = arith.addi %22, %0 : i32
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %23 = arith.addi %arg4, %c1_i32_19 : i32
