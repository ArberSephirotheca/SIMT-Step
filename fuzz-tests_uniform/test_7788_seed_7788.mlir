    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c4_i32, %18) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb3(%16: i32):  // no predecessors
        ...
        %17 = "simt_step.switch"(%arg3, %c3_i32_9) ({
        ^bb0(%arg6: i32):
    ...
    ^bb1(%6: i32):  // no predecessors
      ...
      %8 = "simt_step.if"(%7) ({
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          "simt_step.yield"(%c3_i32_6, %12) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
