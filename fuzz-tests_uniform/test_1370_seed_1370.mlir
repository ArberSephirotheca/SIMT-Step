module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%5: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_9 = arith.constant 1 : i32
          %20 = arith.addi %arg7, %c1_i32_9 : i32
          "simt_step.yield"(%c0_i32_8, %20) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb2(%8: i32):  // no predecessors
      ...
      %10 = arith.addi %arg0, %c3_i32_0 : i32
      ...
      ^bb1(%17: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c2_i32_12, %24) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c4_i32_8 = arith.constant 4 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%21: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %29 = arith.addi %c48_i32_14, %28 : i32
    ...
    ^bb2(%23: i32):  // no predecessors
      ...
      %26 = "simt_step.switch"(%25, %c2_i32_11) ({
      ^bb0(%arg3: i32):
        "simt_step.yield"(%0) {fallthrough = false} : (i32) -> ()
      ^bb1(%27: i32):  // no predecessors
        %c2_i32_13 = arith.constant 2 : i32
        %28 = arith.addi %0, %c2_i32_13 : i32
