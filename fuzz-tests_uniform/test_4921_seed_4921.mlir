    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      ^bb0(%arg6: i32, %arg7: i32):
        ...
        ^bb0(%arg8: i32, %arg9: i32):
          ...
          %12 = arith.addi %11, %c1_i32_10 : i32
          %13 = arith.cmpi slt, %arg9, %12 : i32
          "simt_step.condition"(%13, %arg8, %arg9) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg8: i32, %arg9: i32):
          %c0_i32_10 = arith.constant 0 : i32
          %11 = arith.addi %arg0, %c0_i32_10 : i32
          %c1_i32_11 = arith.constant 1 : i32
          %12 = arith.addi %arg9, %c1_i32_11 : i32
          "simt_step.yield"(%11, %12) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c3_i32_8 = arith.constant 3 : i32
        %9 = arith.addi %arg0, %c3_i32_8 : i32
        %c1_i32_9 = arith.constant 1 : i32
        %10 = arith.addi %arg7, %c1_i32_9 : i32
        "simt_step.yield"(%8#0, %10) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
      %c1_i32 = arith.constant 1 : i32
      %c1_i32_5 = arith.constant 1 : i32
      %7 = arith.addi %arg5, %c1_i32_5 : i32
      "simt_step.continue"(%6#0, %7) : (i32, i32) -> ()
    }) : (i32, i32) -> (i32, i32)
