  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %24 = arith.addi %arg7, %c1_i32_15 : i32
          "simt_step.continue"(%c2_i32, %24) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb1(%19: i32):  // no predecessors
        ...
        %20 = arith.cmpi ne, %arg2, %c0_i32_13 : i32
        %21 = "simt_step.if"(%20) ({
        ...
        %22 = arith.addi %arg0, %c0_i32_14 : i32
    ...
    ^bb1(%9: i32):  // no predecessors
      ...
      %11 = "simt_step.if"(%10) ({
        ...
        %18 = "simt_step.switch"(%17, %c2_i32_10) ({
        ^bb0(%arg5: i32):
          %c2_i32_11 = arith.constant 2 : i32
          %19 = arith.addi %arg0, %c2_i32_11 : i32
    ...
    ^bb2(%12: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %19 = arith.remsi %arg3, %c4_i32_13 : i32
          %c1_i32_14 = arith.constant 1 : i32
          %20 = arith.addi %19, %c1_i32_14 : i32
          %21 = arith.cmpi slt, %arg8, %20 : i32
          "simt_step.condition"(%21, %arg7, %arg8) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg7: i32, %arg8: i32):
          %c1_i32_13 = arith.constant 1 : i32
          %19 = arith.addi %arg8, %c1_i32_13 : i32
          "simt_step.yield"(%arg0, %19) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32_12 = arith.constant 1 : i32
        %18 = arith.addi %arg6, %c1_i32_12 : i32
    ...
    ^bb3(%14: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %20 = arith.remsi %arg3, %c4_i32_14 : i32
          %c1_i32_15 = arith.constant 1 : i32
          %21 = arith.addi %20, %c1_i32_15 : i32
          %22 = arith.cmpi slt, %arg8, %21 : i32
          "simt_step.condition"(%22, %arg7, %arg8) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg7: i32, %arg8: i32):
          %c4_i32_14 = arith.constant 4 : i32
          %20 = arith.addi %arg0, %c4_i32_14 : i32
          %c1_i32_15 = arith.constant 1 : i32
          %21 = arith.addi %arg8, %c1_i32_15 : i32
          "simt_step.continue"(%20, %21) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c4_i32_12 = arith.constant 4 : i32
        %18 = arith.addi %arg0, %c4_i32_12 : i32
        %c1_i32_13 = arith.constant 1 : i32
        %19 = arith.addi %arg6, %c1_i32_13 : i32
        "simt_step.break"(%17#0, %19) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
      %c3_i32_9 = arith.constant 3 : i32
      %16 = arith.addi %arg0, %c3_i32_9 : i32
