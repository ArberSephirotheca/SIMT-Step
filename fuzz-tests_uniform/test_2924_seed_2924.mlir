  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %10 = arith.remsi %arg3, %c4_i32_8 : i32
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %12 = arith.remsi %arg3, %c4_i32_10 : i32
          %c1_i32_11 = arith.constant 1 : i32
          %13 = arith.addi %12, %c1_i32_11 : i32
          %14 = arith.cmpi slt, %arg8, %13 : i32
          "simt_step.condition"(%14, %arg7, %arg8) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg7: i32, %arg8: i32):
          %c1_i32_10 = arith.constant 1 : i32
          %12 = arith.addi %arg8, %c1_i32_10 : i32
      ...
      %5 = arith.addi %arg0, %c3_i32_2 : i32
    ...
    ^bb1(%6: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          %c4_i32_11 = arith.constant 4 : i32
          %12 = arith.addi %arg0, %c4_i32_11 : i32
          %c1_i32_12 = arith.constant 1 : i32
          %13 = arith.addi %arg8, %c1_i32_12 : i32
    ...
    ^bb2(%8: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %c1_i32_12 = arith.constant 1 : i32
          %12 = arith.addi %arg8, %c1_i32_12 : i32
          "simt_step.yield"(%c3_i32_11, %12) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32 = arith.constant 1 : i32
        %c1_i32_10 = arith.constant 1 : i32
        %11 = arith.addi %arg6, %c1_i32_10 : i32
        "simt_step.yield"(%10#0, %11) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        %16 = "simt_step.switch"(%15, %c0_i32_10) ({
        ^bb0(%arg6: i32):
          %c2_i32 = arith.constant 2 : i32
          "simt_step.yield"(%c2_i32) {fallthrough = false} : (i32) -> ()
        ^bb1(%19: i32):  // no predecessors
          %c2_i32_13 = arith.constant 2 : i32
          %20 = arith.addi %0, %c2_i32_13 : i32
          "simt_step.yield"(%20) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0>, default_index = 1 : i64} : (i32, i32) -> i32
        %true_11 = arith.constant true
        %17 = arith.addi %arg4, %16 : i32
        %c1_i32_12 = arith.constant 1 : i32
        %18 = arith.addi %arg5, %c1_i32_12 : i32
