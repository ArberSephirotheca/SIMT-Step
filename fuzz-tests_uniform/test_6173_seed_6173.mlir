  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb2(%6: i32):  // no predecessors
      ...
      ^bb1(%12: i32):  // no predecessors
        ...
        %13 = arith.remsi %arg3, %c2_i32_7 : i32
        %c4_i32_8 = arith.constant 4 : i32
        %14 = "simt_step.switch"(%13, %c4_i32_8) ({
        ^bb0(%arg6: i32):
          "simt_step.yield"(%arg0) {fallthrough = false} : (i32) -> ()
      ...
      ^bb2(%16: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32):
          ...
          %22 = arith.addi %arg0, %c3_i32_16 : i32
          "simt_step.yield"(%22) {fallthrough = false} : (i32) -> ()
        ^bb1(%23: i32):  // no predecessors
          %c2_i32_17 = arith.constant 2 : i32
          %24 = arith.addi %arg0, %c2_i32_17 : i32
          "simt_step.yield"(%24) {fallthrough = true} : (i32) -> ()
        ^bb2(%25: i32):  // no predecessors
          %c3_i32_18 = arith.constant 3 : i32
          %26 = arith.addi %arg0, %c3_i32_18 : i32
      ...
      ^bb3(%19: i32):  // no predecessors
        ...
        %20:2 = "simt_step.loop"(%c0_i32_13, %c0_i32_14) ({
        ^bb0(%arg6: i32, %arg7: i32):
          %c4_i32_16 = arith.constant 4 : i32
          %22 = arith.remsi %arg3, %c4_i32_16 : i32
          %c1_i32 = arith.constant 1 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c1_i32, %22) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c3_i32_15 = arith.constant 3 : i32
        %21 = arith.addi %arg0, %c3_i32_15 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %22 = arith.muli %arg4, %c4_i32_10 : i32
    ...
    ^bb1(%14: i32):  // no predecessors
      ...
      %17 = arith.cmpi ne, %16, %c0_i32_9 : i32
      %18 = "simt_step.if"(%17) ({
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %23 = arith.muli %arg4, %c4_i32_13 : i32
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %24 = arith.addi %arg4, %c1_i32_13 : i32
