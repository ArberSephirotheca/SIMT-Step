module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      "simt_step.yield"(%13#0, %16) : (i32, i32) -> ()
    }) : (i32, i32) -> (i32, i32)
    ...
    ^bb1(%14: i32):  // no predecessors
      ...
      %16 = "simt_step.if"(%15) ({
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          %c4_i32 = arith.constant 4 : i32
          %c1_i32_10 = arith.constant 1 : i32
          %23 = arith.addi %arg6, %c1_i32_10 : i32
    ...
    ^bb2(%17: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb3(%34: i32):  // no predecessors
          ...
          %35 = arith.addi %arg0, %c0_i32_14 : i32
      ...
      ^bb1(%23: i32):  // no predecessors
        ...
        ^bb3(%33: i32):  // no predecessors
          ...
          %34 = arith.addi %arg0, %c2_i32_15 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %34 = arith.addi %arg4, %c1_i32_17 : i32
    ...
    ^bb1(%21: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %35 = arith.addi %c32_i32_18, %34 : i32
        %36 = "simt_step.buffer.load"(%arg1, %35) : (!simt_step.resource<Global, i32>, i32) -> i32
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %37 = arith.addi %arg4, %c1_i32_18 : i32
    ...
    ^bb2(%23: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %39 = arith.addi %arg5, %c1_i32_21 : i32
    ...
    ^bb3(%28: i32):  // no predecessors
      ...
      ^bb1(%37: i32):  // no predecessors
        ...
        %c0_i32_18 = arith.constant 0 : i32
        %40 = "simt_step.switch"(%39, %c0_i32_18) ({
        ^bb0(%arg4: i32):
