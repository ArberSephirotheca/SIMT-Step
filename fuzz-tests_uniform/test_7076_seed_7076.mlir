    ...
    ^bb1(%4: i32):  // no predecessors
      ...
      ^bb1(%10: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %14 = arith.addi %arg7, %c1_i32_5 : i32
      ...
      ^bb2(%12: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.continue"(%c4_i32_5, %14) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb1(%24: i32):  // no predecessors
        ...
        %25:2 = "simt_step.loop"(%c0_i32_17, %c0_i32_18) ({
    ...
    ^bb2(%22: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb1(%29: i32):  // no predecessors
          ...
          %30 = arith.addi %0, %c0_i32_19 : i32
          "simt_step.yield"(%30) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0>, default_index = 0 : i64} : (i32, i32) -> i32
        %true_17 = arith.constant true
        %27 = arith.addi %arg3, %26 : i32
        %c1_i32_18 = arith.constant 1 : i32
        %28 = arith.addi %arg4, %c1_i32_18 : i32
