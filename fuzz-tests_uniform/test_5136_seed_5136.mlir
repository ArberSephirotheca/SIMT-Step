module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        %c4_i32_6 = arith.constant 4 : i32
        %13 = "simt_step.switch"(%arg3, %c4_i32_6) ({
        ^bb0(%arg7: i32):
        ...
        "simt_step.continue"(%13, %15) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %18 = arith.muli %arg3, %c4_i32_11 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %c1_i32_14 = arith.constant 1 : i32
      %20 = arith.addi %arg3, %c1_i32_14 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %20 = arith.addi %c48_i32_12, %19 : i32
      %21 = "simt_step.buffer.load"(%arg1, %20) : (!simt_step.resource<Global, i32>, i32) -> i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %19 = arith.addi %arg3, %c1_i32_11 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %24 = arith.addi %arg4, %c1_i32_16 : i32
    ...
    ^bb1(%19: i32):  // no predecessors
      ...
      %21 = "simt_step.buffer.load"(%arg1, %20) : (!simt_step.resource<Global, i32>, i32) -> i32
      %c1_i32_14 = arith.constant 1 : i32
      %22 = "simt_step.switch"(%21, %c1_i32_14) ({
      ^bb0(%arg3: i32):
        "simt_step.yield"(%0) {fallthrough = true} : (i32) -> ()
      ^bb1(%23: i32):  // no predecessors
        %c0_i32_16 = arith.constant 0 : i32
        %24 = arith.addi %0, %c0_i32_16 : i32
        "simt_step.yield"(%24) {fallthrough = false} : (i32) -> ()
      ^bb2(%25: i32):  // no predecessors
        %c0_i32_17 = arith.constant 0 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %28 = arith.addi %arg5, %c1_i32_20 : i32
