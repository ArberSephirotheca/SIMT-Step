  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%4: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %7 = arith.remsi %arg3, %c2_i32_4 : i32
        %c2_i32_5 = arith.constant 2 : i32
        %8 = arith.addi %arg0, %c2_i32_5 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%19: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %31 = arith.muli %arg5, %c4_i32_17 : i32
          %32 = arith.addi %31, %0 : i32
          %c16_i32_18 = arith.constant 16 : i32
          %33 = arith.addi %c16_i32_18, %32 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %32 = arith.addi %arg5, %c1_i32_17 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb0(%arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %30 = arith.addi %arg6, %c1_i32_16 : i32
    ...
    ^bb1(%19: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %22 = arith.addi %arg4, %c1_i32_10 : i32
