module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      "simt_step.yield"(%c2_i32, %10) : (i32, i32) -> ()
    }) : (i32, i32) -> (i32, i32)
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      ^bb0(%arg6: i32, %arg7: i32):
        ...
        %12:2 = "simt_step.loop"(%c0_i32_10, %c0_i32_11) ({
        ^bb0(%arg8: i32, %arg9: i32):
          %c4_i32 = arith.constant 4 : i32
          %16 = arith.remsi %arg3, %c4_i32 : i32
          %c1_i32_13 = arith.constant 1 : i32
          %17 = arith.addi %16, %c1_i32_13 : i32
          %18 = arith.cmpi slt, %arg9, %17 : i32
          "simt_step.condition"(%18, %arg8, %arg9) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg8: i32, %arg9: i32):
          %c2_i32 = arith.constant 2 : i32
          %c1_i32_13 = arith.constant 1 : i32
        ...
        %15 = arith.addi %arg7, %c1_i32_12 : i32
        "simt_step.yield"(%12#0, %15) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
      %c1_i32 = arith.constant 1 : i32
      %c1_i32_9 = arith.constant 1 : i32
      %11 = arith.addi %arg5, %c1_i32_9 : i32
    ...
    ^bb1(%13: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %23 = arith.muli %arg5, %c4_i32_7 : i32
