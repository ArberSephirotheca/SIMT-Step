module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      "simt_step.yield"(%8#0, %10) : (i32, i32) -> ()
    }) : (i32, i32) -> (i32, i32)
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      %9 = "simt_step.if"(%8) ({
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_10 = arith.constant 1 : i32
          %15 = arith.addi %arg7, %c1_i32_10 : i32
          "simt_step.yield"(%14, %15) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32_9 = arith.constant 1 : i32
        %12 = arith.addi %arg0, %c1_i32_9 : i32
        "simt_step.yield"(%11#0) : (i32) -> ()
      }) : (i1) -> i32
      %c4_i32 = arith.constant 4 : i32
      %c1_i32 = arith.constant 1 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    %18 = "simt_step.if"(%17) ({
      ...
      ^bb0(%arg2: i32):
        %c0_i32_15 = arith.constant 0 : i32
        %c0_i32_16 = arith.constant 0 : i32
        %25:2 = "simt_step.loop"(%c0_i32_15, %c0_i32_16) ({
        ^bb0(%arg3: i32, %arg4: i32):
          %c4_i32_25 = arith.constant 4 : i32
          %32 = arith.muli %arg4, %c4_i32_25 : i32
          %33 = arith.addi %32, %0 : i32
          %c76_i32 = arith.constant 76 : i32
          %34 = arith.addi %c76_i32, %33 : i32
          %35 = "simt_step.buffer.load"(%arg1, %34) : (!simt_step.resource<Global, i32>, i32) -> i32
          %c0_i32_26 = arith.constant 0 : i32
          %36 = arith.cmpi ne, %35, %c0_i32_26 : i32
      ...
      ^bb3(%30: i32):  // no predecessors
        ...
        %31:2 = "simt_step.loop"(%c0_i32_22, %c0_i32_23) ({
        ^bb0(%arg3: i32, %arg4: i32):
          %c4_i32_25 = arith.constant 4 : i32
          %32 = arith.muli %arg4, %c4_i32_25 : i32
          %33 = arith.addi %32, %0 : i32
      ...
      ^bb3(%35: i32):  // no predecessors
        ...
        %c0_i32_22 = arith.constant 0 : i32
        %36:2 = "simt_step.loop"(%c0_i32_21, %c0_i32_22) ({
        ^bb0(%arg3: i32, %arg4: i32):
          %c4_i32_24 = arith.constant 4 : i32
          %37 = arith.muli %arg4, %c4_i32_24 : i32
          %38 = arith.addi %37, %0 : i32
