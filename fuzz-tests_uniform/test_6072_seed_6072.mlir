  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%5: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %8 = arith.remsi %arg3, %c4_i32_3 : i32
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          "simt_step.yield"(%c3_i32, %11) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c2_i32_5 = arith.constant 2 : i32
        %9 = arith.addi %arg0, %c2_i32_5 : i32
        %c1_i32 = arith.constant 1 : i32
        %10 = arith.addi %arg6, %c1_i32 : i32
        "simt_step.continue"(%8#0, %10) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %31 = arith.muli %arg5, %c4_i32_25 : i32
          %32 = arith.addi %31, %0 : i32
          %c36_i32 = arith.constant 36 : i32
          %33 = arith.addi %c36_i32, %32 : i32
          %34 = "simt_step.buffer.load"(%arg1, %33) : (!simt_step.resource<Global, i32>, i32) -> i32
          %c0_i32_26 = arith.constant 0 : i32
          %35 = arith.cmpi ne, %34, %c0_i32_26 : i32
      ...
      ^bb2(%29: i32):  // no predecessors
        ...
        %30:2 = "simt_step.loop"(%c0_i32_22, %c0_i32_23) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_25 = arith.constant 4 : i32
          %31 = arith.muli %arg5, %c4_i32_25 : i32
          %32 = arith.addi %31, %0 : i32
