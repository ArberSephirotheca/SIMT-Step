module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        %21 = "simt_step.if"(%20) ({
          ...
          %30 = arith.addi %arg0, %c3_i32_19 : i32
      ...
      ^bb1(%22: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          %c4_i32_19 = arith.constant 4 : i32
          %30 = arith.remsi %arg3, %c4_i32_19 : i32
          %c1_i32_20 = arith.constant 1 : i32
          %31 = arith.addi %30, %c1_i32_20 : i32
          %32 = arith.cmpi slt, %arg7, %31 : i32
          "simt_step.condition"(%32, %arg6, %arg7) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg6: i32, %arg7: i32):
          %c1_i32_19 = arith.constant 1 : i32
          %30 = arith.addi %arg0, %c1_i32_19 : i32
          %c1_i32_20 = arith.constant 1 : i32
          %31 = arith.addi %arg7, %c1_i32_20 : i32
      ...
      ^bb2(%24: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c1_i32_19, %30) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb3(%27: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_20 = arith.constant 1 : i32
          %30 = arith.addi %arg7, %c1_i32_20 : i32
          "simt_step.break"(%c1_i32_19, %30) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32_18 = arith.constant 1 : i32
        %29 = arith.addi %arg0, %c1_i32_18 : i32
    ...
    ^bb2(%13: i32):  // no predecessors
      ...
      %15 = "simt_step.if"(%14) ({
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %c1_i32_14 = arith.constant 1 : i32
          %22 = arith.addi %arg6, %c1_i32_14 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          %c4_i32_13 = arith.constant 4 : i32
          %22 = arith.remsi %arg3, %c4_i32_13 : i32
          %c1_i32_14 = arith.constant 1 : i32
          %23 = arith.addi %22, %c1_i32_14 : i32
        ...
        %21 = arith.addi %arg0, %c3_i32_12 : i32
        "simt_step.yield"(%20#0) : (i32) -> ()
      }) : (i1) -> i32
    ...
    ^bb3(%17: i32):  // no predecessors
      ...
      %19 = "simt_step.switch"(%18, %c3_i32_9) ({
      ^bb0(%arg5: i32):
        %c2_i32_10 = arith.constant 2 : i32
        %20 = arith.remsi %arg3, %c2_i32_10 : i32
        %c1_i32_11 = arith.constant 1 : i32
        %21 = arith.addi %arg0, %c1_i32_11 : i32
        ...
        ^bb1(%32: i32):  // no predecessors
          ...
          %33 = arith.addi %arg0, %c3_i32_20 : i32
      ...
      ^bb1(%23: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_20 = arith.constant 1 : i32
          %33 = arith.addi %32, %c1_i32_20 : i32
          %34 = arith.cmpi slt, %arg7, %33 : i32
          "simt_step.condition"(%34, %arg6, %arg7) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg6: i32, %arg7: i32):
          %c0_i32_19 = arith.constant 0 : i32
          %32 = arith.addi %arg0, %c0_i32_19 : i32
          %c1_i32_20 = arith.constant 1 : i32
          %33 = arith.addi %arg7, %c1_i32_20 : i32
          "simt_step.yield"(%32, %33) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32_15 = arith.constant 1 : i32
        %25 = arith.addi %arg0, %c1_i32_15 : i32
        "simt_step.yield"(%24#0) {fallthrough = true} : (i32) -> ()
      ^bb2(%26: i32):  // no predecessors
        %c0_i32_16 = arith.constant 0 : i32
        %27 = arith.addi %arg0, %c0_i32_16 : i32
        "simt_step.yield"(%27) {fallthrough = false} : (i32) -> ()
      ^bb3(%28: i32):  // no predecessors
        %c2_i32_17 = arith.constant 2 : i32
        %29 = arith.remsi %arg3, %c2_i32_17 : i32
        %30 = "simt_step.switch"(%29, %arg0) ({
        ^bb0(%arg6: i32):
          "simt_step.yield"(%arg0) {fallthrough = false} : (i32) -> ()
        ^bb1(%32: i32):  // no predecessors
          %c3_i32_19 = arith.constant 3 : i32
          %33 = arith.addi %arg0, %c3_i32_19 : i32
          "simt_step.yield"(%33) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0>, default_index = 0 : i64} : (i32, i32) -> i32
        %c1_i32_18 = arith.constant 1 : i32
        %31 = arith.addi %arg0, %c1_i32_18 : i32
