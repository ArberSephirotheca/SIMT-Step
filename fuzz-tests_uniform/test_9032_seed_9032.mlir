    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      ^bb0(%arg6: i32, %arg7: i32):
        ...
        ^bb0(%arg8: i32, %arg9: i32):
          ...
          %c1_i32_7 = arith.constant 1 : i32
          %13 = arith.addi %arg9, %c1_i32_7 : i32
        ...
        "simt_step.break"(%7#0, %10) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
      %4 = simt_step.lane_id
    ...
    %8 = "simt_step.if"(%7) ({
      ...
      ^bb0(%arg2: i32):
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %29 = arith.addi %c16_i32_14, %28 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb2(%30: i32):  // no predecessors
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %38 = arith.addi %arg6, %c1_i32_13 : i32
