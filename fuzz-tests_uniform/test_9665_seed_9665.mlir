module {
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%21: i32):  // no predecessors
      ...
      %24 = "simt_step.switch"(%23, %c4_i32_12) ({
      ^bb0(%arg3: i32):
        %c0_i32_17 = arith.constant 0 : i32
        "simt_step.yield"(%c0_i32_17) {fallthrough = false} : (i32) -> ()
      ^bb1(%27: i32):  // no predecessors
        %c0_i32_18 = arith.constant 0 : i32
        %28 = arith.addi %0, %c0_i32_18 : i32
        "simt_step.yield"(%28) {fallthrough = false} : (i32) -> ()
      ^bb2(%29: i32):  // no predecessors
        %c0_i32_19 = arith.constant 0 : i32
        %c0_i32_20 = arith.constant 0 : i32
        %30:2 = "simt_step.loop"(%c0_i32_19, %c0_i32_20) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_23 = arith.constant 4 : i32
          %36 = arith.muli %arg5, %c4_i32_23 : i32
          %37 = arith.addi %36, %0 : i32
          %c64_i32_24 = arith.constant 64 : i32
          %38 = arith.addi %c64_i32_24, %37 : i32
