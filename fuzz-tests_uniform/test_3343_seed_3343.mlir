    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      %4 = "simt_step.if"(%3) ({
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.continue"(%c3_i32, %7) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %21 = arith.muli %arg5, %c4_i32_17 : i32
          %22 = arith.addi %21, %0 : i32
          %c16_i32_18 = arith.constant 16 : i32
          %23 = arith.addi %c16_i32_18, %22 : i32
    ...
    ^bb1(%14: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %19 = arith.muli %arg6, %c4_i32_11 : i32
