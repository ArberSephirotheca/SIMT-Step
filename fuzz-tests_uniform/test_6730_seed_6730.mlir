module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%7: i32):  // no predecessors
      ...
      ^bb2(%18: i32):  // no predecessors
        ...
        %20 = arith.addi %arg0, %c2_i32_9 : i32
        %21 = "simt_step.switch"(%19, %20) ({
        ^bb0(%arg6: i32):
          %c1_i32_13 = arith.constant 1 : i32
          %25 = arith.addi %arg0, %c1_i32_13 : i32
      ...
      ^bb3(%22: i32):  // no predecessors
        ...
        %23 = arith.remsi %arg3, %c3_i32_11 : i32
    ...
    ^bb2(%10: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %21 = arith.addi %arg0, %c1_i32_12 : i32
          %c1_i32_13 = arith.constant 1 : i32
      ...
      ^bb1(%15: i32):  // no predecessors
        ...
        %17 = "simt_step.if"(%16) ({
          ...
          %c2_i32_12 = arith.constant 2 : i32
          %21 = arith.addi %arg0, %c2_i32_12 : i32
      ...
      ^bb3(%19: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %21 = arith.addi %arg0, %c0_i32_12 : i32
          %c1_i32_13 = arith.constant 1 : i32
          %22 = arith.addi %arg7, %c1_i32_13 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      %c4_i32_13 = arith.constant 4 : i32
      %20 = arith.muli %arg3, %c4_i32_13 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      %c2_i32 = arith.constant 2 : i32
      %20 = arith.addi %arg2, %c2_i32 : i32
      %c1_i32_13 = arith.constant 1 : i32
      %21 = arith.addi %arg3, %c1_i32_13 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %c1_i32_13 = arith.constant 1 : i32
      %23 = arith.addi %arg3, %c1_i32_13 : i32
    ...
    ^bb1(%24: i32):  // no predecessors
      ...
      %c0_i32_14 = arith.constant 0 : i32
      %27 = "simt_step.switch"(%26, %c0_i32_14) ({
      ^bb0(%arg3: i32):
        %c3_i32 = arith.constant 3 : i32
      ...
      ^bb2(%37: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32):
          %c1_i32_27 = arith.constant 1 : i32
          %43 = arith.addi %0, %c1_i32_27 : i32
          "simt_step.yield"(%43) {fallthrough = false} : (i32) -> ()
        ^bb1(%44: i32):  // no predecessors
          %c3_i32_28 = arith.constant 3 : i32
          %45 = arith.addi %0, %c3_i32_28 : i32
          "simt_step.yield"(%45) {fallthrough = false} : (i32) -> ()
        ^bb2(%46: i32):  // no predecessors
          %c3_i32_29 = arith.constant 3 : i32
          %47 = arith.addi %0, %c3_i32_29 : i32
      ...
      ^bb3(%41: i32):  // no predecessors
        ...
        %42:2 = "simt_step.loop"(%c0_i32_24, %c0_i32_25) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_27 = arith.constant 4 : i32
          %43 = arith.muli %arg5, %c4_i32_27 : i32
          %44 = arith.addi %43, %0 : i32
    ...
    ^bb2(%28: i32):  // no predecessors
      ...
      %29:2 = "simt_step.loop"(%c0_i32_16, %c0_i32_17) ({
      ^bb0(%arg3: i32, %arg4: i32):
        %c4_i32_20 = arith.constant 4 : i32
        %35 = arith.muli %arg4, %c4_i32_20 : i32
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %36 = arith.addi %arg4, %c1_i32_20 : i32
    ...
    %19 = "simt_step.wave_count_bits"(%true_12) : (i1) -> i32
