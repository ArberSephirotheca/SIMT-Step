  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb1(%19: i32):  // no predecessors
          ...
          %20 = arith.addi %arg0, %c1_i32_12 : i32
    ...
    ^bb1(%5: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32):
          ...
          %25 = arith.addi %arg0, %c1_i32_14 : i32
      ...
      ^bb3(%22: i32):  // no predecessors
        ...
        %23 = arith.remsi %arg3, %c3_i32_13 : i32
    ...
    ^bb2(%8: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %c1_i32_14 = arith.constant 1 : i32
          %17 = arith.addi %arg8, %c1_i32_14 : i32
          "simt_step.break"(%c0_i32_13, %17) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb3(%11: i32):  // no predecessors
      ...
      %13 = "simt_step.if"(%12) ({
        ...
        ^bb2(%21: i32):  // no predecessors
          %c4_i32_13 = arith.constant 4 : i32
          %22 = arith.addi %arg0, %c4_i32_13 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb3(%15: i32):  // no predecessors
      ...
      ^bb1(%24: i32):  // no predecessors
        ...
        %27 = "simt_step.switch"(%26, %c3_i32_6) ({
        ^bb0(%arg4: i32):
          %c4_i32_9 = arith.constant 4 : i32
