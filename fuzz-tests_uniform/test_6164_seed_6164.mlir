module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%9: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %c1_i32_14 = arith.constant 1 : i32
          %20 = arith.addi %arg8, %c1_i32_14 : i32
    ...
    ^bb2(%11: i32):  // no predecessors
      ...
      %13 = arith.addi %arg0, %c4_i32_5 : i32
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %27 = arith.remsi %arg3, %c4_i32_18 : i32
          %c1_i32_19 = arith.constant 1 : i32
          %28 = arith.addi %27, %c1_i32_19 : i32
          %29 = arith.cmpi slt, %arg7, %28 : i32
          "simt_step.condition"(%29, %arg6, %arg7) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg6: i32, %arg7: i32):
          %c1_i32_18 = arith.constant 1 : i32
          %27 = arith.addi %arg7, %c1_i32_18 : i32
          "simt_step.yield"(%arg0, %27) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c0_i32_11 = arith.constant 0 : i32
        %18 = arith.addi %arg0, %c0_i32_11 : i32
        "simt_step.yield"(%17#0) {fallthrough = true} : (i32) -> ()
      ^bb1(%19: i32):  // no predecessors
        %c2_i32_12 = arith.constant 2 : i32
        %20 = arith.addi %arg0, %c2_i32_12 : i32
        "simt_step.yield"(%20) {fallthrough = false} : (i32) -> ()
      ^bb2(%21: i32):  // no predecessors
        %c3_i32_13 = arith.constant 3 : i32
        %22 = arith.remsi %arg3, %c3_i32_13 : i32
        %c4_i32_14 = arith.constant 4 : i32
        %23 = arith.addi %arg0, %c4_i32_14 : i32
        %24 = "simt_step.switch"(%22, %23) ({
        ^bb0(%arg6: i32):
          %c4_i32_18 = arith.constant 4 : i32
          %27 = arith.addi %arg0, %c4_i32_18 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb3(%34: i32):  // no predecessors
      ...
      %38 = "simt_step.if"(%37) ({
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %42 = arith.addi %c32_i32_13, %41 : i32
    ...
    ^bb1(%26: i32):  // no predecessors
      ...
      %30 = "simt_step.if"(%29) ({
        ...
        %c2_i32_11 = arith.constant 2 : i32
        %42 = "simt_step.switch"(%41, %c2_i32_11) ({
        ^bb0(%arg3: i32):
          %c1_i32 = arith.constant 1 : i32
    ...
    ^bb3(%36: i32):  // no predecessors
      ...
      %c4_i32_9 = arith.constant 4 : i32
      %39 = "simt_step.switch"(%38, %c4_i32_9) ({
      ^bb0(%arg3: i32):
