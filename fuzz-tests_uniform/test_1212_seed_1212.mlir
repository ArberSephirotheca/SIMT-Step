module {
    ...
    %1 = "simt_step.if"(%0) ({
      ...
      ^bb0(%arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          "simt_step.yield"(%c0_i32_4, %15) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb1(%10: i32):  // no predecessors
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %13 = arith.addi %arg6, %c1_i32_4 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %17 = arith.addi %arg3, %c1_i32_8 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %20 = arith.muli %arg4, %c4_i32_14 : i32
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %21 = arith.addi %arg4, %c1_i32_14 : i32
    ...
    ^bb1(%16: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %23 = arith.muli %arg6, %c4_i32_18 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %24 = arith.addi %arg6, %c1_i32_18 : i32
          "simt_step.yield"(%23, %24) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %true_16 = arith.constant true
        %21 = arith.addi %arg3, %20#0 : i32
        %c1_i32_17 = arith.constant 1 : i32
        %22 = arith.addi %arg4, %c1_i32_17 : i32
