module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      "simt_step.yield"(%13#0, %15) : (i32, i32) -> ()
    }) : (i32, i32) -> (i32, i32)
    ...
    ^bb0(%arg4: i32):
      ...
      %13 = arith.remsi %arg3, %c4_i32_6 : i32
      %c0_i32_7 = arith.constant 0 : i32
      %14 = "simt_step.switch"(%13, %c0_i32_7) ({
      ^bb0(%arg5: i32):
        %c1_i32 = arith.constant 1 : i32
        "simt_step.yield"(%c1_i32) {fallthrough = false} : (i32) -> ()
      ^bb1(%23: i32):  // no predecessors
        %c3_i32_14 = arith.constant 3 : i32
        %24 = arith.remsi %arg3, %c3_i32_14 : i32
        %c4_i32_15 = arith.constant 4 : i32
        %25 = arith.addi %arg0, %c4_i32_15 : i32
      ...
      ^bb2(%28: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %33 = arith.remsi %arg3, %c4_i32_20 : i32
          %c1_i32_21 = arith.constant 1 : i32
          %34 = arith.addi %33, %c1_i32_21 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%arg0, %33) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb3(%31: i32):  // no predecessors
        ...
        %32 = arith.addi %arg0, %c2_i32_19 : i32
    ...
    ^bb1(%16: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %26 = arith.remsi %arg3, %c4_i32_17 : i32
          %c1_i32_18 = arith.constant 1 : i32
          %27 = arith.addi %26, %c1_i32_18 : i32
          %28 = arith.cmpi slt, %arg8, %27 : i32
          "simt_step.condition"(%28, %arg7, %arg8) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg7: i32, %arg8: i32):
          %c1_i32_17 = arith.constant 1 : i32
          %26 = arith.addi %arg8, %c1_i32_17 : i32
          "simt_step.yield"(%arg0, %26) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c4_i32_16 = arith.constant 4 : i32
        %24 = arith.addi %arg0, %c4_i32_16 : i32
        %c1_i32 = arith.constant 1 : i32
        %25 = arith.addi %arg6, %c1_i32 : i32
        "simt_step.yield"(%23#0, %25) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
      "simt_step.yield"(%17#0) {fallthrough = false} : (i32) -> ()
    ^bb2(%18: i32):  // no predecessors
      %c0_i32_11 = arith.constant 0 : i32
      %19 = arith.cmpi ne, %arg2, %c0_i32_11 : i32
      %20 = "simt_step.if"(%19) ({
        %c0_i32_14 = arith.constant 0 : i32
        %23 = arith.cmpi ne, %arg2, %c0_i32_14 : i32
        %24 = "simt_step.if"(%23) ({
        ...
        %24 = arith.addi %arg0, %c2_i32_14 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        %14 = arith.addi %c48_i32_10, %0 : i32
        ...
        ^bb0(%arg6: i32):
          %c4_i32_13 = arith.constant 4 : i32
          %21 = arith.addi %0, %c4_i32_13 : i32
          "simt_step.yield"(%21) {fallthrough = false} : (i32) -> ()
        ^bb1(%22: i32):  // no predecessors
          %c1_i32_14 = arith.constant 1 : i32
          %23 = arith.addi %0, %c1_i32_14 : i32
          "simt_step.yield"(%23) {fallthrough = true} : (i32) -> ()
        ^bb2(%24: i32):  // no predecessors
          %c4_i32_15 = arith.constant 4 : i32
          %25 = arith.addi %0, %c4_i32_15 : i32
          "simt_step.yield"(%25) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1>, default_index = 0 : i64} : (i32, i32) -> i32
        %true_11 = arith.constant true
        %19 = arith.addi %arg4, %18 : i32
        %c1_i32_12 = arith.constant 1 : i32
        %20 = arith.addi %arg5, %c1_i32_12 : i32
