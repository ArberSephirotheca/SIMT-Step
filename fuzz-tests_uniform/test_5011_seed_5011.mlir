module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    %1 = "simt_step.if"(%0) ({
      ...
      %7 = arith.addi %arg0, %c1_i32_1 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      %c4_i32_10 = arith.constant 4 : i32
      %18 = "simt_step.switch"(%17, %c4_i32_10) ({
      ^bb0(%arg3: i32):
    ...
    ^bb1(%19: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        %27:2 = "simt_step.loop"(%c0_i32_19, %c0_i32_20) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_25 = arith.constant 4 : i32
          %36 = arith.muli %arg5, %c4_i32_25 : i32
          %37 = arith.addi %36, %0 : i32
          %c64_i32 = arith.constant 64 : i32
          %38 = arith.addi %c64_i32, %37 : i32
          %39 = "simt_step.buffer.load"(%arg1, %38) : (!simt_step.resource<Global, i32>, i32) -> i32
          %c0_i32_26 = arith.constant 0 : i32
          %40 = arith.cmpi ne, %39, %c0_i32_26 : i32
      ...
      ^bb2(%29: i32):  // no predecessors
        ...
        %32 = arith.cmpi ne, %31, %c0_i32_23 : i32
        %33 = "simt_step.if"(%32) ({
    ...
    ^bb2(%23: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %27 = arith.muli %arg4, %c4_i32_19 : i32
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %c4_i32_19 = arith.constant 4 : i32
        %29 = arith.addi %0, %c4_i32_19 : i32
        %30 = "simt_step.switch"(%28, %29) ({
        ^bb0(%arg5: i32):
          %c1_i32_21 = arith.constant 1 : i32
          %33 = arith.addi %0, %c1_i32_21 : i32
          "simt_step.yield"(%33) {fallthrough = false} : (i32) -> ()
        ^bb1(%34: i32):  // no predecessors
          %c4_i32_22 = arith.constant 4 : i32
          %35 = arith.addi %0, %c4_i32_22 : i32
          "simt_step.yield"(%35) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0>, default_index = 0 : i64} : (i32, i32) -> i32
