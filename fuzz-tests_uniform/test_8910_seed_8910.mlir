module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb3(%14: i32):  // no predecessors
      ...
      %16 = "simt_step.switch"(%15, %c2_i32_6) ({
      ^bb0(%arg5: i32):
        %c0_i32_8 = arith.constant 0 : i32
        %c0_i32_9 = arith.constant 0 : i32
        %18:2 = "simt_step.loop"(%c0_i32_8, %c0_i32_9) ({
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.break"(%c0_i32_19, %28) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c3_i32_10 = arith.constant 3 : i32
        %19 = arith.addi %arg0, %c3_i32_10 : i32
        "simt_step.yield"(%18#0) {fallthrough = false} : (i32) -> ()
      ^bb1(%20: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          %c4_i32_19 = arith.constant 4 : i32
          %28 = arith.addi %arg0, %c4_i32_19 : i32
          %c1_i32_20 = arith.constant 1 : i32
          %29 = arith.addi %arg7, %c1_i32_20 : i32
      ...
      ^bb2(%23: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %28 = arith.addi %arg0, %c1_i32_19 : i32
          %c1_i32_20 = arith.constant 1 : i32
          %29 = arith.addi %arg7, %c1_i32_20 : i32
          "simt_step.yield"(%28, %29) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb3(%26: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_20 = arith.constant 1 : i32
          %28 = arith.addi %arg7, %c1_i32_20 : i32
          "simt_step.yield"(%c2_i32_19, %28) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
