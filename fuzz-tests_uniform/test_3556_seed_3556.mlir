module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %5 = "simt_step.if"(%4) ({
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %16 = arith.addi %arg0, %c3_i32_12 : i32
          %c1_i32 = arith.constant 1 : i32
          %17 = arith.addi %arg6, %c1_i32 : i32
          "simt_step.break"(%16, %17) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c3_i32_11 = arith.constant 3 : i32
        %15 = arith.addi %arg0, %c3_i32_11 : i32
        "simt_step.yield"(%14#0) : (i32) -> ()
      }, {
        %c3_i32_9 = arith.constant 3 : i32
        %14 = arith.remsi %arg3, %c3_i32_9 : i32
        %c0_i32_10 = arith.constant 0 : i32
        %15 = "simt_step.switch"(%14, %c0_i32_10) ({
        ^bb0(%arg5: i32):
          %c0_i32_11 = arith.constant 0 : i32
          %16 = arith.addi %arg0, %c0_i32_11 : i32
    ...
    ^bb2(%8: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %14 = arith.remsi %arg3, %c2_i32_9 : i32
        ...
        %c4_i32_11 = arith.constant 4 : i32
        %17 = arith.addi %arg0, %c4_i32_11 : i32
        %c1_i32 = arith.constant 1 : i32
    ...
    ^bb3(%10: i32):  // no predecessors
      ...
      %12 = "simt_step.if"(%11) ({
        ...
        %c4_i32_10 = arith.constant 4 : i32
        %16 = arith.addi %arg0, %c4_i32_10 : i32
        "simt_step.yield"(%15) : (i32) -> ()
      }, {
        %c0_i32_9 = arith.constant 0 : i32
        %14 = arith.cmpi ne, %arg2, %c0_i32_9 : i32
      ...
      %13 = arith.addi %arg0, %c0_i32_8 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      %c4_i32_11 = arith.constant 4 : i32
      %15 = arith.muli %arg3, %c4_i32_11 : i32
      %16 = arith.addi %15, %0 : i32
      %c8_i32 = arith.constant 8 : i32
      %17 = arith.addi %c8_i32, %16 : i32
      %18 = "simt_step.buffer.load"(%arg1, %17) : (!simt_step.resource<Global, i32>, i32) -> i32
      %c0_i32_12 = arith.constant 0 : i32
      %19 = arith.cmpi ne, %18, %c0_i32_12 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %17 = arith.addi %c48_i32_12, %16 : i32
      %18 = "simt_step.buffer.load"(%arg1, %17) : (!simt_step.resource<Global, i32>, i32) -> i32
      %c0_i32_13 = arith.constant 0 : i32
      %19 = arith.cmpi ne, %18, %c0_i32_13 : i32
      "simt_step.condition"(%19, %arg2, %arg3) : (i1, i32, i32) -> ()
    }, {
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %c0_i32_11 = arith.constant 0 : i32
      %17 = arith.cmpi ne, %16, %c0_i32_11 : i32
      %18 = "simt_step.if"(%17) ({
        %c0_i32_12 = arith.constant 0 : i32
        %c0_i32_13 = arith.constant 0 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %22 = arith.muli %arg5, %c4_i32_15 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %23 = arith.addi %arg5, %c1_i32_15 : i32
