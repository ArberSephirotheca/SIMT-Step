  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %28 = arith.addi %arg6, %c1_i32_14 : i32
        "simt_step.break"(%26, %28) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
    ...
    ^bb1(%14: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        %26 = "simt_step.if"(%25) ({
          ...
          %38 = arith.addi %arg0, %c4_i32_20 : i32
      ...
      ^bb1(%28: i32):  // no predecessors
        ...
        %31 = arith.addi %arg0, %c3_i32_15 : i32
        "simt_step.yield"(%30) {fallthrough = false} : (i32) -> ()
      ^bb2(%32: i32):  // no predecessors
        %c3_i32_16 = arith.constant 3 : i32
        %33 = arith.remsi %arg3, %c3_i32_16 : i32
        %c3_i32_17 = arith.constant 3 : i32
        %34 = "simt_step.switch"(%33, %c3_i32_17) ({
        ^bb0(%arg6: i32):
          %c2_i32_20 = arith.constant 2 : i32
          %38 = arith.addi %arg0, %c2_i32_20 : i32
          "simt_step.yield"(%38) {fallthrough = true} : (i32) -> ()
        ^bb1(%39: i32):  // no predecessors
          "simt_step.yield"(%arg0) {fallthrough = false} : (i32) -> ()
        ^bb2(%40: i32):  // no predecessors
          %c4_i32_21 = arith.constant 4 : i32
          %41 = arith.addi %arg0, %c4_i32_21 : i32
          "simt_step.yield"(%41) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1>, default_index = 1 : i64} : (i32, i32) -> i32
        "simt_step.yield"(%34) {fallthrough = false} : (i32) -> ()
      ^bb3(%35: i32):  // no predecessors
        %c4_i32_18 = arith.constant 4 : i32
        %36 = arith.addi %arg0, %c4_i32_18 : i32
        %37 = "simt_step.switch"(%arg3, %36) ({
        ^bb0(%arg6: i32):
          "simt_step.yield"(%arg0) {fallthrough = false} : (i32) -> ()
    ...
    ^bb2(%18: i32):  // no predecessors
      ...
      %20 = "simt_step.if"(%19) ({
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %26 = arith.remsi %arg3, %c4_i32_14 : i32
          %c1_i32_15 = arith.constant 1 : i32
          %27 = arith.addi %26, %c1_i32_15 : i32
          %28 = arith.cmpi slt, %arg6, %27 : i32
          "simt_step.condition"(%28, %arg5, %arg6) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg5: i32, %arg6: i32):
          %c1_i32_14 = arith.constant 1 : i32
          %26 = arith.addi %arg6, %c1_i32_14 : i32
        ...
        ^bb1(%28: i32):  // no predecessors
          %c2_i32_15 = arith.constant 2 : i32
          %29 = arith.addi %arg0, %c2_i32_15 : i32
    ...
    ^bb3(%21: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        %26 = "simt_step.if"(%25) ({
          %c2_i32_20 = arith.constant 2 : i32
          %40 = arith.addi %arg0, %c2_i32_20 : i32
      ...
      ^bb1(%28: i32):  // no predecessors
        ...
        %30 = "simt_step.if"(%29) ({
          ...
          %40 = arith.addi %arg0, %c1_i32_20 : i32
          "simt_step.yield"(%40) : (i32) -> ()
        }, {
          %c2_i32_20 = arith.constant 2 : i32
      ...
      ^bb2(%32: i32):  // no predecessors
        ...
        %33 = arith.cmpi ne, %arg2, %c0_i32_16 : i32
        %34 = "simt_step.if"(%33) ({
          %c0_i32_20 = arith.constant 0 : i32
          %40 = arith.addi %arg0, %c0_i32_20 : i32
          "simt_step.yield"(%40) : (i32) -> ()
        }, {
          "simt_step.yield"(%arg0) : (i32) -> ()
        }) : (i1) -> i32
        %c3_i32_17 = arith.constant 3 : i32
        %35 = arith.addi %arg0, %c3_i32_17 : i32
        "simt_step.yield"(%34) {fallthrough = false} : (i32) -> ()
      ^bb3(%36: i32):  // no predecessors
        %c0_i32_18 = arith.constant 0 : i32
        %37 = arith.cmpi ne, %arg2, %c0_i32_18 : i32
        %38 = "simt_step.if"(%37) ({
          "simt_step.yield"(%arg0) : (i32) -> ()
        }, {
          "simt_step.yield"(%arg0) : (i32) -> ()
        ...
        %39 = arith.addi %arg0, %c2_i32_19 : i32
