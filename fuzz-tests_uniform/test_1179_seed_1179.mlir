  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        "simt_step.continue"(%20#0, %21) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
    ...
    ^bb1(%9: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %29 = arith.remsi %arg3, %c4_i32_17 : i32
          %c1_i32_18 = arith.constant 1 : i32
          %30 = arith.addi %29, %c1_i32_18 : i32
          %31 = arith.cmpi slt, %arg7, %30 : i32
          "simt_step.condition"(%31, %arg6, %arg7) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg6: i32, %arg7: i32):
          %c1_i32_17 = arith.constant 1 : i32
          %29 = arith.addi %arg7, %c1_i32_17 : i32
          "simt_step.break"(%arg0, %29) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32_10 = arith.constant 1 : i32
        %21 = arith.addi %arg0, %c1_i32_10 : i32
        "simt_step.yield"(%20#0) {fallthrough = true} : (i32) -> ()
      ^bb1(%22: i32):  // no predecessors
        %c2_i32_11 = arith.constant 2 : i32
        %23 = arith.remsi %arg3, %c2_i32_11 : i32
        %c3_i32_12 = arith.constant 3 : i32
        %24 = "simt_step.switch"(%23, %c3_i32_12) ({
        ^bb0(%arg6: i32):
          %c1_i32_17 = arith.constant 1 : i32
          "simt_step.yield"(%c1_i32_17) {fallthrough = false} : (i32) -> ()
        ^bb1(%29: i32):  // no predecessors
          %c4_i32_18 = arith.constant 4 : i32
          %30 = arith.addi %arg0, %c4_i32_18 : i32
          "simt_step.yield"(%30) {fallthrough = false} : (i32) -> ()
        ^bb2(%31: i32):  // no predecessors
          %c1_i32_19 = arith.constant 1 : i32
          %32 = arith.addi %arg0, %c1_i32_19 : i32
      ...
      ^bb2(%26: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_18 = arith.constant 1 : i32
          %30 = arith.addi %arg7, %c1_i32_18 : i32
    ...
    ^bb2(%13: i32):  // no predecessors
      ...
      ^bb2(%27: i32):  // no predecessors
        ...
        %28 = arith.remsi %arg3, %c2_i32_12 : i32
        %29 = "simt_step.switch"(%28, %arg0) ({
        ^bb0(%arg6: i32):
          %c0_i32_17 = arith.constant 0 : i32
          %34 = arith.addi %arg0, %c0_i32_17 : i32
          "simt_step.yield"(%34) {fallthrough = false} : (i32) -> ()
        ^bb1(%35: i32):  // no predecessors
          %c0_i32_18 = arith.constant 0 : i32
          %36 = arith.addi %arg0, %c0_i32_18 : i32
      ...
      ^bb3(%30: i32):  // no predecessors
        ...
        %31 = arith.remsi %arg3, %c2_i32_14 : i32
        %c4_i32_15 = arith.constant 4 : i32
        %32 = "simt_step.switch"(%31, %c4_i32_15) ({
        ^bb0(%arg6: i32):
          %c0_i32_17 = arith.constant 0 : i32
          "simt_step.yield"(%c0_i32_17) {fallthrough = false} : (i32) -> ()
        ^bb1(%34: i32):  // no predecessors
          %c1_i32_18 = arith.constant 1 : i32
          %35 = arith.addi %arg0, %c1_i32_18 : i32
          "simt_step.yield"(%35) {fallthrough = false} : (i32) -> ()
        ^bb2(%36: i32):  // no predecessors
          "simt_step.yield"(%arg0) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1>, default_index = 2 : i64} : (i32, i32) -> i32
        %c4_i32_16 = arith.constant 4 : i32
        %33 = arith.addi %arg0, %c4_i32_16 : i32
        "simt_step.yield"(%32) {fallthrough = false} : (i32) -> ()
    ...
    ^bb3(%16: i32):  // no predecessors
      ...
      %18 = "simt_step.if"(%17) ({
        ...
        %21 = "simt_step.switch"(%20, %c2_i32_9) ({
        ^bb0(%arg5: i32):
          "simt_step.yield"(%arg0) {fallthrough = false} : (i32) -> ()
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%19: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %28 = arith.addi %c16_i32_8, %27 : i32
