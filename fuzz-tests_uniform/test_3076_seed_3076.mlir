module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb3(%11: i32):  // no predecessors
      ...
      %13 = "simt_step.switch"(%12, %c2_i32_5) ({
      ^bb0(%arg5: i32):
        %c0_i32_6 = arith.constant 0 : i32
        %c0_i32_7 = arith.constant 0 : i32
        %14:2 = "simt_step.loop"(%c0_i32_6, %c0_i32_7) ({
      ...
      ^bb1(%16: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_18 = arith.constant 1 : i32
          %26 = arith.addi %arg7, %c1_i32_18 : i32
          "simt_step.yield"(%c3_i32_17, %26) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c3_i32_11 = arith.constant 3 : i32
        %18 = arith.addi %arg0, %c3_i32_11 : i32
      ...
      ^bb2(%19: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_18 = arith.constant 1 : i32
          %26 = arith.addi %arg7, %c1_i32_18 : i32
          "simt_step.yield"(%c4_i32_17, %26) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        "simt_step.yield"(%20#0) {fallthrough = false} : (i32) -> ()
      ^bb3(%21: i32):  // no predecessors
        %c3_i32_14 = arith.constant 3 : i32
        %22 = arith.remsi %arg3, %c3_i32_14 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%14: i32):  // no predecessors
      ...
      ^bb1(%21: i32):  // no predecessors
        ...
        %24 = "simt_step.switch"(%23, %c2_i32_12) ({
        ^bb0(%arg4: i32):
