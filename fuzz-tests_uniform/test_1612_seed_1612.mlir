  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb2(%8: i32):  // no predecessors
      ...
      ^bb2(%17: i32):  // no predecessors
        ...
        %18 = arith.remsi %arg3, %c2_i32_11 : i32
        %c0_i32_12 = arith.constant 0 : i32
        %19 = "simt_step.switch"(%18, %c0_i32_12) ({
        ^bb0(%arg6: i32):
      ...
      ^bb3(%20: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c3_i32_17, %22) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb3(%11: i32):  // no predecessors
      ...
      %13 = "simt_step.if"(%12) ({
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          "simt_step.yield"(%c0_i32_9, %15) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %18 = arith.muli %arg4, %c4_i32_11 : i32
    ...
    ^bb1(%16: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %20 = arith.addi %c32_i32_12, %19 : i32
        %21 = "simt_step.buffer.load"(%arg1, %20) : (!simt_step.resource<Global, i32>, i32) -> i32
