module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    %1 = arith.addi %arg0, %c3_i32_1 : i32
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c4_i32_16, %25) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb1(%18: i32):  // no predecessors
        ...
        %20 = "simt_step.switch"(%19, %c2_i32_12) ({
        ^bb0(%arg6: i32):
          %c4_i32_16 = arith.constant 4 : i32
    ...
    ^bb2(%11: i32):  // no predecessors
      ...
      ^bb1(%17: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.continue"(%c2_i32_14, %21) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c3_i32_11 = arith.constant 3 : i32
      ...
      ^bb2(%19: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32 = arith.constant 1 : i32
          %21 = arith.addi %arg7, %c1_i32 : i32
          "simt_step.yield"(%c2_i32_14, %21) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
