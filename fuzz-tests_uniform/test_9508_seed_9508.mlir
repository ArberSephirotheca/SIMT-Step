  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%5: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %21 = arith.remsi %arg3, %c4_i32_17 : i32
          %c1_i32_18 = arith.constant 1 : i32
          %22 = arith.addi %21, %c1_i32_18 : i32
          %23 = arith.cmpi slt, %arg7, %22 : i32
          "simt_step.condition"(%23, %arg6, %arg7) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg6: i32, %arg7: i32):
          %c2_i32_17 = arith.constant 2 : i32
          %21 = arith.addi %arg0, %c2_i32_17 : i32
          %c1_i32_18 = arith.constant 1 : i32
          %22 = arith.addi %arg7, %c1_i32_18 : i32
          "simt_step.yield"(%21, %22) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c2_i32_10 = arith.constant 2 : i32
        %15 = arith.addi %arg0, %c2_i32_10 : i32
      ...
      ^bb1(%16: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c4_i32_17, %21) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb3(%19: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_18 = arith.constant 1 : i32
          %21 = arith.addi %arg7, %c1_i32_18 : i32
          "simt_step.continue"(%c1_i32_17, %21) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb2(%8: i32):  // no predecessors
      ...
      %10 = "simt_step.if"(%9) ({
        ...
        %14 = arith.remsi %arg3, %c2_i32_8 : i32
        %c0_i32_9 = arith.constant 0 : i32
        %15 = "simt_step.switch"(%14, %c0_i32_9) ({
        ^bb0(%arg5: i32):
          %c1_i32 = arith.constant 1 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %31 = arith.addi %c16_i32_13, %30 : i32
    ...
    ^bb1(%16: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %27 = arith.addi %arg5, %c1_i32_9 : i32
