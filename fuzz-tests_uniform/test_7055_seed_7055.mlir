  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %30 = arith.muli %arg4, %c4_i32_17 : i32
        %31 = arith.addi %30, %0 : i32
        %c32_i32_18 = arith.constant 32 : i32
        %32 = arith.addi %c32_i32_18, %31 : i32
    ...
    ^bb1(%20: i32):  // no predecessors
      ...
      %23 = "simt_step.switch"(%22, %c4_i32_11) ({
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %42 = arith.muli %arg5, %c4_i32_26 : i32
      ...
      ^bb1(%31: i32):  // no predecessors
        ...
        %34 = "simt_step.switch"(%33, %c0_i32_20) ({
        ^bb0(%arg4: i32):
          %c2_i32_26 = arith.constant 2 : i32
          "simt_step.yield"(%c2_i32_26) {fallthrough = false} : (i32) -> ()
      ...
      ^bb2(%35: i32):  // no predecessors
        ...
        %36:2 = "simt_step.loop"(%c0_i32_22, %c0_i32_23) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_26 = arith.constant 4 : i32
          %42 = arith.muli %arg5, %c4_i32_26 : i32
          %43 = arith.addi %42, %0 : i32
      ...
      ^bb3(%37: i32):  // no predecessors
        ...
        %40 = arith.cmpi ne, %39, %c0_i32_25 : i32
        %41 = "simt_step.if"(%40) ({
          %c0_i32_26 = arith.constant 0 : i32
          "simt_step.yield"(%c0_i32_26) : (i32) -> ()
        }, {
          %c2_i32_26 = arith.constant 2 : i32
          %42 = arith.addi %0, %c2_i32_26 : i32
    ...
    ^bb2(%24: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        %c0_i32_17 = arith.constant 0 : i32
        %32 = "simt_step.switch"(%31, %c0_i32_17) ({
        ^bb0(%arg4: i32):
          %c0_i32_22 = arith.constant 0 : i32
    ...
    ^bb3(%28: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %33 = arith.muli %arg6, %c4_i32_20 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %34 = arith.addi %arg6, %c1_i32_20 : i32
    ...
    %13 = arith.addi %c172_i32, %0 : i32
    %14 = "simt_step.buffer.load"(%arg1, %13) : (!simt_step.resource<Global, i32>, i32) -> i32
    %c0_i32_6 = arith.constant 0 : i32
    %15 = arith.cmpi ne, %14, %c0_i32_6 : i32
    %16 = "simt_step.if"(%15) ({
      %c0_i32_8 = arith.constant 0 : i32
      %19 = arith.addi %0, %c0_i32_8 : i32
