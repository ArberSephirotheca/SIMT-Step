    ...
    %1 = "simt_step.if"(%0) ({
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c1_i32_6, %11) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c4_i32 = arith.constant 4 : i32
        %c1_i32 = arith.constant 1 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        %15 = arith.muli %arg5, %c4_i32_11 : i32
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %18 = arith.muli %arg7, %c4_i32_15 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %19 = arith.addi %arg7, %c1_i32_15 : i32
          "simt_step.yield"(%18, %19) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %true_13 = arith.constant true
        %16 = arith.addi %arg4, %15#0 : i32
        %c1_i32_14 = arith.constant 1 : i32
        %17 = arith.addi %arg5, %c1_i32_14 : i32
        "simt_step.yield"(%16, %17) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
      %true_9 = arith.constant true
      %13 = arith.addi %arg2, %12#0 : i32
      %c1_i32_10 = arith.constant 1 : i32
      %14 = arith.addi %arg3, %c1_i32_10 : i32
