module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      "simt_step.break"(%c0_i32_5, %9) : (i32, i32) -> ()
    }) : (i32, i32) -> (i32, i32)
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb1(%19: i32):  // no predecessors
        ...
        %20 = arith.remsi %arg3, %c3_i32_16 : i32
        %c4_i32_17 = arith.constant 4 : i32
        %21 = "simt_step.switch"(%20, %c4_i32_17) ({
        ^bb0(%arg6: i32):
          %c2_i32_21 = arith.constant 2 : i32
          %26 = arith.addi %arg0, %c2_i32_21 : i32
      ...
      ^bb2(%22: i32):  // no predecessors
        ...
        %23 = arith.cmpi ne, %arg2, %c0_i32_19 : i32
        %24 = "simt_step.if"(%23) ({
          %c0_i32_21 = arith.constant 0 : i32
          "simt_step.yield"(%c0_i32_21) : (i32) -> ()
        }, {
          %c1_i32_21 = arith.constant 1 : i32
          %26 = arith.addi %arg0, %c1_i32_21 : i32
          "simt_step.yield"(%26) : (i32) -> ()
        }) : (i1) -> i32
        %c0_i32_20 = arith.constant 0 : i32
        %25 = arith.addi %arg0, %c0_i32_20 : i32
    ...
    ^bb1(%11: i32):  // no predecessors
      ...
      ^bb1(%19: i32):  // no predecessors
        ...
        %20 = arith.remsi %arg3, %c3_i32_14 : i32
        %21 = "simt_step.switch"(%20, %arg0) ({
        ^bb0(%arg6: i32):
          %c1_i32_17 = arith.constant 1 : i32
          %26 = arith.addi %arg0, %c1_i32_17 : i32
          "simt_step.yield"(%26) {fallthrough = false} : (i32) -> ()
        ^bb1(%27: i32):  // no predecessors
        ...
        %22 = arith.addi %arg0, %c3_i32_15 : i32
        "simt_step.yield"(%21) {fallthrough = false} : (i32) -> ()
      ^bb2(%23: i32):  // no predecessors
        %c0_i32_16 = arith.constant 0 : i32
        %24 = arith.cmpi ne, %arg2, %c0_i32_16 : i32
        %25 = "simt_step.if"(%24) ({
    ...
    ^bb2(%14: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        %c0_i32_13 = arith.constant 0 : i32
        %18 = arith.cmpi ne, %arg2, %c0_i32_13 : i32
        %19 = "simt_step.if"(%18) ({
          %c4_i32_16 = arith.constant 4 : i32
          %21 = arith.addi %arg0, %c4_i32_16 : i32
        ...
        %20 = arith.addi %arg6, %c1_i32_15 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %20 = "simt_step.if"(%19) ({
        ...
        %23 = arith.addi %c32_i32_10, %0 : i32
