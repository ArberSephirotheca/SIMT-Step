module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      "simt_step.continue"(%c2_i32, %9) : (i32, i32) -> ()
    }) : (i32, i32) -> (i32, i32)
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb1(%25: i32):  // no predecessors
          ...
          %26 = arith.addi %arg0, %c1_i32_18 : i32
      ...
      ^bb1(%20: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %25 = arith.remsi %arg3, %c4_i32_18 : i32
          %c1_i32_19 = arith.constant 1 : i32
          %26 = arith.addi %25, %c1_i32_19 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          %c1_i32_18 = arith.constant 1 : i32
          %c1_i32_19 = arith.constant 1 : i32
          %25 = arith.addi %arg7, %c1_i32_19 : i32
          "simt_step.yield"(%c1_i32_18, %25) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32_14 = arith.constant 1 : i32
        %22 = arith.addi %arg0, %c1_i32_14 : i32
      ...
      ^bb2(%23: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %25 = arith.addi %arg0, %c3_i32_18 : i32
          %c1_i32_19 = arith.constant 1 : i32
          %26 = arith.addi %arg7, %c1_i32_19 : i32
    ...
    ^bb1(%11: i32):  // no predecessors
      ...
      ^bb1(%19: i32):  // no predecessors
        ...
        %21 = "simt_step.if"(%20) ({
          ...
          %c4_i32_13 = arith.constant 4 : i32
          %23 = arith.addi %arg0, %c4_i32_13 : i32
          "simt_step.yield"(%23) : (i32) -> ()
        }) : (i1) -> i32
    ...
    ^bb2(%15: i32):  // no predecessors
      ...
      %17 = "simt_step.if"(%16) ({
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %19 = arith.remsi %arg3, %c4_i32_12 : i32
          %c1_i32_13 = arith.constant 1 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          %c3_i32_12 = arith.constant 3 : i32
          %19 = arith.addi %arg0, %c3_i32_12 : i32
          %c1_i32_13 = arith.constant 1 : i32
          %20 = arith.addi %arg6, %c1_i32_13 : i32
