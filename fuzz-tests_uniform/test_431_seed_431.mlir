module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %4 = "simt_step.switch"(%arg3, %c1_i32_0) ({
      ^bb0(%arg5: i32):
    ...
    ^bb1(%5: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %16 = arith.addi %arg0, %c0_i32_14 : i32
          %c1_i32_15 = arith.constant 1 : i32
          %17 = arith.addi %arg7, %c1_i32_15 : i32
      ...
      ^bb1(%11: i32):  // no predecessors
        ...
        %13 = "simt_step.switch"(%12, %c3_i32_9) ({
        ^bb0(%arg6: i32):
        ...
        ^bb3(%18: i32):  // no predecessors
          ...
          %19 = arith.addi %arg0, %c2_i32_16 : i32
      ...
      ^bb2(%14: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          %c0_i32_14 = arith.constant 0 : i32
          %c1_i32_15 = arith.constant 1 : i32
          %16 = arith.addi %arg7, %c1_i32_15 : i32
          "simt_step.break"(%c0_i32_14, %16) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb2(%8: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %11 = "simt_step.switch"(%10, %c3_i32_6) ({
        ^bb0(%arg7: i32):
          %c3_i32_9 = arith.constant 3 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %30 = arith.addi %c16_i32_10, %29 : i32
    ...
    ^bb1(%29: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %34 = arith.addi %c64_i32_17, %33 : i32
        %35 = "simt_step.buffer.load"(%arg1, %34) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_18 = arith.constant 0 : i32
