    ...
    ^bb1(%8: i32):  // no predecessors
      ...
      ^bb2(%25: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_15 = arith.constant 1 : i32
          %27 = arith.addi %arg7, %c1_i32_15 : i32
          "simt_step.yield"(%c0_i32_14, %27) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb2(%12: i32):  // no predecessors
      ...
      %14 = "simt_step.if"(%13) ({
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          "simt_step.continue"(%c0_i32_9, %20) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    %8 = "simt_step.if"(%7) ({
      ...
      ^bb2(%33: i32):  // no predecessors
        ...
        %36 = "simt_step.switch"(%35, %c4_i32_13) ({
        ^bb0(%arg3: i32):
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %21 = arith.addi %c48_i32_10, %0 : i32
        ...
        %c1_i32_12 = arith.constant 1 : i32
        %26 = arith.addi %arg3, %c1_i32_12 : i32
