  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %13 = "simt_step.if"(%12) ({
        ...
        %26 = arith.addi %arg0, %c0_i32_14 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %25 = arith.remsi %arg3, %c4_i32_15 : i32
          %c1_i32_16 = arith.constant 1 : i32
          %26 = arith.addi %25, %c1_i32_16 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          %c3_i32_15 = arith.constant 3 : i32
          %c1_i32_16 = arith.constant 1 : i32
          %25 = arith.addi %arg6, %c1_i32_16 : i32
          "simt_step.break"(%c3_i32_15, %25) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32 = arith.constant 1 : i32
    ...
    ^bb3(%20: i32):  // no predecessors
      ...
      %21 = arith.remsi %arg3, %c2_i32_12 : i32
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %32 = arith.remsi %arg3, %c4_i32_18 : i32
          %c1_i32_19 = arith.constant 1 : i32
          %33 = arith.addi %32, %c1_i32_19 : i32
      ...
      ^bb1(%25: i32):  // no predecessors
        ...
        %26 = arith.remsi %arg3, %c2_i32_15 : i32
      ...
      ^bb2(%28: i32):  // no predecessors
        ...
        %31 = arith.addi %arg0, %c3_i32_17 : i32
        "simt_step.yield"(%30) {fallthrough = false} : (i32) -> ()
      }) {case_values = array<i64: 0, 1>, default_index = 0 : i64} : (i32, i32) -> i32
      %c3_i32 = arith.constant 3 : i32
      %23 = arith.addi %arg0, %c3_i32 : i32
      "simt_step.yield"(%22) {fallthrough = false} : (i32) -> ()
    }) {case_values = array<i64: 0, 1, 2>, default_index = 2 : i64} : (i32, i32) -> i32
    %true_5 = arith.constant true
    %8 = "simt_step.wave_count_bits"(%true_5) : (i1) -> i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb2(%23: i32):  // no predecessors
      ...
      %27 = "simt_step.if"(%26) ({
        ...
        %28 = arith.addi %c48_i32_8, %0 : i32
        %29 = "simt_step.buffer.load"(%arg1, %28) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c4_i32_9 = arith.constant 4 : i32
        %30 = "simt_step.switch"(%29, %c4_i32_9) ({
        ^bb0(%arg3: i32):
          "simt_step.yield"(%0) {fallthrough = false} : (i32) -> ()
