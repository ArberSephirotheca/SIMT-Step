    ...
    ^bb1(%6: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %25 = arith.addi %arg7, %c1_i32_15 : i32
      ...
      ^bb1(%15: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c4_i32_15, %25) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c0_i32_11 = arith.constant 0 : i32
        %17 = arith.addi %arg0, %c0_i32_11 : i32
      ...
      ^bb3(%22: i32):  // no predecessors
        ...
        %24 = "simt_step.switch"(%23, %c3_i32_14) ({
        ^bb0(%arg6: i32):
          %c4_i32_15 = arith.constant 4 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %16 = "simt_step.if"(%15) ({
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %22 = arith.addi %c32_i32_11, %21 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          %c4_i32_15 = arith.constant 4 : i32
          %23 = arith.muli %arg6, %c4_i32_15 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %c1_i32_15 = arith.constant 1 : i32
          %24 = arith.addi %arg6, %c1_i32_15 : i32
          "simt_step.yield"(%23, %24) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %true_13 = arith.constant true
        %21 = arith.addi %arg3, %20#0 : i32
        %c1_i32_14 = arith.constant 1 : i32
        %22 = arith.addi %arg4, %c1_i32_14 : i32
