  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        %18 = arith.remsi %arg3, %c3_i32_10 : i32
        %c2_i32_11 = arith.constant 2 : i32
        %19 = "simt_step.switch"(%18, %c2_i32_11) ({
        ^bb0(%arg6: i32):
        ...
        ^bb1(%27: i32):  // no predecessors
          ...
          %28 = arith.addi %arg0, %c2_i32_17 : i32
        ...
        ^bb3(%30: i32):  // no predecessors
          ...
          %31 = arith.addi %arg0, %c1_i32_19 : i32
      ...
      ^bb1(%20: i32):  // no predecessors
        ...
        %22 = arith.addi %arg0, %c0_i32_13 : i32
      ...
      ^bb2(%24: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %27 = arith.addi %26, %c1_i32_17 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.break"(%c3_i32_16, %26) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb1(%9: i32):  // no predecessors
      ...
      ^bb1(%21: i32):  // no predecessors
        ...
        %23 = "simt_step.if"(%22) ({
          ...
          %27 = arith.addi %arg0, %c2_i32_16 : i32
    ...
    ^bb2(%13: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %18 = arith.remsi %arg3, %c4_i32_10 : i32
    ...
    ^bb3(%15: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb1(%28: i32):  // no predecessors
          %c1_i32_17 = arith.constant 1 : i32
          %29 = arith.addi %arg0, %c1_i32_17 : i32
