  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%6: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %12 = arith.remsi %arg3, %c3_i32_8 : i32
        %c0_i32_9 = arith.constant 0 : i32
        %13 = "simt_step.switch"(%12, %c0_i32_9) ({
        ^bb0(%arg7: i32):
          %c1_i32_11 = arith.constant 1 : i32
          %15 = arith.addi %arg0, %c1_i32_11 : i32
    ...
    ^bb2(%9: i32):  // no predecessors
      ...
      %10 = "simt_step.switch"(%arg3, %c3_i32_6) ({
      ^bb0(%arg5: i32):
        %c0_i32_8 = arith.constant 0 : i32
        %c0_i32_9 = arith.constant 0 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %15 = arith.addi %arg7, %c1_i32_14 : i32
          "simt_step.yield"(%c0_i32_13, %15) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32_10 = arith.constant 1 : i32
      ...
      ^bb1(%13: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_14 = arith.constant 1 : i32
          %15 = arith.addi %arg7, %c1_i32_14 : i32
          "simt_step.break"(%c0_i32_13, %15) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c2_i32 = arith.constant 2 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      %15 = "simt_step.if"(%14) ({
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %25 = arith.addi %c16_i32_7, %24 : i32
