  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %15 = arith.addi %14, %c1_i32_12 : i32
          %16 = arith.cmpi slt, %arg8, %15 : i32
          "simt_step.condition"(%16, %arg7, %arg8) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg7: i32, %arg8: i32):
          %c1_i32_12 = arith.constant 1 : i32
          %14 = arith.addi %arg0, %c1_i32_12 : i32
          %c1_i32_13 = arith.constant 1 : i32
          %15 = arith.addi %arg8, %c1_i32_13 : i32
          "simt_step.yield"(%14, %15) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c3_i32_10 = arith.constant 3 : i32
        %c1_i32_11 = arith.constant 1 : i32
        %13 = arith.addi %arg6, %c1_i32_11 : i32
    ...
    ^bb1(%5: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %13 = "simt_step.switch"(%12, %c3_i32_8) ({
        ^bb0(%arg7: i32):
          %c3_i32_10 = arith.constant 3 : i32
    ...
    ^bb3(%8: i32):  // no predecessors
      ...
      %9 = arith.remsi %arg3, %c3_i32_6 : i32
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %20 = arith.addi %arg7, %c1_i32_15 : i32
      ...
      ^bb2(%15: i32):  // no predecessors
        ...
        %16 = arith.cmpi ne, %arg2, %c0_i32_13 : i32
        %17 = "simt_step.if"(%16) ({
          %c3_i32_14 = arith.constant 3 : i32
          "simt_step.yield"(%c3_i32_14) : (i32) -> ()
        }, {
          %c1_i32_14 = arith.constant 1 : i32
          %19 = arith.addi %arg0, %c1_i32_14 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb2(%14: i32):  // no predecessors
      ...
      %18 = "simt_step.if"(%17) ({
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          %c4_i32_12 = arith.constant 4 : i32
          %20 = arith.muli %arg4, %c4_i32_12 : i32
        ...
        ^bb0(%arg3: i32):
          %c0_i32_10 = arith.constant 0 : i32
          %22 = arith.addi %0, %c0_i32_10 : i32
          "simt_step.yield"(%22) {fallthrough = true} : (i32) -> ()
        ^bb1(%23: i32):  // no predecessors
          %c1_i32_11 = arith.constant 1 : i32
          %24 = arith.addi %0, %c1_i32_11 : i32
