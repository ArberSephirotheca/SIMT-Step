module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    %1:2 = "simt_step.loop"(%c0_i32_0, %c0_i32_1) ({
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      ^bb0(%arg6: i32, %arg7: i32):
        ...
        "simt_step.continue"(%c3_i32, %17) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
    ...
    %3 = arith.addi %c0_i32_2, %arg0 : i32
    ...
    ^bb1(%16: i32):  // no predecessors
      ...
      %18 = "simt_step.switch"(%17, %c4_i32_7) ({
      ^bb0(%arg5: i32):
        %c0_i32_11 = arith.constant 0 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %31 = arith.remsi %arg3, %c4_i32_15 : i32
          %c1_i32 = arith.constant 1 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %31 = arith.addi %arg0, %c0_i32_15 : i32
          %c1_i32 = arith.constant 1 : i32
      ...
      ^bb1(%27: i32):  // no predecessors
        ...
        %28 = arith.cmpi ne, %arg2, %c0_i32_14 : i32
        %29 = "simt_step.if"(%28) ({
          "simt_step.yield"(%arg0) : (i32) -> ()
        }, {
          %c4_i32_15 = arith.constant 4 : i32
          %31 = arith.addi %arg0, %c4_i32_15 : i32
    ...
    ^bb2(%19: i32):  // no predecessors
      ...
      ^bb1(%28: i32):  // no predecessors
        %c3_i32_13 = arith.constant 3 : i32
        %29 = arith.remsi %arg3, %c3_i32_13 : i32
        %c4_i32_14 = arith.constant 4 : i32
        %30 = "simt_step.switch"(%29, %c4_i32_14) ({
        ^bb0(%arg6: i32):
          %c3_i32_21 = arith.constant 3 : i32
          %37 = arith.addi %arg0, %c3_i32_21 : i32
          "simt_step.yield"(%37) {fallthrough = false} : (i32) -> ()
        ^bb1(%38: i32):  // no predecessors
          %c4_i32_22 = arith.constant 4 : i32
          %39 = arith.addi %arg0, %c4_i32_22 : i32
      ...
      ^bb2(%31: i32):  // no predecessors
        ...
        %32 = arith.remsi %arg3, %c2_i32_16 : i32
        %c0_i32_17 = arith.constant 0 : i32
        %33 = "simt_step.switch"(%32, %c0_i32_17) ({
        ^bb0(%arg6: i32):
          %c3_i32_21 = arith.constant 3 : i32
      ...
      ^bb3(%34: i32):  // no predecessors
        ...
        %35 = arith.remsi %arg3, %c3_i32_19 : i32
        %c2_i32_20 = arith.constant 2 : i32
        %36 = "simt_step.switch"(%35, %c2_i32_20) ({
        ^bb0(%arg6: i32):
          "simt_step.yield"(%arg0) {fallthrough = false} : (i32) -> ()
        ^bb1(%37: i32):  // no predecessors
    ...
    ^bb3(%23: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32):
          ...
          %31 = arith.addi %arg0, %c1_i32_12 : i32
          "simt_step.yield"(%31) {fallthrough = false} : (i32) -> ()
        ^bb1(%32: i32):  // no predecessors
          %c4_i32_13 = arith.constant 4 : i32
          %33 = arith.addi %arg0, %c4_i32_13 : i32
          "simt_step.yield"(%33) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0>, default_index = 1 : i64} : (i32, i32) -> i32
        "simt_step.yield"(%27) {fallthrough = true} : (i32) -> ()
      ^bb1(%28: i32):  // no predecessors
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %c1_i32_12 = arith.constant 1 : i32
          %41 = arith.addi %arg5, %c1_i32_12 : i32
