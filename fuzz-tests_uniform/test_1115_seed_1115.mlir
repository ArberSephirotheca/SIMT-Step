module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    %0 = arith.cmpi ne, %arg2, %c0_i32_0 : i32
    %1 = "simt_step.if"(%0) ({
      ...
      ^bb0(%arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %16 = arith.remsi %arg3, %c4_i32_14 : i32
          %c1_i32_15 = arith.constant 1 : i32
          %17 = arith.addi %16, %c1_i32_15 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %17 = arith.addi %arg6, %c1_i32_14 : i32
      ...
      ^bb2(%11: i32):  // no predecessors
        ...
        %12:2 = "simt_step.loop"(%c0_i32_9, %c0_i32_10) ({
        ^bb0(%arg5: i32, %arg6: i32):
          %c4_i32_14 = arith.constant 4 : i32
          %16 = arith.remsi %arg3, %c4_i32_14 : i32
          %c1_i32_15 = arith.constant 1 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          %c4_i32_14 = arith.constant 4 : i32
          %16 = arith.addi %arg0, %c4_i32_14 : i32
          %c1_i32_15 = arith.constant 1 : i32
          %17 = arith.addi %arg6, %c1_i32_15 : i32
          "simt_step.break"(%16, %17) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c0_i32_11 = arith.constant 0 : i32
        %13 = arith.addi %arg0, %c0_i32_11 : i32
        "simt_step.yield"(%12#0) {fallthrough = true} : (i32) -> ()
      ^bb3(%14: i32):  // no predecessors
        %c0_i32_12 = arith.constant 0 : i32
        %c0_i32_13 = arith.constant 0 : i32
        %15:2 = "simt_step.loop"(%c0_i32_12, %c0_i32_13) ({
        ^bb0(%arg5: i32, %arg6: i32):
          %c4_i32_14 = arith.constant 4 : i32
          %16 = arith.remsi %arg3, %c4_i32_14 : i32
          %c1_i32_15 = arith.constant 1 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          %c4_i32_14 = arith.constant 4 : i32
          %c1_i32_15 = arith.constant 1 : i32
          %16 = arith.addi %arg6, %c1_i32_15 : i32
          "simt_step.yield"(%c4_i32_14, %16) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
