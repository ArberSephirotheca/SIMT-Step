module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      ^bb0(%arg6: i32, %arg7: i32):
        ...
        %14 = arith.addi %arg7, %c1_i32_7 : i32
    ...
    ^bb1(%10: i32):  // no predecessors
      ...
      %12 = "simt_step.switch"(%11, %c4_i32_5) ({
      ^bb0(%arg5: i32):
      ...
      ^bb1(%22: i32):  // no predecessors
        ...
        %23 = arith.remsi %arg3, %c3_i32_12 : i32
    ...
    ^bb3(%15: i32):  // no predecessors
      ...
      %16 = arith.remsi %arg3, %c2_i32_8 : i32
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %26 = arith.addi %arg7, %c1_i32_17 : i32
      ...
      ^bb2(%22: i32):  // no predecessors
        ...
        %25 = arith.addi %arg0, %c0_i32_16 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %17 = arith.muli %arg3, %c4_i32_16 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      %c0_i32_16 = arith.constant 0 : i32
      %17 = arith.addi %arg2, %c0_i32_16 : i32
      %c1_i32 = arith.constant 1 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %19 = arith.addi %c48_i32_17, %18 : i32
      %20 = "simt_step.buffer.load"(%arg1, %19) : (!simt_step.resource<Global, i32>, i32) -> i32
      %c0_i32_18 = arith.constant 0 : i32
      %21 = arith.cmpi ne, %20, %c0_i32_18 : i32
      "simt_step.condition"(%21, %arg2, %arg3) : (i1, i32, i32) -> ()
    }, {
    ^bb0(%arg2: i32, %arg3: i32):
      %17 = arith.addi %arg2, %arg3 : i32
    ...
    %14:2 = "simt_step.loop"(%c0_i32_12, %c0_i32_13) ({
    ^bb0(%arg2: i32, %arg3: i32):
      %c4_i32_16 = arith.constant 4 : i32
      %17 = arith.muli %arg3, %c4_i32_16 : i32
      %18 = arith.addi %17, %0 : i32
    ...
    %16 = "simt_step.wave_count_bits"(%true_15) : (i1) -> i32
