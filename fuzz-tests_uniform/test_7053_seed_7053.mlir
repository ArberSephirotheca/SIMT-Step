    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        %16 = "simt_step.if"(%15) ({
          ...
          %24 = arith.addi %arg0, %c0_i32_16 : i32
      ...
      ^bb1(%17: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.continue"(%c2_i32_16, %24) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb2(%19: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %28 = arith.muli %arg6, %c4_i32_19 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %29 = arith.addi %arg6, %c1_i32_19 : i32
          "simt_step.yield"(%28, %29) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %true_17 = arith.constant true
        %26 = arith.addi %arg3, %25#0 : i32
        %c1_i32_18 = arith.constant 1 : i32
        %27 = arith.addi %arg4, %c1_i32_18 : i32
