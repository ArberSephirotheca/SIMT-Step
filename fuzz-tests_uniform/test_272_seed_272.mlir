module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      "simt_step.yield"(%c3_i32, %8) : (i32, i32) -> ()
    }) : (i32, i32) -> (i32, i32)
    ...
    %3 = "simt_step.switch"(%arg3, %c0_i32_2) ({
    ^bb0(%arg4: i32):
      %c3_i32 = arith.constant 3 : i32
      ...
      ^bb0(%arg5: i32):
        ...
        %14 = "simt_step.if"(%13) ({
          ...
          %c0_i32_14 = arith.constant 0 : i32
          %21 = arith.addi %arg0, %c0_i32_14 : i32
    ...
    ^bb1(%10: i32):  // no predecessors
      ...
      %12 = "simt_step.if"(%11) ({
        ...
        %13 = "simt_step.switch"(%arg3, %c3_i32_7) ({
        ^bb0(%arg5: i32):
    ...
    %4 = "simt_step.wave_count_bits"(%true_3) : (i1) -> i32
    ...
    %8 = "simt_step.if"(%7) ({
      ...
      %26 = "simt_step.if"(%25) ({
        ...
        ^bb0(%arg2: i32, %arg3: i32):
          ...
          %30 = arith.addi %c32_i32_10, %29 : i32
