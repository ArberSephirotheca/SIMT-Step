module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      %c1_i32 = arith.constant 1 : i32
      %10 = "simt_step.switch"(%arg3, %c1_i32) ({
      ^bb0(%arg6: i32):
    ...
    ^bb0(%arg4: i32):
      ...
      %11 = "simt_step.if"(%10) ({
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %21 = arith.remsi %arg3, %c4_i32_14 : i32
          %c1_i32_15 = arith.constant 1 : i32
          %22 = arith.addi %21, %c1_i32_15 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %c1_i32_15 = arith.constant 1 : i32
          %21 = arith.addi %arg6, %c1_i32_15 : i32
          "simt_step.yield"(%c0_i32_14, %21) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32_13 = arith.constant 1 : i32
        %20 = arith.addi %arg0, %c1_i32_13 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %c1_i32_14 = arith.constant 1 : i32
          %20 = arith.addi %arg6, %c1_i32_14 : i32
          "simt_step.yield"(%c3_i32_13, %20) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c2_i32 = arith.constant 2 : i32
        "simt_step.yield"(%19#0) : (i32) -> ()
      }) : (i1) -> i32
    ...
    ^bb1(%12: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        "simt_step.yield"(%c0_i32_11, %19) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
      %c3_i32_8 = arith.constant 3 : i32
      %14 = arith.addi %arg0, %c3_i32_8 : i32
      "simt_step.yield"(%13#0) {fallthrough = true} : (i32) -> ()
    ^bb2(%15: i32):  // no predecessors
      %c4_i32_9 = arith.constant 4 : i32
      %16 = arith.remsi %arg3, %c4_i32_9 : i32
      %c3_i32_10 = arith.constant 3 : i32
      %17 = "simt_step.switch"(%16, %c3_i32_10) ({
      ^bb0(%arg5: i32):
        %c2_i32 = arith.constant 2 : i32
        %19 = arith.remsi %arg3, %c2_i32 : i32
        %c1_i32_11 = arith.constant 1 : i32
        %20 = "simt_step.switch"(%19, %c1_i32_11) ({
        ^bb0(%arg6: i32):
          "simt_step.yield"(%arg0) {fallthrough = true} : (i32) -> ()
        ^bb1(%28: i32):  // no predecessors
          %c0_i32_18 = arith.constant 0 : i32
          %29 = arith.addi %arg0, %c0_i32_18 : i32
      ...
      ^bb2(%22: i32):  // no predecessors
        ...
        %23 = arith.cmpi ne, %arg2, %c0_i32_13 : i32
        %24 = "simt_step.if"(%23) ({
          %c2_i32_18 = arith.constant 2 : i32
          %28 = arith.addi %arg0, %c2_i32_18 : i32
        ...
        %c0_i32_14 = arith.constant 0 : i32
        %25 = arith.addi %arg0, %c0_i32_14 : i32
      ...
      ^bb3(%26: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %28 = arith.remsi %arg3, %c4_i32_18 : i32
          %c1_i32_19 = arith.constant 1 : i32
          %29 = arith.addi %28, %c1_i32_19 : i32
