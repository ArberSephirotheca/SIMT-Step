module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %29 = arith.addi %arg0, %c3_i32_15 : i32
          %c1_i32 = arith.constant 1 : i32
      ...
      ^bb1(%22: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.continue"(%c4_i32_15, %29) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb1(%10: i32):  // no predecessors
      ...
      %13 = arith.addi %arg0, %c2_i32_2 : i32
    ...
    ^bb2(%14: i32):  // no predecessors
      ...
      %16 = "simt_step.if"(%15) ({
        ...
        ^bb3(%26: i32):  // no predecessors
          ...
          %27 = arith.addi %arg0, %c3_i32_10 : i32
          "simt_step.yield"(%27) {fallthrough = false} : (i32) -> ()
    ...
    ^bb3(%17: i32):  // no predecessors
      ...
      ^bb3(%27: i32):  // no predecessors
        %c3_i32_13 = arith.constant 3 : i32
        %28 = arith.remsi %arg3, %c3_i32_13 : i32
        %c0_i32_14 = arith.constant 0 : i32
        %29 = arith.addi %arg0, %c0_i32_14 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %20 = arith.muli %arg3, %c4_i32_11 : i32
