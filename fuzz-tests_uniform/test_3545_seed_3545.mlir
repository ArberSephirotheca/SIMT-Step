  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb1(%16: i32):  // no predecessors
        ...
        %17:2 = "simt_step.loop"(%c0_i32_13, %c0_i32_14) ({
        ^bb0(%arg6: i32, %arg7: i32):
          %c4_i32_17 = arith.constant 4 : i32
          %20 = arith.remsi %arg3, %c4_i32_17 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %20 = arith.addi %arg7, %c1_i32_17 : i32
          "simt_step.yield"(%c1_i32, %20) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        "simt_step.yield"(%17#0) {fallthrough = false} : (i32) -> ()
      ^bb2(%18: i32):  // no predecessors
        %c0_i32_15 = arith.constant 0 : i32
        %c0_i32_16 = arith.constant 0 : i32
        %19:2 = "simt_step.loop"(%c0_i32_15, %c0_i32_16) ({
        ^bb0(%arg6: i32, %arg7: i32):
          %c4_i32_17 = arith.constant 4 : i32
          %20 = arith.remsi %arg3, %c4_i32_17 : i32
          %c1_i32 = arith.constant 1 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c2_i32_17, %20) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb1(%8: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %16 = arith.remsi %arg3, %c4_i32_12 : i32
        %c1_i32 = arith.constant 1 : i32
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        %c0_i32_12 = arith.constant 0 : i32
        %16 = arith.cmpi ne, %arg2, %c0_i32_12 : i32
        %17 = "simt_step.if"(%16) ({
        ...
        %18 = arith.addi %arg0, %c2_i32_13 : i32
        %c1_i32 = arith.constant 1 : i32
    ...
    ^bb2(%10: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %16 = arith.remsi %arg3, %c2_i32_12 : i32
        %c2_i32_13 = arith.constant 2 : i32
        %17 = arith.addi %arg0, %c2_i32_13 : i32
    ...
    ^bb3(%13: i32):  // no predecessors
      ...
      %15 = "simt_step.switch"(%14, %c2_i32_10) ({
      ^bb0(%arg5: i32):
        %c0_i32_12 = arith.constant 0 : i32
        %c0_i32_13 = arith.constant 0 : i32
        %16:2 = "simt_step.loop"(%c0_i32_12, %c0_i32_13) ({
        ^bb0(%arg6: i32, %arg7: i32):
          %c4_i32_22 = arith.constant 4 : i32
          %28 = arith.remsi %arg3, %c4_i32_22 : i32
          %c1_i32 = arith.constant 1 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %28 = arith.addi %arg0, %c3_i32_22 : i32
          %c1_i32 = arith.constant 1 : i32
          %29 = arith.addi %arg7, %c1_i32 : i32
          "simt_step.continue"(%28, %29) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c4_i32_14 = arith.constant 4 : i32
        %17 = arith.addi %arg0, %c4_i32_14 : i32
        "simt_step.yield"(%16#0) {fallthrough = false} : (i32) -> ()
      ^bb1(%18: i32):  // no predecessors
        %c2_i32_15 = arith.constant 2 : i32
        %19 = arith.remsi %arg3, %c2_i32_15 : i32
        %c2_i32_16 = arith.constant 2 : i32
        %20 = "simt_step.switch"(%19, %c2_i32_16) ({
        ^bb0(%arg6: i32):
          %c0_i32_22 = arith.constant 0 : i32
          %28 = arith.addi %arg0, %c0_i32_22 : i32
      ...
      ^bb2(%21: i32):  // no predecessors
        ...
        %22:2 = "simt_step.loop"(%c0_i32_17, %c0_i32_18) ({
        ^bb0(%arg6: i32, %arg7: i32):
          %c4_i32_22 = arith.constant 4 : i32
          %28 = arith.remsi %arg3, %c4_i32_22 : i32
          %c1_i32 = arith.constant 1 : i32
        ...
        %23 = arith.addi %arg0, %c4_i32_19 : i32
        "simt_step.yield"(%22#0) {fallthrough = false} : (i32) -> ()
      ^bb3(%24: i32):  // no predecessors
        %c2_i32_20 = arith.constant 2 : i32
        %25 = arith.remsi %arg3, %c2_i32_20 : i32
        %c4_i32_21 = arith.constant 4 : i32
        %26 = arith.addi %arg0, %c4_i32_21 : i32
        %27 = "simt_step.switch"(%25, %26) ({
        ^bb0(%arg6: i32):
          %c2_i32_22 = arith.constant 2 : i32
          %28 = arith.addi %arg0, %c2_i32_22 : i32
