  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%13: i32):  // no predecessors
      ...
      %15 = "simt_step.if"(%14) ({
        ...
        %21 = "simt_step.switch"(%20, %c4_i32_6) ({
        ^bb0(%arg5: i32):
    ...
    ^bb2(%16: i32):  // no predecessors
      ...
      ^bb1(%23: i32):  // no predecessors
        ...
        %c0_i32_7 = arith.constant 0 : i32
        %26 = arith.addi %arg0, %c0_i32_7 : i32
        "simt_step.yield"(%25) {fallthrough = false} : (i32) -> ()
      ^bb2(%27: i32):  // no predecessors
        %c2_i32_8 = arith.constant 2 : i32
        %28 = arith.remsi %arg3, %c2_i32_8 : i32
        %c3_i32_9 = arith.constant 3 : i32
        %29 = "simt_step.switch"(%28, %c3_i32_9) ({
        ^bb0(%arg6: i32):
          "simt_step.yield"(%arg0) {fallthrough = false} : (i32) -> ()
      ...
      ^bb3(%30: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          %c4_i32_13 = arith.constant 4 : i32
          %33 = arith.remsi %arg3, %c4_i32_13 : i32
          %c1_i32_14 = arith.constant 1 : i32
          %34 = arith.addi %33, %c1_i32_14 : i32
          %35 = arith.cmpi slt, %arg7, %34 : i32
          "simt_step.condition"(%35, %arg6, %arg7) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg6: i32, %arg7: i32):
          %c0_i32_13 = arith.constant 0 : i32
          %33 = arith.addi %arg0, %c0_i32_13 : i32
          %c1_i32_14 = arith.constant 1 : i32
          %34 = arith.addi %arg7, %c1_i32_14 : i32
    ...
    %8 = "simt_step.if"(%7) ({
      ...
      ^bb0(%arg2: i32):
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %26 = arith.addi %c16_i32_7, %25 : i32
