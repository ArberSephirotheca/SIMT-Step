module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      ^bb0(%arg6: i32, %arg7: i32):
        %c1_i32_8 = arith.constant 1 : i32
        %11 = arith.addi %arg7, %c1_i32_8 : i32
        "simt_step.yield"(%arg0, %11) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
      %c1_i32 = arith.constant 1 : i32
      %c1_i32_7 = arith.constant 1 : i32
      %10 = arith.addi %arg5, %c1_i32_7 : i32
    ...
    %4 = "simt_step.if"(%3) ({
      ...
      ^bb1(%15: i32):  // no predecessors
        ...
        %c0_i32_7 = arith.constant 0 : i32
        %17 = "simt_step.switch"(%16, %c0_i32_7) ({
        ^bb0(%arg5: i32):
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %21 = arith.addi %arg4, %c1_i32_12 : i32
    ...
    ^bb1(%12: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %22 = arith.addi %c32_i32_13, %21 : i32
        %23 = "simt_step.buffer.load"(%arg1, %22) : (!simt_step.resource<Global, i32>, i32) -> i32
    ...
    ^bb2(%14: i32):  // no predecessors
      ...
      ^bb1(%24: i32):  // no predecessors
        ...
        %27 = "simt_step.switch"(%26, %c1_i32_14) ({
        ^bb0(%arg4: i32):
    ...
    ^bb3(%18: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %23 = arith.muli %arg6, %c4_i32_16 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %24 = arith.addi %arg6, %c1_i32_16 : i32
          "simt_step.yield"(%23, %24) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
