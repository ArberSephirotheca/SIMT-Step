  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      ^bb0(%arg6: i32, %arg7: i32):
        ...
        %18 = arith.addi %arg7, %c1_i32_8 : i32
    ...
    ^bb0(%arg4: i32):
      ...
      %15 = "simt_step.if"(%14) ({
        ...
        %25 = arith.cmpi ne, %arg2, %c0_i32_11 : i32
        %26 = "simt_step.if"(%25) ({
    ...
    ^bb2(%19: i32):  // no predecessors
      ...
      ^bb1(%27: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_22 = arith.constant 1 : i32
          %35 = arith.addi %arg7, %c1_i32_22 : i32
          "simt_step.yield"(%c3_i32_21, %35) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb3(%32: i32):  // no predecessors
        ...
        %33 = arith.cmpi ne, %arg2, %c0_i32_19 : i32
        %34 = "simt_step.if"(%33) ({
          "simt_step.yield"(%arg0) : (i32) -> ()
        }, {
          %c4_i32_21 = arith.constant 4 : i32
          %35 = arith.addi %arg0, %c4_i32_21 : i32
    ...
    ^bb3(%23: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %26 = "simt_step.switch"(%25, %c3_i32_12) ({
        ^bb0(%arg7: i32):
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %15 = "simt_step.if"(%14) ({
        ...
        %20 = "simt_step.switch"(%19, %c1_i32_5) ({
        ^bb0(%arg4: i32):
