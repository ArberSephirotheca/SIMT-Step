  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %9 = arith.remsi %arg3, %c4_i32_7 : i32
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %9 = arith.remsi %arg3, %c2_i32_7 : i32
        ...
        ^bb1(%12: i32):  // no predecessors
          ...
          %13 = arith.addi %arg0, %c4_i32_10 : i32
    ...
    ^bb1(%5: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          %c4_i32_10 = arith.constant 4 : i32
          %11 = arith.remsi %arg3, %c4_i32_10 : i32
          %c1_i32_11 = arith.constant 1 : i32
          %12 = arith.addi %11, %c1_i32_11 : i32
          %13 = arith.cmpi slt, %arg8, %12 : i32
          "simt_step.condition"(%13, %arg7, %arg8) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg7: i32, %arg8: i32):
          %c1_i32_10 = arith.constant 1 : i32
          %11 = arith.addi %arg0, %c1_i32_10 : i32
          %c1_i32_11 = arith.constant 1 : i32
          %12 = arith.addi %arg8, %c1_i32_11 : i32
          "simt_step.yield"(%11, %12) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32_9 = arith.constant 1 : i32
        %10 = arith.addi %arg6, %c1_i32_9 : i32
    ...
    ^bb2(%7: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32):
          ...
          %13 = arith.addi %arg0, %c4_i32_9 : i32
          "simt_step.yield"(%13) {fallthrough = false} : (i32) -> ()
