module {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %25 = arith.addi %24, %c1_i32_17 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_17 = arith.constant 1 : i32
          %24 = arith.addi %arg7, %c1_i32_17 : i32
          "simt_step.break"(%c1_i32_16, %24) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c4_i32_8 = arith.constant 4 : i32
        "simt_step.yield"(%13#0) {fallthrough = false} : (i32) -> ()
      ^bb1(%14: i32):  // no predecessors
        %c3_i32_9 = arith.constant 3 : i32
        %15 = arith.remsi %arg3, %c3_i32_9 : i32
        %c4_i32_10 = arith.constant 4 : i32
        %16 = "simt_step.switch"(%15, %c4_i32_10) ({
        ^bb0(%arg6: i32):
      ...
      ^bb2(%17: i32):  // no predecessors
        ...
        %19 = arith.addi %arg0, %c4_i32_14 : i32
        "simt_step.yield"(%18#0) {fallthrough = false} : (i32) -> ()
      ^bb3(%20: i32):  // no predecessors
        %c0_i32_15 = arith.constant 0 : i32
        %21 = arith.cmpi ne, %arg2, %c0_i32_15 : i32
        %22 = "simt_step.if"(%21) ({
          %c4_i32_16 = arith.constant 4 : i32
    ...
    ^bb3(%10: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c2_i32_13, %19) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        "simt_step.yield"(%13#0) {fallthrough = false} : (i32) -> ()
      ^bb1(%14: i32):  // no predecessors
        ...
        ^bb1(%20: i32):  // no predecessors
          %c4_i32_14 = arith.constant 4 : i32
          %21 = arith.addi %arg0, %c4_i32_14 : i32
      ...
      ^bb2(%17: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32 = arith.constant 1 : i32
          %19 = arith.addi %arg7, %c1_i32 : i32
          "simt_step.yield"(%c4_i32_13, %19) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c0_i32_12 = arith.constant 0 : i32
        "simt_step.yield"(%18#0) {fallthrough = false} : (i32) -> ()
      }) {case_values = array<i64: 0, 1>, default_index = 1 : i64} : (i32, i32) -> i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %22 = arith.addi %c48_i32_8, %21 : i32
