  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%10: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %32 = arith.addi %31, %c1_i32_16 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c2_i32_15, %31) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb3(%14: i32):  // no predecessors
      ...
      ^bb1(%19: i32):  // no predecessors
        ...
        %20 = "simt_step.switch"(%arg3, %c3_i32_10) ({
        ^bb0(%arg6: i32):
          %c0_i32_16 = arith.constant 0 : i32
          "simt_step.yield"(%c0_i32_16) {fallthrough = false} : (i32) -> ()
        ^bb1(%26: i32):  // no predecessors
          %c1_i32_17 = arith.constant 1 : i32
          %27 = arith.addi %arg0, %c1_i32_17 : i32
          "simt_step.yield"(%27) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0>, default_index = 1 : i64} : (i32, i32) -> i32
        %c4_i32_11 = arith.constant 4 : i32
        %21 = arith.addi %arg0, %c4_i32_11 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %15 = arith.muli %arg4, %c4_i32_8 : i32
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %c1_i32_8 = arith.constant 1 : i32
        %16 = arith.addi %arg4, %c1_i32_8 : i32
