  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c4_i32_15, %28) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb2(%25: i32):  // no predecessors
        ...
        %26 = arith.cmpi ne, %arg2, %c0_i32_14 : i32
        %27 = "simt_step.if"(%26) ({
          %c0_i32_15 = arith.constant 0 : i32
          %28 = arith.addi %arg0, %c0_i32_15 : i32
    ...
    ^bb1(%15: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %24 = arith.addi %arg6, %c1_i32_13 : i32
        "simt_step.yield"(%22, %24) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
      %c1_i32 = arith.constant 1 : i32
    ...
    ^bb2(%17: i32):  // no predecessors
      ...
      %19 = "simt_step.if"(%18) ({
        ...
        %21 = arith.remsi %arg3, %c3_i32_11 : i32
        ...
        ^bb0(%arg5: i32):
          ...
          %23 = arith.addi %arg0, %c4_i32_12 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb1(%32: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %41 = arith.addi %arg5, %c1_i32_11 : i32
    ...
    ^bb1(%21: i32):  // no predecessors
      ...
      %25 = "simt_step.if"(%24) ({
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %34 = arith.addi %c48_i32_10, %33 : i32
