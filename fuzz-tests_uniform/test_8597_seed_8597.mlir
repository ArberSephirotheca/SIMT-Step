module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb3(%18: i32):  // no predecessors
        ...
        ^bb1(%23: i32):  // no predecessors
          ...
          %24 = arith.addi %arg0, %c0_i32_12 : i32
    ...
    ^bb1(%7: i32):  // no predecessors
      ...
      %9 = "simt_step.if"(%8) ({
        ...
        %14 = "simt_step.switch"(%13, %c3_i32_7) ({
        ^bb0(%arg5: i32):
    ...
    ^bb2(%10: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        %14 = "simt_step.switch"(%13, %c1_i32_7) ({
        ^bb0(%arg6: i32):
      ...
      ^bb1(%15: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %22 = arith.remsi %arg3, %c4_i32_16 : i32
          %c1_i32_17 = arith.constant 1 : i32
          %23 = arith.addi %22, %c1_i32_17 : i32
          %24 = arith.cmpi slt, %arg7, %23 : i32
          "simt_step.condition"(%24, %arg6, %arg7) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg6: i32, %arg7: i32):
          %c1_i32_16 = arith.constant 1 : i32
          %22 = arith.addi %arg7, %c1_i32_16 : i32
      ...
      ^bb3(%19: i32):  // no predecessors
        %c0_i32_14 = arith.constant 0 : i32
        %20 = arith.cmpi ne, %arg2, %c0_i32_14 : i32
        %21 = "simt_step.if"(%20) ({
          %c1_i32_16 = arith.constant 1 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    %14 = "simt_step.wave_count_bits"(%true_11) : (i1) -> i32
    "simt_step.buffer.store"(%arg0, %13, %14) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
    %c68_i32 = arith.constant 68 : i32
    %15 = arith.addi %c68_i32, %0 : i32
    %16 = "simt_step.buffer.load"(%arg1, %15) : (!simt_step.resource<Global, i32>, i32) -> i32
    %c0_i32_12 = arith.constant 0 : i32
    %17 = arith.cmpi ne, %16, %c0_i32_12 : i32
    %18 = "simt_step.if"(%17) ({
      ...
      ^bb0(%arg2: i32):
        %c0_i32_15 = arith.constant 0 : i32
        %c0_i32_16 = arith.constant 0 : i32
        %24:2 = "simt_step.loop"(%c0_i32_15, %c0_i32_16) ({
      ...
      %c0_i32_14 = arith.constant 0 : i32
      %c0_i32_15 = arith.constant 0 : i32
      %21:2 = "simt_step.loop"(%c0_i32_14, %c0_i32_15) ({
      ^bb0(%arg2: i32, %arg3: i32):
        %c4_i32_17 = arith.constant 4 : i32
        %22 = arith.muli %arg3, %c4_i32_17 : i32
        %23 = arith.addi %22, %0 : i32
        %c96_i32 = arith.constant 96 : i32
        %24 = arith.addi %c96_i32, %23 : i32
        %25 = "simt_step.buffer.load"(%arg1, %24) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_18 = arith.constant 0 : i32
        %26 = arith.cmpi ne, %25, %c0_i32_18 : i32
