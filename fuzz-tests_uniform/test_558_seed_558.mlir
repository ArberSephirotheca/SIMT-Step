  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %34 = arith.muli %arg5, %c4_i32_23 : i32
          %35 = arith.addi %34, %0 : i32
          %c16_i32_24 = arith.constant 16 : i32
          %36 = arith.addi %c16_i32_24, %35 : i32
          %37 = "simt_step.buffer.load"(%arg1, %36) : (!simt_step.resource<Global, i32>, i32) -> i32
          %c0_i32_25 = arith.constant 0 : i32
          %38 = arith.cmpi ne, %37, %c0_i32_25 : i32
      ...
      ^bb1(%30: i32):  // no predecessors
        ...
        %31:2 = "simt_step.loop"(%c0_i32_17, %c0_i32_18) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_23 = arith.constant 4 : i32
          %34 = arith.muli %arg5, %c4_i32_23 : i32
          %35 = arith.addi %34, %0 : i32
      ...
      ^bb2(%32: i32):  // no predecessors
        ...
        %33:2 = "simt_step.loop"(%c0_i32_20, %c0_i32_21) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_23 = arith.constant 4 : i32
          %34 = arith.muli %arg5, %c4_i32_23 : i32
          %35 = arith.addi %34, %0 : i32
    ...
    ^bb1(%22: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %30 = arith.addi %arg4, %c1_i32_14 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb1(%28: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_18 = arith.constant 4 : i32
          %33 = arith.muli %arg5, %c4_i32_18 : i32
          %34 = arith.addi %33, %0 : i32
          %c132_i32 = arith.constant 132 : i32
          %35 = arith.addi %c132_i32, %34 : i32
    ...
    ^bb1(%22: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %27 = arith.muli %arg6, %c4_i32_16 : i32
