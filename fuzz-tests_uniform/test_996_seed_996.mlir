module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      %8 = arith.addi %arg5, %c1_i32_6 : i32
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      ^bb0(%arg6: i32, %arg7: i32):
        ...
        ^bb0(%arg8: i32, %arg9: i32):
          ...
          %17 = arith.cmpi slt, %arg9, %16 : i32
          "simt_step.condition"(%17, %arg8, %arg9) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg8: i32, %arg9: i32):
          %c1_i32_11 = arith.constant 1 : i32
          %15 = arith.addi %arg9, %c1_i32_11 : i32
          "simt_step.yield"(%arg0, %15) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c3_i32 = arith.constant 3 : i32
        %13 = arith.addi %arg0, %c3_i32 : i32
        %c1_i32_10 = arith.constant 1 : i32
        %14 = arith.addi %arg7, %c1_i32_10 : i32
      ...
      "simt_step.yield"(%8#0, %11) : (i32, i32) -> ()
    }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb2(%25: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        %35 = arith.addi %c48_i32_13, %0 : i32
        %36 = "simt_step.buffer.load"(%arg1, %35) : (!simt_step.resource<Global, i32>, i32) -> i32
    ...
    ^bb3(%30: i32):  // no predecessors
      ...
      %31 = arith.addi %c64_i32_10, %0 : i32
      ...
      ^bb2(%38: i32):  // no predecessors
        ...
        %39:2 = "simt_step.loop"(%c0_i32_19, %c0_i32_20) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_22 = arith.constant 4 : i32
          %40 = arith.muli %arg5, %c4_i32_22 : i32
          %41 = arith.addi %40, %0 : i32
