  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb2(%7: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        %c4_i32_8 = arith.constant 4 : i32
        %15 = "simt_step.switch"(%14, %c4_i32_8) ({
        ^bb0(%arg6: i32):
        ...
        ^bb2(%23: i32):  // no predecessors
          ...
          %24 = arith.addi %arg0, %c1_i32_14 : i32
      ...
      ^bb3(%18: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c4_i32_12, %21) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      %10 = arith.addi %arg0, %c4_i32_6 : i32
    ...
    ^bb3(%11: i32):  // no predecessors
      ...
      ^bb2(%17: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c1_i32_14, %23) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32 = arith.constant 1 : i32
