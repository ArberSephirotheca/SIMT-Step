  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb1(%20: i32):  // no predecessors
        ...
        %21 = "simt_step.switch"(%arg3, %c3_i32_9) ({
        ^bb0(%arg6: i32):
      ...
      ^bb2(%23: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c0_i32_13, %25) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb3(%15: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %18 = "simt_step.switch"(%17, %c3_i32_8) ({
        ^bb0(%arg7: i32):
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb1(%18: i32):  // no predecessors
      ...
      ^bb1(%31: i32):  // no predecessors
        ...
        %32 = arith.addi %c16_i32_10, %0 : i32
    ...
    ^bb2(%23: i32):  // no predecessors
      ...
      %27 = "simt_step.if"(%26) ({
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %33 = arith.addi %c32_i32_14, %32 : i32
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %32 = arith.addi %arg4, %c1_i32_13 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %29 = arith.muli %arg6, %c4_i32_15 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %30 = arith.addi %arg6, %c1_i32_15 : i32
