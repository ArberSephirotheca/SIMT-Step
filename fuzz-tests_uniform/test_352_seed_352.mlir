  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        %20 = arith.addi %arg0, %c4_i32_4 : i32
    ...
    ^bb1(%10: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        %19 = "simt_step.if"(%18) ({
          ...
          %23 = arith.addi %arg0, %c0_i32_5 : i32
    ...
    ^bb2(%12: i32):  // no predecessors
      ...
      %14 = arith.addi %arg0, %c3_i32_1 : i32
      ...
      ^bb1(%20: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.break"(%c0_i32_8, %25) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
