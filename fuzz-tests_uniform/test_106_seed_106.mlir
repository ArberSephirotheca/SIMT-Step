module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      "simt_step.break"(%c0_i32_5, %10) : (i32, i32) -> ()
    }) : (i32, i32) -> (i32, i32)
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb1(%24: i32):  // no predecessors
        ...
        %25 = arith.remsi %arg3, %c2_i32_15 : i32
        %c1_i32_16 = arith.constant 1 : i32
        %26 = arith.addi %arg0, %c1_i32_16 : i32
      ...
      ^bb2(%28: i32):  // no predecessors
        ...
        %29 = arith.cmpi ne, %arg2, %c0_i32_17 : i32
        %30 = "simt_step.if"(%29) ({
    ...
    ^bb2(%15: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        %22 = "simt_step.if"(%21) ({
          ...
          %32 = arith.addi %arg0, %c2_i32_21 : i32
          "simt_step.yield"(%32) : (i32) -> ()
        }, {
          %c1_i32_21 = arith.constant 1 : i32
          %32 = arith.addi %arg0, %c1_i32_21 : i32
          "simt_step.yield"(%32) : (i32) -> ()
        }) : (i1) -> i32
      ...
      ^bb2(%25: i32):  // no predecessors
        ...
        %26 = arith.cmpi ne, %arg2, %c0_i32_16 : i32
        %27 = "simt_step.if"(%26) ({
          "simt_step.yield"(%arg0) : (i32) -> ()
        }, {
          "simt_step.yield"(%arg0) : (i32) -> ()
      ...
      ^bb3(%28: i32):  // no predecessors
        ...
        %29 = arith.remsi %arg3, %c2_i32_18 : i32
        %c0_i32_19 = arith.constant 0 : i32
        %30 = arith.addi %arg0, %c0_i32_19 : i32
        %31 = "simt_step.switch"(%29, %30) ({
        ^bb0(%arg6: i32):
          "simt_step.yield"(%arg0) {fallthrough = true} : (i32) -> ()
        ^bb1(%32: i32):  // no predecessors
          %c2_i32_21 = arith.constant 2 : i32
          %33 = arith.addi %arg0, %c2_i32_21 : i32
    ...
    ^bb3(%18: i32):  // no predecessors
      ...
      %19 = arith.remsi %arg3, %c3_i32_10 : i32
      %c3_i32_11 = arith.constant 3 : i32
      %20 = "simt_step.switch"(%19, %c3_i32_11) ({
      ^bb0(%arg5: i32):
        %c0_i32_13 = arith.constant 0 : i32
        %c0_i32_14 = arith.constant 0 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %31 = arith.remsi %arg3, %c4_i32_21 : i32
          %c1_i32_22 = arith.constant 1 : i32
          %32 = arith.addi %31, %c1_i32_22 : i32
          %33 = arith.cmpi slt, %arg7, %32 : i32
          "simt_step.condition"(%33, %arg6, %arg7) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg6: i32, %arg7: i32):
          %c0_i32_21 = arith.constant 0 : i32
          %31 = arith.addi %arg0, %c0_i32_21 : i32
          %c1_i32_22 = arith.constant 1 : i32
          %32 = arith.addi %arg7, %c1_i32_22 : i32
      ...
      ^bb1(%23: i32):  // no predecessors
        ...
        %24 = arith.remsi %arg3, %c4_i32_16 : i32
        %c4_i32_17 = arith.constant 4 : i32
        %25 = arith.addi %arg0, %c4_i32_17 : i32
        %26 = "simt_step.switch"(%24, %25) ({
        ^bb0(%arg6: i32):
          %c3_i32_21 = arith.constant 3 : i32
          %31 = arith.addi %arg0, %c3_i32_21 : i32
          "simt_step.yield"(%31) {fallthrough = false} : (i32) -> ()
        ^bb1(%32: i32):  // no predecessors
          "simt_step.yield"(%arg0) {fallthrough = false} : (i32) -> ()
        ...
        ^bb3(%34: i32):  // no predecessors
          ...
          %35 = arith.addi %arg0, %c1_i32_23 : i32
          "simt_step.yield"(%35) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1, 2>, default_index = 0 : i64} : (i32, i32) -> i32
        %c3_i32_18 = arith.constant 3 : i32
        %27 = arith.addi %arg0, %c3_i32_18 : i32
        "simt_step.yield"(%26) {fallthrough = false} : (i32) -> ()
      ^bb2(%28: i32):  // no predecessors
        %c0_i32_19 = arith.constant 0 : i32
        %29 = arith.cmpi ne, %arg2, %c0_i32_19 : i32
        %30 = "simt_step.if"(%29) ({
          %c1_i32_21 = arith.constant 1 : i32
    ...
    %6 = "simt_step.wave_count_bits"(%true_3) : (i1) -> i32
    ...
    ^bb1(%14: i32):  // no predecessors
      ...
      %18 = "simt_step.if"(%17) ({
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %26 = arith.addi %c32_i32_9, %25 : i32
