  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      ^bb0(%arg6: i32, %arg7: i32):
        ...
        %17 = arith.addi %arg7, %c1_i32_7 : i32
    ...
    ^bb2(%15: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          %c4_i32_14 = arith.constant 4 : i32
          %24 = arith.remsi %arg3, %c4_i32_14 : i32
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          %c1_i32_15 = arith.constant 1 : i32
          %24 = arith.addi %arg8, %c1_i32_15 : i32
          "simt_step.yield"(%c3_i32_14, %24) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c1_i32 = arith.constant 1 : i32
    ...
    ^bb3(%17: i32):  // no predecessors
      ...
      ^bb1(%24: i32):  // no predecessors
        ...
        %27 = arith.addi %arg0, %c0_i32_15 : i32
      ...
      ^bb2(%28: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32):
          ...
          %34 = arith.addi %arg0, %c1_i32_19 : i32
      ...
      ^bb3(%31: i32):  // no predecessors
        ...
        %32 = arith.cmpi ne, %arg2, %c0_i32_18 : i32
        %33 = "simt_step.if"(%32) ({
          %c0_i32_19 = arith.constant 0 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    %13 = "simt_step.if"(%12) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %19 = arith.addi %c32_i32_9, %18 : i32
