  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %10 = "simt_step.if"(%9) ({
        ...
        %18:2 = "simt_step.loop"(%c0_i32_12, %c0_i32_13) ({
        ^bb0(%arg5: i32, %arg6: i32):
          %c4_i32_15 = arith.constant 4 : i32
          %19 = arith.remsi %arg3, %c4_i32_15 : i32
          %c1_i32 = arith.constant 1 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %19 = arith.addi %arg0, %c2_i32_15 : i32
          %c1_i32 = arith.constant 1 : i32
    ...
    ^bb1(%11: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        "simt_step.break"(%c3_i32_12, %18) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
    ...
    ^bb2(%13: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          %c4_i32_15 = arith.constant 4 : i32
          %21 = arith.remsi %arg3, %c4_i32_15 : i32
          %c1_i32_16 = arith.constant 1 : i32
          %22 = arith.addi %21, %c1_i32_16 : i32
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          %c4_i32_15 = arith.constant 4 : i32
          %c1_i32_16 = arith.constant 1 : i32
          %21 = arith.addi %arg8, %c1_i32_16 : i32
          "simt_step.yield"(%c4_i32_15, %21) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %c0_i32_14 = arith.constant 0 : i32
        %19 = arith.addi %arg0, %c0_i32_14 : i32
        %c1_i32 = arith.constant 1 : i32
        %20 = arith.addi %arg6, %c1_i32 : i32
    ...
    ^bb3(%15: i32):  // no predecessors
      ...
      %16 = arith.remsi %arg3, %c3_i32_10 : i32
      %c3_i32_11 = arith.constant 3 : i32
      %17 = "simt_step.switch"(%16, %c3_i32_11) ({
      ^bb0(%arg5: i32):
        %c3_i32_12 = arith.constant 3 : i32
        %18 = arith.remsi %arg3, %c3_i32_12 : i32
        %c4_i32_13 = arith.constant 4 : i32
        %19 = "simt_step.switch"(%18, %c4_i32_13) ({
        ^bb0(%arg6: i32):
          %c3_i32_16 = arith.constant 3 : i32
          %27 = arith.addi %arg0, %c3_i32_16 : i32
        ...
        %20 = arith.addi %arg0, %c3_i32_14 : i32
        "simt_step.yield"(%19) {fallthrough = false} : (i32) -> ()
      ^bb1(%21: i32):  // no predecessors
        "simt_step.yield"(%arg0) {fallthrough = true} : (i32) -> ()
      ^bb2(%22: i32):  // no predecessors
        %c0_i32_15 = arith.constant 0 : i32
        %23 = arith.cmpi ne, %arg2, %c0_i32_15 : i32
        %24 = "simt_step.if"(%23) ({
    ...
    ^bb1(%10: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %26 = arith.addi %c32_i32_12, %25 : i32
        ...
        %23 = arith.addi %arg4, %c1_i32_10 : i32
