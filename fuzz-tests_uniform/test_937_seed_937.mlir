  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb1(%19: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %25 = arith.remsi %arg3, %c4_i32_16 : i32
          %c1_i32_17 = arith.constant 1 : i32
          %26 = arith.addi %25, %c1_i32_17 : i32
      ...
      ^bb3(%22: i32):  // no predecessors
        ...
        %24 = "simt_step.switch"(%23, %c4_i32_14) ({
        ^bb0(%arg6: i32):
        ...
        ^bb3(%28: i32):  // no predecessors
          ...
          %29 = arith.addi %arg0, %c2_i32_17 : i32
    ...
    ^bb1(%6: i32):  // no predecessors
      ...
      ^bb2(%18: i32):  // no predecessors
        ...
        %19 = arith.remsi %arg3, %c2_i32_10 : i32
        %c4_i32_11 = arith.constant 4 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb2(%27: i32):  // no predecessors
      ...
      ^bb2(%40: i32):  // no predecessors
        ...
        %43 = "simt_step.switch"(%42, %c0_i32_16) ({
        ^bb0(%arg4: i32):
          "simt_step.yield"(%0) {fallthrough = false} : (i32) -> ()
        ^bb1(%48: i32):  // no predecessors
          %c3_i32 = arith.constant 3 : i32
      ...
      ^bb3(%44: i32):  // no predecessors
        ...
        %45 = arith.addi %c148_i32, %0 : i32
        %46 = "simt_step.buffer.load"(%arg1, %45) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c4_i32_18 = arith.constant 4 : i32
        %47 = "simt_step.switch"(%46, %c4_i32_18) ({
        ^bb0(%arg4: i32):
          %c2_i32_20 = arith.constant 2 : i32
          "simt_step.yield"(%c2_i32_20) {fallthrough = false} : (i32) -> ()
        ^bb1(%48: i32):  // no predecessors
