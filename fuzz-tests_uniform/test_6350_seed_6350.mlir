module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      %c1_i32_9 = arith.constant 1 : i32
      %19 = arith.addi %arg5, %c1_i32_9 : i32
    ...
    %12 = "simt_step.if"(%11) ({
      ...
      %17 = arith.remsi %arg3, %c3_i32_9 : i32
      %c4_i32 = arith.constant 4 : i32
      ...
      ^bb1(%23: i32):  // no predecessors
        ...
        %25 = "simt_step.if"(%24) ({
          ...
          %34 = arith.addi %arg0, %c3_i32_20 : i32
          "simt_step.yield"(%34) : (i32) -> ()
        }) : (i1) -> i32
      ...
      ^bb2(%27: i32):  // no predecessors
        ...
        %28:2 = "simt_step.loop"(%c0_i32_15, %c0_i32_16) ({
        ^bb0(%arg5: i32, %arg6: i32):
          %c4_i32_20 = arith.constant 4 : i32
          %34 = arith.remsi %arg3, %c4_i32_20 : i32
          %c1_i32_21 = arith.constant 1 : i32
          %35 = arith.addi %34, %c1_i32_21 : i32
          %36 = arith.cmpi slt, %arg6, %35 : i32
          "simt_step.condition"(%36, %arg5, %arg6) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg5: i32, %arg6: i32):
          %c0_i32_20 = arith.constant 0 : i32
          %c1_i32_21 = arith.constant 1 : i32
          %34 = arith.addi %arg6, %c1_i32_21 : i32
          "simt_step.break"(%c0_i32_20, %34) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb3(%29: i32):  // no predecessors
        ...
        %33 = arith.addi %arg0, %c2_i32_19 : i32
      ...
      %18 = "simt_step.if"(%17) ({
        ...
        %20 = arith.remsi %arg3, %c3_i32_11 : i32
        ...
        ^bb1(%26: i32):  // no predecessors
          %c0_i32_13 = arith.constant 0 : i32
          %27 = arith.addi %arg0, %c0_i32_13 : i32
