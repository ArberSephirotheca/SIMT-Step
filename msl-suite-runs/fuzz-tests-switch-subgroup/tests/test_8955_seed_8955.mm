    ...
    case 1:
      ...
      switch (v61) {
        ...
        case 2:
          ...
          int v103 = 3;
          int v104 = v3 % v103;
          uint v105 = simt_subgroup_id(__simt_tid);
          int v106 = (int)(v105);
          int v107;
          v107 = v106;
          switch (v104) {
...
kernel void kernel_main(device int* v180 [[buffer(0)]], device int* v181 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v182 = static_cast<int>(__simt_tid3.x);
  int v183 = 0;
  int v184 = v183 + v182;
  int v185 = v181[v184];
  int v186 = 4;
  int v187 = v186 + v182;
  int v188 = v181[v187];
  helper0(v182, v180, v185, v188, static_cast<int>(__simt_tid3.x));
  int v189 = 8;
  int v190 = v189 + v182;
  int v191 = v181[v190];
  int v192 = 3;
