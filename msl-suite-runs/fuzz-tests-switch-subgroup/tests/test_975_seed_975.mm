...
kernel void kernel_main(device int* v177 [[buffer(0)]], device int* v178 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v179 = static_cast<int>(__simt_tid3.x);
  int v180 = 0;
  int v181 = v180 + v179;
  int v182 = v178[v181];
  int v183 = 4;
  int v184 = v183 + v179;
  int v185 = v178[v184];
  helper0(v179, v177, v182, v185, static_cast<int>(__simt_tid3.x));
  int v186 = 0;
  int v187 = 0;
  int v188;
  int v189;
