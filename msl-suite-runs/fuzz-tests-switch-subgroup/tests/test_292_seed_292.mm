...
inline void helper0(int v0, device int* v1, int v2, int v3, int __simt_tid){
  ...
  switch (v33) {
    ...
    default:
      ...
      if (v124) {
        ...
        int v144 = 3;
        int v145 = v3 % v144;
        uint v146 = simt_subgroup_id(__simt_tid);
        int v147 = (int)(v146);
        int v148;
        v148 = v147;
        switch (v145) {
  ...
  int v190 = 0;
  bool v191 = v2 != v190;
  int v192 = v191 ? v6 : v36;
  return;
}

kernel void kernel_main(device int* v193 [[buffer(0)]], device int* v194 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v195 = static_cast<int>(__simt_tid3.x);
  int v196 = 0;
  int v197 = v196 + v195;
  int v198 = v194[v197];
  int v199 = 4;
  int v200 = v199 + v195;
  int v201 = v194[v200];
  helper0(v195, v193, v198, v201, static_cast<int>(__simt_tid3.x));
  int v202 = 0;
  int v203 = 0;
  int v204;
  int v205;
