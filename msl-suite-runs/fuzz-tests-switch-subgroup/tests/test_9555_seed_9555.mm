...
kernel void kernel_main(device int* v51 [[buffer(0)]], device int* v52 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  ...
  switch (v217) {
    ...
    case 2:
      ...
      switch (v268) {
        ...
        default:
          {
          uint v290 = simt_lane_id(static_cast<int>(__simt_tid3.x));
          int v291 = (int)(v290);
          bool v292 = true;
          int v293 = 368;
          int v294 = v293 + v53;
  ...
  if (v376) {
    ...
    switch (v380) {
      ...
      case 1:
        ...
        if (v411) {
          ...
          uint v414 = simt_lane_id(static_cast<int>(__simt_tid3.x));
          int v415 = (int)(v414);
          v412 = v415;
        }
        int v416 = 512;
      ...
      default:
        ...
        int v425;
        if (v424) {
          uint v426 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
          int v427 = (int)(v426);
          v425 = v427;
        } else {
          v425 = v53;
    ...
    if (v441) {
      ...
      int v465;
      if (v464) {
        uint v466 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
        int v467 = (int)(v466);
        v465 = v467;
      } else {
        int v468 = 0;
