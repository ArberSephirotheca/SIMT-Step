...
kernel void kernel_main(device int* v63 [[buffer(0)]], device int* v64 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  ...
  switch (v334) {
    case 0:
      ...
      switch (v339) {
        ...
        case 2:
          ...
          int v389 = v388 + v65;
          int v390 = v64[v389];
          uint v391 = simt_lane_id(static_cast<int>(__simt_tid3.x));
          int v392 = (int)(v391);
          int v393;
          v393 = v392;
          switch (v390) {
            ...
            case 1:
              {
              uint v401 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
              int v402 = (int)(v401);
              v393 = v402;
              break;
            }
    ...
    default:
      {
      uint v502 = simt_lane_id(static_cast<int>(__simt_tid3.x));
      int v503 = (int)(v502);
      v336 = v503;
      break;
    }
