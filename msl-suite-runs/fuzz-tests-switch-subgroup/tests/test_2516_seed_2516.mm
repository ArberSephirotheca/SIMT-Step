...
inline void helper0(int v0, device int* v1, int v2, int v3, int __simt_tid){
  ...
  int v213 = 0;
  bool v214 = v2 != v213;
  int v215 = v214 ? v5 : v12;
  return;
}

kernel void kernel_main(device int* v216 [[buffer(0)]], device int* v217 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v218 = static_cast<int>(__simt_tid3.x);
  int v219 = 0;
  int v220 = v219 + v218;
  int v221 = v217[v220];
  int v222 = 4;
  int v223 = v222 + v218;
  int v224 = v217[v223];
  helper0(v218, v216, v221, v224, static_cast<int>(__simt_tid3.x));
  int v225 = 8;
  int v226 = v225 + v218;
  int v227 = v217[v226];
  int v228 = 0;
