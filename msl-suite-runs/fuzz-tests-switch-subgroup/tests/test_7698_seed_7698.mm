    ...
    default:
      ...
      switch (v141) {
        ...
        default:
          ...
          int v161 = 2;
          int v162 = v3 % v161;
          uint v163 = simt_lane_id(__simt_tid);
          int v164 = (int)(v163);
          int v165;
          v165 = v164;
          switch (v162) {
...
kernel void kernel_main(device int* v178 [[buffer(0)]], device int* v179 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v180 = static_cast<int>(__simt_tid3.x);
  int v181 = 0;
  int v182 = v181 + v180;
  int v183 = v179[v182];
  int v184 = 4;
  int v185 = v184 + v180;
  int v186 = v179[v185];
  helper0(v180, v178, v183, v186, static_cast<int>(__simt_tid3.x));
  int v187 = 8;
  int v188 = v187 + v180;
  int v189 = v179[v188];
  int v190 = 0;
