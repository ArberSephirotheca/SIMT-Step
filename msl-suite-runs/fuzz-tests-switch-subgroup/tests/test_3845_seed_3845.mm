...
inline void helper0(int v0, device int* v1, int v2, int v3, int __simt_tid){
  ...
  int v164 = 0;
  bool v165 = v2 != v164;
  int v166 = v165 ? v39 : v43;
  return;
}

kernel void kernel_main(device int* v167 [[buffer(0)]], device int* v168 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v169 = static_cast<int>(__simt_tid3.x);
  int v170 = 0;
  int v171 = v170 + v169;
  int v172 = v168[v171];
  int v173 = 4;
  int v174 = v173 + v169;
  int v175 = v168[v174];
  helper0(v169, v167, v172, v175, static_cast<int>(__simt_tid3.x));
  int v176 = 0;
  int v177 = 0;
  int v178;
  int v179;
  ...
  if (v205) {
    ...
    while (true) {
      ...
      switch (v306) {
        ...
        default:
          {
          uint v310 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
          int v311 = (int)(v310);
          bool v312 = true;
          int v313 = 368;
          int v314 = v313 + v169;
