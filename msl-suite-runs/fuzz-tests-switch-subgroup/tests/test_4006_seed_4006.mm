...
inline void helper0(int v0, device int* v1, int v2, int v3, int __simt_tid){
    ...
    case 1:
      ...
      switch (v130) {
        ...
        default:
          ...
          int v152 = 2;
          int v153 = v3 % v152;
          uint v154 = simt_lane_id(__simt_tid);
          int v155 = (int)(v154);
          int v156;
          v156 = v155;
          switch (v153) {
  ...
  int v173 = 0;
  bool v174 = v2 != v173;
  int v175 = v174 ? v42 : v45;
  return;
}

kernel void kernel_main(device int* v176 [[buffer(0)]], device int* v177 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v178 = static_cast<int>(__simt_tid3.x);
  int v179 = 0;
  int v180 = v179 + v178;
  int v181 = v177[v180];
  int v182 = 4;
  int v183 = v182 + v178;
  int v184 = v177[v183];
  helper0(v178, v176, v181, v184, static_cast<int>(__simt_tid3.x));
  int v185 = 8;
  int v186 = v185 + v178;
  int v187 = v177[v186];
  int v188 = 0;
