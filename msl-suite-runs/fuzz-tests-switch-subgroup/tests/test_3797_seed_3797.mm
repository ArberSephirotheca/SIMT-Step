  ...
  switch (v5) {
    ...
    case 0:
      ...
      switch (v28) {
        ...
        case 2:
          {
          uint v82 = simt_subgroup_id(__simt_tid);
          int v83 = (int)(v82);
          int v84;
          v84 = v83;
          switch (v3) {
    ...
    case 2:
      ...
      int v147 = 3;
      int v148 = v3 % v147;
      uint v149 = simt_lane_id(__simt_tid);
      int v150 = (int)(v149);
      int v151;
      v151 = v150;
      switch (v148) {
...
kernel void kernel_main(device int* v212 [[buffer(0)]], device int* v213 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  int v214 = static_cast<int>(__simt_tid3.x);
  int v215 = 0;
  int v216 = v215 + v214;
  int v217 = v213[v216];
  int v218 = 4;
  ...
  if (v222) {
    ...
    while (true) {
      ...
      helper0(v214, v212, v217, v220, static_cast<int>(__simt_tid3.x));
      int v238 = 1;
      int v239 = v226 + v238;
      v225 = v225;
      v226 = v239;
