...
kernel void kernel_main(device int* v47 [[buffer(0)]], device int* v48 [[buffer(1)]], uint3 __simt_tid3 [[thread_position_in_grid]], uint3 __simt_group_id [[threadgroup_position_in_grid]], uint3 __simt_local_tid [[thread_position_in_threadgroup]]){
  ...
  if (v262) {
    ...
    switch (v312) {
      case 0:
        ...
        int v316 = v315 + v49;
        int v317 = v48[v316];
        uint v318 = simt_lane_id(static_cast<int>(__simt_tid3.x));
        int v319 = (int)(v318);
        int v320;
        v320 = v319;
        switch (v317) {
          ...
          case 2:
            {
            uint v331 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
            int v332 = (int)(v331);
            v320 = v332;
            break;
          }
  ...
  switch (v383) {
    ...
    case 1:
      ...
      if (v427) {
        ...
        if (v433) {
          ...
          uint v435 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
          int v436 = (int)(v435);
          v434 = v436;
        }
        int v437 = 480;
    ...
    default:
      {
      uint v480 = simt_subgroup_id(static_cast<int>(__simt_tid3.x));
      int v481 = (int)(v480);
      v386 = v481;
      break;
    }
