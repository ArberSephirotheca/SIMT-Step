    ...
    ^bb1(%5: i32):  // no predecessors
      ...
      %7 = "simt_step.if"(%6) ({
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          "simt_step.yield"(%c2_i32_6, %14) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %43 = arith.addi %c16_i32_7, %42 : i32
    ...
    ^bb1(%22: i32):  // no predecessors
      ...
      %26 = "simt_step.if"(%25) ({
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %32 = arith.muli %arg4, %c4_i32_4 : i32
