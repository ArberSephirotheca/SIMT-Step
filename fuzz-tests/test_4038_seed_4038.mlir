module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb3(%10: i32):  // no predecessors
      ...
      %12 = "simt_step.switch"(%11, %c2_i32_1) ({
      ^bb0(%arg5: i32):
        %c2_i32_2 = arith.constant 2 : i32
      ...
      ^bb2(%16: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.continue"(%c0_i32_5, %19) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %32 = arith.addi %c32_i32_12, %31 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %31 = arith.addi %arg6, %c1_i32_11 : i32
    ...
    ^bb1(%23: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %43 = arith.addi %arg5, %c1_i32_9 : i32
          %true_10 = arith.constant true
    ...
    ^bb2(%27: i32):  // no predecessors
      ...
      %c4_i32_5 = arith.constant 4 : i32
      %30 = "simt_step.switch"(%29, %c4_i32_5) ({
      ^bb0(%arg3: i32):
