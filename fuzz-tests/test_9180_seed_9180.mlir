  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %18 = arith.muli %arg4, %c4_i32_4 : i32
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb1(%24: i32):  // no predecessors
          %c4_i32_4 = arith.constant 4 : i32
          %25 = arith.addi %0, %c4_i32_4 : i32
          "simt_step.yield"(%25) {fallthrough = false} : (i32) -> ()
        ^bb2(%26: i32):  // no predecessors
          %c3_i32_5 = arith.constant 3 : i32
          %27 = arith.addi %0, %c3_i32_5 : i32
    ...
    ^bb2(%21: i32):  // no predecessors
      ...
      ^bb2(%36: i32):  // no predecessors
        ...
        %39 = "simt_step.switch"(%38, %c4_i32_5) ({
        ^bb0(%arg4: i32):
          %c3_i32 = arith.constant 3 : i32
    ...
    ^bb3(%25: i32):  // no predecessors
      ...
      ^bb1(%34: i32):  // no predecessors
        %c0_i32_3 = arith.constant 0 : i32
        %c0_i32_4 = arith.constant 0 : i32
        %35:2 = "simt_step.loop"(%c0_i32_3, %c0_i32_4) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_7 = arith.constant 4 : i32
          %46 = arith.muli %arg5, %c4_i32_7 : i32
          %47 = arith.addi %46, %0 : i32
          %c128_i32 = arith.constant 128 : i32
          %48 = arith.addi %c128_i32, %47 : i32
          %49 = "simt_step.buffer.load"(%arg1, %48) : (!simt_step.resource<Global, i32>, i32) -> i32
          %c0_i32_8 = arith.constant 0 : i32
          %50 = arith.cmpi ne, %49, %c0_i32_8 : i32
      ...
      ^bb3(%41: i32):  // no predecessors
        ...
        %42 = arith.addi %c152_i32, %0 : i32
        %43 = "simt_step.buffer.load"(%arg1, %42) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_6 = arith.constant 0 : i32
        %44 = arith.cmpi ne, %43, %c0_i32_6 : i32
        %45 = "simt_step.if"(%44) ({
          %c1_i32 = arith.constant 1 : i32
          "simt_step.yield"(%c1_i32) : (i32) -> ()
        }, {
