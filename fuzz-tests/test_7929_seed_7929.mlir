module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %4 = "simt_step.switch"(%arg3, %c3_i32_0) ({
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c1_i32_6, %17) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb2(%7: i32):  // no predecessors
      ...
      ^bb1(%15: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32_7 = arith.constant 1 : i32
          %17 = arith.addi %arg7, %c1_i32_7 : i32
          "simt_step.yield"(%c3_i32_6, %17) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %25 = arith.muli %arg4, %c4_i32_3 : i32
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %28 = arith.muli %arg6, %c4_i32_5 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %29 = arith.addi %arg6, %c1_i32_5 : i32
    ...
    ^bb3(%21: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_6 = arith.constant 4 : i32
          %30 = arith.muli %arg5, %c4_i32_6 : i32
