module {
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %c0_i32_9 = arith.constant 0 : i32
      %9:2 = "simt_step.loop"(%c0_i32_8, %c0_i32_9) ({
      ^bb0(%arg4: i32, %arg5: i32):
        %c4_i32_12 = arith.constant 4 : i32
        %16 = arith.muli %arg5, %c4_i32_12 : i32
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %23 = arith.muli %arg7, %c4_i32_18 : i32
          %24 = arith.addi %23, %0 : i32
          %c108_i32 = arith.constant 108 : i32
          %25 = arith.addi %c108_i32, %24 : i32
          %26 = "simt_step.buffer.load"(%arg1, %25) : (!simt_step.resource<Global, i32>, i32) -> i32
          %c0_i32_19 = arith.constant 0 : i32
          %27 = arith.cmpi ne, %26, %c0_i32_19 : i32
          "simt_step.condition"(%27, %arg6, %arg7) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg6: i32, %arg7: i32):
          %23 = arith.addi %arg6, %arg7 : i32
          %c1_i32_18 = arith.constant 1 : i32
          %24 = arith.addi %arg7, %c1_i32_18 : i32
          %true_19 = arith.constant true
          %c64_i32 = arith.constant 64 : i32
          %c4_i32_20 = arith.constant 4 : i32
          %25 = arith.muli %arg7, %c4_i32_20 : i32
          %26 = arith.addi %c64_i32, %25 : i32
          %27 = arith.addi %26, %0 : i32
          %true_21 = arith.constant true
          %28 = "simt_step.wave_count_bits"(%true_21) : (i1) -> i32
        ...
        %19 = arith.muli %arg5, %c4_i32_16 : i32
        %20 = arith.addi %c80_i32, %19 : i32
        %21 = arith.addi %20, %0 : i32
        %true_17 = arith.constant true
        %22 = "simt_step.wave_count_bits"(%true_17) : (i1) -> i32
      ...
      %12 = arith.muli %arg3, %c4_i32_10 : i32
      %13 = arith.addi %c96_i32, %12 : i32
      %14 = arith.addi %13, %0 : i32
      %true_11 = arith.constant true
      %15 = "simt_step.wave_count_bits"(%true_11) : (i1) -> i32
