module {
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [64, 1, 1], simt.subgroup_width = 32 : i64} {
    ...
    %6 = "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %24 = arith.muli %arg5, %c64_i32_11 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %26 = arith.muli %arg5, %c64_i32_14 : i32
          %27 = arith.addi %c0_i32_13, %26 : i32
    ...
    %12 = "simt_step.if"(%11) ({
      ...
      ^bb0(%arg2: i32):
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %36 = arith.addi %c1280_i32_13, %35 : i32
      ...
      ^bb3(%30: i32):  // no predecessors
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %36 = arith.addi %c1664_i32, %35 : i32
          %37 = "simt_step.buffer.load"(%arg1, %36) : (!simt_step.resource<Global, i32>, i32) -> i32
          %c0_i32_13 = arith.constant 0 : i32
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %c64_i32 = arith.constant 64 : i32
          %36 = arith.muli %arg4, %c64_i32 : i32
          %37 = arith.addi %c2816_i32, %36 : i32
          %38 = arith.addi %37, %0 : i32
          %true_14 = arith.constant true
          %39 = "simt_step.wave_count_bits"(%true_14) : (i1) -> i32
          "simt_step.buffer.store"(%arg0, %38, %39) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %18 = arith.addi %c2176_i32, %17 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %19 = arith.addi %c4608_i32, %18 : i32
