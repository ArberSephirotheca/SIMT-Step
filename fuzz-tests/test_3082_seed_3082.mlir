  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb2(%27: i32):  // no predecessors
          ...
          %28 = arith.addi %arg0, %c1_i32_8 : i32
          "simt_step.yield"(%28) {fallthrough = true} : (i32) -> ()
        ^bb3(%29: i32):  // no predecessors
          %c0_i32_9 = arith.constant 0 : i32
          %30 = arith.addi %arg0, %c0_i32_9 : i32
    ...
    ^bb1(%9: i32):  // no predecessors
      ...
      ^bb1(%15: i32):  // no predecessors
        ...
        %17 = "simt_step.switch"(%16, %c1_i32_3) ({
        ^bb0(%arg6: i32):
    ...
    ^bb2(%12: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        %15 = "simt_step.switch"(%arg3, %c3_i32_1) ({
        ^bb0(%arg6: i32):
      ...
      ^bb1(%16: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.continue"(%c1_i32_4, %18) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    %8 = "simt_step.if"(%7) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %34 = arith.addi %c32_i32_13, %33 : i32
    ...
    %14 = "simt_step.if"(%13) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %27 = arith.addi %c80_i32_8, %26 : i32
        %28 = "simt_step.buffer.load"(%arg1, %27) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_9 = arith.constant 0 : i32
    ...
    ^bb1(%25: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %33 = arith.muli %arg4, %c4_i32_10 : i32
        %34 = arith.addi %33, %0 : i32
        %c144_i32_11 = arith.constant 144 : i32
        %35 = arith.addi %c144_i32_11, %34 : i32
        %36 = "simt_step.buffer.load"(%arg1, %35) : (!simt_step.resource<Global, i32>, i32) -> i32
