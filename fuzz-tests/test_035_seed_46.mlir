module {
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [64, 1, 1], simt.subgroup_width = 32 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb1(%32: i32):  // no predecessors
        ...
        ^bb1(%39: i32):  // no predecessors
          ...
          %40 = arith.addi %c256_i32_12, %0 : i32
    ...
    ^bb2(%22: i32):  // no predecessors
      ...
      %23:2 = "simt_step.loop"(%c0_i32_1, %c0_i32_2) ({
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %26 = arith.addi %c768_i32_5, %0 : i32
        %27 = "simt_step.buffer.load"(%arg1, %26) : (!simt_step.resource<Global, i32>, i32) -> i32
        ...
        %33 = arith.muli %arg4, %c64_i32_7 : i32
        %34 = arith.addi %c2304_i32, %33 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      %13 = arith.addi %0, %c0_i32_0 : i32
      %14 = "simt_step.switch"(%12, %13) ({
      ^bb0(%arg3: i32):
        %c960_i32 = arith.constant 960 : i32
        %26 = arith.addi %c960_i32, %0 : i32
        %27 = "simt_step.buffer.load"(%arg1, %26) : (!simt_step.resource<Global, i32>, i32) -> i32
      ...
      ^bb2(%37: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          %c64_i32 = arith.constant 64 : i32
          %39 = arith.muli %arg5, %c64_i32 : i32
          %40 = arith.addi %39, %0 : i32
          %c1024_i32 = arith.constant 1024 : i32
          %41 = arith.addi %c1024_i32, %40 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %42 = arith.addi %c3328_i32, %41 : i32
    ...
    ^bb1(%15: i32):  // no predecessors
      ...
      %19 = "simt_step.if"(%18) ({
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %29 = arith.addi %c1408_i32, %28 : i32
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %30 = arith.addi %c3584_i32, %29 : i32
