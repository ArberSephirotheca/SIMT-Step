module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %5 = arith.addi %arg0, %c2_i32_0 : i32
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c4_i32_10, %18) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb1(%13: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32 = arith.constant 1 : i32
          %18 = arith.addi %arg7, %c1_i32 : i32
          "simt_step.yield"(%c2_i32_10, %18) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb3(%16: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %c1_i32 = arith.constant 1 : i32
          %18 = arith.addi %arg7, %c1_i32 : i32
          "simt_step.yield"(%c0_i32_10, %18) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb1(%7: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %13 = "simt_step.switch"(%12, %c4_i32_5) ({
        ^bb0(%arg7: i32):
          "simt_step.yield"(%arg0) {fallthrough = false} : (i32) -> ()
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %28 = arith.addi %c16_i32_10, %27 : i32
    ...
    %17 = "simt_step.if"(%16) ({
      ...
      %23 = "simt_step.if"(%22) ({
        ...
        ^bb0(%arg2: i32, %arg3: i32):
          ...
          %29 = arith.muli %arg3, %c4_i32_11 : i32
        ...
        ^bb0(%arg2: i32, %arg3: i32):
          ...
          %29 = arith.muli %arg3, %c4_i32_12 : i32
          %30 = arith.addi %c64_i32_11, %29 : i32
          %31 = arith.addi %30, %0 : i32
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %21 = arith.addi %c128_i32_8, %0 : i32
