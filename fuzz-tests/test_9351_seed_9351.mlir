  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        ^bb0(%arg4: i32):
          ...
          %25 = arith.addi %arg4, %c3_i32_6 : i32
          "simt_step.yield"(%25) {fallthrough = false} : (i32) -> ()
        ^bb1(%26: i32):  // no predecessors
          %c3_i32_7 = arith.constant 3 : i32
          %27 = arith.addi %26, %c3_i32_7 : i32
        ...
        ^bb3(%30: i32):  // no predecessors
          ...
          %31 = arith.addi %30, %c4_i32_9 : i32
          "simt_step.yield"(%31) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1, 2>, default_index = 2 : i64} : (i32, i32) -> i32
        func.call @helper0(%0, %arg0, %2, %4) : (i32, !simt_step.resource<Global, i32>, i32, i32) -> ()
        %c1_i32_5 = arith.constant 1 : i32
        %24 = arith.addi %arg3, %c1_i32_5 : i32
    ...
    ^bb2(%20: i32):  // no predecessors
      ...
      ^bb3(%32: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %35 = arith.addi %arg5, %c1_i32_7 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      %22 = "simt_step.if"(%21) ({
        ...
        %30 = "simt_step.switch"(%29, %c1_i32_9) ({
        ^bb0(%arg3: i32):
    ...
    %16 = "simt_step.if"(%15) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %c1_i32_5 = arith.constant 1 : i32
        %21 = arith.addi %arg3, %c1_i32_5 : i32
