module {
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb1(%17: i32):  // no predecessors
      ...
      %18 = arith.addi %arg0, %c0_i32_4 : i32
      "simt_step.yield"(%18) {fallthrough = false} : (i32) -> ()
    }) {case_values = array<i64: 0>, default_index = 0 : i64} : (i32, i32) -> i32
    %true = arith.constant true
    %7 = "simt_step.wave_count_bits"(%true) : (i1) -> i32
    %c0_i32 = arith.constant 0 : i32
    %8 = arith.addi %c0_i32, %arg0 : i32
    ...
    ^bb0(%arg4: i32):
      ...
      %18 = "simt_step.switch"(%17, %c2_i32_5) ({
      ^bb0(%arg5: i32):
        %c3_i32 = arith.constant 3 : i32
        %28 = "simt_step.switch"(%arg3, %c3_i32) ({
        ^bb0(%arg6: i32):
      ...
      ^bb1(%30: i32):  // no predecessors
        ...
        %31 = arith.cmpi ne, %arg2, %c0_i32_11 : i32
        %32 = "simt_step.if"(%31) ({
      ...
      ^bb2(%33: i32):  // no predecessors
        ...
        %34 = arith.cmpi ne, %arg2, %c0_i32_12 : i32
        %35 = "simt_step.if"(%34) ({
          "simt_step.yield"(%arg0) : (i32) -> ()
        }, {
          "simt_step.yield"(%arg0) : (i32) -> ()
    ...
    ^bb1(%19: i32):  // no predecessors
      ...
      ^bb2(%31: i32):  // no predecessors
        %c0_i32_12 = arith.constant 0 : i32
        %32 = "simt_step.switch"(%arg3, %c0_i32_12) ({
        ^bb0(%arg6: i32):
          "simt_step.yield"(%arg0) {fallthrough = true} : (i32) -> ()
    ...
    ^bb2(%23: i32):  // no predecessors
      ...
      %25 = "simt_step.if"(%24) ({
        ...
        %29 = "simt_step.if"(%28) ({
          %c0_i32_12 = arith.constant 0 : i32
          %30 = arith.addi %arg0, %c0_i32_12 : i32
          "simt_step.yield"(%30) : (i32) -> ()
        }, {
          %c2_i32_12 = arith.constant 2 : i32
          %30 = arith.addi %arg0, %c2_i32_12 : i32
          "simt_step.yield"(%30) : (i32) -> ()
        }) : (i1) -> i32
    ...
    ^bb3(%26: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        %28 = arith.remsi %arg3, %c4_i32_11 : i32
        %c1_i32 = arith.constant 1 : i32
    ...
    %8 = "simt_step.if"(%7) ({
      ...
      ^bb1(%14: i32):  // no predecessors
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %23 = arith.addi %c16_i32_5, %22 : i32
