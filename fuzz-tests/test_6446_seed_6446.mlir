  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      %7 = "simt_step.if"(%6) ({
        ...
        %14 = arith.remsi %arg3, %c2_i32_3 : i32
        %c2_i32_4 = arith.constant 2 : i32
    ...
    ^bb1(%8: i32):  // no predecessors
      ...
      ^bb2(%16: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c3_i32, %18) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb2(%11: i32):  // no predecessors
      ...
      ^bb2(%19: i32):  // no predecessors
        ...
        %20 = arith.addi %arg0, %c2_i32_5 : i32
        "simt_step.yield"(%20) {fallthrough = false} : (i32) -> ()
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %21 = arith.remsi %0, %c4_i32_4 : i32
        %22 = simt_step.subgroup_id
        %23 = arith.index_cast %22 : index to i32
        %24 = "simt_step.switch"(%21, %23) ({
        ^bb0(%arg4: i32):
          %c0_i32_5 = arith.constant 0 : i32
          %26 = arith.addi %arg4, %c0_i32_5 : i32
          "simt_step.yield"(%26) {fallthrough = false} : (i32) -> ()
        ^bb1(%27: i32):  // no predecessors
          %c1_i32_6 = arith.constant 1 : i32
          %28 = arith.addi %27, %c1_i32_6 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %c1_i32_7 = arith.constant 1 : i32
          %29 = arith.addi %arg6, %c1_i32_7 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb1(%38: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %41 = arith.addi %arg5, %c1_i32_8 : i32
    ...
    ^bb2(%28: i32):  // no predecessors
      ...
      %31 = "simt_step.switch"(%30, %c4_i32_2) ({
      ^bb0(%arg3: i32):
    ...
    ^bb3(%32: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %35 = arith.addi %arg4, %c1_i32_5 : i32
        %true_6 = arith.constant true
