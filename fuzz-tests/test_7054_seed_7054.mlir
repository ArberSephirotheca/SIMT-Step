  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %16 = arith.cmpi slt, %arg3, %c2_i32_7 : i32
        "simt_step.condition"(%16, %arg2, %arg3) : (i1, i32, i32) -> ()
      }, {
      ^bb0(%arg2: i32, %arg3: i32):
        %c2_i32_7 = arith.constant 2 : i32
        %16 = arith.remsi %0, %c2_i32_7 : i32
        %c1_i32 = arith.constant 1 : i32
        %17 = "simt_step.switch"(%16, %c1_i32) ({
        ^bb0(%arg4: i32):
          %c4_i32_9 = arith.constant 4 : i32
          %19 = arith.addi %arg4, %c4_i32_9 : i32
          "simt_step.yield"(%19) {fallthrough = false} : (i32) -> ()
        ^bb1(%20: i32):  // no predecessors
          %c0_i32_10 = arith.constant 0 : i32
          %21 = arith.addi %20, %c0_i32_10 : i32
          "simt_step.yield"(%21) {fallthrough = false} : (i32) -> ()
        ^bb2(%22: i32):  // no predecessors
          %c4_i32_11 = arith.constant 4 : i32
          %23 = arith.addi %22, %c4_i32_11 : i32
          "simt_step.yield"(%23) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1>, default_index = 0 : i64} : (i32, i32) -> i32
        func.call @helper0(%0, %arg0, %2, %4) : (i32, !simt_step.resource<Global, i32>, i32, i32) -> ()
        %c1_i32_8 = arith.constant 1 : i32
        %18 = arith.addi %arg3, %c1_i32_8 : i32
