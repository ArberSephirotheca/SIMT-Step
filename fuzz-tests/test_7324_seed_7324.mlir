    ...
    ^bb1(%8: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c0_i32_9, %24) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb2(%12: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %28 = arith.addi %arg0, %c3_i32_10 : i32
          %c1_i32_11 = arith.constant 1 : i32
      ...
      ^bb2(%20: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32):
          ...
          %28 = arith.addi %arg0, %c2_i32_10 : i32
          "simt_step.yield"(%28) {fallthrough = false} : (i32) -> ()
        ^bb1(%29: i32):  // no predecessors
          "simt_step.yield"(%arg0) {fallthrough = false} : (i32) -> ()
        ^bb2(%30: i32):  // no predecessors
      ...
      ^bb3(%25: i32):  // no predecessors
        ...
        %26 = arith.remsi %arg3, %c2_i32_8 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %27 = arith.muli %arg7, %c4_i32_16 : i32
          %28 = arith.addi %27, %0 : i32
          %c48_i32_17 = arith.constant 48 : i32
          %29 = arith.addi %c48_i32_17, %28 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %29 = arith.muli %arg7, %c4_i32_18 : i32
          %30 = arith.addi %c16_i32, %29 : i32
          %31 = arith.addi %30, %0 : i32
          %true_19 = arith.constant true
          %32 = "simt_step.wave_count_bits"(%true_19) : (i1) -> i32
          "simt_step.buffer.store"(%arg0, %31, %32) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%27, %28) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %21 = arith.addi %arg4, %20#0 : i32
