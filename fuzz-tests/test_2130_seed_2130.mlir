  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb2(%15: i32):  // no predecessors
      ...
      %17 = "simt_step.if"(%16) ({
        ...
        %19 = "simt_step.switch"(%18, %c1_i32_5) ({
        ^bb0(%arg5: i32):
          %c4_i32 = arith.constant 4 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      "simt_step.if"(%12) ({
        ...
        ^bb0(%arg2: i32):
          %c0_i32_6 = arith.constant 0 : i32
          %15 = arith.addi %arg2, %c0_i32_6 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %13 = arith.addi %c32_i32_4, %12 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        %c4_i32_8 = arith.constant 4 : i32
        %13 = arith.muli %arg4, %c4_i32_8 : i32
        %14 = arith.addi %13, %0 : i32
        ...
        "simt_step.condition"(%17, %arg3, %arg4) : (i1, i32, i32) -> ()
      }, {
      ^bb0(%arg3: i32, %arg4: i32):
        %c0_i32_8 = arith.constant 0 : i32
        %c0_i32_9 = arith.constant 0 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %16 = arith.muli %arg6, %c4_i32_10 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          %16 = arith.addi %arg5, %arg6 : i32
          %c1_i32_10 = arith.constant 1 : i32
          %17 = arith.addi %arg6, %c1_i32_10 : i32
          %true_11 = arith.constant true
          "simt_step.yield"(%16, %17) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %14 = arith.addi %arg3, %13#0 : i32
        %c1_i32 = arith.constant 1 : i32
