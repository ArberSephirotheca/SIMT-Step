  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb2(%12: i32):  // no predecessors
      ...
      ^bb2(%20: i32):  // no predecessors
        ...
        %22 = "simt_step.switch"(%21, %c0_i32_9) ({
        ^bb0(%arg6: i32):
          %c2_i32_10 = arith.constant 2 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      "simt_step.if"(%11) ({
        ...
        ^bb0(%arg2: i32):
          ...
          %16 = arith.addi %arg2, %c1_i32_2 : i32
          "simt_step.yield"(%16) {fallthrough = false} : (i32) -> ()
        ^bb1(%17: i32):  // no predecessors
          %c4_i32_3 = arith.constant 4 : i32
          %18 = arith.addi %17, %c4_i32_3 : i32
    ...
    ^bb1(%9: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        %c4_i32_3 = arith.constant 4 : i32
        %11 = arith.muli %arg4, %c4_i32_3 : i32
        ...
        "simt_step.condition"(%15, %arg3, %arg4) : (i1, i32, i32) -> ()
      }, {
      ^bb0(%arg3: i32, %arg4: i32):
        %c0_i32_3 = arith.constant 0 : i32
        %c0_i32_4 = arith.constant 0 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          %14 = arith.addi %arg5, %arg6 : i32
          %c1_i32_6 = arith.constant 1 : i32
          %15 = arith.addi %arg6, %c1_i32_6 : i32
          %true_7 = arith.constant true
          "simt_step.yield"(%14, %15) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %12 = arith.addi %arg3, %11#0 : i32
        %c1_i32_5 = arith.constant 1 : i32
        %13 = arith.addi %arg4, %c1_i32_5 : i32
        %true = arith.constant true
