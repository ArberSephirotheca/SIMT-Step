  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.break"(%c1_i32_5, %16) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb2(%8: i32):  // no predecessors
      ...
      ^bb3(%15: i32):  // no predecessors
        ...
        %16 = "simt_step.switch"(%arg3, %c3_i32_4) ({
        ^bb0(%arg6: i32):
          "simt_step.yield"(%arg0) {fallthrough = false} : (i32) -> ()
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        %c1_i32_6 = arith.constant 1 : i32
        %15 = arith.cmpi slt, %arg3, %c1_i32_6 : i32
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        ^bb0(%arg4: i32):
          ...
          %18 = arith.addi %arg4, %c3_i32_8 : i32
        ...
        ^bb2(%21: i32):  // no predecessors
          ...
          %22 = arith.addi %21, %c0_i32_10 : i32
          "simt_step.yield"(%22) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1>, default_index = 0 : i64} : (i32, i32) -> i32
        func.call @helper0(%0, %arg0, %2, %4) : (i32, !simt_step.resource<Global, i32>, i32, i32) -> ()
        %c1_i32_7 = arith.constant 1 : i32
        %17 = arith.addi %arg3, %c1_i32_7 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb1(%25: i32):  // no predecessors
        ...
        %26 = arith.addi %c32_i32_11, %0 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          %c4_i32_13 = arith.constant 4 : i32
          %27 = arith.muli %arg6, %c4_i32_13 : i32
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %28 = arith.addi %arg6, %c1_i32_13 : i32
