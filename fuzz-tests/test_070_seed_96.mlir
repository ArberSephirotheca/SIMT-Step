module {
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [64, 1, 1], simt.subgroup_width = 32 : i64} {
    ...
    ^bb2(%17: i32):  // no predecessors
      ...
      %18 = arith.addi %c512_i32_6, %0 : i32
    ...
    ^bb3(%20: i32):  // no predecessors
      ...
      %23 = "simt_step.switch"(%22, %c2_i32_8) ({
      ^bb0(%arg3: i32):
      ...
      ^bb1(%26: i32):  // no predecessors
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %34 = arith.muli %arg5, %c64_i32_14 : i32
          %35 = arith.addi %34, %0 : i32
          %c128_i32_15 = arith.constant 128 : i32
          %36 = arith.addi %c128_i32_15, %35 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %36 = arith.muli %arg5, %c64_i32_15 : i32
          %37 = arith.addi %c768_i32, %36 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %28 = arith.addi %c1536_i32, %27 : i32
