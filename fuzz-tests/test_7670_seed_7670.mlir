module {
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      %7 = arith.addi %arg2, %0 : i32
      %c1_i32_4 = arith.constant 1 : i32
      %8 = arith.addi %arg3, %c1_i32_4 : i32
      %true = arith.constant true
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        %14 = arith.muli %arg5, %c4_i32_9 : i32
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %21 = arith.muli %arg7, %c4_i32_15 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %23 = arith.muli %arg7, %c4_i32_17 : i32
          %24 = arith.addi %c112_i32, %23 : i32
          %25 = arith.addi %24, %0 : i32
          %true_18 = arith.constant true
          %26 = "simt_step.wave_count_bits"(%true_18) : (i1) -> i32
          "simt_step.buffer.store"(%arg0, %25, %26) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
          "simt_step.yield"(%21, %22) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        %15 = arith.addi %arg4, %14#0 : i32
        %c1_i32_11 = arith.constant 1 : i32
        %16 = arith.addi %arg5, %c1_i32_11 : i32
        %true_12 = arith.constant true
        %c128_i32 = arith.constant 128 : i32
        %c4_i32_13 = arith.constant 4 : i32
        %17 = arith.muli %arg5, %c4_i32_13 : i32
        %18 = arith.addi %c128_i32, %17 : i32
        %19 = arith.addi %18, %0 : i32
        %true_14 = arith.constant true
        %20 = "simt_step.wave_count_bits"(%true_14) : (i1) -> i32
        "simt_step.buffer.store"(%arg0, %19, %20) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
        "simt_step.yield"(%15, %16) : (i32, i32) -> ()
      }) : (i32, i32) -> (i32, i32)
      %8 = arith.addi %arg2, %7#0 : i32
      %c1_i32_6 = arith.constant 1 : i32
      %9 = arith.addi %arg3, %c1_i32_6 : i32
      %true = arith.constant true
      %c144_i32 = arith.constant 144 : i32
      %c4_i32_7 = arith.constant 4 : i32
      %10 = arith.muli %arg3, %c4_i32_7 : i32
