  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %27 = arith.addi %arg7, %c1_i32_9 : i32
      ...
      ^bb1(%17: i32):  // no predecessors
        ...
        ^bb3(%31: i32):  // no predecessors
          ...
          %32 = arith.addi %arg0, %c4_i32_11 : i32
      ...
      ^bb3(%24: i32):  // no predecessors
        ...
        %26 = "simt_step.if"(%25) ({
          %c4_i32_9 = arith.constant 4 : i32
          %27 = arith.addi %arg0, %c4_i32_9 : i32
          "simt_step.yield"(%27) : (i32) -> ()
        }, {
          %c1_i32_9 = arith.constant 1 : i32
          %27 = arith.addi %arg0, %c1_i32_9 : i32
          "simt_step.yield"(%27) : (i32) -> ()
        }) : (i1) -> i32
    ...
    ^bb1(%7: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.yield"(%c3_i32_8, %25) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        "simt_step.yield"(%16#0) {fallthrough = false} : (i32) -> ()
      ^bb1(%17: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %25 = arith.addi %arg7, %c1_i32_8 : i32
      ...
      ^bb2(%19: i32):  // no predecessors
        ...
        %21 = "simt_step.if"(%20) ({
          %c3_i32_8 = arith.constant 3 : i32
          %25 = arith.addi %arg0, %c3_i32_8 : i32
    ...
    ^bb3(%13: i32):  // no predecessors
      ...
      %15 = "simt_step.if"(%14) ({
        ...
        %17 = arith.addi %arg0, %c1_i32_3 : i32
