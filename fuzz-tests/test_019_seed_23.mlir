  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [64, 1, 1], simt.subgroup_width = 32 : i64} {
    ...
    %6 = "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32):
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %33 = arith.muli %arg4, %c64_i32_10 : i32
          %34 = arith.addi %33, %0 : i32
          %c128_i32_11 = arith.constant 128 : i32
          %35 = arith.addi %c128_i32_11, %34 : i32
        ...
        ^bb0(%arg3: i32, %arg4: i32):
          ...
          %35 = arith.muli %arg4, %c64_i32_12 : i32
          %36 = arith.addi %c0_i32_11, %35 : i32
      ...
      ^bb2(%26: i32):  // no predecessors
        ...
        %31 = arith.addi %c512_i32_8, %0 : i32
    ...
    %12 = "simt_step.if"(%11) ({
      ...
      %21 = "simt_step.if"(%20) ({
        ...
        %28 = arith.addi %c1024_i32_6, %0 : i32
        %true_7 = arith.constant true
        ...
        ^bb0(%arg2: i32, %arg3: i32):
          %c64_i32 = arith.constant 64 : i32
          %25 = arith.muli %arg3, %c64_i32 : i32
        ...
        ^bb0(%arg2: i32, %arg3: i32):
          ...
          %c64_i32 = arith.constant 64 : i32
          %27 = arith.muli %arg3, %c64_i32 : i32
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %25 = arith.addi %c1088_i32, %24 : i32
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %28 = arith.addi %c2048_i32, %27 : i32
        %29 = arith.addi %28, %0 : i32
        %true_10 = arith.constant true
    ...
    ^bb1(%21: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %25 = arith.addi %c1408_i32, %24 : i32
        %26 = "simt_step.buffer.load"(%arg1, %25) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_9 = arith.constant 0 : i32
        %27 = arith.cmpi ne, %26, %c0_i32_9 : i32
        "simt_step.condition"(%27, %arg3, %arg4) : (i1, i32, i32) -> ()
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %26 = arith.addi %c2560_i32, %25 : i32
