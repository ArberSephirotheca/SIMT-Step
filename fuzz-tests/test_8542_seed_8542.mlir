  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32):
        ...
        %20 = "simt_step.if"(%19) ({
          ...
          %29 = arith.addi %arg0, %c0_i32_8 : i32
      ...
      ^bb1(%21: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %29 = arith.addi %arg7, %c1_i32_8 : i32
    ...
    ^bb2(%12: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        %20 = arith.addi %arg0, %c1_i32_4 : i32
        %21 = "simt_step.switch"(%19, %20) ({
        ^bb0(%arg6: i32):
          %c0_i32_10 = arith.constant 0 : i32
          %29 = arith.addi %arg0, %c0_i32_10 : i32
        ...
        ^bb3(%32: i32):  // no predecessors
          ...
          %33 = arith.addi %arg0, %c1_i32_13 : i32
          "simt_step.yield"(%33) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1, 2>, default_index = 1 : i64} : (i32, i32) -> i32
        "simt_step.yield"(%21) {fallthrough = false} : (i32) -> ()
      ^bb1(%22: i32):  // no predecessors
        %c2_i32_5 = arith.constant 2 : i32
        %23 = arith.remsi %arg3, %c2_i32_5 : i32
        %c2_i32_6 = arith.constant 2 : i32
        %24 = "simt_step.switch"(%23, %c2_i32_6) ({
        ^bb0(%arg6: i32):
          %c2_i32_10 = arith.constant 2 : i32
          %29 = arith.addi %arg0, %c2_i32_10 : i32
          "simt_step.yield"(%29) {fallthrough = true} : (i32) -> ()
        ^bb1(%30: i32):  // no predecessors
          %c2_i32_11 = arith.constant 2 : i32
          %31 = arith.addi %arg0, %c2_i32_11 : i32
      ...
      ^bb2(%25: i32):  // no predecessors
        ...
        %26 = arith.remsi %arg3, %c3_i32_7 : i32
        %c1_i32_8 = arith.constant 1 : i32
        %27 = arith.addi %arg0, %c1_i32_8 : i32
        ...
        ^bb2(%30: i32):  // no predecessors
          ...
          %31 = arith.addi %arg0, %c4_i32_11 : i32
    ...
    ^bb3(%16: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        %20 = "simt_step.if"(%19) ({
          %c0_i32_8 = arith.constant 0 : i32
          %28 = arith.addi %arg0, %c0_i32_8 : i32
      ...
      ^bb1(%21: i32):  // no predecessors
        %c0_i32_4 = arith.constant 0 : i32
        %22 = "simt_step.switch"(%arg3, %c0_i32_4) ({
        ^bb0(%arg6: i32):
          %c0_i32_8 = arith.constant 0 : i32
          %28 = arith.addi %arg0, %c0_i32_8 : i32
      ...
      ^bb2(%23: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          %c1_i32_8 = arith.constant 1 : i32
          %28 = arith.addi %arg7, %c1_i32_8 : i32
          "simt_step.yield"(%arg0, %28) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        "simt_step.yield"(%24#0) {fallthrough = false} : (i32) -> ()
      ^bb3(%25: i32):  // no predecessors
        %c2_i32_7 = arith.constant 2 : i32
        %26 = arith.addi %arg0, %c2_i32_7 : i32
