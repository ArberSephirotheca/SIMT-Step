    ...
    ^bb0(%arg4: i32, %arg5: i32):
      ...
      ^bb1(%12: i32):  // no predecessors
        ...
        ^bb1(%20: i32):  // no predecessors
          ...
          %21 = arith.addi %arg0, %c0_i32_9 : i32
      ...
      ^bb2(%15: i32):  // no predecessors
        ...
        ^bb0(%arg7: i32, %arg8: i32):
          ...
          "simt_step.continue"(%c0_i32_8, %19) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
