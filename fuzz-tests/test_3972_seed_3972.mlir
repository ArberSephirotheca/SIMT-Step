  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32):
      ...
      ^bb2(%38: i32):  // no predecessors
        %c0_i32_2 = arith.constant 0 : i32
        %c0_i32_3 = arith.constant 0 : i32
        %39:2 = "simt_step.loop"(%c0_i32_2, %c0_i32_3) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_5 = arith.constant 4 : i32
          %41 = arith.muli %arg5, %c4_i32_5 : i32
          %42 = arith.addi %41, %0 : i32
          %c40_i32 = arith.constant 40 : i32
          %43 = arith.addi %c40_i32, %42 : i32
          %44 = "simt_step.buffer.load"(%arg1, %43) : (!simt_step.resource<Global, i32>, i32) -> i32
          %c0_i32_6 = arith.constant 0 : i32
          %45 = arith.cmpi ne, %44, %c0_i32_6 : i32
          "simt_step.condition"(%45, %arg4, %arg5) : (i1, i32, i32) -> ()
        }, {
        ^bb0(%arg4: i32, %arg5: i32):
          %41 = arith.addi %arg4, %arg5 : i32
          %c1_i32_5 = arith.constant 1 : i32
          %42 = arith.addi %arg5, %c1_i32_5 : i32
    ...
    ^bb1(%21: i32):  // no predecessors
      ...
      ^bb1(%34: i32):  // no predecessors
        ...
        %36 = "simt_step.buffer.load"(%arg1, %35) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_2 = arith.constant 0 : i32
        %37 = arith.cmpi ne, %36, %c0_i32_2 : i32
        %38 = "simt_step.if"(%37) ({
          %c3_i32 = arith.constant 3 : i32
          "simt_step.yield"(%c3_i32) : (i32) -> ()
        }, {
          %c0_i32_3 = arith.constant 0 : i32
          %43 = arith.addi %0, %c0_i32_3 : i32
          "simt_step.yield"(%43) : (i32) -> ()
        }) : (i1) -> i32
    ...
    ^bb2(%25: i32):  // no predecessors
      ...
      ^bb0(%arg3: i32, %arg4: i32):
        ...
        %34 = arith.addi %arg4, %c1_i32_4 : i32
