    ...
    ^bb0(%arg4: i32):
      ...
      ^bb1(%19: i32):  // no predecessors
        ...
        ^bb2(%30: i32):  // no predecessors
          ...
          %31 = arith.addi %arg0, %c3_i32_13 : i32
      ...
      ^bb3(%24: i32):  // no predecessors
        ...
        ^bb2(%28: i32):  // no predecessors
          ...
          %29 = arith.addi %arg0, %c2_i32_13 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        %c2_i32 = arith.constant 2 : i32
        %8 = arith.cmpi slt, %arg3, %c2_i32 : i32
        "simt_step.condition"(%8, %arg2, %arg3) : (i1, i32, i32) -> ()
      }, {
      ^bb0(%arg2: i32, %arg3: i32):
        %c4_i32_5 = arith.constant 4 : i32
        %8 = arith.remsi %0, %c4_i32_5 : i32
        %9 = simt_step.subgroup_id
        %10 = arith.index_cast %9 : index to i32
        %11 = "simt_step.switch"(%8, %10) ({
        ^bb0(%arg4: i32):
          %c4_i32_6 = arith.constant 4 : i32
          %13 = arith.addi %arg4, %c4_i32_6 : i32
        ...
        ^bb2(%16: i32):  // no predecessors
          %c4_i32_7 = arith.constant 4 : i32
          %17 = arith.addi %16, %c4_i32_7 : i32
          "simt_step.yield"(%17) {fallthrough = false} : (i32) -> ()
        ^bb3(%18: i32):  // no predecessors
          %c2_i32_8 = arith.constant 2 : i32
          %19 = arith.addi %18, %c2_i32_8 : i32
          "simt_step.yield"(%19) {fallthrough = false} : (i32) -> ()
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb0(%arg4: i32):
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %25 = arith.addi %c32_i32_10, %24 : i32
