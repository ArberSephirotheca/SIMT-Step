module {
    ...
    ^bb2(%10: i32):  // no predecessors
      ...
      %12 = "simt_step.if"(%11) ({
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          "simt_step.continue"(%c1_i32_7, %18) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
        "simt_step.yield"(%17#0) : (i32) -> ()
      }) : (i1) -> i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb3(%35: i32):  // no predecessors
      ...
      %38 = "simt_step.switch"(%37, %c4_i32_4) ({
      ^bb0(%arg3: i32):
      ...
      ^bb3(%49: i32):  // no predecessors
        %c0_i32_8 = arith.constant 0 : i32
        %c0_i32_9 = arith.constant 0 : i32
        %50:2 = "simt_step.loop"(%c0_i32_8, %c0_i32_9) ({
        ^bb0(%arg4: i32, %arg5: i32):
          %c4_i32_10 = arith.constant 4 : i32
          %51 = arith.muli %arg5, %c4_i32_10 : i32
          %52 = arith.addi %51, %0 : i32
          %c124_i32 = arith.constant 124 : i32
          %53 = arith.addi %c124_i32, %52 : i32
          %54 = "simt_step.buffer.load"(%arg1, %53) : (!simt_step.resource<Global, i32>, i32) -> i32
          %c0_i32_11 = arith.constant 0 : i32
          %55 = arith.cmpi ne, %54, %c0_i32_11 : i32
