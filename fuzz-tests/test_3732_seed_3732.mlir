  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb1(%13: i32):  // no predecessors
        ...
        %15 = arith.addi %arg0, %c4_i32_2 : i32
      ...
      ^bb2(%17: i32):  // no predecessors
        ...
        %19 = "simt_step.switch"(%18, %c0_i32_4) ({
        ^bb0(%arg6: i32):
        ...
        ^bb1(%25: i32):  // no predecessors
          ...
          %26 = arith.addi %arg0, %c1_i32_7 : i32
    ...
    ^bb2(%9: i32):  // no predecessors
      ...
      %10 = arith.remsi %arg3, %c4_i32_0 : i32
      %c2_i32 = arith.constant 2 : i32
      %11 = "simt_step.switch"(%10, %c2_i32) ({
      ^bb0(%arg5: i32):
        %c2_i32_1 = arith.constant 2 : i32
        %13 = arith.remsi %arg3, %c2_i32_1 : i32
        %14 = "simt_step.switch"(%13, %arg0) ({
        ^bb0(%arg6: i32):
          %c3_i32_6 = arith.constant 3 : i32
          %26 = arith.addi %arg0, %c3_i32_6 : i32
          "simt_step.yield"(%26) {fallthrough = false} : (i32) -> ()
      ...
      ^bb2(%18: i32):  // no predecessors
        %c2_i32_3 = arith.constant 2 : i32
        %19 = arith.remsi %arg3, %c2_i32_3 : i32
        %c1_i32 = arith.constant 1 : i32
        %20 = arith.addi %arg0, %c1_i32 : i32
        %21 = "simt_step.switch"(%19, %20) ({
        ^bb0(%arg6: i32):
          %c0_i32_6 = arith.constant 0 : i32
          %26 = arith.addi %arg0, %c0_i32_6 : i32
          "simt_step.yield"(%26) {fallthrough = false} : (i32) -> ()
        ^bb1(%27: i32):  // no predecessors
          %c1_i32_7 = arith.constant 1 : i32
          %28 = arith.addi %arg0, %c1_i32_7 : i32
          "simt_step.yield"(%28) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0>, default_index = 1 : i64} : (i32, i32) -> i32
        %c0_i32_4 = arith.constant 0 : i32
        %22 = arith.addi %arg0, %c0_i32_4 : i32
        "simt_step.yield"(%21) {fallthrough = true} : (i32) -> ()
      ^bb3(%23: i32):  // no predecessors
        %c2_i32_5 = arith.constant 2 : i32
        %24 = arith.remsi %arg3, %c2_i32_5 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb1(%17: i32):  // no predecessors
        ...
        %20 = "simt_step.switch"(%19, %c4_i32_8) ({
        ^bb0(%arg5: i32):
          %c0_i32_9 = arith.constant 0 : i32
          %21 = arith.addi %0, %c0_i32_9 : i32
