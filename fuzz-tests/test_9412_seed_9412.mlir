    ...
    ^bb0(%arg4: i32):
      ...
      ^bb1(%19: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %25 = arith.addi %arg0, %c1_i32_9 : i32
          %c1_i32_10 = arith.constant 1 : i32
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [4, 1, 1], simt.subgroup_width = 8 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        %c2_i32 = arith.constant 2 : i32
        %17 = arith.cmpi slt, %arg3, %c2_i32 : i32
        "simt_step.condition"(%17, %arg2, %arg3) : (i1, i32, i32) -> ()
      }, {
      ^bb0(%arg2: i32, %arg3: i32):
        %c4_i32_5 = arith.constant 4 : i32
        %17 = arith.remsi %0, %c4_i32_5 : i32
        %c4_i32_6 = arith.constant 4 : i32
        %18 = "simt_step.switch"(%17, %c4_i32_6) ({
        ^bb0(%arg4: i32):
          %c0_i32_7 = arith.constant 0 : i32
          %20 = arith.addi %arg4, %c0_i32_7 : i32
          "simt_step.yield"(%20) {fallthrough = false} : (i32) -> ()
        ^bb1(%21: i32):  // no predecessors
          %c4_i32_8 = arith.constant 4 : i32
          %22 = arith.addi %21, %c4_i32_8 : i32
          "simt_step.yield"(%22) {fallthrough = false} : (i32) -> ()
        ^bb2(%23: i32):  // no predecessors
          %c4_i32_9 = arith.constant 4 : i32
          %24 = arith.addi %23, %c4_i32_9 : i32
