  ...
  func.func @helper0(%arg0: i32, %arg1: !simt_step.resource<Global, i32>, %arg2: i32, %arg3: i32) {
    ...
    %1 = "simt_step.if"(%0) ({
      ...
      ^bb0(%arg4: i32):
        ...
        "simt_step.yield"(%c1_i32_1) {fallthrough = true} : (i32) -> ()
    ...
    ^bb0(%arg4: i32):
      ...
      ^bb0(%arg5: i32, %arg6: i32):
        ...
        ^bb2(%26: i32):  // no predecessors
          ...
          %27 = arith.addi %arg0, %c0_i32_7 : i32
          "simt_step.yield"(%27) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1>, default_index = 0 : i64} : (i32, i32) -> i32
        %c1_i32_5 = arith.constant 1 : i32
        %23 = arith.addi %arg6, %c1_i32_5 : i32
    ...
    ^bb1(%11: i32):  // no predecessors
      ...
      %13 = "simt_step.if"(%12) ({
        ...
        ^bb0(%arg5: i32):
          ...
          %23 = arith.addi %arg0, %c0_i32_6 : i32
          "simt_step.yield"(%23) {fallthrough = false} : (i32) -> ()
        ^bb1(%24: i32):  // no predecessors
          %c4_i32_7 = arith.constant 4 : i32
          %25 = arith.addi %arg0, %c4_i32_7 : i32
    ...
    ^bb2(%14: i32):  // no predecessors
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32):
          ...
          %31 = arith.addi %arg0, %c2_i32_12 : i32
          "simt_step.yield"(%31) {fallthrough = false} : (i32) -> ()
        ^bb1(%32: i32):  // no predecessors
          "simt_step.yield"(%arg0) {fallthrough = true} : (i32) -> ()
        ^bb2(%33: i32):  // no predecessors
          %c2_i32_13 = arith.constant 2 : i32
          %34 = arith.addi %arg0, %c2_i32_13 : i32
      ...
      ^bb1(%24: i32):  // no predecessors
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %31 = arith.remsi %arg3, %c4_i32_12 : i32
          %c1_i32_13 = arith.constant 1 : i32
          %32 = arith.addi %31, %c1_i32_13 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.continue"(%c0_i32_12, %31) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
      ...
      ^bb3(%28: i32):  // no predecessors
        ...
        ^bb3(%33: i32):  // no predecessors
          ...
          %34 = arith.addi %arg0, %c3_i32_12 : i32
          "simt_step.yield"(%34) {fallthrough = false} : (i32) -> ()
        }) {case_values = array<i64: 0, 1, 2>, default_index = 2 : i64} : (i32, i32) -> i32
    ...
    ^bb3(%18: i32):  // no predecessors
      ...
      %19 = arith.addi %arg0, %c1_i32_4 : i32
      ...
      ^bb0(%arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          "simt_step.continue"(%c3_i32_7, %23) : (i32, i32) -> ()
        }) : (i32, i32) -> (i32, i32)
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb1(%22: i32):  // no predecessors
        ...
        ^bb0(%arg5: i32, %arg6: i32):
          ...
          %c1_i32_8 = arith.constant 1 : i32
          %30 = arith.addi %arg6, %c1_i32_8 : i32
