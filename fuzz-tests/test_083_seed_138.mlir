  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [64, 1, 1], simt.subgroup_width = 32 : i64} {
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        %18 = arith.muli %arg5, %c64_i32_8 : i32
      ...
      ^bb0(%arg4: i32, %arg5: i32):
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %25 = arith.muli %arg7, %c64_i32_14 : i32
          %26 = arith.addi %25, %0 : i32
          %c1088_i32 = arith.constant 1088 : i32
          %27 = arith.addi %c1088_i32, %26 : i32
        ...
        ^bb0(%arg6: i32, %arg7: i32):
          ...
          %27 = arith.muli %arg7, %c64_i32_16 : i32
        ...
        %21 = arith.muli %arg5, %c64_i32_12 : i32
      ...
      %15 = arith.addi %c1536_i32, %14 : i32
