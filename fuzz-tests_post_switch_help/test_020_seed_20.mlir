  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [64, 1, 1], simt.subgroup_width = 32 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        ^bb1(%20: i32):  // no predecessors
          ...
          %21 = arith.addi %20, %c0_i32_8 : i32
          "simt_step.yield"(%21) {fallthrough = false} : (i32) -> ()
        ^bb2(%22: i32):  // no predecessors
          %c2_i32_9 = arith.constant 2 : i32
          %23 = arith.addi %22, %c2_i32_9 : i32
          "simt_step.yield"(%23) {fallthrough = false} : (i32) -> ()
        ^bb3(%24: i32):  // no predecessors
          %c3_i32_10 = arith.constant 3 : i32
          %25 = arith.addi %24, %c3_i32_10 : i32
    ...
    %9 = "simt_step.if"(%8) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %15 = arith.muli %arg3, %c64_i32_8 : i32
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %22 = arith.muli %arg5, %c64_i32_13 : i32
          %23 = arith.addi %22, %0 : i32
          %c512_i32_14 = arith.constant 512 : i32
          %24 = arith.addi %c512_i32_14, %23 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %24 = arith.muli %arg5, %c64_i32_15 : i32
        ...
        %18 = arith.muli %arg3, %c64_i32_11 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %16 = arith.addi %c1152_i32, %15 : i32
      %17 = "simt_step.buffer.load"(%arg1, %16) : (!simt_step.resource<Global, i32>, i32) -> i32
      %c0_i32_7 = arith.constant 0 : i32
      %18 = arith.cmpi ne, %17, %c0_i32_7 : i32
      "simt_step.condition"(%18, %arg2, %arg3) : (i1, i32, i32) -> ()
