module {
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [64, 1, 1], simt.subgroup_width = 32 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        %c3_i32_6 = arith.constant 3 : i32
        %15 = "simt_step.switch"(%0, %c3_i32_6) ({
        ^bb0(%arg4: i32):
          %c4_i32 = arith.constant 4 : i32
          %17 = arith.addi %arg4, %c4_i32 : i32
          "simt_step.yield"(%17) {fallthrough = false} : (i32) -> ()
        ^bb1(%18: i32):  // no predecessors
          %c4_i32_7 = arith.constant 4 : i32
          %19 = arith.addi %18, %c4_i32_7 : i32
    ...
    %9 = "simt_step.if"(%8) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %15 = arith.muli %arg3, %c64_i32_6 : i32
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %22 = arith.muli %arg5, %c64_i32_11 : i32
          %23 = arith.addi %22, %0 : i32
          %c512_i32_12 = arith.constant 512 : i32
          %24 = arith.addi %c512_i32_12, %23 : i32
        ...
        ^bb0(%arg4: i32, %arg5: i32):
          ...
          %24 = arith.muli %arg5, %c64_i32_13 : i32
        ...
        %18 = arith.muli %arg3, %c64_i32_9 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %17 = arith.addi %c1024_i32, %16 : i32
