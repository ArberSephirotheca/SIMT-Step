module {
  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [64, 1, 1], simt.subgroup_width = 32 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        ^bb3(%30: i32):  // no predecessors
          ...
          %31 = arith.addi %30, %c2_i32_10 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %21 = arith.addi %c1152_i32, %20 : i32
    ...
    %16 = "simt_step.if"(%15) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %22 = arith.addi %c1536_i32_9, %21 : i32
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %27 = arith.muli %arg3, %c64_i32_12 : i32
        %28 = arith.addi %c2304_i32, %27 : i32
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %22 = arith.addi %c1920_i32, %21 : i32
        %23 = "simt_step.buffer.load"(%arg1, %22) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_9 = arith.constant 0 : i32
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %25 = arith.addi %c2560_i32, %24 : i32
