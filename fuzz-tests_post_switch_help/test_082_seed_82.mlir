  ...
  func.func @main(%arg0: !simt_step.resource<Global, i32>, %arg1: !simt_step.resource<Global, i32>) attributes {simt.num_threads = [64, 1, 1], simt.subgroup_width = 32 : i64} {
    ...
    "simt_step.if"(%5) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        ^bb0(%arg4: i32):
          %c4_i32 = arith.constant 4 : i32
          %23 = arith.addi %arg4, %c4_i32 : i32
          "simt_step.yield"(%23) {fallthrough = false} : (i32) -> ()
        ^bb1(%24: i32):  // no predecessors
          %c2_i32_8 = arith.constant 2 : i32
          %25 = arith.addi %24, %c2_i32_8 : i32
          "simt_step.yield"(%25) {fallthrough = false} : (i32) -> ()
        ^bb2(%26: i32):  // no predecessors
          %c4_i32_9 = arith.constant 4 : i32
          %27 = arith.addi %26, %c4_i32_9 : i32
    ...
    ^bb0(%arg2: i32, %arg3: i32):
      ...
      %22 = "simt_step.if"(%21) ({
        ...
        %34 = "simt_step.if"(%33) ({
          ...
          %37 = arith.addi %0, %c0_i32_14 : i32
          "simt_step.yield"(%37) : (i32) -> ()
        }) : (i1) -> i32
        %c512_i32_12 = arith.constant 512 : i32
        %35 = arith.addi %c512_i32_12, %0 : i32
      ...
      %27 = arith.muli %arg3, %c64_i32_9 : i32
    ...
    %10 = "simt_step.if"(%9) ({
      ...
      %22 = "simt_step.if"(%21) ({
        ...
        ^bb0(%arg2: i32, %arg3: i32):
          ...
          %26 = arith.muli %arg3, %c64_i32_10 : i32
        ...
        ^bb0(%arg2: i32, %arg3: i32):
          ...
          %28 = arith.muli %arg3, %c64_i32_11 : i32
          %29 = arith.addi %c1280_i32, %28 : i32
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %22 = arith.addi %c1088_i32, %21 : i32
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %c64_i32_9 = arith.constant 64 : i32
        %22 = arith.muli %arg3, %c64_i32_9 : i32
        %23 = arith.addi %c2048_i32, %22 : i32
    ...
    %11 = arith.addi %c2304_i32, %0 : i32
    %true = arith.constant true
    %12 = "simt_step.wave_count_bits"(%true) : (i1) -> i32
    "simt_step.buffer.store"(%arg0, %11, %12) : (!simt_step.resource<Global, i32>, i32, i32) -> ()
    %c1408_i32 = arith.constant 1408 : i32
    %13 = arith.addi %c1408_i32, %0 : i32
    ...
    %16 = "simt_step.if"(%15) ({
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %22 = arith.addi %c1472_i32, %21 : i32
        %23 = "simt_step.buffer.load"(%arg1, %22) : (!simt_step.resource<Global, i32>, i32) -> i32
        %c0_i32_9 = arith.constant 0 : i32
        %24 = arith.cmpi ne, %23, %c0_i32_9 : i32
        "simt_step.condition"(%24, %arg2, %arg3) : (i1, i32, i32) -> ()
      ...
      ^bb0(%arg2: i32, %arg3: i32):
        ...
        %c64_i32_9 = arith.constant 64 : i32
        %23 = arith.muli %arg3, %c64_i32_9 : i32
